# ----------------------------------------------------------------------------
# prepwr VHDL output 'prepwr_main.vhdl' vs Untimed C++
#
...
# Generated date: Wed Mar 08 15:22:50 CET 2023
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/dirren/Catapult/Catapult_example/main.v2
#   WORKING_DIR   /home/dirren/Catapult/Catapult_example/main.v2/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult_example/main.v2
PROJ2SOLN = ./Catapult_example/main.v2
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/dirren/Catapult/Catapult_example/main.v2/prepwr_main.vhdl
endif
...
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./Catapult_example/main.v2/scverify_msim.tcl
...
ifeq ($(GATE_VHDL_DEP),)
GATE_VHDL_DEP = ./prepwr_main.vhdl/prepwr_main.vhdl.vhdlts
endif
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = 
endif
endif
VHDL_SRC += ./prepwr_main_ccs_out_v1.vhd/prepwr_main_ccs_out_v1.vhd.vhdlts ./prepwr_main_mgc_io_sync_v2.vhd/prepwr_main_mgc_io_sync_v2.vhd.vhdlts $(GATE_VHDL_DEP)
VLOG_SRC +=  $(GATE_VLOG_DEP)
else
VHDL_SRC += ./prepwr_main_ccs_out_v1.vhd/prepwr_main_ccs_out_v1.vhd.vhdlts ./prepwr_main_mgc_io_sync_v2.vhd/prepwr_main_mgc_io_sync_v2.vhd.vhdlts ./prepwr_main.vhdl/prepwr_main.vhdl.vhdlts
VLOG_SRC += 
endif
CXX_SRC  = ../example.cpp/example.cpp.cxxts ./scverify/mc_testbench.cpp/mc_testbench.cpp.cxxts ./scverify/scverify_top.cpp/scverify_top.cpp.cxxts
...
$(TARGET)/prepwr_main_ccs_out_v1.vhd.vhdlts: ./prepwr_main_ccs_out_v1.vhd
$(TARGET)/prepwr_main_mgc_io_sync_v2.vhd.vhdlts: ./prepwr_main_mgc_io_sync_v2.vhd
$(TARGET)/prepwr_main.vhdl.vhdlts: ./prepwr_main.vhdl
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/example.cpp.cxxts: ../example.cpp
...
$(TARGET)/example.cpp.cxxts: CXX_OPTS=
$(TARGET)/scverify_top.cpp.cxxts: CXX_OPTS=
$(TARGET)/mc_testbench.cpp.cxxts: CXX_OPTS=$(F_WRAP_OPT)
# 
# Specify dependencies
$(TARGET)/example.cpp.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
...
$(TARGET)/prepwr_main_ccs_out_v1.vhd.vhdlts: HDL_LIB=mgc_hls
$(TARGET)/prepwr_main.vhdl.vhdlts: HDL_LIB=work
$(TARGET)/prepwr_main_mgc_io_sync_v2.vhd.vhdlts: HDL_LIB=mgc_hls
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/prepwr_main_ccs_out_v1.vhd.vhdlts: VHDL_F_OPTS=
$(TARGET)/prepwr_main.vhdl.vhdlts: VHDL_F_OPTS=
$(TARGET)/prepwr_main_mgc_io_sync_v2.vhd.vhdlts: VHDL_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/prepwr_main.vhdl.vhdlts: DUT_E=main

# Specify top design unit
$(TARGET)/prepwr_main.vhdl.vhdlts: VHDL_TOP=1
