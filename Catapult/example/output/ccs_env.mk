ifeq "$(CXX_HOME)" ""
CXX_HOME                                               := /softs/mentor/cpult/10.5c/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                               := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                         := can't read "MODEL_TECH": no such variable
...
OSCI_SYSTEMC_INCLUDE                                   := /softs/mentor/cpult/10.5c/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                       := /softs/mentor/cpult/10.5c/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(VCS_VCS_HOME)" ""
VCS_VCS_HOME                                           := can't read "VCS_HOME": no such variable
export VCS_VCS_HOME
endif
...
DesignCompiler_MaxCores                                := 8
export DesignCompiler_MaxCores
endif
ifeq "$(DesignCompiler_HighVthMarker)" ""
DesignCompiler_HighVthMarker                           := 
export DesignCompiler_HighVthMarker
endif
ifeq "$(DesignCompiler_LowVthMarker)" ""
DesignCompiler_LowVthMarker                            := 
export DesignCompiler_LowVthMarker
endif
ifeq "$(DesignCompiler_LowVthPercent)" ""
DesignCompiler_LowVthPercent                           := 
export DesignCompiler_LowVthPercent
endif
ifeq "$(DesignCompiler_LowVthConstraintType)" ""
DesignCompiler_LowVthConstraintType                    := none
export DesignCompiler_LowVthConstraintType
endif
...
ifeq "$(PowerAnalysis_GLOBAL_OPTIONS)" ""
PowerAnalysis_GLOBAL_OPTIONS                           := 
export PowerAnalysis_GLOBAL_OPTIONS
endif
ifeq "$(PowerAnalysis_WIRELOAD_MODE)" ""
PowerAnalysis_WIRELOAD_MODE                            := top
export PowerAnalysis_WIRELOAD_MODE
endif
ifeq "$(PowerAnalysis_WIRELOAD_MODEL)" ""
PowerAnalysis_WIRELOAD_MODEL                           := 
export PowerAnalysis_WIRELOAD_MODEL
endif
ifeq "$(PowerAnalysis_CLOCK_TREE_BUFFER)" ""
PowerAnalysis_CLOCK_TREE_BUFFER                        := 
export PowerAnalysis_CLOCK_TREE_BUFFER
endif
ifeq "$(PowerAnalysis_CLOCK_TREE_FANOUT)" ""
PowerAnalysis_CLOCK_TREE_FANOUT                        := 16
export PowerAnalysis_CLOCK_TREE_FANOUT
endif
ifeq "$(PowerAnalysis_CLOCK_TREE_ROOT_BUFFER)" ""
PowerAnalysis_CLOCK_TREE_ROOT_BUFFER                   := 
export PowerAnalysis_CLOCK_TREE_ROOT_BUFFER
endif
ifeq "$(PowerAnalysis_CLOCK_TREE_ROOT_BUFFER_FANOUT)" ""
PowerAnalysis_CLOCK_TREE_ROOT_BUFFER_FANOUT            := 8
export PowerAnalysis_CLOCK_TREE_ROOT_BUFFER_FANOUT
endif
ifeq "$(PowerAnalysis_CLOCK_TREE_FINAL_BUFFER)" ""
PowerAnalysis_CLOCK_TREE_FINAL_BUFFER                  := 
export PowerAnalysis_CLOCK_TREE_FINAL_BUFFER
endif
ifeq "$(PowerAnalysis_CLOCK_TREE_FINAL_BUFFER_FANOUT)" ""
PowerAnalysis_CLOCK_TREE_FINAL_BUFFER_FANOUT           := 32
export PowerAnalysis_CLOCK_TREE_FINAL_BUFFER_FANOUT
endif
ifeq "$(PowerAnalysis_SWITCHING_ACTIVITY_TYPE)" ""
PowerAnalysis_SWITCHING_ACTIVITY_TYPE                  := fsdb
export PowerAnalysis_SWITCHING_ACTIVITY_TYPE
endif
ifeq "$(PowerAnalysis_STARTUP_SCRIPT_PATH)" ""
PowerAnalysis_STARTUP_SCRIPT_PATH                      := 
export PowerAnalysis_STARTUP_SCRIPT_PATH
endif
ifeq "$(PowerAnalysis_SPEF_FILE)" ""
PowerAnalysis_SPEF_FILE                                := 
export PowerAnalysis_SPEF_FILE
endif
ifeq "$(PowerAnalysis_CLOCK_GATING_MIN_WIDTH)" ""
PowerAnalysis_CLOCK_GATING_MIN_WIDTH                   := 0
export PowerAnalysis_CLOCK_GATING_MIN_WIDTH
endif
ifeq "$(PowerAnalysis_INSERT_OBS)" ""
PowerAnalysis_INSERT_OBS                               := true
export PowerAnalysis_INSERT_OBS
endif
ifeq "$(PowerAnalysis_OBS_EFFORT_LEVEL)" ""
PowerAnalysis_OBS_EFFORT_LEVEL                         := high
export PowerAnalysis_OBS_EFFORT_LEVEL
endif
ifeq "$(PowerAnalysis_INSERT_STB_C)" ""
PowerAnalysis_INSERT_STB_C                             := true
export PowerAnalysis_INSERT_STB_C
endif
ifeq "$(PowerAnalysis_STB_C_EFFORT_LEVEL)" ""
PowerAnalysis_STB_C_EFFORT_LEVEL                       := high
export PowerAnalysis_STB_C_EFFORT_LEVEL
endif
ifeq "$(PowerAnalysis_INSERT_STB_S)" ""
PowerAnalysis_INSERT_STB_S                             := true
export PowerAnalysis_INSERT_STB_S
endif
ifeq "$(PowerAnalysis_STB_S_EFFORT_LEVEL)" ""
PowerAnalysis_STB_S_EFFORT_LEVEL                       := high
export PowerAnalysis_STB_S_EFFORT_LEVEL
endif
ifeq "$(PowerAnalysis_CG_OVERRIDE)" ""
PowerAnalysis_CG_OVERRIDE                              := 
export PowerAnalysis_CG_OVERRIDE
endif
ifeq "$(PowerAnalysis_ENABLE_SLECPRO)" ""
PowerAnalysis_ENABLE_SLECPRO                           := disabled
export PowerAnalysis_ENABLE_SLECPRO
endif
ifeq "$(PowerAnalysis_SLECPRO_QUEUELIC_LIMIT)" ""
PowerAnalysis_SLECPRO_QUEUELIC_LIMIT                   := 0s
export PowerAnalysis_SLECPRO_QUEUELIC_LIMIT
endif
ifeq "$(PowerAnalysis_USE_SLECPRO_MAP_FILE)" ""
PowerAnalysis_USE_SLECPRO_MAP_FILE                     := false
export PowerAnalysis_USE_SLECPRO_MAP_FILE
endif
ifeq "$(PowerAnalysis_DEBUG)" ""
PowerAnalysis_DEBUG                                    := false
export PowerAnalysis_DEBUG
endif
ifeq "$(PowerAnalysis_NO_LIBERTY)" ""
PowerAnalysis_NO_LIBERTY                               := false
export PowerAnalysis_NO_LIBERTY
endif
ifeq "$(PowerAnalysis_NO_VECTORS)" ""
PowerAnalysis_NO_VECTORS                               := false
export PowerAnalysis_NO_VECTORS
endif
ifeq "$(PowerAnalysis_ITERATIVE_WRITE_RTL)" ""
PowerAnalysis_ITERATIVE_WRITE_RTL                      := true
export PowerAnalysis_ITERATIVE_WRITE_RTL
endif
ifeq "$(PowerAnalysis_NUMERICAL_SOLVERS)" ""
PowerAnalysis_NUMERICAL_SOLVERS                        := false
export PowerAnalysis_NUMERICAL_SOLVERS
endif
ifeq "$(PowerAnalysis_DEBUG_LEVEL)" ""
PowerAnalysis_DEBUG_LEVEL                              := 0
export PowerAnalysis_DEBUG_LEVEL
endif
ifeq "$(PowerAnalysis_EFFORT_LEVEL)" ""
PowerAnalysis_EFFORT_LEVEL                             := high
export PowerAnalysis_EFFORT_LEVEL
endif
