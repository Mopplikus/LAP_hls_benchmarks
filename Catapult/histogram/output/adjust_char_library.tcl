...
#library load /softs/mentor/cpult/10.5c/Mgc_home/pkgs/siflibs/nangate/nangate-45nm_beh.lib
...
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_l/PARAMETERS/width_s -- -CHAR_RANGE {1 to 6 by 1, 9}
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_bl/PARAMETERS/width_a -- -CHAR_RANGE {1, 4 to 32 by 7}
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_bl/PARAMETERS/width_s -- -CHAR_RANGE {1 to 6 by 1, 10}
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_r/PARAMETERS/width_s -- -CHAR_RANGE {1 to 6 by 1, 9}
library set /LIBS/nangate-45nm_beh/MODS/mgc_shift_br/PARAMETERS/width_s -- -CHAR_RANGE {1 to 6 by 1, 10}
