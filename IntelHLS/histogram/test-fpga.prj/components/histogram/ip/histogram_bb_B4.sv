...
// SystemVerilog created from bb_histogram_B4
...
module histogram_bb_B4 (
    ...
    wire [0:0] bb_histogram_B4_stall_region_out_stall_out;
    wire [0:0] bb_histogram_B4_stall_region_out_valid_out;
    wire [0:0] histogram_B4_branch_out_stall_out;
    wire [0:0] histogram_B4_branch_out_valid_out_0;
    wire [0:0] histogram_B4_merge_out_stall_out_0;
    wire [0:0] histogram_B4_merge_out_valid_out;


    // histogram_B4_branch(BLACKBOX,3)
    histogram_B4_branch thehistogram_B4_branch (
    ...
    histogram_bb_B4_stall_region thebb_histogram_B4_stall_region (
    ...
    histogram_B4_merge thehistogram_B4_merge (
    ...
    assign out_stall_out_0 = histogram_B4_merge_out_stall_out_0;

    // out_valid_out_0(GPOUT,8)
    assign out_valid_out_0 = histogram_B4_branch_out_valid_out_0;
