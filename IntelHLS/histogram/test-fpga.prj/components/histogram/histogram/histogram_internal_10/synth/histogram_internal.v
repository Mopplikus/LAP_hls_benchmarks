...
/////////////////////////////////////////////////////////////////
// MODULE histogram_internal
/////////////////////////////////////////////////////////////////
module histogram_internal
(
   input logic clock,
   input logic resetn,
   input logic [63:0] hist_r,
   input logic [31:0] n,
   input logic start,
   output logic busy,
   output logic done,
   ...
   // INST histogram_internal of histogram_function_wrapper
   histogram_function_wrapper histogram_internal
   (
      .clock(clock),
      .resetn(resetn),
      .hist_r(hist_r),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_unnamed_histogram9_histogram
      .avm_unnamed_histogram9_histogram_enable(avmm_0_global_avm_enable[0]),
      .avm_unnamed_histogram9_histogram_read(avmm_0_global_avm_read[0]),
      .avm_unnamed_histogram9_histogram_write(avmm_0_global_avm_write[0]),
      .avm_unnamed_histogram9_histogram_address(avmm_0_global_avm_address[0]),
      .avm_unnamed_histogram9_histogram_writedata(avmm_0_global_avm_writedata[0]),
      .avm_unnamed_histogram9_histogram_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_unnamed_histogram9_histogram_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_unnamed_histogram9_histogram_readdata(avmm_0_global_avm_readdata[0]),
      .avm_unnamed_histogram9_histogram_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_unnamed_histogram9_histogram_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_unnamed_histogram9_histogram_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_lm1_histogram
      .avm_lm1_histogram_enable(local_avm_aspace64_enable[0][0]),
      .avm_lm1_histogram_read(local_avm_aspace64_read[0][0]),
      .avm_lm1_histogram_write(local_avm_aspace64_write[0][0]),
      .avm_lm1_histogram_address(local_avm_aspace64_address[0][0]),
      .avm_lm1_histogram_writedata(local_avm_aspace64_writedata[0][0]),
      .avm_lm1_histogram_byteenable(local_avm_aspace64_byteenable[0][0]),
      .avm_lm1_histogram_waitrequest(local_avm_aspace64_waitrequest[0][0]),
      .avm_lm1_histogram_readdata(local_avm_aspace64_readdata[0][0]),
      .avm_lm1_histogram_readdatavalid(local_avm_aspace64_readdatavalid[0][0]),
      .avm_lm1_histogram_burstcount(local_avm_aspace64_burstcount[0][0]),
      .avm_lm1_histogram_writeack(local_avm_aspace64_writeack[0][0]),
      // AVM avm_memdep_histogram
      .avm_memdep_histogram_enable(local_avm_aspace64_enable[0][1]),
      .avm_memdep_histogram_read(local_avm_aspace64_read[0][1]),
      .avm_memdep_histogram_write(local_avm_aspace64_write[0][1]),
      .avm_memdep_histogram_address(local_avm_aspace64_address[0][1]),
      .avm_memdep_histogram_writedata(local_avm_aspace64_writedata[0][1]),
      .avm_memdep_histogram_byteenable(local_avm_aspace64_byteenable[0][1]),
      .avm_memdep_histogram_waitrequest(local_avm_aspace64_waitrequest[0][1]),
      .avm_memdep_histogram_readdata(local_avm_aspace64_readdata[0][1]),
      .avm_memdep_histogram_readdatavalid(local_avm_aspace64_readdatavalid[0][1]),
      .avm_memdep_histogram_burstcount(local_avm_aspace64_burstcount[0][1]),
      .avm_memdep_histogram_writeack(local_avm_aspace64_writeack[0][1]),
      // AVM avm_lm92_histogram
      .avm_lm92_histogram_enable(local_avm_aspace65_enable[0][0]),
      .avm_lm92_histogram_read(local_avm_aspace65_read[0][0]),
      .avm_lm92_histogram_write(local_avm_aspace65_write[0][0]),
      .avm_lm92_histogram_address(local_avm_aspace65_address[0][0]),
      .avm_lm92_histogram_writedata(local_avm_aspace65_writedata[0][0]),
      .avm_lm92_histogram_byteenable(local_avm_aspace65_byteenable[0][0]),
      .avm_lm92_histogram_waitrequest(local_avm_aspace65_waitrequest[0][0]),
      .avm_lm92_histogram_readdata(local_avm_aspace65_readdata[0][0]),
      .avm_lm92_histogram_readdatavalid(local_avm_aspace65_readdatavalid[0][0]),
      .avm_lm92_histogram_burstcount(local_avm_aspace65_burstcount[0][0]),
      .avm_lm92_histogram_writeack(local_avm_aspace65_writeack[0][0]),
      // AVM avm_memdep_4_histogram
      .avm_memdep_4_histogram_enable(local_avm_aspace65_enable[0][1]),
      .avm_memdep_4_histogram_read(local_avm_aspace65_read[0][1]),
      .avm_memdep_4_histogram_write(local_avm_aspace65_write[0][1]),
      .avm_memdep_4_histogram_address(local_avm_aspace65_address[0][1]),
      .avm_memdep_4_histogram_writedata(local_avm_aspace65_writedata[0][1]),
      .avm_memdep_4_histogram_byteenable(local_avm_aspace65_byteenable[0][1]),
      .avm_memdep_4_histogram_waitrequest(local_avm_aspace65_waitrequest[0][1]),
      .avm_memdep_4_histogram_readdata(local_avm_aspace65_readdata[0][1]),
      .avm_memdep_4_histogram_readdatavalid(local_avm_aspace65_readdatavalid[0][1]),
      .avm_memdep_4_histogram_burstcount(local_avm_aspace65_burstcount[0][1]),
      .avm_memdep_4_histogram_writeack(local_avm_aspace65_writeack[0][1]),
      // AVM avm_lm113_histogram
      .avm_lm113_histogram_enable(local_avm_aspace66_enable[0][0]),
      .avm_lm113_histogram_read(local_avm_aspace66_read[0][0]),
      .avm_lm113_histogram_write(local_avm_aspace66_write[0][0]),
      .avm_lm113_histogram_address(local_avm_aspace66_address[0][0]),
      .avm_lm113_histogram_writedata(local_avm_aspace66_writedata[0][0]),
      .avm_lm113_histogram_byteenable(local_avm_aspace66_byteenable[0][0]),
      .avm_lm113_histogram_waitrequest(local_avm_aspace66_waitrequest[0][0]),
      .avm_lm113_histogram_readdata(local_avm_aspace66_readdata[0][0]),
      .avm_lm113_histogram_readdatavalid(local_avm_aspace66_readdatavalid[0][0]),
      .avm_lm113_histogram_burstcount(local_avm_aspace66_burstcount[0][0]),
      .avm_lm113_histogram_writeack(local_avm_aspace66_writeack[0][0]),
      // AVM avm_memdep_5_histogram
      .avm_memdep_5_histogram_enable(local_avm_aspace66_enable[0][1]),
      .avm_memdep_5_histogram_read(local_avm_aspace66_read[0][1]),
      .avm_memdep_5_histogram_write(local_avm_aspace66_write[0][1]),
      .avm_memdep_5_histogram_address(local_avm_aspace66_address[0][1]),
      .avm_memdep_5_histogram_writedata(local_avm_aspace66_writedata[0][1]),
      .avm_memdep_5_histogram_byteenable(local_avm_aspace66_byteenable[0][1]),
      .avm_memdep_5_histogram_waitrequest(local_avm_aspace66_waitrequest[0][1]),
      .avm_memdep_5_histogram_readdata(local_avm_aspace66_readdata[0][1]),
      .avm_memdep_5_histogram_readdatavalid(local_avm_aspace66_readdatavalid[0][1]),
      .avm_memdep_5_histogram_burstcount(local_avm_aspace66_burstcount[0][1]),
      .avm_memdep_5_histogram_writeack(local_avm_aspace66_writeack[0][1]),
      // AVM avm_memdep_6_histogram
      .avm_memdep_6_histogram_enable(local_avm_aspace66_enable[0][2]),
      .avm_memdep_6_histogram_read(local_avm_aspace66_read[0][2]),
      .avm_memdep_6_histogram_write(local_avm_aspace66_write[0][2]),
      .avm_memdep_6_histogram_address(local_avm_aspace66_address[0][2]),
      .avm_memdep_6_histogram_writedata(local_avm_aspace66_writedata[0][2]),
      .avm_memdep_6_histogram_byteenable(local_avm_aspace66_byteenable[0][2]),
      .avm_memdep_6_histogram_waitrequest(local_avm_aspace66_waitrequest[0][2]),
      .avm_memdep_6_histogram_readdata(local_avm_aspace66_readdata[0][2]),
      .avm_memdep_6_histogram_readdatavalid(local_avm_aspace66_readdatavalid[0][2]),
      .avm_memdep_6_histogram_burstcount(local_avm_aspace66_burstcount[0][2]),
      .avm_memdep_6_histogram_writeack(local_avm_aspace66_writeack[0][2]),
      // AVM avm_unnamed_histogram8_histogram
      .avm_unnamed_histogram8_histogram_enable(local_avm_aspace66_enable[0][3]),
      .avm_unnamed_histogram8_histogram_read(local_avm_aspace66_read[0][3]),
      .avm_unnamed_histogram8_histogram_write(local_avm_aspace66_write[0][3]),
      .avm_unnamed_histogram8_histogram_address(local_avm_aspace66_address[0][3]),
      .avm_unnamed_histogram8_histogram_writedata(local_avm_aspace66_writedata[0][3]),
      .avm_unnamed_histogram8_histogram_byteenable(local_avm_aspace66_byteenable[0][3]),
      .avm_unnamed_histogram8_histogram_waitrequest(local_avm_aspace66_waitrequest[0][3]),
      .avm_unnamed_histogram8_histogram_readdata(local_avm_aspace66_readdata[0][3]),
      .avm_unnamed_histogram8_histogram_readdatavalid(local_avm_aspace66_readdatavalid[0][3]),
      .avm_unnamed_histogram8_histogram_burstcount(local_avm_aspace66_burstcount[0][3]),
      .avm_unnamed_histogram8_histogram_writeack(local_avm_aspace66_writeack[0][3])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of histogram_internal_ic_5272295805250791862
      histogram_internal_ic_5272295805250791862 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE histogram_internal_ic_5272295805250791862
/////////////////////////////////////////////////////////////////
module histogram_internal_ic_5272295805250791862
(
   input logic clock,
