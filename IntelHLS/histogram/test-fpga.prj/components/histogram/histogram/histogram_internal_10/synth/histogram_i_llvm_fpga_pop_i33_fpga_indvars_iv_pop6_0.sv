...
module histogram_i_llvm_fpga_pop_i33_fpga_indvars_iv_pop6_0 (
    ...
    // i_llvm_fpga_pop_i33_fpga_indvars_iv_pop6_histogram1(EXTIFACE,7)@5
    ...
    assign i_llvm_fpga_pop_i33_fpga_indvars_iv_pop6_histogram1_stall_in = in_stall_in;
    ...
    assign adapt_scalar_trunc4_sel_x_b = i_llvm_fpga_pop_i33_fpga_indvars_iv_pop6_histogram1_data_out[32:0];

    // dupName_0_sync_out_x(GPOUT,12)@5
    assign out_data_out = adapt_scalar_trunc4_sel_x_b;
    assign out_valid_out = i_llvm_fpga_pop_i33_fpga_indvars_iv_pop6_histogram1_valid_out;
