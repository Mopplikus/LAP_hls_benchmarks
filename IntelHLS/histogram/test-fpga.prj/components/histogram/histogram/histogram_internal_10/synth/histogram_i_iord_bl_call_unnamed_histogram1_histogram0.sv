...
// SystemVerilog created from i_iord_bl_call_histogram_unnamed_histogram1_histogram0
...
module histogram_i_iord_bl_call_unnamed_histogram1_histogram0 (
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,17)@76
