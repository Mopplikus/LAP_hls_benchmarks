...
# ACDS 21.4 67 linux 2023.04.07.17:13:22
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     sso_histogram_hist_r
# 
...
# ----------------------------------------
# If sso_histogram_hist_r is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sso_histogram_hist_r.sso_histogram_hist_r"
}
...
append ELAB_OPTIONS [subst [sso_histogram_hist_r::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [sso_histogram_hist_r::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [sso_histogram_hist_r::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [sso_histogram_hist_r::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [sso_histogram_hist_r::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [sso_histogram_hist_r::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
