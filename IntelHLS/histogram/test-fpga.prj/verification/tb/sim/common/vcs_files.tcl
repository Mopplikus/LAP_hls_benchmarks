...
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_histogram_avmm_0_rw/sim/common/vcs_files.tcl]
...
namespace eval tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [mm_agent_histogram_avmm_0_rw::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_histogram_avmm_0_rw/sim/"]]
  ...
  proc get_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [mm_agent_histogram_avmm_0_rw::get_design_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_histogram_avmm_0_rw/sim/"]]
