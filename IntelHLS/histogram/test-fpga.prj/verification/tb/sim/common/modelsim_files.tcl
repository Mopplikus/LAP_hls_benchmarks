source [file join [file dirname [info script]] ./../../../ip/tb/histogram_en_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/histogram/histogram/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_histogram_n/sim/common/modelsim_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_histogram/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_histogram_avmm_0_rw/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_histogram_hist_r/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_done/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/histogram_ir_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/histogram_cfan/sim/common/modelsim_files.tcl]
