...
# ACDS 21.4 67 linux 2023.03.14.13:55:14
# ----------------------------------------
...
# ----------------------------------------
# If sso_example_B is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sso_example_B.sso_example_B"
}
...
append ELAB_OPTIONS [subst [sso_example_B::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [sso_example_B::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [sso_example_B::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [sso_example_B::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [sso_example_B::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [sso_example_B::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
