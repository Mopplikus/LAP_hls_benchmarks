...
module example_bb_B1_start_stall_region (
    ...
    wire [0:0] i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_stall_out;
    wire [0:0] i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_valid_out;
    ...
    assign SE_stall_entry_backStall = example_B1_start_merge_reg_out_stall_out | ~ (SE_stall_entry_wireValid);
    // Computing multiple Valid(s)
    assign SE_stall_entry_wireValid = in_valid_in;

    // example_B1_start_merge_reg(BLACKBOX,6)@0
    // in in_stall_in@20000000
    // out out_data_out@1
    // out out_stall_out@20000000
    // out out_valid_out@1
    example_B1_start_merge_reg theexample_B1_start_merge_reg (
        .in_data_in(GND_q),
        .in_stall_in(SE_out_example_B1_start_merge_reg_backStall),
        .in_valid_in(SE_stall_entry_V0),
        .out_data_out(),
        .out_stall_out(example_B1_start_merge_reg_out_stall_out),
        .out_valid_out(example_B1_start_merge_reg_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    // Backward Stall generation
    assign SE_out_example_B1_start_merge_reg_backStall = i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_out_o_stall | ~ (SE_out_example_B1_start_merge_reg_wireValid);
    // Computing multiple Valid(s)
    ...
    // out out_stall_out@20000000
    // out out_valid_out@2
    example_i_llvm_fpga_pop_throttle_i1_throttle_pop_0 thei_llvm_fpga_pop_throttle_i1_throttle_pop_example1 (
        .in_data_in(GND_q),
        .in_dir(GND_q),
        .in_feedback_in_1(in_feedback_in_1),
        .in_feedback_valid_in_1(in_feedback_valid_in_1),
        .in_predicate(GND_q),
        .in_stall_in(SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_example1_backStall),
        .in_valid_in(SE_out_i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_V0),
        .out_data_out(i_llvm_fpga_pop_throttle_i1_throttle_pop_example1_out_data_out),
        .out_feedback_stall_out_1(i_llvm_fpga_pop_throttle_i1_throttle_pop_example1_out_feedback_stall_out_1),
        .out_stall_out(i_llvm_fpga_pop_throttle_i1_throttle_pop_example1_out_stall_out),
        .out_valid_out(i_llvm_fpga_pop_throttle_i1_throttle_pop_example1_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    // Backward Stall generation
    assign SE_out_i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_backStall = i_llvm_fpga_pop_throttle_i1_throttle_pop_example1_out_stall_out | ~ (SE_out_i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_wireValid);
    // Computing multiple Valid(s)
    ...
    example_i_sfc_s_c0_in_wt_entry_s_c0_enter1_example0 thei_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x (
        .in_i_stall(SE_out_i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_backStall),
        .in_i_valid(SE_out_example_B1_start_merge_reg_V0),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_unnamed_example0_0_tpl(GND_q),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_stall_out(i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_valid_out(i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_valid_out),
    ...
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_valid_out = i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_valid_out;
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_stall_out = i_sfc_s_c0_in_wt_entry_examples_c0_enter1_example0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going3_example1_exiting_stall_out;
