...
(
   ...
   (
      ...
      // AVM avm_unnamed_example5_example
      .avm_unnamed_example5_example_enable(avmm_0_global_avm_enable[0]),
      .avm_unnamed_example5_example_read(avmm_0_global_avm_read[0]),
      .avm_unnamed_example5_example_write(avmm_0_global_avm_write[0]),
      .avm_unnamed_example5_example_address(avmm_0_global_avm_address[0]),
      .avm_unnamed_example5_example_writedata(avmm_0_global_avm_writedata[0]),
      .avm_unnamed_example5_example_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_unnamed_example5_example_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_unnamed_example5_example_readdata(avmm_0_global_avm_readdata[0]),
      .avm_unnamed_example5_example_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_unnamed_example5_example_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_unnamed_example5_example_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_example6_example
      .avm_unnamed_example6_example_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_example6_example_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_example6_example_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_example6_example_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_example6_example_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_example6_example_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_example6_example_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_example6_example_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_example6_example_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_example6_example_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_example6_example_writeack(avmm_0_global_avm_writeack[1])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of example_internal_ic_15164838281812161745
      example_internal_ic_15164838281812161745 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE example_internal_ic_15164838281812161745
/////////////////////////////////////////////////////////////////
module example_internal_ic_15164838281812161745
(
   input logic clock,
