...
source [file join [file dirname [info script]] ./../../../ip/tb/sso_atax_tmp/sim/common/modelsim_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_atax_avmm_0_rw/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_atax_y/sim/common/modelsim_files.tcl]
...
namespace eval tb {
  proc get_design_libraries {} {
    ...
    set libraries [dict merge $libraries [sso_atax_tmp::get_design_libraries]]
    ...
    set libraries [dict merge $libraries [mm_agent_atax_avmm_0_rw::get_design_libraries]]
    set libraries [dict merge $libraries [sso_atax_y::get_design_libraries]]
  ...
  proc get_memory_files {QSYS_SIMDIR} {
    ...
    set memory_files [concat $memory_files [sso_atax_tmp::get_memory_files "$QSYS_SIMDIR/../../ip/tb/sso_atax_tmp/sim/"]]
    ...
    set memory_files [concat $memory_files [mm_agent_atax_avmm_0_rw::get_memory_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_atax_avmm_0_rw/sim/"]]
    set memory_files [concat $memory_files [sso_atax_y::get_memory_files "$QSYS_SIMDIR/../../ip/tb/sso_atax_y/sim/"]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_atax_tmp::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_atax_tmp/sim/"]]
    ...
    set design_files [dict merge $design_files [mm_agent_atax_avmm_0_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_atax_avmm_0_rw/sim/"]]
    set design_files [dict merge $design_files [sso_atax_y::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_atax_y/sim/"]]
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [sso_atax_tmp::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_atax_tmp/sim/"]]
    ...
    set design_files [concat $design_files [mm_agent_atax_avmm_0_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_atax_avmm_0_rw/sim/"]]
    set design_files [concat $design_files [sso_atax_y::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_atax_y/sim/"]]
  ...
  proc get_elab_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append ELAB_OPTIONS [sso_atax_tmp::get_elab_options $SIMULATOR_TOOL_BITNESS]
    ...
    append ELAB_OPTIONS [mm_agent_atax_avmm_0_rw::get_elab_options $SIMULATOR_TOOL_BITNESS]
    append ELAB_OPTIONS [sso_atax_y::get_elab_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_sim_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append SIM_OPTIONS [sso_atax_tmp::get_sim_options $SIMULATOR_TOOL_BITNESS]
    ...
    append SIM_OPTIONS [mm_agent_atax_avmm_0_rw::get_sim_options $SIMULATOR_TOOL_BITNESS]
    append SIM_OPTIONS [sso_atax_y::get_sim_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_env_variables {SIMULATOR_TOOL_BITNESS} {
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [sso_atax_tmp::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mm_agent_atax_avmm_0_rw::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [sso_atax_y::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
