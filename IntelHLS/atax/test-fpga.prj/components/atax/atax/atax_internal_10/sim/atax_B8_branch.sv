...
module atax_B8_branch (
    ...
    assign out_c0_exe21793 = in_c0_exe21793;

    // out_c0_exe31804(GPOUT,11)
    assign out_c0_exe31804 = in_c0_exe31804;

    // out_c0_exe61836(GPOUT,12)
    assign out_c0_exe61836 = in_c0_exe61836;

    // out_c0_exe71847(GPOUT,13)
    assign out_c0_exe71847 = in_c0_exe71847;

    // out_c0_exe88(GPOUT,14)
    assign out_c0_exe88 = in_c0_exe88;
