...
module atax_bb_B1_start (
    ...
    wire [0:0] bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_stall_out;
    wire [0:0] bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_valid_out;
    ...
    wire [63:0] bb_atax_B1_start_stall_region_out_intel_reserved_ffwd_3_0;
    ...
    atax_bb_B1_start_stall_region thebb_atax_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_stall_out(bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_valid_out(bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_valid_out),
        ...
        .out_intel_reserved_ffwd_3_0(bb_atax_B1_start_stall_region_out_intel_reserved_ffwd_3_0),
    ...
    assign out_exiting_stall_out = bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,14)
    assign out_exiting_valid_out = bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going89_atax1_exiting_valid_out;
    ...
    assign out_intel_reserved_ffwd_3_0 = bb_atax_B1_start_stall_region_out_intel_reserved_ffwd_3_0;

    // out_iord_bl_call_atax_o_fifoalmost_full(GPOUT,19)
    assign out_iord_bl_call_atax_o_fifoalmost_full = bb_atax_B1_start_stall_region_out_iord_bl_call_atax_o_fifoalmost_full;

    // out_iord_bl_call_atax_o_fifoready(GPOUT,20)
