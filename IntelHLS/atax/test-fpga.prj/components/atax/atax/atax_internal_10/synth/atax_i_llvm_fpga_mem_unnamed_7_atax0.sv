...
// SystemVerilog created from i_llvm_fpga_mem_unnamed_atax7_atax0
...
module atax_i_llvm_fpga_mem_unnamed_7_atax0 (
    ...
    wire [2:0] c_i3_09_q;
    wire [3:0] c_i4_05_q;
    wire [31:0] i_llvm_fpga_mem_unnamed_atax7_atax1_avm_readdata;
    ...
    wire [31:0] i_llvm_fpga_mem_unnamed_atax7_atax1_i_address;
    wire [2:0] i_llvm_fpga_mem_unnamed_atax7_atax1_i_atomic_op;
    wire [31:0] i_llvm_fpga_mem_unnamed_atax7_atax1_i_bitwiseor;
    ...
    wire [31:0] i_llvm_fpga_mem_unnamed_atax7_atax1_stream_base_addr;
    ...
    wire [31:0] i_llvm_fpga_mem_unnamed_atax7_atax1_avm_address;
    ...
    wire [3:0] i_llvm_fpga_mem_unnamed_atax7_atax1_avm_byteenable;
    ...
    wire [31:0] i_llvm_fpga_mem_unnamed_atax7_atax1_avm_writedata;
    ...
    reg [31:0] readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_data_reg_x_q;
    reg [0:0] readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_valid_reg_x_q;
    ...
    // i_llvm_fpga_mem_unnamed_atax7_atax1(EXTIFACE,14)@7 + 3
    ...
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_address = addr_trunc_sel_x_b;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_atomic_op = c_i3_09_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_bitwiseor = c_i32_010_q;
    ...
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_stall = GND_q;
    ...
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_stream_base_addr = c_i32_010_q;
    ...
    // readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_valid_reg_x(REG,25)@10 + 1
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_valid_reg_x_q <= $unsigned(1'b0);
        end
        else
        begin
            readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_valid_reg_x_q <= i_llvm_fpga_mem_unnamed_atax7_atax1_o_valid;
        end
    end

    // readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_data_reg_x(REG,24)@10 + 1
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_data_reg_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else
        begin
            readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_data_reg_x_q <= i_llvm_fpga_mem_unnamed_atax7_atax1_o_readdata;
        end
    end

    // dupName_0_sync_out_x(GPOUT,21)@11
    assign out_o_readdata = readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_data_reg_x_q;
    assign out_o_valid = readdata_reg_unnamed_atax7_atax3_readdata_reg_unnamed_atax7_atax3_valid_reg_x_q;
