...
// SystemVerilog created from i_iord_bl_call_atax_unnamed_atax0_atax0
...
module atax_i_iord_bl_call_unnamed_atax0_atax0 (
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,21)@59
