...
module atax_bb_B3 (
    ...
    wire [0:0] atax_B3_branch_out_c0_exe2;
    wire [31:0] atax_B3_branch_out_c0_exe3;
    wire [0:0] atax_B3_branch_out_stall_out;
    wire [0:0] atax_B3_branch_out_valid_out_0;
    wire [0:0] atax_B3_merge_out_forked92;
    wire [0:0] atax_B3_merge_out_stall_out_0;
    wire [0:0] atax_B3_merge_out_stall_out_1;
    wire [0:0] atax_B3_merge_out_valid_out;
    wire [0:0] bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_stall_out;
    wire [0:0] bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_valid_out;
    wire [0:0] bb_atax_B3_stall_region_out_c0_exe2;
    wire [31:0] bb_atax_B3_stall_region_out_c0_exe3;
    ...
    atax_B3_merge theatax_B3_merge (
        ...
        .out_forked92(atax_B3_merge_out_forked92),
    ...
    atax_bb_B3_stall_region thebb_atax_B3_stall_region (
        .in_forked92(atax_B3_merge_out_forked92),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(atax_B3_branch_out_stall_out),
        .in_valid_in(atax_B3_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_stall_out(bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_valid_out(bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_valid_out),
        .out_c0_exe2(bb_atax_B3_stall_region_out_c0_exe2),
    ...
    assign out_c0_exe2 = atax_B3_branch_out_c0_exe2;

    // out_c0_exe3(GPOUT,11)
    assign out_c0_exe3 = atax_B3_branch_out_c0_exe3;

    // out_exiting_stall_out(GPOUT,12)
    assign out_exiting_stall_out = bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,13)
    assign out_exiting_valid_out = bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going85_atax2_exiting_valid_out;
