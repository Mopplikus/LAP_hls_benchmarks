...
module atax_B1_start_branch (
    ...
    wire [7:0] atax_B1_start_branch_data_pack_q;
    wire [6:0] c_i7_01_q;
    ...
    assign element_extension0_q = {c_i7_01_q, in_memdep_phi_pop9};

    // atax_B1_start_branch_data_pack(BITJOIN,3)
    assign atax_B1_start_branch_data_pack_q = element_extension0_q;

    // adapt_scalar_trunc2(ROUND,2)
    assign adapt_scalar_trunc2_in = atax_B1_start_branch_data_pack_q[0:0];
    assign adapt_scalar_trunc2_q = adapt_scalar_trunc2_in[0:0];

    // out_memdep_phi_pop9(GPOUT,12)
    assign out_memdep_phi_pop9 = adapt_scalar_trunc2_q;
