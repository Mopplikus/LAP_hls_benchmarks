...
module atax_bb_B1_start (
    ...
    wire [0:0] atax_B1_start_branch_out_memdep_phi_pop9;
    wire [0:0] atax_B1_start_branch_out_stall_out;
    wire [0:0] atax_B1_start_branch_out_valid_out_0;
    wire [0:0] atax_B1_start_merge_out_forked34;
    ...
    wire [0:0] bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_stall_out;
    wire [0:0] bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_valid_out;
    wire [0:0] bb_atax_B1_start_stall_region_out_feedback_stall_out_10;
    ...
    wire [0:0] bb_atax_B1_start_stall_region_out_memdep_phi_pop9;
    ...
    atax_B1_start_branch theatax_B1_start_branch (
        .in_memdep_phi_pop9(bb_atax_B1_start_stall_region_out_memdep_phi_pop9),
        .in_stall_in_0(in_stall_in_0),
        .in_valid_in(bb_atax_B1_start_stall_region_out_valid_out),
        .out_memdep_phi_pop9(atax_B1_start_branch_out_memdep_phi_pop9),
    ...
    atax_B1_start_merge theatax_B1_start_merge (
        ...
        .out_forked34(atax_B1_start_merge_out_forked34),
    ...
    atax_bb_B1_start_stall_region thebb_atax_B1_start_stall_region (
        ...
        .in_forked34(atax_B1_start_merge_out_forked34),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_stall_out(bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_valid_out(bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_valid_out),
        .out_feedback_stall_out_10(bb_atax_B1_start_stall_region_out_feedback_stall_out_10),
        ...
        .out_memdep_phi_pop9(bb_atax_B1_start_stall_region_out_memdep_phi_pop9),
    ...
    assign out_feedback_stall_out_10 = bb_atax_B1_start_stall_region_out_feedback_stall_out_10;

    // out_exiting_stall_out(GPOUT,15)
    assign out_exiting_stall_out = bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,16)
    assign out_exiting_valid_out = bb_atax_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_atax2_exiting_valid_out;
    ...
    // out_memdep_phi_pop9(GPOUT,19)
    assign out_memdep_phi_pop9 = atax_B1_start_branch_out_memdep_phi_pop9;
