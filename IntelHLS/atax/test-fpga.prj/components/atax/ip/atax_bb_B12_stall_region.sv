...
module atax_bb_B12_stall_region (
    ...
    wire [0:0] SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_wireValid;
    wire [0:0] SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_backStall;
    wire [0:0] SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_V0;
    ...
    assign SE_stall_entry_consumed0 = (~ (i_iowr_bl_return_atax_unnamed_atax17_atax0_out_o_stall) & SE_stall_entry_wireValid) | SE_stall_entry_fromReg0;
    ...
    // bubble_join_i_iowr_bl_return_atax_unnamed_atax17_atax0(BITJOIN,23)
    assign bubble_join_i_iowr_bl_return_atax_unnamed_atax17_atax0_q = i_iowr_bl_return_atax_unnamed_atax17_atax0_out_o_ack;

    // bubble_select_i_iowr_bl_return_atax_unnamed_atax17_atax0(BITSELECT,24)
    ...
    atax_i_llvm_fpga_push_token_i1_throttle_push_0 thei_llvm_fpga_push_token_i1_throttle_push_atax1 (
        ...
        .in_valid_in(SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_V0),
        .out_data_out(),
    ...
    // SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0(STALLENABLE,28)
    // Valid signal propagation
    assign SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_V0 = SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_wireValid;
    // Backward Stall generation
    assign SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_backStall = i_llvm_fpga_push_token_i1_throttle_push_atax1_out_stall_out | ~ (SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_wireValid = i_iowr_bl_return_atax_unnamed_atax17_atax0_out_o_valid;

    // GND(CONSTANT,0)
    assign GND_q = $unsigned(1'b0);

    // i_iowr_bl_return_atax_unnamed_atax17_atax0(BLACKBOX,10)@0
    ...
    atax_i_iowr_bl_return_unnamed_atax17_atax0 thei_iowr_bl_return_atax_unnamed_atax17_atax0 (
        .in_i_data(GND_q),
        .in_i_stall(SE_out_i_iowr_bl_return_atax_unnamed_atax17_atax0_backStall),
