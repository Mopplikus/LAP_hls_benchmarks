source [file join [file dirname [info script]] ./../../../ip/tb/matvec_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/matvec_ir_cfan/sim/common/modelsim_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_matvec_avmm_0_rw/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_cwfsw/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/matvec/matvec/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_matvec/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_matvec_Out0/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_matvec_V/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_matvec_M/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/matvec_en_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_done/sim/common/modelsim_files.tcl]

namespace eval tb {
  proc get_design_libraries {} {
    set libraries [dict create]
    set libraries [dict merge $libraries [matvec_cfan::get_design_libraries]]
    set libraries [dict merge $libraries [matvec_ir_cfan::get_design_libraries]]
    ...
    set libraries [dict merge $libraries [mm_agent_matvec_avmm_0_rw::get_design_libraries]]
    set libraries [dict merge $libraries [cat_cwfsw::get_design_libraries]]
    set libraries [dict merge $libraries [matvec::get_design_libraries]]
    set libraries [dict merge $libraries [clock_reset::get_design_libraries]]
    set libraries [dict merge $libraries [dpic_matvec::get_design_libraries]]
    set libraries [dict merge $libraries [sso_matvec_Out0::get_design_libraries]]
    set libraries [dict merge $libraries [sso_matvec_V::get_design_libraries]]
    set libraries [dict merge $libraries [sso_matvec_M::get_design_libraries]]
    set libraries [dict merge $libraries [matvec_en_cfan::get_design_libraries]]
  ...
  proc get_memory_files {QSYS_SIMDIR} {
    ...
    set memory_files [concat $memory_files [mm_agent_matvec_avmm_0_rw::get_memory_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_matvec_avmm_0_rw/sim/"]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [matvec_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/matvec_cfan/sim/"]]
    set design_files [dict merge $design_files [matvec_ir_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/matvec_ir_cfan/sim/"]]
    ...
    set design_files [dict merge $design_files [mm_agent_matvec_avmm_0_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_matvec_avmm_0_rw/sim/"]]
    ...
    set design_files [dict merge $design_files [matvec::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../../components/matvec/matvec/sim/"]]
    ...
    set design_files [dict merge $design_files [dpic_matvec::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/dpic_matvec/sim/"]]
    set design_files [dict merge $design_files [sso_matvec_Out0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_matvec_Out0/sim/"]]
    set design_files [dict merge $design_files [sso_matvec_V::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_matvec_V/sim/"]]
    set design_files [dict merge $design_files [sso_matvec_M::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_matvec_M/sim/"]]
    set design_files [dict merge $design_files [matvec_en_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/matvec_en_cfan/sim/"]]
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [matvec_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/matvec_cfan/sim/"]]
    set design_files [concat $design_files [matvec_ir_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/matvec_ir_cfan/sim/"]]
    ...
    set design_files [concat $design_files [mm_agent_matvec_avmm_0_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_matvec_avmm_0_rw/sim/"]]
    ...
    set design_files [concat $design_files [matvec::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../../components/matvec/matvec/sim/"]]
    ...
    set design_files [concat $design_files [dpic_matvec::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/dpic_matvec/sim/"]]
    set design_files [concat $design_files [sso_matvec_Out0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_matvec_Out0/sim/"]]
    set design_files [concat $design_files [sso_matvec_V::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_matvec_V/sim/"]]
    set design_files [concat $design_files [sso_matvec_M::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_matvec_M/sim/"]]
    set design_files [concat $design_files [matvec_en_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/matvec_en_cfan/sim/"]]
  ...
  proc get_elab_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append ELAB_OPTIONS [mm_agent_matvec_avmm_0_rw::get_elab_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_sim_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append SIM_OPTIONS [mm_agent_matvec_avmm_0_rw::get_sim_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_env_variables {SIMULATOR_TOOL_BITNESS} {
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mm_agent_matvec_avmm_0_rw::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
