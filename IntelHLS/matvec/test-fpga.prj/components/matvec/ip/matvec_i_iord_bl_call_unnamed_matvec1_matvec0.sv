...
// SystemVerilog created from i_iord_bl_call_matvec_unnamed_matvec1_matvec0
...
module matvec_i_iord_bl_call_unnamed_matvec1_matvec0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_matvec_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_matvec_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_matvec_i_fifodata),
    ...
    assign out_iord_bl_call_matvec_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,16)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,18)
    assign out_iord_bl_call_matvec_o_fifoready = iord_o_fifoready;
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,19)@59
