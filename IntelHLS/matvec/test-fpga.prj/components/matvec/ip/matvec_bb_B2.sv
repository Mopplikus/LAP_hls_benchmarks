...
module matvec_bb_B2 (
    ...
    wire [0:0] bb_matvec_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_stall_out;
    wire [0:0] bb_matvec_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_valid_out;
    ...
    wire [0:0] matvec_B2_merge_out_forked13;
    ...
    matvec_B2_merge thematvec_B2_merge (
        ...
        .out_forked13(matvec_B2_merge_out_forked13),
    ...
    matvec_bb_B2_stall_region thebb_matvec_B2_stall_region (
        .in_forked13(matvec_B2_merge_out_forked13),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(matvec_B2_branch_out_stall_out),
        .in_valid_in(matvec_B2_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_stall_out(bb_matvec_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_valid_out(bb_matvec_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_matvec_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,13)
    assign out_exiting_valid_out = bb_matvec_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_matvec2_exiting_valid_out;
