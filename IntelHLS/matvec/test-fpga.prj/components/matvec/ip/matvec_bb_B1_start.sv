...
module matvec_bb_B1_start (
    ...
    wire [0:0] bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_stall_out;
    wire [0:0] bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_valid_out;
    wire [0:0] bb_matvec_B1_start_stall_region_out_feedback_stall_out_1;
    wire [63:0] bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_0_0;
    wire [63:0] bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_1_0;
    wire [63:0] bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_2_0;
    ...
    // matvec_B1_start_merge(BLACKBOX,12)
    ...
    // matvec_B1_start_branch(BLACKBOX,11)
    ...
    matvec_bb_B1_start_stall_region thebb_matvec_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_stall_out(bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_valid_out(bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_valid_out),
        .out_feedback_stall_out_1(bb_matvec_B1_start_stall_region_out_feedback_stall_out_1),
        .out_intel_reserved_ffwd_0_0(bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_0_0),
        .out_intel_reserved_ffwd_1_0(bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_1_0),
        .out_intel_reserved_ffwd_2_0(bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_2_0),
    ...
    assign out_feedback_stall_out_1 = bb_matvec_B1_start_stall_region_out_feedback_stall_out_1;

    // out_exiting_stall_out(GPOUT,13)
    assign out_exiting_stall_out = bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,14)
    assign out_exiting_valid_out = bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going64_matvec1_exiting_valid_out;

    // out_intel_reserved_ffwd_0_0(GPOUT,15)
    assign out_intel_reserved_ffwd_0_0 = bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_0_0;

    // out_intel_reserved_ffwd_1_0(GPOUT,16)
    assign out_intel_reserved_ffwd_1_0 = bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_1_0;

    // out_intel_reserved_ffwd_2_0(GPOUT,17)
    assign out_intel_reserved_ffwd_2_0 = bb_matvec_B1_start_stall_region_out_intel_reserved_ffwd_2_0;

    // out_iord_bl_call_matvec_o_fifoalmost_full(GPOUT,18)
    ...
    // out_iord_bl_call_matvec_o_fifoready(GPOUT,19)
