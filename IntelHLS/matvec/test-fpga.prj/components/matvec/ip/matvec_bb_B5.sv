...
module matvec_bb_B5 (
    ...
    wire [0:0] bb_matvec_B5_stall_region_out_almost_empty_out;
    wire [0:0] bb_matvec_B5_stall_region_out_empty_out;
    ...
    wire [0:0] matvec_B5_branch_out_valid_out_0;
    wire [0:0] matvec_B5_merge_out_almost_empty_out;
    wire [0:0] matvec_B5_merge_out_empty_out;
    wire [0:0] matvec_B5_merge_out_stall_out_0;
    ...
    matvec_B5_branch thematvec_B5_branch (
        .in_almost_empty_in(bb_matvec_B5_stall_region_out_almost_empty_out),
        .in_empty_in(bb_matvec_B5_stall_region_out_empty_out),
        .in_stall_in_0(in_stall_in_0),
        .in_valid_in(bb_matvec_B5_stall_region_out_valid_out),
        .out_stall_out(matvec_B5_branch_out_stall_out),
        .out_valid_out_0(matvec_B5_branch_out_valid_out_0),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    matvec_B5_merge thematvec_B5_merge (
        ...
        .out_almost_empty_out(matvec_B5_merge_out_almost_empty_out),
        .out_empty_out(matvec_B5_merge_out_empty_out),
    ...
    matvec_bb_B5_stall_region thebb_matvec_B5_stall_region (
        .in_almost_empty_in(matvec_B5_merge_out_almost_empty_out),
        .in_empty_in(matvec_B5_merge_out_empty_out),
        ...
        .out_almost_empty_out(bb_matvec_B5_stall_region_out_almost_empty_out),
        .out_empty_out(bb_matvec_B5_stall_region_out_empty_out),
