...
(
   ...
   (
      ...
      .done(done),
      .stall(stall),
      // AVM avm_unnamed_matvec4_matvec
      .avm_unnamed_matvec4_matvec_enable(local_avm_aspace64_enable[0][0]),
      .avm_unnamed_matvec4_matvec_read(local_avm_aspace64_read[0][0]),
      .avm_unnamed_matvec4_matvec_write(local_avm_aspace64_write[0][0]),
      .avm_unnamed_matvec4_matvec_address(local_avm_aspace64_address[0][0]),
      .avm_unnamed_matvec4_matvec_writedata(local_avm_aspace64_writedata[0][0]),
      .avm_unnamed_matvec4_matvec_byteenable(local_avm_aspace64_byteenable[0][0]),
      .avm_unnamed_matvec4_matvec_waitrequest(local_avm_aspace64_waitrequest[0][0]),
      .avm_unnamed_matvec4_matvec_readdata(local_avm_aspace64_readdata[0][0]),
      .avm_unnamed_matvec4_matvec_readdatavalid(local_avm_aspace64_readdatavalid[0][0]),
      .avm_unnamed_matvec4_matvec_burstcount(local_avm_aspace64_burstcount[0][0]),
      .avm_unnamed_matvec4_matvec_writeack(local_avm_aspace64_writeack[0][0]),
      // AVM avm_unnamed_matvec3_matvec
      .avm_unnamed_matvec3_matvec_enable(local_avm_aspace65_enable[0][0]),
      .avm_unnamed_matvec3_matvec_read(local_avm_aspace65_read[0][0]),
      .avm_unnamed_matvec3_matvec_write(local_avm_aspace65_write[0][0]),
      .avm_unnamed_matvec3_matvec_address(local_avm_aspace65_address[0][0]),
      .avm_unnamed_matvec3_matvec_writedata(local_avm_aspace65_writedata[0][0]),
      .avm_unnamed_matvec3_matvec_byteenable(local_avm_aspace65_byteenable[0][0]),
      .avm_unnamed_matvec3_matvec_waitrequest(local_avm_aspace65_waitrequest[0][0]),
      .avm_unnamed_matvec3_matvec_readdata(local_avm_aspace65_readdata[0][0]),
      .avm_unnamed_matvec3_matvec_readdatavalid(local_avm_aspace65_readdatavalid[0][0]),
      .avm_unnamed_matvec3_matvec_burstcount(local_avm_aspace65_burstcount[0][0]),
      .avm_unnamed_matvec3_matvec_writeack(local_avm_aspace65_writeack[0][0]),
      // AVM avm_unnamed_matvec5_matvec
      .avm_unnamed_matvec5_matvec_enable(local_avm_aspace66_enable[0][0]),
      .avm_unnamed_matvec5_matvec_read(local_avm_aspace66_read[0][0]),
      .avm_unnamed_matvec5_matvec_write(local_avm_aspace66_write[0][0]),
      .avm_unnamed_matvec5_matvec_address(local_avm_aspace66_address[0][0]),
      .avm_unnamed_matvec5_matvec_writedata(local_avm_aspace66_writedata[0][0]),
      .avm_unnamed_matvec5_matvec_byteenable(local_avm_aspace66_byteenable[0][0]),
      .avm_unnamed_matvec5_matvec_waitrequest(local_avm_aspace66_waitrequest[0][0]),
      .avm_unnamed_matvec5_matvec_readdata(local_avm_aspace66_readdata[0][0]),
      .avm_unnamed_matvec5_matvec_readdatavalid(local_avm_aspace66_readdatavalid[0][0]),
      .avm_unnamed_matvec5_matvec_burstcount(local_avm_aspace66_burstcount[0][0]),
      .avm_unnamed_matvec5_matvec_writeack(local_avm_aspace66_writeack[0][0])
   );
