...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_llvm_fpga_ffwd_source_p1025i32_unnamed_4_if_loop_30.sv"          -work if_loop_3_internal_inst                                              
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_llvm_fpga_ffwd_dest_p1025i32_mptr_bitcast24277_0.sv"             -work if_loop_3_internal_inst                                              
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_sfc_s_c1_in_for_body_s_c1_enter_if_loop_36.sv"                   -work if_loop_3_internal_inst                                              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_llvm_fpga_sfc_exit_s_c1_out_0000s_c1_exit_if_loop_30.sv"         -work if_loop_3_internal_inst                                              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_llvm_fpga_sfc_exit_s_c1_out_0000if_loop_31_data_fifo.sv"         -work if_loop_3_internal_inst                                              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_llvm_fpga_sfc_exit_s_c1_out_0000oop_31_full_detector.sv"         -work if_loop_3_internal_inst                                              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_sfc_logic_s_c1_in_for_body_s_c1_enter_if_loop_30.sv"             -work if_loop_3_internal_inst                                              
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_readdata_reg_lm1_0.sv"                                             -work if_loop_3_internal_inst                                              
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_readdata_reg_lm22_1.sv"                                            -work if_loop_3_internal_inst                                              
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/if_loop_3_i_iowr_bl_return_unnamed_if_loop_311_if_loop_30.sv"                -work if_loop_3_internal_inst                                              
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm.sv"                                               -work mm_agent_dpi_bfm_if_loop_3_avmm_1_r_inst                             
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/hls_sim_mm_agent_dpi_bfm.sv"                                                 -work mm_agent_dpi_bfm_if_loop_3_avmm_1_r_inst                             
