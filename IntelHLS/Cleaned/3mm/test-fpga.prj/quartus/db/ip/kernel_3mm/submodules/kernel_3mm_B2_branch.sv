...
module kernel_3mm_B2_branch (
    input wire [31:0] in_c0_exe1263,
    input wire [0:0] in_c0_exe2,
    input wire [0:0] in_c0_exe3,
    input wire [0:0] in_memdep_phi1_pop24,
    ...
    // out_c0_exe1263(GPOUT,8)
    assign out_c0_exe1263 = in_c0_exe1263;
    ...
    // out_memdep_phi1_pop24(GPOUT,11)
    assign out_memdep_phi1_pop24 = in_memdep_phi1_pop24;
