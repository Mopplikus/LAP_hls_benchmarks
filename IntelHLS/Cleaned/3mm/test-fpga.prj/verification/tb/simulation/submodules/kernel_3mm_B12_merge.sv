...
module kernel_3mm_B12_merge (
    ...
    output wire [0:0] out_c0_exe741910,
    output wire [0:0] out_c0_exe842012,
    output wire [0:0] out_memdep_318,
    ...
    // out_c0_exe741910(GPOUT,7)
    assign out_c0_exe741910 = in_c0_exe741910_0;

    // out_c0_exe842012(GPOUT,8)
    assign out_c0_exe842012 = in_c0_exe842012_0;

    // out_memdep_318(GPOUT,9)
    assign out_memdep_318 = in_memdep_318_0;
