...
// SystemVerilog created from bb_kernel_3mm_B16_sr_1
...
module kernel_3mm_bb_B16_sr_1 (
    ...
    // combined_valid(LOGICAL,66)
    assign combined_valid_q = in_i_valid | sr_valid_q;

    // stall_and_valid(LOGICAL,69)
