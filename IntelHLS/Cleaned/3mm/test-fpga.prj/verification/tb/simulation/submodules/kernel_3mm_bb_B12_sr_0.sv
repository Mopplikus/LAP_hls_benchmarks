...
// SystemVerilog created from bb_kernel_3mm_B12_sr_0
...
module kernel_3mm_bb_B12_sr_0 (
    ...
    // combined_valid(LOGICAL,18)
    assign combined_valid_q = in_i_valid | sr_valid_q;

    // stall_and_valid(LOGICAL,21)
