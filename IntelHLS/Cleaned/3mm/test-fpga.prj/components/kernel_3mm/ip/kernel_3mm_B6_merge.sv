...
module kernel_3mm_B6_merge (
    ...
    output wire [0:0] out_c0_exe73071,
    output wire [0:0] out_c0_exe83083,
    output wire [0:0] out_memdep_9,
    ...
    // out_c0_exe73071(GPOUT,7)
    assign out_c0_exe73071 = in_c0_exe73071_0;

    // out_c0_exe83083(GPOUT,8)
    assign out_c0_exe83083 = in_c0_exe83083_0;

    // out_memdep_9(GPOUT,9)
    assign out_memdep_9 = in_memdep_9_0;
