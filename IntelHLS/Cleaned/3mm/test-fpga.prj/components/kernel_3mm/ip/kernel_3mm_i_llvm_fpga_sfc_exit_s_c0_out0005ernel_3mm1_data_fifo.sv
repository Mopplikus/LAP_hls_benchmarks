...
// SystemVerilog created from i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm1_data_fifo
...
module kernel_3mm_i_llvm_fpga_sfc_exit_s_c0_out0005ernel_3mm1_data_fifo (
    ...
    wire [511:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_data;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_stall;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_stall_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_valid;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_valid_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_almost_full;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_almost_full_bitsignaltemp;
    wire [511:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_stall;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_stall_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_valid;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_valid_bitsignaltemp;
    ...
    assign ip_dsdk_adapt_bitselect69_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[511:480];

    // ip_dsdk_adapt_bitselect67(BITSELECT,66)
    assign ip_dsdk_adapt_bitselect67_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[464:464];
    ...
    assign ip_dsdk_adapt_bitselect65_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[456:456];
    ...
    assign ip_dsdk_adapt_bitselect63_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[448:448];
    ...
    assign ip_dsdk_adapt_bitselect61_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[447:416];

    // ip_dsdk_adapt_bitselect59(BITSELECT,62)
    assign ip_dsdk_adapt_bitselect59_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[400:400];
    ...
    assign ip_dsdk_adapt_bitselect57_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[392:392];
    ...
    assign ip_dsdk_adapt_bitselect55_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[384:384];
    ...
    assign ip_dsdk_adapt_bitselect53_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[383:320];

    // ip_dsdk_adapt_bitselect51(BITSELECT,58)
    assign ip_dsdk_adapt_bitselect51_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[272:272];
    ...
    assign ip_dsdk_adapt_bitselect49_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[264:264];
    ...
    assign ip_dsdk_adapt_bitselect47_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[256:256];
    ...
    assign ip_dsdk_adapt_bitselect45_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[255:192];

    // ip_dsdk_adapt_bitselect43(BITSELECT,54)
    assign ip_dsdk_adapt_bitselect43_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[128:128];
    ...
    assign ip_dsdk_adapt_bitselect41_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[127:64];

    // ip_dsdk_adapt_bitselect39(BITSELECT,52)
    assign ip_dsdk_adapt_bitselect39_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[16:16];
    ...
    assign ip_dsdk_adapt_bitselect37_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[8:8];
    ...
    assign ip_dsdk_adapt_bitselect35_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data[0:0];
    ...
    // i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0(EXTIFACE,49)
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_data = dsdk_ip_adapt_bitjoin1_q;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_stall = in_i_stall;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_valid = in_i_valid;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_stall_bitsignaltemp = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_stall[0];
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_valid_bitsignaltemp = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_valid[0];
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_almost_full[0] = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_almost_full_bitsignaltemp;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_stall[0] = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_stall_bitsignaltemp;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_valid[0] = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_valid_bitsignaltemp;
    hld_fifo #(
        .DEPTH(32),
        .STYLE("ms"),
        .ASYNC_RESET(1),
        ...
        .SYNCHRONIZE_RESET(0),
        .WIDTH(512)
    ) thei_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0 (
        .i_data(dsdk_ip_adapt_bitjoin1_q),
        .i_stall(i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_stall_bitsignaltemp),
        .i_valid(i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_i_valid_bitsignaltemp),
        .o_almost_full(i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_almost_full_bitsignaltemp),
        .o_data(i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_data),
        .o_stall(i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_stall_bitsignaltemp),
        .o_valid(i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_valid_bitsignaltemp),
        .clock(clock),
        .resetn(resetn)
    );

    // dupName_0_sync_out_aunroll_x(GPOUT,2)@20000000
    assign out_o_almost_full = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_almost_full;
    ...
    assign out_o_valid = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_valid;

    // sync_out(GPOUT,74)@20000000
    assign out_o_stall = i_llvm_fpga_sfc_exit_s_c0_out_for_body36_kernel_3mms_c0_exit412_kernel_3mm0_o_stall;
