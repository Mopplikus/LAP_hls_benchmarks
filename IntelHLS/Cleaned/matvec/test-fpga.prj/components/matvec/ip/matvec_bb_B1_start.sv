...
module matvec_bb_B1_start (
    ...
    wire [0:0] bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_stall_out;
    wire [0:0] bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_valid_out;
    ...
    matvec_bb_B1_start_stall_region thebb_matvec_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_stall_out(bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_valid_out(bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,14)
    assign out_exiting_valid_out = bb_matvec_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_matvec1_exiting_valid_out;
