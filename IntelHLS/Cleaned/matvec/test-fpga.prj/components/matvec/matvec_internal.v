...
(
   ...
   (
      ...
      .avm_memdep_matvec_enable(avmm_1_global_avm_enable[0]),
      .avm_memdep_matvec_read(avmm_1_global_avm_read[0]),
      .avm_memdep_matvec_write(avmm_1_global_avm_write[0]),
      .avm_memdep_matvec_address(avmm_1_global_avm_address[0]),
      .avm_memdep_matvec_writedata(avmm_1_global_avm_writedata[0]),
      .avm_memdep_matvec_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_memdep_matvec_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_memdep_matvec_readdata(avmm_1_global_avm_readdata[0]),
      .avm_memdep_matvec_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_memdep_matvec_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_memdep_matvec_writeack(avmm_1_global_avm_writeack[0]),
      // AVM avm_unnamed_matvec8_matvec
      .avm_unnamed_matvec8_matvec_enable(avmm_1_global_avm_enable[1]),
      .avm_unnamed_matvec8_matvec_read(avmm_1_global_avm_read[1]),
      .avm_unnamed_matvec8_matvec_write(avmm_1_global_avm_write[1]),
      .avm_unnamed_matvec8_matvec_address(avmm_1_global_avm_address[1]),
      .avm_unnamed_matvec8_matvec_writedata(avmm_1_global_avm_writedata[1]),
      .avm_unnamed_matvec8_matvec_byteenable(avmm_1_global_avm_byteenable[1]),
      .avm_unnamed_matvec8_matvec_waitrequest(avmm_1_global_avm_waitrequest[1]),
      .avm_unnamed_matvec8_matvec_readdata(avmm_1_global_avm_readdata[1]),
      .avm_unnamed_matvec8_matvec_readdatavalid(avmm_1_global_avm_readdatavalid[1]),
      .avm_unnamed_matvec8_matvec_burstcount(avmm_1_global_avm_burstcount[1]),
      .avm_unnamed_matvec8_matvec_writeack(avmm_1_global_avm_writeack[1]),
      // AVM avm_unnamed_matvec9_matvec
      .avm_unnamed_matvec9_matvec_enable(avmm_1_global_avm_enable[2]),
      .avm_unnamed_matvec9_matvec_read(avmm_1_global_avm_read[2]),
      .avm_unnamed_matvec9_matvec_write(avmm_1_global_avm_write[2]),
      .avm_unnamed_matvec9_matvec_address(avmm_1_global_avm_address[2]),
      .avm_unnamed_matvec9_matvec_writedata(avmm_1_global_avm_writedata[2]),
      .avm_unnamed_matvec9_matvec_byteenable(avmm_1_global_avm_byteenable[2]),
      .avm_unnamed_matvec9_matvec_waitrequest(avmm_1_global_avm_waitrequest[2]),
      .avm_unnamed_matvec9_matvec_readdata(avmm_1_global_avm_readdata[2]),
      .avm_unnamed_matvec9_matvec_readdatavalid(avmm_1_global_avm_readdatavalid[2]),
      .avm_unnamed_matvec9_matvec_burstcount(avmm_1_global_avm_burstcount[2]),
      .avm_unnamed_matvec9_matvec_writeack(avmm_1_global_avm_writeack[2])
   );
   ...
   begin:avmm_1_
      ...
      // INST global_icavmm_1_rw of matvec_internal_ic_18252752692117882361
      matvec_internal_ic_18252752692117882361 global_icavmm_1_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE matvec_internal_ic_18252752692117882361
/////////////////////////////////////////////////////////////////
module matvec_internal_ic_18252752692117882361
(
   input logic clock,
