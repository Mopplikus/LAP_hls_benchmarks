...
module triangular_bb_B1_start (
    ...
    wire [0:0] bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_stall_out;
    wire [0:0] bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_valid_out;
    ...
    wire [63:0] bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_0_0;
    wire [31:0] bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_1_0;
    wire [0:0] bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_2_0;
    wire [63:0] bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_3_0;
    wire [31:0] bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_4_0;
    wire [32:0] bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_5_0;
    ...
    wire [0:0] bb_triangular_B1_start_stall_region_out_pipeline_valid_out;
    ...
    wire [0:0] triangular_B1_start_merge_out_forked34;
    ...
    // triangular_B1_start_branch(BLACKBOX,36)
    ...
    // triangular_B1_start_merge(BLACKBOX,37)
    triangular_B1_start_merge thetriangular_B1_start_merge (
        ...
        .out_forked34(triangular_B1_start_merge_out_forked34),
    ...
    triangular_bb_B1_start_stall_region thebb_triangular_B1_start_stall_region (
        ...
        .in_forked34(triangular_B1_start_merge_out_forked34),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_stall_out(bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_valid_out(bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_valid_out),
        ...
        .out_intel_reserved_ffwd_4_0(bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_4_0),
        .out_intel_reserved_ffwd_5_0(bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_5_0),
        ...
        .out_pipeline_valid_out(bb_triangular_B1_start_stall_region_out_pipeline_valid_out),
    ...
    assign out_exiting_stall_out = bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,17)
    assign out_exiting_valid_out = bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going32_triangular2_exiting_valid_out;
    ...
    assign out_intel_reserved_ffwd_4_0 = bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_4_0;

    // out_intel_reserved_ffwd_5_0(GPOUT,23)
    assign out_intel_reserved_ffwd_5_0 = bb_triangular_B1_start_stall_region_out_intel_reserved_ffwd_5_0;

    // out_iord_bl_call_triangular_o_fifoalmost_full(GPOUT,24)
    ...
    // out_iord_bl_call_triangular_o_fifoready(GPOUT,25)
    ...
    // out_reorder_limiter_enter(GPOUT,26)
    ...
    assign out_pipeline_valid_out = bb_triangular_B1_start_stall_region_out_pipeline_valid_out;
