...
module triangular_B2_merge (
    ...
    output wire [0:0] out_c0_exe8974,
    output wire [0:0] out_memdep_5,
    ...
    // out_c0_exe6951(GPOUT,8)
    assign out_c0_exe6951 = in_c0_exe6951_0;

    // out_c0_exe7963(GPOUT,9)
    assign out_c0_exe7963 = in_c0_exe7963_0;

    // out_c0_exe8974(GPOUT,10)
    assign out_c0_exe8974 = in_c0_exe8974_0;

    // out_memdep_5(GPOUT,11)
    assign out_memdep_5 = in_memdep_5_0;
