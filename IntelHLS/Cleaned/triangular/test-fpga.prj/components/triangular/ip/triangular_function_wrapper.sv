...
module triangular_function_wrapper (
    ...
    input wire [31:0] avm_lm62_triangular_readdata,
    input wire [0:0] avm_lm62_triangular_readdatavalid,
    input wire [0:0] avm_lm62_triangular_waitrequest,
    input wire [0:0] avm_lm62_triangular_writeack,
    input wire [31:0] avm_lm83_triangular_readdata,
    input wire [0:0] avm_lm83_triangular_readdatavalid,
    input wire [0:0] avm_lm83_triangular_waitrequest,
    input wire [0:0] avm_lm83_triangular_writeack,
    ...
    output wire [31:0] avm_lm62_triangular_address,
    output wire [0:0] avm_lm62_triangular_burstcount,
    output wire [3:0] avm_lm62_triangular_byteenable,
    output wire [0:0] avm_lm62_triangular_enable,
    output wire [0:0] avm_lm62_triangular_read,
    output wire [0:0] avm_lm62_triangular_write,
    output wire [31:0] avm_lm62_triangular_writedata,
    output wire [31:0] avm_lm83_triangular_address,
    output wire [0:0] avm_lm83_triangular_burstcount,
    output wire [3:0] avm_lm83_triangular_byteenable,
    output wire [0:0] avm_lm83_triangular_enable,
    output wire [0:0] avm_lm83_triangular_read,
    output wire [0:0] avm_lm83_triangular_write,
    output wire [31:0] avm_lm83_triangular_writedata,
    ...
    wire [31:0] triangular_function_out_lm62_triangular_avm_address;
    wire [0:0] triangular_function_out_lm62_triangular_avm_burstcount;
    wire [3:0] triangular_function_out_lm62_triangular_avm_byteenable;
    wire [0:0] triangular_function_out_lm62_triangular_avm_enable;
    wire [0:0] triangular_function_out_lm62_triangular_avm_read;
    wire [0:0] triangular_function_out_lm62_triangular_avm_write;
    wire [31:0] triangular_function_out_lm62_triangular_avm_writedata;
    wire [31:0] triangular_function_out_lm83_triangular_avm_address;
    wire [0:0] triangular_function_out_lm83_triangular_avm_burstcount;
    wire [3:0] triangular_function_out_lm83_triangular_avm_byteenable;
    wire [0:0] triangular_function_out_lm83_triangular_avm_enable;
    wire [0:0] triangular_function_out_lm83_triangular_avm_read;
    wire [0:0] triangular_function_out_lm83_triangular_avm_write;
    wire [31:0] triangular_function_out_lm83_triangular_avm_writedata;
    ...
    triangular_function thetriangular_function (
        ...
        .in_lm62_triangular_avm_readdata(avm_lm62_triangular_readdata),
        .in_lm62_triangular_avm_readdatavalid(avm_lm62_triangular_readdatavalid),
        .in_lm62_triangular_avm_waitrequest(avm_lm62_triangular_waitrequest),
        .in_lm62_triangular_avm_writeack(avm_lm62_triangular_writeack),
        .in_lm83_triangular_avm_readdata(avm_lm83_triangular_readdata),
        .in_lm83_triangular_avm_readdatavalid(avm_lm83_triangular_readdatavalid),
        .in_lm83_triangular_avm_waitrequest(avm_lm83_triangular_waitrequest),
        .in_lm83_triangular_avm_writeack(avm_lm83_triangular_writeack),
        ...
        .out_lm62_triangular_avm_address(triangular_function_out_lm62_triangular_avm_address),
        .out_lm62_triangular_avm_burstcount(triangular_function_out_lm62_triangular_avm_burstcount),
        .out_lm62_triangular_avm_byteenable(triangular_function_out_lm62_triangular_avm_byteenable),
        .out_lm62_triangular_avm_enable(triangular_function_out_lm62_triangular_avm_enable),
        .out_lm62_triangular_avm_read(triangular_function_out_lm62_triangular_avm_read),
        .out_lm62_triangular_avm_write(triangular_function_out_lm62_triangular_avm_write),
        .out_lm62_triangular_avm_writedata(triangular_function_out_lm62_triangular_avm_writedata),
        .out_lm83_triangular_avm_address(triangular_function_out_lm83_triangular_avm_address),
        .out_lm83_triangular_avm_burstcount(triangular_function_out_lm83_triangular_avm_burstcount),
        .out_lm83_triangular_avm_byteenable(triangular_function_out_lm83_triangular_avm_byteenable),
        .out_lm83_triangular_avm_enable(triangular_function_out_lm83_triangular_avm_enable),
        .out_lm83_triangular_avm_read(triangular_function_out_lm83_triangular_avm_read),
        .out_lm83_triangular_avm_write(triangular_function_out_lm83_triangular_avm_write),
        .out_lm83_triangular_avm_writedata(triangular_function_out_lm83_triangular_avm_writedata),
    ...
    // avm_lm1_triangular_address(GPOUT,39)
    assign avm_lm1_triangular_address = triangular_function_out_lm1_triangular_avm_address;

    // avm_lm1_triangular_burstcount(GPOUT,40)
    assign avm_lm1_triangular_burstcount = triangular_function_out_lm1_triangular_avm_burstcount;

    // avm_lm1_triangular_byteenable(GPOUT,41)
    assign avm_lm1_triangular_byteenable = triangular_function_out_lm1_triangular_avm_byteenable;

    // avm_lm1_triangular_enable(GPOUT,42)
    assign avm_lm1_triangular_enable = triangular_function_out_lm1_triangular_avm_enable;

    // avm_lm1_triangular_read(GPOUT,43)
    assign avm_lm1_triangular_read = triangular_function_out_lm1_triangular_avm_read;

    // avm_lm1_triangular_write(GPOUT,44)
    assign avm_lm1_triangular_write = triangular_function_out_lm1_triangular_avm_write;

    // avm_lm1_triangular_writedata(GPOUT,45)
    assign avm_lm1_triangular_writedata = triangular_function_out_lm1_triangular_avm_writedata;

    // avm_lm62_triangular_address(GPOUT,46)
    assign avm_lm62_triangular_address = triangular_function_out_lm62_triangular_avm_address;

    // avm_lm62_triangular_burstcount(GPOUT,47)
    assign avm_lm62_triangular_burstcount = triangular_function_out_lm62_triangular_avm_burstcount;

    // avm_lm62_triangular_byteenable(GPOUT,48)
    assign avm_lm62_triangular_byteenable = triangular_function_out_lm62_triangular_avm_byteenable;

    // avm_lm62_triangular_enable(GPOUT,49)
    assign avm_lm62_triangular_enable = triangular_function_out_lm62_triangular_avm_enable;

    // avm_lm62_triangular_read(GPOUT,50)
    assign avm_lm62_triangular_read = triangular_function_out_lm62_triangular_avm_read;

    // avm_lm62_triangular_write(GPOUT,51)
    assign avm_lm62_triangular_write = triangular_function_out_lm62_triangular_avm_write;

    // avm_lm62_triangular_writedata(GPOUT,52)
    assign avm_lm62_triangular_writedata = triangular_function_out_lm62_triangular_avm_writedata;

    // avm_lm83_triangular_address(GPOUT,53)
    assign avm_lm83_triangular_address = triangular_function_out_lm83_triangular_avm_address;

    // avm_lm83_triangular_burstcount(GPOUT,54)
    assign avm_lm83_triangular_burstcount = triangular_function_out_lm83_triangular_avm_burstcount;

    // avm_lm83_triangular_byteenable(GPOUT,55)
    assign avm_lm83_triangular_byteenable = triangular_function_out_lm83_triangular_avm_byteenable;

    // avm_lm83_triangular_enable(GPOUT,56)
    assign avm_lm83_triangular_enable = triangular_function_out_lm83_triangular_avm_enable;

    // avm_lm83_triangular_read(GPOUT,57)
    assign avm_lm83_triangular_read = triangular_function_out_lm83_triangular_avm_read;

    // avm_lm83_triangular_write(GPOUT,58)
    assign avm_lm83_triangular_write = triangular_function_out_lm83_triangular_avm_write;

    // avm_lm83_triangular_writedata(GPOUT,59)
    assign avm_lm83_triangular_writedata = triangular_function_out_lm83_triangular_avm_writedata;
