...
module triangular_i_llvm_fpga_pipeline_keep_going_0 (
    ...
    wire i_llvm_fpga_pipeline_keep_going_triangular1_not_exitcond_valid_in_bitsignaltemp;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_triangular1_pipeline_stall_in;
    wire i_llvm_fpga_pipeline_keep_going_triangular1_pipeline_stall_in_bitsignaltemp;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_triangular1_stall_in;
    wire i_llvm_fpga_pipeline_keep_going_triangular1_stall_in_bitsignaltemp;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_triangular1_valid_in;
    wire i_llvm_fpga_pipeline_keep_going_triangular1_valid_in_bitsignaltemp;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_triangular1_data_out;
    ...
    wire i_llvm_fpga_pipeline_keep_going_triangular1_stall_out_bitsignaltemp;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_triangular1_valid_out;
    wire i_llvm_fpga_pipeline_keep_going_triangular1_valid_out_bitsignaltemp;
    ...
    // i_llvm_fpga_pipeline_keep_going_triangular1(EXTIFACE,4)@69
    ...
    assign i_llvm_fpga_pipeline_keep_going_triangular1_stall_in_bitsignaltemp = i_llvm_fpga_pipeline_keep_going_triangular1_stall_in[0];
    ...
    acl_pipeline #(
        ...
        .stall_in(i_llvm_fpga_pipeline_keep_going_triangular1_stall_in_bitsignaltemp),
