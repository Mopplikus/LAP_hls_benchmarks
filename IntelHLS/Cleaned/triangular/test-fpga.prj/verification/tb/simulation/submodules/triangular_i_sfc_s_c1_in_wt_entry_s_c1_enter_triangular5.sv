...
module triangular_i_sfc_s_c1_in_wt_entry_s_c1_enter_triangular5 (
    ...
    // i_sfc_logic_s_c1_in_wt_entry_triangulars_c1_enter_triangular0_aunroll_x(BLACKBOX,4)@1
    // out out_c1_exi1_0_tpl@4
    // out out_c1_exi1_1_tpl@4
    // out out_o_valid@4
    ...
    triangular_i_sfc_logic_s_c1_in_wt_entry_s_c1_enter_triangular0 thei_sfc_logic_s_c1_in_wt_entry_triangulars_c1_enter_triangular0_aunroll_x (
        ...
        .out_o_valid(i_sfc_logic_s_c1_in_wt_entry_triangulars_c1_enter_triangular0_aunroll_x_out_o_valid),
        .out_unnamed_triangular0(),
        .clock(clock),
        .resetn(resetn)
    );

    // i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_triangulars_c1_exit_triangular1_aunroll_x(BLACKBOX,3)@4
