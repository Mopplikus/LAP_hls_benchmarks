...
module triangular_B2_branch (
    ...
    wire [0:0] VCC_q;
    wire [0:0] c0_exe6951_cmp_q;
    reg [31:0] c0_exe7963_reg_q;
    ...
    // c0_exe6951_cmp(LOGICAL,2)
    assign c0_exe6951_cmp_q = ~ (in_c0_exe6951);

    // valid_out_1_and(LOGICAL,24)
    assign valid_out_1_and_q = in_valid_in & c0_exe6951_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe6951;
    ...
    // c0_exe7963_reg(REG,3)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            c0_exe7963_reg_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (triangular_B2_branch_enable_q == 1'b1)
        begin
            c0_exe7963_reg_q <= in_c0_exe7963;
        end
    end

    // out_c0_exe7963(GPOUT,15)
    assign out_c0_exe7963 = c0_exe7963_reg_q;
