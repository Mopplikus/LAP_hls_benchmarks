...
(
   ...
   (
      ...
      .avm_lm1_triangular_enable(avmm_1_global_avm_enable[0]),
      .avm_lm1_triangular_read(avmm_1_global_avm_read[0]),
      .avm_lm1_triangular_write(avmm_1_global_avm_write[0]),
      .avm_lm1_triangular_address(avmm_1_global_avm_address[0]),
      .avm_lm1_triangular_writedata(avmm_1_global_avm_writedata[0]),
      .avm_lm1_triangular_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_lm1_triangular_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_lm1_triangular_readdata(avmm_1_global_avm_readdata[0]),
      .avm_lm1_triangular_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_lm1_triangular_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_lm1_triangular_writeack(avmm_1_global_avm_writeack[0]),
      // AVM avm_lm62_triangular
      .avm_lm62_triangular_enable(avmm_1_global_avm_enable[1]),
      .avm_lm62_triangular_read(avmm_1_global_avm_read[1]),
      .avm_lm62_triangular_write(avmm_1_global_avm_write[1]),
      .avm_lm62_triangular_address(avmm_1_global_avm_address[1]),
      .avm_lm62_triangular_writedata(avmm_1_global_avm_writedata[1]),
      .avm_lm62_triangular_byteenable(avmm_1_global_avm_byteenable[1]),
      .avm_lm62_triangular_waitrequest(avmm_1_global_avm_waitrequest[1]),
      .avm_lm62_triangular_readdata(avmm_1_global_avm_readdata[1]),
      .avm_lm62_triangular_readdatavalid(avmm_1_global_avm_readdatavalid[1]),
      .avm_lm62_triangular_burstcount(avmm_1_global_avm_burstcount[1]),
      .avm_lm62_triangular_writeack(avmm_1_global_avm_writeack[1]),
      // AVM avm_lm83_triangular
      .avm_lm83_triangular_enable(avmm_1_global_avm_enable[2]),
      .avm_lm83_triangular_read(avmm_1_global_avm_read[2]),
      .avm_lm83_triangular_write(avmm_1_global_avm_write[2]),
      .avm_lm83_triangular_address(avmm_1_global_avm_address[2]),
      .avm_lm83_triangular_writedata(avmm_1_global_avm_writedata[2]),
      .avm_lm83_triangular_byteenable(avmm_1_global_avm_byteenable[2]),
      .avm_lm83_triangular_waitrequest(avmm_1_global_avm_waitrequest[2]),
      .avm_lm83_triangular_readdata(avmm_1_global_avm_readdata[2]),
      .avm_lm83_triangular_readdatavalid(avmm_1_global_avm_readdatavalid[2]),
      .avm_lm83_triangular_burstcount(avmm_1_global_avm_burstcount[2]),
      .avm_lm83_triangular_writeack(avmm_1_global_avm_writeack[2]),
      // AVM avm_memdep_triangular
      .avm_memdep_triangular_enable(avmm_1_global_avm_enable[3]),
      .avm_memdep_triangular_read(avmm_1_global_avm_read[3]),
      .avm_memdep_triangular_write(avmm_1_global_avm_write[3]),
      .avm_memdep_triangular_address(avmm_1_global_avm_address[3]),
      .avm_memdep_triangular_writedata(avmm_1_global_avm_writedata[3]),
      .avm_memdep_triangular_byteenable(avmm_1_global_avm_byteenable[3]),
      .avm_memdep_triangular_waitrequest(avmm_1_global_avm_waitrequest[3]),
      .avm_memdep_triangular_readdata(avmm_1_global_avm_readdata[3]),
      .avm_memdep_triangular_readdatavalid(avmm_1_global_avm_readdatavalid[3]),
      .avm_memdep_triangular_burstcount(avmm_1_global_avm_burstcount[3]),
      .avm_memdep_triangular_writeack(avmm_1_global_avm_writeack[3])
   );
