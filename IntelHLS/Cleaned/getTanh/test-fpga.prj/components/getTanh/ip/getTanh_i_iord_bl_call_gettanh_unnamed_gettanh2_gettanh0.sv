...
// SystemVerilog created from i_iord_bl_call_gettanh_unnamed_gettanh2_gettanh0
...
module getTanh_i_iord_bl_call_gettanh_unnamed_gettanh2_gettanh0 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_getTanh_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_getTanh_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_getTanh_i_fifodata),
    ...
    assign out_iord_bl_call_getTanh_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,14)
    assign out_iord_bl_call_getTanh_o_fifoalmost_full = iord_o_fifoalmost_full;
