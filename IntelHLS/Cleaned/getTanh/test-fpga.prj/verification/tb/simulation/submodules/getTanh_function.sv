...
module getTanh_function (
    ...
    wire [63:0] bb_getTanh_B1_start_out_intel_reserved_ffwd_0_0;
    wire [63:0] bb_getTanh_B1_start_out_intel_reserved_ffwd_1_0;
    ...
    wire [31:0] bb_getTanh_B3_out_intel_reserved_ffwd_2_0;
    wire [0:0] bb_getTanh_B3_out_lsu_memdep_o_active;
    ...
    wire [31:0] bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_address;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_burstcount;
    wire [3:0] bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_byteenable;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_enable;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_read;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_write;
    wire [31:0] bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_writedata;
    wire [31:0] bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_address;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_burstcount;
    wire [3:0] bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_byteenable;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_enable;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_read;
    wire [0:0] bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_write;
    wire [31:0] bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_writedata;
    ...
    wire [0:0] i_llvm_fpga_pipeline_keep_going6_gettanh1_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going6_gettanh1_sr_out_o_valid;
    wire [0:0] i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo_out_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo_out_valid_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_gettanh4_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_gettanh4_sr_out_o_valid;
    ...
    // i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo(BLACKBOX,25)
    getTanh_i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo thei_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo (
        .in_data_in(c_i2_010_q),
        .in_stall_in(bb_getTanh_B1_start_out_stall_out_0),
        .in_valid_in(i_llvm_fpga_pipeline_keep_going6_gettanh1_sr_out_o_valid),
        .out_almost_full(),
        .out_data_out(),
        .out_stall_out(i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo_out_stall_out),
        .out_valid_out(i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_getTanh_B2_sr_0_aunroll_x(BLACKBOX,2)
    ...
    // i_llvm_fpga_pipeline_keep_going_gettanh4_sr(BLACKBOX,26)
    getTanh_i_llvm_fpga_pipeline_keep_going_gettanh4_sr thei_llvm_fpga_pipeline_keep_going_gettanh4_sr (
        .in_i_data(GND_q),
        .in_i_stall(bb_getTanh_B3_out_stall_out_0),
        .in_i_valid(bb_getTanh_B3_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going_gettanh4_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going_gettanh4_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_getTanh_B3(BLACKBOX,7)
    getTanh_bb_B3 thebb_getTanh_B3 (
        .in_flush(in_start),
        .in_forked_0(GND_q),
        .in_forked_1(bb_getTanh_B3_sr_1_aunroll_x_out_o_data_0_tpl),
        .in_intel_reserved_ffwd_0_0(bb_getTanh_B1_start_out_intel_reserved_ffwd_0_0),
        .in_intel_reserved_ffwd_1_0(bb_getTanh_B1_start_out_intel_reserved_ffwd_1_0),
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going_gettanh4_sr_out_o_stall),
        ...
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going_gettanh4_sr_out_o_valid),
        ...
        .out_intel_reserved_ffwd_2_0(bb_getTanh_B3_out_intel_reserved_ffwd_2_0),
        .out_lsu_memdep_o_active(bb_getTanh_B3_out_lsu_memdep_o_active),
        ...
        .out_unnamed_getTanh7_getTanh_avm_address(bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_address),
        .out_unnamed_getTanh7_getTanh_avm_burstcount(bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_burstcount),
        .out_unnamed_getTanh7_getTanh_avm_byteenable(bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_byteenable),
        .out_unnamed_getTanh7_getTanh_avm_enable(bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_enable),
        .out_unnamed_getTanh7_getTanh_avm_read(bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_read),
        .out_unnamed_getTanh7_getTanh_avm_write(bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_write),
        .out_unnamed_getTanh7_getTanh_avm_writedata(bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_writedata),
        .out_unnamed_getTanh9_getTanh_avm_address(bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_address),
        .out_unnamed_getTanh9_getTanh_avm_burstcount(bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_burstcount),
        .out_unnamed_getTanh9_getTanh_avm_byteenable(bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_byteenable),
        .out_unnamed_getTanh9_getTanh_avm_enable(bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_enable),
        .out_unnamed_getTanh9_getTanh_avm_read(bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_read),
        .out_unnamed_getTanh9_getTanh_avm_write(bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_write),
        .out_unnamed_getTanh9_getTanh_avm_writedata(bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_writedata),
    ...
    // bb_getTanh_B3_sr_1_aunroll_x(BLACKBOX,3)
    ...
    // loop_limiter_getTanh0(BLACKBOX,49)
    ...
    // i_llvm_fpga_pipeline_keep_going6_gettanh1_sr(BLACKBOX,24)
    getTanh_i_llvm_fpga_pipeline_keep_going6_gettanh1_sr thei_llvm_fpga_pipeline_keep_going6_gettanh1_sr (
        .in_i_data(GND_q),
        .in_i_stall(i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo_out_stall_out),
        .in_i_valid(bb_getTanh_B1_start_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going6_gettanh1_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going6_gettanh1_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_getTanh_B1_start(BLACKBOX,5)
    getTanh_bb_B1_start thebb_getTanh_B1_start (
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going6_gettanh1_sr_out_o_stall),
        .in_stall_in_0(loop_limiter_getTanh0_out_o_stall),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going6_gettanh1_valid_fifo_out_valid_out),
        .in_valid_in_1(in_valid_in),
        .out_exiting_stall_out(),
        .out_exiting_valid_out(),
        .out_feedback_stall_out_1(bb_getTanh_B1_start_out_feedback_stall_out_1),
        .out_intel_reserved_ffwd_0_0(bb_getTanh_B1_start_out_intel_reserved_ffwd_0_0),
        .out_intel_reserved_ffwd_1_0(bb_getTanh_B1_start_out_intel_reserved_ffwd_1_0),
    ...
    // getTanh_B1_start_x(EXTIFACE,22)
    ...
    // out_unnamed_getTanh7_getTanh_avm_address(GPOUT,63)
    assign out_unnamed_getTanh7_getTanh_avm_address = bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_address;

    // out_unnamed_getTanh7_getTanh_avm_burstcount(GPOUT,64)
    assign out_unnamed_getTanh7_getTanh_avm_burstcount = bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_burstcount;

    // out_unnamed_getTanh7_getTanh_avm_byteenable(GPOUT,65)
    assign out_unnamed_getTanh7_getTanh_avm_byteenable = bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_byteenable;

    // out_unnamed_getTanh7_getTanh_avm_enable(GPOUT,66)
    assign out_unnamed_getTanh7_getTanh_avm_enable = bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_enable;

    // out_unnamed_getTanh7_getTanh_avm_read(GPOUT,67)
    assign out_unnamed_getTanh7_getTanh_avm_read = bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_read;

    // out_unnamed_getTanh7_getTanh_avm_write(GPOUT,68)
    assign out_unnamed_getTanh7_getTanh_avm_write = bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_write;

    // out_unnamed_getTanh7_getTanh_avm_writedata(GPOUT,69)
    assign out_unnamed_getTanh7_getTanh_avm_writedata = bb_getTanh_B3_out_unnamed_getTanh7_getTanh_avm_writedata;

    // out_unnamed_getTanh9_getTanh_avm_address(GPOUT,70)
    assign out_unnamed_getTanh9_getTanh_avm_address = bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_address;

    // out_unnamed_getTanh9_getTanh_avm_burstcount(GPOUT,71)
    assign out_unnamed_getTanh9_getTanh_avm_burstcount = bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_burstcount;

    // out_unnamed_getTanh9_getTanh_avm_byteenable(GPOUT,72)
    assign out_unnamed_getTanh9_getTanh_avm_byteenable = bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_byteenable;

    // out_unnamed_getTanh9_getTanh_avm_enable(GPOUT,73)
    assign out_unnamed_getTanh9_getTanh_avm_enable = bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_enable;

    // out_unnamed_getTanh9_getTanh_avm_read(GPOUT,74)
    assign out_unnamed_getTanh9_getTanh_avm_read = bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_read;

    // out_unnamed_getTanh9_getTanh_avm_write(GPOUT,75)
    assign out_unnamed_getTanh9_getTanh_avm_write = bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_write;

    // out_unnamed_getTanh9_getTanh_avm_writedata(GPOUT,76)
    assign out_unnamed_getTanh9_getTanh_avm_writedata = bb_getTanh_B3_out_unnamed_getTanh9_getTanh_avm_writedata;
