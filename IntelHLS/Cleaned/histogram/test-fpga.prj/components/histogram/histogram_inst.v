...
histogram histogram_inst (
  ...
  // Interface: feature (conduit sink)
  .feature             ( ), // 64-bit data input
  // Interface: weight (conduit sink)
  .weight              ( ), // 64-bit data input
  // Interface: hist (conduit sink)
  .hist                ( ), // 64-bit data input
