...
module histogram_function (
    ...
    input wire [63:0] in_arg_feature,
    input wire [63:0] in_arg_hist,
    input wire [63:0] in_arg_return,
    input wire [63:0] in_arg_weight,
    ...
    wire [63:0] bb_histogram_B1_start_out_intel_reserved_ffwd_1_0;
    wire [63:0] bb_histogram_B1_start_out_intel_reserved_ffwd_2_0;
    wire [63:0] bb_histogram_B1_start_out_intel_reserved_ffwd_3_0;
    wire [32:0] bb_histogram_B1_start_out_intel_reserved_ffwd_4_0;
    ...
    wire [31:0] bb_histogram_B2_out_lm22_histogram_avm_address;
    wire [0:0] bb_histogram_B2_out_lm22_histogram_avm_burstcount;
    wire [3:0] bb_histogram_B2_out_lm22_histogram_avm_byteenable;
    wire [0:0] bb_histogram_B2_out_lm22_histogram_avm_enable;
    wire [0:0] bb_histogram_B2_out_lm22_histogram_avm_read;
    wire [0:0] bb_histogram_B2_out_lm22_histogram_avm_write;
    wire [31:0] bb_histogram_B2_out_lm22_histogram_avm_writedata;
    wire [31:0] bb_histogram_B2_out_lm43_histogram_avm_address;
    wire [0:0] bb_histogram_B2_out_lm43_histogram_avm_burstcount;
    wire [3:0] bb_histogram_B2_out_lm43_histogram_avm_byteenable;
    wire [0:0] bb_histogram_B2_out_lm43_histogram_avm_enable;
    wire [0:0] bb_histogram_B2_out_lm43_histogram_avm_read;
    wire [0:0] bb_histogram_B2_out_lm43_histogram_avm_write;
    wire [31:0] bb_histogram_B2_out_lm43_histogram_avm_writedata;
    wire [0:0] bb_histogram_B2_out_lsu_memdep_o_active;
    ...
    wire [0:0] i_llvm_fpga_pipeline_keep_going13_histogram1_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going13_histogram1_sr_out_o_valid;
    wire [0:0] i_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo_out_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo_out_valid_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_histogram4_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_histogram4_sr_out_o_valid;
    ...
    // i_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo(BLACKBOX,25)
    histogram_i_llvm_fpga_pipeline_keep_going13_1_valid_fifo thei_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo (
        .in_data_in(c_i2_011_q),
        .in_stall_in(bb_histogram_B1_start_out_stall_out_0),
        .in_valid_in(i_llvm_fpga_pipeline_keep_going13_histogram1_sr_out_o_valid),
        .out_almost_full(),
        .out_data_out(),
        .out_stall_out(i_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo_out_stall_out),
        .out_valid_out(i_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_histogram_B3_sr_0_aunroll_x(BLACKBOX,3)
    ...
    // i_llvm_fpga_pipeline_keep_going_histogram4_sr(BLACKBOX,26)
    histogram_i_llvm_fpga_pipeline_keep_going_4_sr thei_llvm_fpga_pipeline_keep_going_histogram4_sr (
        .in_i_data(GND_q),
        .in_i_stall(bb_histogram_B2_out_stall_out_0),
        .in_i_valid(bb_histogram_B2_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going_histogram4_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going_histogram4_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_histogram_B2(BLACKBOX,6)
    histogram_bb_B2 thebb_histogram_B2 (
        ...
        .in_intel_reserved_ffwd_2_0(bb_histogram_B1_start_out_intel_reserved_ffwd_2_0),
        .in_intel_reserved_ffwd_3_0(bb_histogram_B1_start_out_intel_reserved_ffwd_3_0),
        .in_intel_reserved_ffwd_4_0(bb_histogram_B1_start_out_intel_reserved_ffwd_4_0),
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going_histogram4_sr_out_o_stall),
        .in_stall_in_0(bb_histogram_B3_sr_0_aunroll_x_out_o_stall),
        .in_stall_in_1(GND_q),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going_histogram4_sr_out_o_valid),
        ...
        .out_lm22_histogram_avm_address(bb_histogram_B2_out_lm22_histogram_avm_address),
        .out_lm22_histogram_avm_burstcount(bb_histogram_B2_out_lm22_histogram_avm_burstcount),
        .out_lm22_histogram_avm_byteenable(bb_histogram_B2_out_lm22_histogram_avm_byteenable),
        .out_lm22_histogram_avm_enable(bb_histogram_B2_out_lm22_histogram_avm_enable),
        .out_lm22_histogram_avm_read(bb_histogram_B2_out_lm22_histogram_avm_read),
        .out_lm22_histogram_avm_write(bb_histogram_B2_out_lm22_histogram_avm_write),
        .out_lm22_histogram_avm_writedata(bb_histogram_B2_out_lm22_histogram_avm_writedata),
        .out_lm43_histogram_avm_address(bb_histogram_B2_out_lm43_histogram_avm_address),
        .out_lm43_histogram_avm_burstcount(bb_histogram_B2_out_lm43_histogram_avm_burstcount),
        .out_lm43_histogram_avm_byteenable(bb_histogram_B2_out_lm43_histogram_avm_byteenable),
        .out_lm43_histogram_avm_enable(bb_histogram_B2_out_lm43_histogram_avm_enable),
        .out_lm43_histogram_avm_read(bb_histogram_B2_out_lm43_histogram_avm_read),
        .out_lm43_histogram_avm_write(bb_histogram_B2_out_lm43_histogram_avm_write),
        .out_lm43_histogram_avm_writedata(bb_histogram_B2_out_lm43_histogram_avm_writedata),
        .out_lsu_memdep_o_active(bb_histogram_B2_out_lsu_memdep_o_active),
    ...
    // bb_histogram_B2_sr_1_aunroll_x(BLACKBOX,2)
    ...
    // loop_limiter_histogram0(BLACKBOX,54)
    ...
    // i_llvm_fpga_pipeline_keep_going13_histogram1_sr(BLACKBOX,24)
    histogram_i_llvm_fpga_pipeline_keep_going13_1_sr thei_llvm_fpga_pipeline_keep_going13_histogram1_sr (
        .in_i_data(GND_q),
        .in_i_stall(i_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo_out_stall_out),
        .in_i_valid(bb_histogram_B1_start_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going13_histogram1_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going13_histogram1_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_histogram_B1_start(BLACKBOX,5)
    histogram_bb_B1_start thebb_histogram_B1_start (
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going13_histogram1_sr_out_o_stall),
        .in_stall_in_0(loop_limiter_histogram0_out_o_stall),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going13_histogram1_valid_fifo_out_valid_out),
        ...
        .out_intel_reserved_ffwd_2_0(bb_histogram_B1_start_out_intel_reserved_ffwd_2_0),
        .out_intel_reserved_ffwd_3_0(bb_histogram_B1_start_out_intel_reserved_ffwd_3_0),
        .out_intel_reserved_ffwd_4_0(bb_histogram_B1_start_out_intel_reserved_ffwd_4_0),
    ...
    // histogram_B1_start_x(EXTIFACE,22)
    ...
    // out_iord_bl_call_histogram_o_fifoalmost_full(GPOUT,55)
    assign out_iord_bl_call_histogram_o_fifoalmost_full = bb_histogram_B1_start_out_iord_bl_call_histogram_o_fifoalmost_full;

    // out_iord_bl_call_histogram_o_fifoready(GPOUT,56)
    assign out_iord_bl_call_histogram_o_fifoready = bb_histogram_B1_start_out_iord_bl_call_histogram_o_fifoready;

    // out_iowr_bl_return_histogram_o_fifodata(GPOUT,57)
    assign out_iowr_bl_return_histogram_o_fifodata = bb_histogram_B3_out_iowr_bl_return_histogram_o_fifodata;

    // out_iowr_bl_return_histogram_o_fifovalid(GPOUT,58)
    assign out_iowr_bl_return_histogram_o_fifovalid = bb_histogram_B3_out_iowr_bl_return_histogram_o_fifovalid;

    // out_lm1_histogram_avm_address(GPOUT,59)
    assign out_lm1_histogram_avm_address = bb_histogram_B2_out_lm1_histogram_avm_address;

    // out_lm1_histogram_avm_burstcount(GPOUT,60)
    assign out_lm1_histogram_avm_burstcount = bb_histogram_B2_out_lm1_histogram_avm_burstcount;

    // out_lm1_histogram_avm_byteenable(GPOUT,61)
    assign out_lm1_histogram_avm_byteenable = bb_histogram_B2_out_lm1_histogram_avm_byteenable;

    // out_lm1_histogram_avm_enable(GPOUT,62)
    assign out_lm1_histogram_avm_enable = bb_histogram_B2_out_lm1_histogram_avm_enable;

    // out_lm1_histogram_avm_read(GPOUT,63)
    assign out_lm1_histogram_avm_read = bb_histogram_B2_out_lm1_histogram_avm_read;

    // out_lm1_histogram_avm_write(GPOUT,64)
    assign out_lm1_histogram_avm_write = bb_histogram_B2_out_lm1_histogram_avm_write;

    // out_lm1_histogram_avm_writedata(GPOUT,65)
    assign out_lm1_histogram_avm_writedata = bb_histogram_B2_out_lm1_histogram_avm_writedata;

    // out_lm22_histogram_avm_address(GPOUT,66)
    assign out_lm22_histogram_avm_address = bb_histogram_B2_out_lm22_histogram_avm_address;

    // out_lm22_histogram_avm_burstcount(GPOUT,67)
    assign out_lm22_histogram_avm_burstcount = bb_histogram_B2_out_lm22_histogram_avm_burstcount;

    // out_lm22_histogram_avm_byteenable(GPOUT,68)
    assign out_lm22_histogram_avm_byteenable = bb_histogram_B2_out_lm22_histogram_avm_byteenable;

    // out_lm22_histogram_avm_enable(GPOUT,69)
    assign out_lm22_histogram_avm_enable = bb_histogram_B2_out_lm22_histogram_avm_enable;

    // out_lm22_histogram_avm_read(GPOUT,70)
    assign out_lm22_histogram_avm_read = bb_histogram_B2_out_lm22_histogram_avm_read;

    // out_lm22_histogram_avm_write(GPOUT,71)
    assign out_lm22_histogram_avm_write = bb_histogram_B2_out_lm22_histogram_avm_write;

    // out_lm22_histogram_avm_writedata(GPOUT,72)
    assign out_lm22_histogram_avm_writedata = bb_histogram_B2_out_lm22_histogram_avm_writedata;

    // out_lm43_histogram_avm_address(GPOUT,73)
    assign out_lm43_histogram_avm_address = bb_histogram_B2_out_lm43_histogram_avm_address;

    // out_lm43_histogram_avm_burstcount(GPOUT,74)
    assign out_lm43_histogram_avm_burstcount = bb_histogram_B2_out_lm43_histogram_avm_burstcount;

    // out_lm43_histogram_avm_byteenable(GPOUT,75)
    assign out_lm43_histogram_avm_byteenable = bb_histogram_B2_out_lm43_histogram_avm_byteenable;

    // out_lm43_histogram_avm_enable(GPOUT,76)
    assign out_lm43_histogram_avm_enable = bb_histogram_B2_out_lm43_histogram_avm_enable;

    // out_lm43_histogram_avm_read(GPOUT,77)
    assign out_lm43_histogram_avm_read = bb_histogram_B2_out_lm43_histogram_avm_read;

    // out_lm43_histogram_avm_write(GPOUT,78)
    assign out_lm43_histogram_avm_write = bb_histogram_B2_out_lm43_histogram_avm_write;

    // out_lm43_histogram_avm_writedata(GPOUT,79)
    assign out_lm43_histogram_avm_writedata = bb_histogram_B2_out_lm43_histogram_avm_writedata;

    // out_memdep_histogram_avm_address(GPOUT,80)
    assign out_memdep_histogram_avm_address = bb_histogram_B2_out_memdep_histogram_avm_address;

    // out_memdep_histogram_avm_burstcount(GPOUT,81)
    assign out_memdep_histogram_avm_burstcount = bb_histogram_B2_out_memdep_histogram_avm_burstcount;

    // out_memdep_histogram_avm_byteenable(GPOUT,82)
    assign out_memdep_histogram_avm_byteenable = bb_histogram_B2_out_memdep_histogram_avm_byteenable;

    // out_memdep_histogram_avm_enable(GPOUT,83)
    assign out_memdep_histogram_avm_enable = bb_histogram_B2_out_memdep_histogram_avm_enable;

    // out_memdep_histogram_avm_read(GPOUT,84)
    assign out_memdep_histogram_avm_read = bb_histogram_B2_out_memdep_histogram_avm_read;

    // out_memdep_histogram_avm_write(GPOUT,85)
    assign out_memdep_histogram_avm_write = bb_histogram_B2_out_memdep_histogram_avm_write;

    // out_memdep_histogram_avm_writedata(GPOUT,86)
    assign out_memdep_histogram_avm_writedata = bb_histogram_B2_out_memdep_histogram_avm_writedata;

    // out_o_active_memdep(GPOUT,87)
    assign out_o_active_memdep = bb_histogram_B2_out_lsu_memdep_o_active;

    // bb_histogram_B0_runOnce(BLACKBOX,4)
