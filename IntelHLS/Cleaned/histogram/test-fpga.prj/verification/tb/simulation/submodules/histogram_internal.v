...
(
   input logic clock,
   input logic resetn,
   input logic [63:0] feature,
   input logic [63:0] weight,
   input logic [63:0] hist,
   input logic [31:0] n,
   input logic start,
   output logic busy,
   output logic done,
   ...
   genvar __i;
   logic avmm_1_global_avm_enable [4];
   logic avmm_1_global_avm_read [4];
   logic avmm_1_global_avm_write [4];
   logic [31:0] avmm_1_global_avm_address [4];
   logic [31:0] avmm_1_global_avm_writedata [4];
   logic [3:0] avmm_1_global_avm_byteenable [4];
   logic avmm_1_global_avm_waitrequest [4];
   logic [31:0] avmm_1_global_avm_readdata [4];
   logic avmm_1_global_avm_readdatavalid [4];
   logic avmm_1_global_avm_burstcount [4];
   logic avmm_1_global_avm_writeack [4];
   ...
   (
      ...
      .avm_lm1_histogram_enable(avmm_1_global_avm_enable[0]),
      .avm_lm1_histogram_read(avmm_1_global_avm_read[0]),
      .avm_lm1_histogram_write(avmm_1_global_avm_write[0]),
      .avm_lm1_histogram_address(avmm_1_global_avm_address[0]),
      .avm_lm1_histogram_writedata(avmm_1_global_avm_writedata[0]),
      .avm_lm1_histogram_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_lm1_histogram_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_lm1_histogram_readdata(avmm_1_global_avm_readdata[0]),
      .avm_lm1_histogram_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_lm1_histogram_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_lm1_histogram_writeack(avmm_1_global_avm_writeack[0]),
      // AVM avm_lm22_histogram
      .avm_lm22_histogram_enable(avmm_1_global_avm_enable[1]),
      .avm_lm22_histogram_read(avmm_1_global_avm_read[1]),
      .avm_lm22_histogram_write(avmm_1_global_avm_write[1]),
      .avm_lm22_histogram_address(avmm_1_global_avm_address[1]),
      .avm_lm22_histogram_writedata(avmm_1_global_avm_writedata[1]),
      .avm_lm22_histogram_byteenable(avmm_1_global_avm_byteenable[1]),
      .avm_lm22_histogram_waitrequest(avmm_1_global_avm_waitrequest[1]),
      .avm_lm22_histogram_readdata(avmm_1_global_avm_readdata[1]),
      .avm_lm22_histogram_readdatavalid(avmm_1_global_avm_readdatavalid[1]),
      .avm_lm22_histogram_burstcount(avmm_1_global_avm_burstcount[1]),
      .avm_lm22_histogram_writeack(avmm_1_global_avm_writeack[1]),
      // AVM avm_lm43_histogram
      .avm_lm43_histogram_enable(avmm_1_global_avm_enable[2]),
      .avm_lm43_histogram_read(avmm_1_global_avm_read[2]),
      .avm_lm43_histogram_write(avmm_1_global_avm_write[2]),
      .avm_lm43_histogram_address(avmm_1_global_avm_address[2]),
      .avm_lm43_histogram_writedata(avmm_1_global_avm_writedata[2]),
      .avm_lm43_histogram_byteenable(avmm_1_global_avm_byteenable[2]),
      .avm_lm43_histogram_waitrequest(avmm_1_global_avm_waitrequest[2]),
      .avm_lm43_histogram_readdata(avmm_1_global_avm_readdata[2]),
      .avm_lm43_histogram_readdatavalid(avmm_1_global_avm_readdatavalid[2]),
      .avm_lm43_histogram_burstcount(avmm_1_global_avm_burstcount[2]),
      .avm_lm43_histogram_writeack(avmm_1_global_avm_writeack[2]),
      // AVM avm_memdep_histogram
      .avm_memdep_histogram_enable(avmm_1_global_avm_enable[3]),
      .avm_memdep_histogram_read(avmm_1_global_avm_read[3]),
      .avm_memdep_histogram_write(avmm_1_global_avm_write[3]),
      .avm_memdep_histogram_address(avmm_1_global_avm_address[3]),
      .avm_memdep_histogram_writedata(avmm_1_global_avm_writedata[3]),
      .avm_memdep_histogram_byteenable(avmm_1_global_avm_byteenable[3]),
      .avm_memdep_histogram_waitrequest(avmm_1_global_avm_waitrequest[3]),
      .avm_memdep_histogram_readdata(avmm_1_global_avm_readdata[3]),
      .avm_memdep_histogram_readdatavalid(avmm_1_global_avm_readdatavalid[3]),
      .avm_memdep_histogram_burstcount(avmm_1_global_avm_burstcount[3]),
      .avm_memdep_histogram_writeack(avmm_1_global_avm_writeack[3])
   );

   generate
   begin:avmm_1_
      logic avmm_1_icm_in_arb_request [4];
      logic avmm_1_icm_in_arb_enable [4];
      logic avmm_1_icm_in_arb_read [4];
      logic avmm_1_icm_in_arb_write [4];
      logic avmm_1_icm_in_arb_burstcount [4];
      logic [29:0] avmm_1_icm_in_arb_address [4];
      logic [31:0] avmm_1_icm_in_arb_writedata [4];
      logic [3:0] avmm_1_icm_in_arb_byteenable [4];
      logic avmm_1_icm_in_arb_stall [4];
      logic avmm_1_icm_in_wrp_ack [4];
      logic avmm_1_icm_in_rrp_datavalid [4];
      logic [31:0] avmm_1_icm_in_rrp_data [4];
      ...
      logic icm_routedavmm_1_rw_arb_request [4];
      logic icm_routedavmm_1_rw_arb_enable [4];
      logic icm_routedavmm_1_rw_arb_read [4];
      logic icm_routedavmm_1_rw_arb_write [4];
      logic icm_routedavmm_1_rw_arb_burstcount [4];
      logic [29:0] icm_routedavmm_1_rw_arb_address [4];
      logic [31:0] icm_routedavmm_1_rw_arb_writedata [4];
      logic [3:0] icm_routedavmm_1_rw_arb_byteenable [4];
      logic icm_routedavmm_1_rw_arb_stall [4];
      logic icm_routedavmm_1_rw_wrp_ack [4];
      logic icm_routedavmm_1_rw_rrp_datavalid [4];
      logic [31:0] icm_routedavmm_1_rw_rrp_data [4];
      ...
      // INST global_icavmm_1_rw of histogram_internal_ic_2279474832706600798
      histogram_internal_ic_2279474832706600798 global_icavmm_1_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE histogram_internal_ic_2279474832706600798
/////////////////////////////////////////////////////////////////
module histogram_internal_ic_2279474832706600798
(
   input logic clock,
   ...
   input logic [29:0] m_arb_address [4],
