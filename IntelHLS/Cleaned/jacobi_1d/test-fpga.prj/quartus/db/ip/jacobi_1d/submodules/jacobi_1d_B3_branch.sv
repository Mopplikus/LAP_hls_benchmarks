...
module jacobi_1d_B3_branch (
    ...
    // out_exitcond1749_pop194(GPOUT,8)
    assign out_exitcond1749_pop194 = in_exitcond1749_pop194;

    // out_mPtr_bitcast70761(GPOUT,9)
    assign out_mPtr_bitcast70761 = in_mPtr_bitcast70761;

    // out_memdep_phi6_pop1355_pop232(GPOUT,10)
    assign out_memdep_phi6_pop1355_pop232 = in_memdep_phi6_pop1355_pop232;

    // out_notcmp3951_pop205(GPOUT,11)
    assign out_notcmp3951_pop205 = in_notcmp3951_pop205;
