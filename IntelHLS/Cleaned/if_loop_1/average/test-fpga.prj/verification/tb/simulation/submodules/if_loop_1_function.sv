...
module if_loop_1_function (
    ...
    wire [63:0] bb_if_loop_1_B1_start_out_intel_reserved_ffwd_1_0;
    wire [32:0] bb_if_loop_1_B1_start_out_intel_reserved_ffwd_2_0;
    ...
    wire [31:0] bb_if_loop_1_B2_out_intel_reserved_ffwd_3_0;
    ...
    wire [1:0] c_i2_011_q;
    wire [0:0] i_llvm_fpga_pipeline_keep_going11_if_loop_11_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going11_if_loop_11_sr_out_o_valid;
    wire [0:0] i_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo_out_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo_out_valid_out;
    ...
    // i_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo(BLACKBOX,24)
    if_loop_1_i_llvm_fpga_pipeline_keep_going11_1_valid_fifo thei_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo (
        .in_data_in(c_i2_011_q),
        .in_stall_in(bb_if_loop_1_B1_start_out_stall_out_0),
        .in_valid_in(i_llvm_fpga_pipeline_keep_going11_if_loop_11_sr_out_o_valid),
        .out_almost_full(),
        .out_data_out(),
        .out_stall_out(i_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo_out_stall_out),
        .out_valid_out(i_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // i_llvm_fpga_pipeline_keep_going_if_loop_16_valid_fifo(BLACKBOX,26)
    ...
    // bb_if_loop_1_B3_sr_0_aunroll_x(BLACKBOX,3)
    ...
    // i_llvm_fpga_pipeline_keep_going_if_loop_16_sr(BLACKBOX,25)
    ...
    if_loop_1_bb_B2 thebb_if_loop_1_B2 (
        ...
        .in_intel_reserved_ffwd_2_0(bb_if_loop_1_B1_start_out_intel_reserved_ffwd_2_0),
        ...
        .out_intel_reserved_ffwd_3_0(bb_if_loop_1_B2_out_intel_reserved_ffwd_3_0),
    ...
    // bb_if_loop_1_B2_sr_1_aunroll_x(BLACKBOX,2)
    ...
    // loop_limiter_if_loop_10(BLACKBOX,42)
    ...
    // i_llvm_fpga_pipeline_keep_going11_if_loop_11_sr(BLACKBOX,23)
    if_loop_1_i_llvm_fpga_pipeline_keep_going11_1_sr thei_llvm_fpga_pipeline_keep_going11_if_loop_11_sr (
        .in_i_data(GND_q),
        .in_i_stall(i_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo_out_stall_out),
        .in_i_valid(bb_if_loop_1_B1_start_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going11_if_loop_11_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going11_if_loop_11_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_if_loop_1_B1_start(BLACKBOX,5)
    if_loop_1_bb_B1_start thebb_if_loop_1_B1_start (
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going11_if_loop_11_sr_out_o_stall),
        .in_stall_in_0(loop_limiter_if_loop_10_out_o_stall),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going11_if_loop_11_valid_fifo_out_valid_out),
        ...
        .out_intel_reserved_ffwd_2_0(bb_if_loop_1_B1_start_out_intel_reserved_ffwd_2_0),
    ...
    // if_loop_1_B1_start_x(EXTIFACE,27)
