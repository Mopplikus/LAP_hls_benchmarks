...
(
   ...
   logic [31:0] avmm_1_global_avm_writedata [1];
   logic [3:0] avmm_1_global_avm_byteenable [1];
   logic avmm_1_global_avm_waitrequest [1];
   logic [31:0] avmm_1_global_avm_readdata [1];
   logic avmm_1_global_avm_readdatavalid [1];
   logic avmm_1_global_avm_burstcount [1];
   logic avmm_1_global_avm_writeack [1];

   // INST if_loop_1_internal of if_loop_1_function_wrapper
   if_loop_1_function_wrapper if_loop_1_internal
   (
      .clock(clock),
      .resetn(resetn),
      .a(a),
      ...
      // AVM avm_lm1_if_loop_1
      .avm_lm1_if_loop_1_enable(avmm_1_global_avm_enable[0]),
      .avm_lm1_if_loop_1_read(avmm_1_global_avm_read[0]),
      .avm_lm1_if_loop_1_write(avmm_1_global_avm_write[0]),
      .avm_lm1_if_loop_1_address(avmm_1_global_avm_address[0]),
      .avm_lm1_if_loop_1_writedata(avmm_1_global_avm_writedata[0]),
      .avm_lm1_if_loop_1_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_lm1_if_loop_1_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_lm1_if_loop_1_readdata(avmm_1_global_avm_readdata[0]),
      .avm_lm1_if_loop_1_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_lm1_if_loop_1_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_lm1_if_loop_1_writeack(avmm_1_global_avm_writeack[0])
   );
   ...
   begin:avmm_1_
      ...
      logic [29:0] avmm_1_icm_in_arb_address [1];
      logic [31:0] avmm_1_icm_in_arb_writedata [1];
      logic [3:0] avmm_1_icm_in_arb_byteenable [1];
      logic avmm_1_icm_in_arb_stall [1];
      logic avmm_1_icm_in_wrp_ack [1];
      logic avmm_1_icm_in_rrp_datavalid [1];
      logic [31:0] avmm_1_icm_in_rrp_data [1];
      ...
      logic [29:0] icm_routedavmm_1_rw_arb_address [1];
      logic [31:0] icm_routedavmm_1_rw_arb_writedata [1];
      logic [3:0] icm_routedavmm_1_rw_arb_byteenable [1];
      logic icm_routedavmm_1_rw_arb_stall [1];
      logic icm_routedavmm_1_rw_wrp_ack [1];
      logic icm_routedavmm_1_rw_rrp_datavalid [1];
      logic [31:0] icm_routedavmm_1_rw_rrp_data [1];
      ...
      // INST global_icavmm_1_rw of if_loop_1_internal_ic_10343365110530167922
      if_loop_1_internal_ic_10343365110530167922 global_icavmm_1_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE if_loop_1_internal_ic_10343365110530167922
/////////////////////////////////////////////////////////////////
module if_loop_1_internal_ic_10343365110530167922
(
   input logic clock,
