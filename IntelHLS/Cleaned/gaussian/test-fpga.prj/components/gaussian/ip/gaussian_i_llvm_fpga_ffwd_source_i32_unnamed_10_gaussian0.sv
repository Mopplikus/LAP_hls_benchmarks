...
module gaussian_i_llvm_fpga_ffwd_source_i32_unnamed_10_gaussian0 (
    ...
    wire [0:0] i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_predicate_in;
    wire i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_predicate_in_bitsignaltemp;
    wire [31:0] i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_source_in;
    wire [0:0] i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_valid_in;
    wire i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_valid_in_bitsignaltemp;
    wire [31:0] i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_source_out;


    // dupName_0_sync_out_x(GPOUT,2)@4
    assign out_valid_out = in_valid_in;

    // i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1(EXTIFACE,3)
    assign i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_predicate_in = in_predicate_in;
    assign i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_source_in = in_src_data_in_5_0;
    ...
    assign out_intel_reserved_ffwd_5_0 = i_llvm_fpga_ffwd_source_i32_unnamed_gaussian10_gaussian1_source_out;
