...
module gaussian_function (
    ...
    wire [31:0] bb_gaussian_B2_out_add44_push172;
    ...
    wire [63:0] bb_gaussian_B4_out_intel_reserved_ffwd_10_0;
    wire [31:0] bb_gaussian_B4_out_intel_reserved_ffwd_4_0;
    wire [31:0] bb_gaussian_B4_out_intel_reserved_ffwd_5_0;
    wire [32:0] bb_gaussian_B4_out_intel_reserved_ffwd_6_0;
    wire [31:0] bb_gaussian_B4_out_intel_reserved_ffwd_7_0;
    wire [0:0] bb_gaussian_B4_out_intel_reserved_ffwd_8_0;
    wire [31:0] bb_gaussian_B4_out_intel_reserved_ffwd_9_0;
    ...
    wire [31:0] bb_gaussian_B5_out_c0_exe163;
    ...
    wire [31:0] bb_gaussian_B6_out_add44_push173;
    ...
    wire [31:0] bb_gaussian_B7_out_add44_push17;
    ...
    wire [31:0] bb_gaussian_B7_out_lm32_gaussian_avm_address;
    wire [0:0] bb_gaussian_B7_out_lm32_gaussian_avm_burstcount;
    wire [3:0] bb_gaussian_B7_out_lm32_gaussian_avm_byteenable;
    ...
    wire [31:0] bb_gaussian_B7_out_lm32_gaussian_avm_writedata;
    wire [31:0] bb_gaussian_B7_out_lm53_gaussian_avm_address;
    wire [0:0] bb_gaussian_B7_out_lm53_gaussian_avm_burstcount;
    wire [3:0] bb_gaussian_B7_out_lm53_gaussian_avm_byteenable;
    ...
    wire [31:0] bb_gaussian_B7_out_lm53_gaussian_avm_writedata;
    ...
    wire [0:0] bb_gaussian_B7_out_notcmp3546_pop20;
    ...
    wire [0:0] i_llvm_fpga_pipeline_keep_going36_gaussian2_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going36_gaussian2_sr_out_o_valid;
    wire [0:0] i_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo_out_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo_out_valid_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going40_gaussian1_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going40_gaussian1_sr_out_o_valid;
    wire [0:0] i_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo_out_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo_out_valid_out;
    ...
    // c_i2_038(CONSTANT,42)
    assign c_i2_038_q = $unsigned(2'b00);

    // i_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo(BLACKBOX,56)
    gaussian_i_llvm_fpga_pipeline_keep_going40_1_valid_fifo thei_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo (
        .in_data_in(c_i2_038_q),
        .in_stall_in(bb_gaussian_B1_start_out_stall_out_0),
        .in_valid_in(i_llvm_fpga_pipeline_keep_going40_gaussian1_sr_out_o_valid),
        .out_almost_full(),
        .out_data_out(),
        .out_stall_out(i_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo_out_stall_out),
        .out_valid_out(i_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_gaussian_B4_sr_0_aunroll_x(BLACKBOX,4)
    gaussian_bb_B4_sr_0 thebb_gaussian_B4_sr_0_aunroll_x (
        .in_i_data_0_tpl(bb_gaussian_B2_out_add44_push172),
    ...
    // i_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo(BLACKBOX,54)
    gaussian_i_llvm_fpga_pipeline_keep_going36_2_valid_fifo thei_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo (
        .in_data_in(c_i2_038_q),
        .in_stall_in(bb_gaussian_B5_out_stall_out_0),
        .in_valid_in(i_llvm_fpga_pipeline_keep_going36_gaussian2_sr_out_o_valid),
        .out_almost_full(),
        .out_data_out(),
        .out_stall_out(i_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo_out_stall_out),
        .out_valid_out(i_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_gaussian_B6_sr_0_aunroll_x(BLACKBOX,7)
    gaussian_bb_B6_sr_0 thebb_gaussian_B6_sr_0_aunroll_x (
        .in_i_data_0_tpl(bb_gaussian_B7_out_memdep),
        .in_i_data_1_tpl(bb_gaussian_B7_out_add44_push17),
        .in_i_data_2_tpl(bb_gaussian_B7_out_pop19),
        .in_i_data_3_tpl(bb_gaussian_B7_out_notcmp3546_pop20),
    ...
    // i_llvm_fpga_pipeline_keep_going_gaussian4_sr(BLACKBOX,57)
    ...
    // bb_gaussian_B7(BLACKBOX,16)
    gaussian_bb_B7 thebb_gaussian_B7 (
        .in_add43_pop1154_0(c_i32_undef16_q),
        .in_add43_pop1154_1(bb_gaussian_B7_sr_1_aunroll_x_out_o_data_5_tpl),
        .in_flush(in_start),
        .in_forked31_0(GND_q),
        .in_forked31_1(bb_gaussian_B7_sr_1_aunroll_x_out_o_data_0_tpl),
        .in_intel_reserved_ffwd_0_0(bb_gaussian_B1_start_out_intel_reserved_ffwd_0_0),
        .in_intel_reserved_ffwd_10_0(bb_gaussian_B4_out_intel_reserved_ffwd_10_0),
        ...
        .in_memdep_phi_pop1053_0(GND_q),
        .in_memdep_phi_pop1053_1(bb_gaussian_B7_sr_1_aunroll_x_out_o_data_4_tpl),
        .in_mul_add1651_0(c_i32_undef16_q),
        .in_mul_add1651_1(bb_gaussian_B7_sr_1_aunroll_x_out_o_data_1_tpl),
        .in_notcmp3552_0(GND_q),
        .in_notcmp3552_1(bb_gaussian_B7_sr_1_aunroll_x_out_o_data_3_tpl),
        ...
        .in_stall_in_1(GND_q),
        .in_unnamed_gaussian17_0(GND_q),
        .in_unnamed_gaussian17_1(bb_gaussian_B7_sr_1_aunroll_x_out_o_data_2_tpl),
        ...
        .out_add44_push17(bb_gaussian_B7_out_add44_push17),
        ...
        .out_notcmp3546_pop20(bb_gaussian_B7_out_notcmp3546_pop20),
    ...
    // bb_gaussian_B7_sr_1_aunroll_x(BLACKBOX,8)
    gaussian_bb_B7_sr_1 thebb_gaussian_B7_sr_1_aunroll_x (
        .in_i_data_0_tpl(VCC_q),
        .in_i_data_1_tpl(bb_gaussian_B5_out_c0_exe163),
    ...
    // loop_limiter_gaussian2(BLACKBOX,86)
    ...
    // i_llvm_fpga_pipeline_keep_going36_gaussian2_sr(BLACKBOX,53)
    gaussian_i_llvm_fpga_pipeline_keep_going36_2_sr thei_llvm_fpga_pipeline_keep_going36_gaussian2_sr (
        .in_i_data(GND_q),
        .in_i_stall(i_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo_out_stall_out),
        .in_i_valid(bb_gaussian_B5_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going36_gaussian2_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going36_gaussian2_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_gaussian_B6(BLACKBOX,15)
    gaussian_bb_B6 thebb_gaussian_B6 (
        .in_add44_push173_0(bb_gaussian_B6_sr_0_aunroll_x_out_o_data_1_tpl),
        ...
        .in_notcmp3546_pop205_0(bb_gaussian_B6_sr_0_aunroll_x_out_o_data_3_tpl),
        ...
        .out_add44_push173(bb_gaussian_B6_out_add44_push173),
    ...
    gaussian_bb_B5 thebb_gaussian_B5 (
        ...
        .in_intel_reserved_ffwd_8_0(bb_gaussian_B4_out_intel_reserved_ffwd_8_0),
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going36_gaussian2_sr_out_o_stall),
        .in_stall_in_0(loop_limiter_gaussian2_out_o_stall),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going36_gaussian2_valid_fifo_out_valid_out),
        .in_valid_in_1(bb_gaussian_B5_sr_1_aunroll_x_out_o_valid),
        .out_c0_exe163(bb_gaussian_B5_out_c0_exe163),
    ...
    // bb_gaussian_B5_sr_1_aunroll_x(BLACKBOX,6)
    ...
    // loop_limiter_gaussian1(BLACKBOX,85)
    ...
    gaussian_bb_B4 thebb_gaussian_B4 (
        ...
        .in_j_047_0(bb_gaussian_B4_sr_0_aunroll_x_out_o_data_0_tpl),
        .in_j_047_1(bb_gaussian_B4_sr_1_aunroll_x_out_o_data_0_tpl),
        ...
        .out_intel_reserved_ffwd_10_0(bb_gaussian_B4_out_intel_reserved_ffwd_10_0),
    ...
    // bb_gaussian_B2_sr_0_aunroll_x(BLACKBOX,2)
    gaussian_bb_B2_sr_0 thebb_gaussian_B2_sr_0_aunroll_x (
        .in_i_data_0_tpl(bb_gaussian_B6_out_add44_push173),
    ...
    // bb_gaussian_B2(BLACKBOX,11)
    gaussian_bb_B2 thebb_gaussian_B2 (
        .in_add44_push172_0(bb_gaussian_B2_sr_0_aunroll_x_out_o_data_0_tpl),
        ...
        .out_add44_push172(bb_gaussian_B2_out_add44_push172),
    ...
    // bb_gaussian_B3_sr_0_aunroll_x(BLACKBOX,3)
    ...
    // loop_limiter_gaussian0(BLACKBOX,84)
    ...
    // i_llvm_fpga_pipeline_keep_going40_gaussian1_sr(BLACKBOX,55)
    gaussian_i_llvm_fpga_pipeline_keep_going40_1_sr thei_llvm_fpga_pipeline_keep_going40_gaussian1_sr (
        .in_i_data(GND_q),
        .in_i_stall(i_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo_out_stall_out),
        .in_i_valid(bb_gaussian_B1_start_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going40_gaussian1_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going40_gaussian1_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // bb_gaussian_B1_start(BLACKBOX,10)
    gaussian_bb_B1_start thebb_gaussian_B1_start (
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going40_gaussian1_sr_out_o_stall),
        .in_stall_in_0(loop_limiter_gaussian0_out_o_stall),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going40_gaussian1_valid_fifo_out_valid_out),
    ...
    // gaussian_B1_start_x(EXTIFACE,49)
