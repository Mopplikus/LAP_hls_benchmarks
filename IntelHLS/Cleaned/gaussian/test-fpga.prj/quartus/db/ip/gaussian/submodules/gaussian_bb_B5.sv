...
module gaussian_bb_B5 (
    ...
    input wire [31:0] in_add48_0,
    input wire [31:0] in_add48_1,
    ...
    wire [0:0] bb_gaussian_B5_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_stall_out;
    wire [0:0] bb_gaussian_B5_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_valid_out;
    wire [31:0] bb_gaussian_B5_stall_region_out_c0_exe163;
    ...
    wire [31:0] gaussian_B5_branch_out_c0_exe163;
    ...
    wire [31:0] gaussian_B5_merge_out_add48;
    wire [0:0] gaussian_B5_merge_out_forked23;
    ...
    gaussian_B5_branch thegaussian_B5_branch (
        .in_c0_exe163(bb_gaussian_B5_stall_region_out_c0_exe163),
        ...
        .out_c0_exe163(gaussian_B5_branch_out_c0_exe163),
    ...
    gaussian_B5_merge thegaussian_B5_merge (
        .in_add48_0(in_add48_0),
        .in_add48_1(in_add48_1),
        .in_forked23_0(in_forked23_0),
        .in_forked23_1(in_forked23_1),
        .in_stall_in(bb_gaussian_B5_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .in_valid_in_1(in_valid_in_1),
        .out_add48(gaussian_B5_merge_out_add48),
        .out_forked23(gaussian_B5_merge_out_forked23),
    ...
    gaussian_bb_B5_stall_region thebb_gaussian_B5_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_stall_out(bb_gaussian_B5_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_valid_out(bb_gaussian_B5_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_valid_out),
        .out_c0_exe163(bb_gaussian_B5_stall_region_out_c0_exe163),
    ...
    // out_c0_exe163(GPOUT,18)
    assign out_c0_exe163 = gaussian_B5_branch_out_c0_exe163;
    ...
    assign out_exiting_stall_out = bb_gaussian_B5_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,23)
    assign out_exiting_valid_out = bb_gaussian_B5_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian2_exiting_valid_out;
