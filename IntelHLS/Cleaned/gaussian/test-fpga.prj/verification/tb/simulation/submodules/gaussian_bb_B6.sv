...
module gaussian_bb_B6 (
    ...
    wire [31:0] gaussian_B6_merge_out_add44_push173;
    wire [0:0] gaussian_B6_merge_out_memdep_1;
    wire [0:0] gaussian_B6_merge_out_notcmp3546_pop205;
    ...
    gaussian_B6_branch thegaussian_B6_branch (
        .in_add44_push173(bb_gaussian_B6_stall_region_out_add44_push173),
        .in_notcmp3546_pop205(bb_gaussian_B6_stall_region_out_notcmp3546_pop205),
        .in_stall_in_0(in_stall_in_0),
        .in_stall_in_1(in_stall_in_1),
        .in_valid_in(bb_gaussian_B6_stall_region_out_valid_out),
        .out_add44_push173(gaussian_B6_branch_out_add44_push173),
    ...
    gaussian_B6_merge thegaussian_B6_merge (
        .in_add44_push173_0(in_add44_push173_0),
        .in_memdep_1_0(in_memdep_1_0),
        .in_notcmp3546_pop205_0(in_notcmp3546_pop205_0),
        .in_pop194_0(in_pop194_0),
        .in_stall_in(bb_gaussian_B6_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_add44_push173(gaussian_B6_merge_out_add44_push173),
        .out_memdep_1(gaussian_B6_merge_out_memdep_1),
        .out_notcmp3546_pop205(gaussian_B6_merge_out_notcmp3546_pop205),
    ...
    gaussian_bb_B6_stall_region thebb_gaussian_B6_stall_region (
        .in_add44_push173(gaussian_B6_merge_out_add44_push173),
        .in_feedback_stall_in_10(in_feedback_stall_in_10),
        .in_memdep_1(gaussian_B6_merge_out_memdep_1),
        .in_notcmp3546_pop205(gaussian_B6_merge_out_notcmp3546_pop205),
        ...
        .out_add44_push173(bb_gaussian_B6_stall_region_out_add44_push173),
        ...
        .out_notcmp3546_pop205(bb_gaussian_B6_stall_region_out_notcmp3546_pop205),
    ...
    // out_add44_push173(GPOUT,15)
    assign out_add44_push173 = gaussian_B6_branch_out_add44_push173;
