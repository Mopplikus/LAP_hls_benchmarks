...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/fir_function_wrapper.sv \
  $QSYS_SIMDIR/submodules/fir_function.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B2_sr_1.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B3_sr_0.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B0_runOnce.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B0_runOnce_stall_region.sv \
  $QSYS_SIMDIR/submodules/fir_B0_runOnce_merge_reg.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_token_i1_wt_limpop_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_token_i1_wt_limpop_0_reg.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_token_i1_wt_limpush_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_token_i1_wt_limpush_1_reg.sv \
  $QSYS_SIMDIR/submodules/fir_B0_runOnce_branch.sv \
  $QSYS_SIMDIR/submodules/fir_B0_runOnce_merge.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B1_start.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B1_start_stall_region.sv \
  $QSYS_SIMDIR/submodules/fir_i_iord_bl_call_unnamed_fir2_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_sfc_s_c0_in_wt_entry_s_c0_enter1_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_sfc_exit_s_c0_out_wt_entry_s_c0_exit_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_sfc_logic_s_c0_in_wt_entry_s_c0_enter1_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pipeline_keep_going6_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i1_notexitcond7_0.sv \
  $QSYS_SIMDIR/submodules/fir_B1_start_merge_reg.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_ffwd_source_p1025i32_unnamed_3_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_ffwd_source_p1025i32_unnamed_4_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_throttle_i1_throttle_pop_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_throttle_i1_throttle_pop_1_reg.sv \
  $QSYS_SIMDIR/submodules/fir_B1_start_branch.sv \
  $QSYS_SIMDIR/submodules/fir_B1_start_merge.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B2.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B2_stall_region.sv \
  $QSYS_SIMDIR/submodules/fir_B2_merge_reg.sv \
  $QSYS_SIMDIR/submodules/fir_i_sfc_s_c0_in_for_body_s_c0_enter92_fir1.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_sfc_exit_s_c0_out_for_body_s_c0_exit11_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_sfc_logic_s_c0_in_for_body_s_c0_enter92_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_ffwd_dest_p1025i32_mptr_bitcast21241_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_ffwd_dest_p1025i32_mptr_bitcast232_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pipeline_keep_going_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_i11_fpga_indvars_iv_pop6_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_i32_i_019_pop8_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_i4_cleanups_pop10_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_i4_initerations_pop9_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i11_fpga_indvars_iv_push6_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i1_lastiniteration_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i1_notexitcond_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i32_i_019_push8_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i4_cleanups_push10_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i4_initerations_push9_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_sfc_s_c1_in_for_body_s_c1_enter_fir6.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_sfc_exit_s_c1_out_for_body_s_c1_exit_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_sfc_logic_s_c1_in_for_body_s_c1_enter_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_ffwd_source_i32_unnamed_9_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pop_i32_tmp_020_pop7_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_i32_tmp_020_push7_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_mem_unnamed_7_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_readdata_reg_unnamed_7_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_mem_unnamed_8_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_readdata_reg_unnamed_8_fir1.sv \
  $QSYS_SIMDIR/submodules/fir_B2_branch.sv \
  $QSYS_SIMDIR/submodules/fir_B2_merge.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B3.sv \
  $QSYS_SIMDIR/submodules/fir_bb_B3_stall_region.sv \
  $QSYS_SIMDIR/submodules/fir_i_iowr_bl_return_unnamed_fir11_fir0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_ffwd_dest_i32_add3_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_token_i1_throttle_push_0.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_push_token_i1_throttle_push_2_reg.sv \
  $QSYS_SIMDIR/submodules/fir_B3_branch.sv \
  $QSYS_SIMDIR/submodules/fir_B3_merge.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pipeline_keep_going6_1_sr.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pipeline_keep_going6_1_valid_fifo.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pipeline_keep_going_6_sr.sv \
  $QSYS_SIMDIR/submodules/fir_i_llvm_fpga_pipeline_keep_going_6_valid_fifo.sv \
  $QSYS_SIMDIR/submodules/fir_loop_limiter_0.sv \
  ...
  $QSYS_SIMDIR/submodules/fir_internal.v \
  ...
  $QSYS_SIMDIR/submodules/tb_fir_inst.v \
  $QSYS_SIMDIR/submodules/tb_fir_component_dpi_controller_implicit_ready_conduit_fanout_inst.sv \
  $QSYS_SIMDIR/submodules/tb_fir_component_dpi_controller_bind_conduit_fanout_inst.sv \
