...
module fir_bb_B1_start (
    ...
    wire [0:0] bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_stall_out;
    wire [0:0] bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_valid_out;
    ...
    fir_bb_B1_start_stall_region thebb_fir_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_stall_out(bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_valid_out(bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,14)
    assign out_exiting_valid_out = bb_fir_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going6_fir1_exiting_valid_out;
