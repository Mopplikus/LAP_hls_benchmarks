...
(
   ...
   (
      ...
      // AVM avm_unnamed_fir7_fir
      .avm_unnamed_fir7_fir_enable(avmm_1_global_avm_enable[0]),
      .avm_unnamed_fir7_fir_read(avmm_1_global_avm_read[0]),
      .avm_unnamed_fir7_fir_write(avmm_1_global_avm_write[0]),
      .avm_unnamed_fir7_fir_address(avmm_1_global_avm_address[0]),
      .avm_unnamed_fir7_fir_writedata(avmm_1_global_avm_writedata[0]),
      .avm_unnamed_fir7_fir_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_unnamed_fir7_fir_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_unnamed_fir7_fir_readdata(avmm_1_global_avm_readdata[0]),
      .avm_unnamed_fir7_fir_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_unnamed_fir7_fir_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_unnamed_fir7_fir_writeack(avmm_1_global_avm_writeack[0]),
      // AVM avm_unnamed_fir8_fir
      .avm_unnamed_fir8_fir_enable(avmm_1_global_avm_enable[1]),
      .avm_unnamed_fir8_fir_read(avmm_1_global_avm_read[1]),
      .avm_unnamed_fir8_fir_write(avmm_1_global_avm_write[1]),
      .avm_unnamed_fir8_fir_address(avmm_1_global_avm_address[1]),
      .avm_unnamed_fir8_fir_writedata(avmm_1_global_avm_writedata[1]),
      .avm_unnamed_fir8_fir_byteenable(avmm_1_global_avm_byteenable[1]),
      .avm_unnamed_fir8_fir_waitrequest(avmm_1_global_avm_waitrequest[1]),
      .avm_unnamed_fir8_fir_readdata(avmm_1_global_avm_readdata[1]),
      .avm_unnamed_fir8_fir_readdatavalid(avmm_1_global_avm_readdatavalid[1]),
      .avm_unnamed_fir8_fir_burstcount(avmm_1_global_avm_burstcount[1]),
      .avm_unnamed_fir8_fir_writeack(avmm_1_global_avm_writeack[1])
   );
   ...
   begin:avmm_1_
      ...
      logic [29:0] icm_routedavmm_1_rw_arb_address [2];
      logic [31:0] icm_routedavmm_1_rw_arb_writedata [2];
      logic [3:0] icm_routedavmm_1_rw_arb_byteenable [2];
      logic icm_routedavmm_1_rw_arb_stall [2];
      logic icm_routedavmm_1_rw_wrp_ack [2];
      logic icm_routedavmm_1_rw_rrp_datavalid [2];
      logic [31:0] icm_routedavmm_1_rw_rrp_data [2];
      ...
      // INST global_icavmm_1_rw of fir_internal_ic_11171317216813168177
      fir_internal_ic_11171317216813168177 global_icavmm_1_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE fir_internal_ic_11171317216813168177
/////////////////////////////////////////////////////////////////
module fir_internal_ic_11171317216813168177
(
   input logic clock,
