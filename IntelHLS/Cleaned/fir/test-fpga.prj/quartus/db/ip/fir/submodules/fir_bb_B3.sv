...
module fir_bb_B3 (
    ...
    wire [0:0] bb_fir_B3_stall_region_out_feedback_out_1;
    wire [0:0] bb_fir_B3_stall_region_out_feedback_valid_out_1;
    wire [31:0] bb_fir_B3_stall_region_out_iowr_bl_return_fir_o_fifodata;
    wire [0:0] bb_fir_B3_stall_region_out_iowr_bl_return_fir_o_fifovalid;
    ...
    fir_bb_B3_stall_region thebb_fir_B3_stall_region (
        ...
        .out_feedback_out_1(bb_fir_B3_stall_region_out_feedback_out_1),
        .out_feedback_valid_out_1(bb_fir_B3_stall_region_out_feedback_valid_out_1),
        .out_iowr_bl_return_fir_o_fifodata(bb_fir_B3_stall_region_out_iowr_bl_return_fir_o_fifodata),
        .out_iowr_bl_return_fir_o_fifovalid(bb_fir_B3_stall_region_out_iowr_bl_return_fir_o_fifovalid),
    ...
    assign out_feedback_out_1 = bb_fir_B3_stall_region_out_feedback_out_1;

    // feedback_valid_out_1_sync(GPOUT,5)
    assign out_feedback_valid_out_1 = bb_fir_B3_stall_region_out_feedback_valid_out_1;

    // out_iowr_bl_return_fir_o_fifodata(GPOUT,12)
    assign out_iowr_bl_return_fir_o_fifodata = bb_fir_B3_stall_region_out_iowr_bl_return_fir_o_fifodata;

    // out_iowr_bl_return_fir_o_fifovalid(GPOUT,13)
    assign out_iowr_bl_return_fir_o_fifovalid = bb_fir_B3_stall_region_out_iowr_bl_return_fir_o_fifovalid;
