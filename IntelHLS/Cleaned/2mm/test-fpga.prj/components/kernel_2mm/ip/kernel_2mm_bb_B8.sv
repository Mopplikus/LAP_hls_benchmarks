...
module kernel_2mm_bb_B8 (
    input wire [0:0] in_c0_exe62572_0,
    ...
    wire [0:0] bb_kernel_2mm_B8_stall_region_out_c0_exe62572;
    ...
    wire [0:0] kernel_2mm_B8_branch_out_valid_out_1;
    wire [0:0] kernel_2mm_B8_merge_out_c0_exe62572;
    ...
    // kernel_2mm_B8_branch(BLACKBOX,7)
    kernel_2mm_B8_branch thekernel_2mm_B8_branch (
        .in_c0_exe62572(bb_kernel_2mm_B8_stall_region_out_c0_exe62572),
        ...
        .out_valid_out_1(kernel_2mm_B8_branch_out_valid_out_1),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    kernel_2mm_bb_B8_stall_region thebb_kernel_2mm_B8_stall_region (
        .in_c0_exe62572(kernel_2mm_B8_merge_out_c0_exe62572),
        .in_stall_in(kernel_2mm_B8_branch_out_stall_out),
        .in_valid_in(kernel_2mm_B8_merge_out_valid_out),
        .out_c0_exe62572(bb_kernel_2mm_B8_stall_region_out_c0_exe62572),
    ...
    // kernel_2mm_B8_merge(BLACKBOX,8)
    kernel_2mm_B8_merge thekernel_2mm_B8_merge (
        .in_c0_exe62572_0(in_c0_exe62572_0),
        .in_stall_in(bb_kernel_2mm_B8_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe62572(kernel_2mm_B8_merge_out_c0_exe62572),
    ...
    assign out_valid_out_1 = kernel_2mm_B8_branch_out_valid_out_1;
