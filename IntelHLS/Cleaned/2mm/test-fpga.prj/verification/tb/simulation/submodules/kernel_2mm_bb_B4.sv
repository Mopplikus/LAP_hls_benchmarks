...
module kernel_2mm_bb_B4 (
    input wire [0:0] in_c0_exe32041_0,
    ...
    wire [0:0] bb_kernel_2mm_B4_stall_region_out_c0_exe32041;
    ...
    wire [0:0] kernel_2mm_B4_branch_out_valid_out_1;
    wire [0:0] kernel_2mm_B4_merge_out_c0_exe32041;
    ...
    // kernel_2mm_B4_branch(BLACKBOX,7)
    kernel_2mm_B4_branch thekernel_2mm_B4_branch (
        .in_c0_exe32041(bb_kernel_2mm_B4_stall_region_out_c0_exe32041),
        ...
        .out_valid_out_1(kernel_2mm_B4_branch_out_valid_out_1),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    kernel_2mm_bb_B4_stall_region thebb_kernel_2mm_B4_stall_region (
        .in_c0_exe32041(kernel_2mm_B4_merge_out_c0_exe32041),
        .in_stall_in(kernel_2mm_B4_branch_out_stall_out),
        .in_valid_in(kernel_2mm_B4_merge_out_valid_out),
        .out_c0_exe32041(bb_kernel_2mm_B4_stall_region_out_c0_exe32041),
    ...
    // kernel_2mm_B4_merge(BLACKBOX,8)
    kernel_2mm_B4_merge thekernel_2mm_B4_merge (
        .in_c0_exe32041_0(in_c0_exe32041_0),
        .in_stall_in(bb_kernel_2mm_B4_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe32041(kernel_2mm_B4_merge_out_c0_exe32041),
    ...
    assign out_valid_out_1 = kernel_2mm_B4_branch_out_valid_out_1;
