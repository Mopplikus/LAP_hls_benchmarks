...
module kernel_2mm_bb_B13 (
    ...
    wire [0:0] bb_kernel_2mm_B13_stall_region_out_feedback_out_1;
    wire [0:0] bb_kernel_2mm_B13_stall_region_out_feedback_valid_out_1;
    wire [0:0] bb_kernel_2mm_B13_stall_region_out_iowr_bl_return_kernel_2mm_o_fifodata;
    wire [0:0] bb_kernel_2mm_B13_stall_region_out_iowr_bl_return_kernel_2mm_o_fifovalid;
    ...
    // kernel_2mm_B13_merge(BLACKBOX,10)
    ...
    // kernel_2mm_B13_branch(BLACKBOX,9)
    ...
    kernel_2mm_bb_B13_stall_region thebb_kernel_2mm_B13_stall_region (
        ...
        .out_feedback_out_1(bb_kernel_2mm_B13_stall_region_out_feedback_out_1),
        .out_feedback_valid_out_1(bb_kernel_2mm_B13_stall_region_out_feedback_valid_out_1),
        .out_iowr_bl_return_kernel_2mm_o_fifodata(bb_kernel_2mm_B13_stall_region_out_iowr_bl_return_kernel_2mm_o_fifodata),
        .out_iowr_bl_return_kernel_2mm_o_fifovalid(bb_kernel_2mm_B13_stall_region_out_iowr_bl_return_kernel_2mm_o_fifovalid),
    ...
    assign out_feedback_out_1 = bb_kernel_2mm_B13_stall_region_out_feedback_out_1;

    // feedback_valid_out_1_sync(GPOUT,5)
    assign out_feedback_valid_out_1 = bb_kernel_2mm_B13_stall_region_out_feedback_valid_out_1;

    // out_iowr_bl_return_kernel_2mm_o_fifodata(GPOUT,11)
    assign out_iowr_bl_return_kernel_2mm_o_fifodata = bb_kernel_2mm_B13_stall_region_out_iowr_bl_return_kernel_2mm_o_fifodata;

    // out_iowr_bl_return_kernel_2mm_o_fifovalid(GPOUT,12)
    assign out_iowr_bl_return_kernel_2mm_o_fifovalid = bb_kernel_2mm_B13_stall_region_out_iowr_bl_return_kernel_2mm_o_fifovalid;
