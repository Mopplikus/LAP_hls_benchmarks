...
module kernel_2mm_bb_B10 (
    input wire [0:0] in_c0_exe62573_0,
    input wire [63:0] in_c0_exe72584_0,
    input wire [0:0] in_c0_exe82595_0,
    input wire [31:0] in_c1_exe16_0,
    ...
    wire [0:0] bb_kernel_2mm_B10_stall_region_out_c0_exe62573;
    wire [0:0] bb_kernel_2mm_B10_stall_region_out_c0_exe82595;
    ...
    wire [0:0] kernel_2mm_B10_branch_out_c0_exe62573;
    ...
    wire [0:0] kernel_2mm_B10_merge_out_c0_exe62573;
    wire [63:0] kernel_2mm_B10_merge_out_c0_exe72584;
    wire [0:0] kernel_2mm_B10_merge_out_c0_exe82595;
    wire [31:0] kernel_2mm_B10_merge_out_c1_exe16;
    ...
    kernel_2mm_B10_merge thekernel_2mm_B10_merge (
        .in_c0_exe62573_0(in_c0_exe62573_0),
        .in_c0_exe72584_0(in_c0_exe72584_0),
        .in_c0_exe82595_0(in_c0_exe82595_0),
        .in_c1_exe16_0(in_c1_exe16_0),
        .in_stall_in(bb_kernel_2mm_B10_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe62573(kernel_2mm_B10_merge_out_c0_exe62573),
        .out_c0_exe72584(kernel_2mm_B10_merge_out_c0_exe72584),
        .out_c0_exe82595(kernel_2mm_B10_merge_out_c0_exe82595),
        .out_c1_exe16(kernel_2mm_B10_merge_out_c1_exe16),
    ...
    kernel_2mm_bb_B10_stall_region thebb_kernel_2mm_B10_stall_region (
        .in_c0_exe62573(kernel_2mm_B10_merge_out_c0_exe62573),
        .in_c0_exe72584(kernel_2mm_B10_merge_out_c0_exe72584),
        .in_c0_exe82595(kernel_2mm_B10_merge_out_c0_exe82595),
        .in_c1_exe16(kernel_2mm_B10_merge_out_c1_exe16),
        .in_flush(in_flush),
        ...
        .out_c0_exe62573(bb_kernel_2mm_B10_stall_region_out_c0_exe62573),
        .out_c0_exe82595(bb_kernel_2mm_B10_stall_region_out_c0_exe82595),
    ...
    kernel_2mm_B10_branch thekernel_2mm_B10_branch (
        .in_c0_exe62573(bb_kernel_2mm_B10_stall_region_out_c0_exe62573),
        .in_c0_exe82595(bb_kernel_2mm_B10_stall_region_out_c0_exe82595),
        .in_stall_in_0(in_stall_in_0),
        .in_stall_in_1(in_stall_in_1),
        .in_valid_in(bb_kernel_2mm_B10_stall_region_out_valid_out),
        .out_c0_exe62573(kernel_2mm_B10_branch_out_c0_exe62573),
    ...
    // out_c0_exe62573(GPOUT,17)
    assign out_c0_exe62573 = kernel_2mm_B10_branch_out_c0_exe62573;
