...
module stencil_2d_B5_merge (
    ...
    output wire [0:0] out_c0_exe102824,
    ...
    // out_c0_exe102824(GPOUT,7)
    assign out_c0_exe102824 = in_c0_exe102824_0;

    // out_c0_exe112837(GPOUT,8)
    assign out_c0_exe112837 = in_c0_exe112837_0;
