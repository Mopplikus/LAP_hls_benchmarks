...
module stencil_2d_bb_B7 (
    ...
    input wire [0:0] in_c0_exe102825_0,
    input wire [0:0] in_c0_exe112838_0,
    input wire [0:0] in_c0_exe1228410_0,
    input wire [0:0] in_c0_exe1328512_0,
    input wire [31:0] in_c0_exe1428614_0,
    input wire [31:0] in_c0_exe92812_0,
    ...
    wire [0:0] bb_stencil_2d_B7_stall_region_out_c0_exe102825;
    wire [0:0] bb_stencil_2d_B7_stall_region_out_c0_exe112838;
    wire [0:0] bb_stencil_2d_B7_stall_region_out_c0_exe1328512;
    ...
    wire [31:0] bb_stencil_2d_B7_stall_region_out_memdep_stencil_2d_avm_address;
    wire [0:0] bb_stencil_2d_B7_stall_region_out_memdep_stencil_2d_avm_burstcount;
    wire [3:0] bb_stencil_2d_B7_stall_region_out_memdep_stencil_2d_avm_byteenable;
    ...
    wire [31:0] bb_stencil_2d_B7_stall_region_out_memdep_stencil_2d_avm_writedata;
    wire [0:0] bb_stencil_2d_B7_stall_region_out_stall_out;
    wire [0:0] bb_stencil_2d_B7_stall_region_out_valid_out;
    wire [0:0] stencil_2d_B7_branch_out_c0_exe102825;
    wire [0:0] stencil_2d_B7_branch_out_c0_exe112838;
    ...
    wire [0:0] stencil_2d_B7_merge_out_c0_exe102825;
    wire [0:0] stencil_2d_B7_merge_out_c0_exe112838;
    wire [0:0] stencil_2d_B7_merge_out_c0_exe1228410;
    wire [0:0] stencil_2d_B7_merge_out_c0_exe1328512;
    wire [31:0] stencil_2d_B7_merge_out_c0_exe1428614;
    wire [31:0] stencil_2d_B7_merge_out_c0_exe92812;
    ...
    stencil_2d_B7_branch thestencil_2d_B7_branch (
        .in_c0_exe102825(bb_stencil_2d_B7_stall_region_out_c0_exe102825),
        .in_c0_exe112838(bb_stencil_2d_B7_stall_region_out_c0_exe112838),
        .in_c0_exe1328512(bb_stencil_2d_B7_stall_region_out_c0_exe1328512),
        .in_memdep(bb_stencil_2d_B7_stall_region_out_memdep),
        .in_stall_in_0(in_stall_in_0),
        .in_stall_in_1(in_stall_in_1),
        .in_valid_in(bb_stencil_2d_B7_stall_region_out_valid_out),
        .out_c0_exe102825(stencil_2d_B7_branch_out_c0_exe102825),
        .out_c0_exe112838(stencil_2d_B7_branch_out_c0_exe112838),
    ...
    stencil_2d_B7_merge thestencil_2d_B7_merge (
        .in_c0_exe102825_0(in_c0_exe102825_0),
        .in_c0_exe112838_0(in_c0_exe112838_0),
        .in_c0_exe1228410_0(in_c0_exe1228410_0),
        .in_c0_exe1328512_0(in_c0_exe1328512_0),
        .in_c0_exe1428614_0(in_c0_exe1428614_0),
        .in_c0_exe92812_0(in_c0_exe92812_0),
        .in_c1_exe117_0(in_c1_exe117_0),
        .in_stall_in(bb_stencil_2d_B7_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe102825(stencil_2d_B7_merge_out_c0_exe102825),
        .out_c0_exe112838(stencil_2d_B7_merge_out_c0_exe112838),
        .out_c0_exe1228410(stencil_2d_B7_merge_out_c0_exe1228410),
        .out_c0_exe1328512(stencil_2d_B7_merge_out_c0_exe1328512),
        .out_c0_exe1428614(stencil_2d_B7_merge_out_c0_exe1428614),
        .out_c0_exe92812(stencil_2d_B7_merge_out_c0_exe92812),
    ...
    stencil_2d_bb_B7_stall_region thebb_stencil_2d_B7_stall_region (
        .in_c0_exe102825(stencil_2d_B7_merge_out_c0_exe102825),
        .in_c0_exe112838(stencil_2d_B7_merge_out_c0_exe112838),
        .in_c0_exe1228410(stencil_2d_B7_merge_out_c0_exe1228410),
        .in_c0_exe1328512(stencil_2d_B7_merge_out_c0_exe1328512),
        .in_c0_exe1428614(stencil_2d_B7_merge_out_c0_exe1428614),
        .in_c0_exe92812(stencil_2d_B7_merge_out_c0_exe92812),
        ...
        .out_c0_exe102825(bb_stencil_2d_B7_stall_region_out_c0_exe102825),
        .out_c0_exe112838(bb_stencil_2d_B7_stall_region_out_c0_exe112838),
        .out_c0_exe1328512(bb_stencil_2d_B7_stall_region_out_c0_exe1328512),
    ...
    // out_c0_exe102825(GPOUT,22)
    assign out_c0_exe102825 = stencil_2d_B7_branch_out_c0_exe102825;

    // out_c0_exe112838(GPOUT,23)
    assign out_c0_exe112838 = stencil_2d_B7_branch_out_c0_exe112838;
