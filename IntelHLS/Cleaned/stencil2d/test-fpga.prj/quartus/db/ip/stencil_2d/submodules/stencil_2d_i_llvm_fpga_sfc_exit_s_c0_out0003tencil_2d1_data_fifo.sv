...
// SystemVerilog created from i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d1_data_fifo
...
module stencil_2d_i_llvm_fpga_sfc_exit_s_c0_out0003tencil_2d1_data_fifo (
    ...
    wire [703:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_data;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_stall;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_stall_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_valid;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_valid_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_almost_full;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_almost_full_bitsignaltemp;
    wire [703:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_stall;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_stall_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_valid;
    wire i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_valid_bitsignaltemp;
    ...
    // ip_dsdk_adapt_bitselect111(BITSELECT,81)
    assign ip_dsdk_adapt_bitselect111_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[688:688];
    ...
    // ip_dsdk_adapt_bitselect109(BITSELECT,80)
    assign ip_dsdk_adapt_bitselect109_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[680:680];
    ...
    // ip_dsdk_adapt_bitselect107(BITSELECT,79)
    assign ip_dsdk_adapt_bitselect107_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[672:672];
    ...
    // ip_dsdk_adapt_bitselect105(BITSELECT,78)
    assign ip_dsdk_adapt_bitselect105_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[671:640];

    // ip_dsdk_adapt_bitselect103(BITSELECT,77)
    assign ip_dsdk_adapt_bitselect103_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[639:608];

    // ip_dsdk_adapt_bitselect101(BITSELECT,76)
    assign ip_dsdk_adapt_bitselect101_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[576:576];

    // adapt_scalar_trunc102(ROUND,4)
    assign adapt_scalar_trunc102_in = ip_dsdk_adapt_bitselect101_b;
    assign adapt_scalar_trunc102_q = adapt_scalar_trunc102_in[0:0];

    // ip_dsdk_adapt_bitselect99(BITSELECT,105)
    assign ip_dsdk_adapt_bitselect99_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[575:544];

    // ip_dsdk_adapt_bitselect97(BITSELECT,104)
    assign ip_dsdk_adapt_bitselect97_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[512:512];

    // adapt_scalar_trunc98(ROUND,24)
    assign adapt_scalar_trunc98_in = ip_dsdk_adapt_bitselect97_b;
    assign adapt_scalar_trunc98_q = adapt_scalar_trunc98_in[0:0];

    // ip_dsdk_adapt_bitselect95(BITSELECT,103)
    assign ip_dsdk_adapt_bitselect95_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[504:504];

    // adapt_scalar_trunc96(ROUND,23)
    assign adapt_scalar_trunc96_in = ip_dsdk_adapt_bitselect95_b;
    assign adapt_scalar_trunc96_q = adapt_scalar_trunc96_in[0:0];

    // ip_dsdk_adapt_bitselect93(BITSELECT,102)
    assign ip_dsdk_adapt_bitselect93_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[496:496];

    // adapt_scalar_trunc94(ROUND,22)
    assign adapt_scalar_trunc94_in = ip_dsdk_adapt_bitselect93_b;
    assign adapt_scalar_trunc94_q = adapt_scalar_trunc94_in[0:0];

    // ip_dsdk_adapt_bitselect91(BITSELECT,101)
    assign ip_dsdk_adapt_bitselect91_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[488:488];

    // adapt_scalar_trunc92(ROUND,21)
    assign adapt_scalar_trunc92_in = ip_dsdk_adapt_bitselect91_b;
    assign adapt_scalar_trunc92_q = adapt_scalar_trunc92_in[0:0];

    // ip_dsdk_adapt_bitselect89(BITSELECT,100)
    assign ip_dsdk_adapt_bitselect89_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[480:480];

    // adapt_scalar_trunc90(ROUND,20)
    assign adapt_scalar_trunc90_in = ip_dsdk_adapt_bitselect89_b;
    assign adapt_scalar_trunc90_q = adapt_scalar_trunc90_in[0:0];

    // ip_dsdk_adapt_bitselect87(BITSELECT,99)
    assign ip_dsdk_adapt_bitselect87_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[479:448];

    // ip_dsdk_adapt_bitselect85(BITSELECT,98)
    assign ip_dsdk_adapt_bitselect85_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[447:416];

    // ip_dsdk_adapt_bitselect83(BITSELECT,97)
    assign ip_dsdk_adapt_bitselect83_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[384:384];

    // adapt_scalar_trunc84(ROUND,19)
    assign adapt_scalar_trunc84_in = ip_dsdk_adapt_bitselect83_b;
    assign adapt_scalar_trunc84_q = adapt_scalar_trunc84_in[0:0];

    // ip_dsdk_adapt_bitselect81(BITSELECT,96)
    assign ip_dsdk_adapt_bitselect81_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[383:352];

    // ip_dsdk_adapt_bitselect79(BITSELECT,95)
    assign ip_dsdk_adapt_bitselect79_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[344:344];
    ...
    // ip_dsdk_adapt_bitselect77(BITSELECT,94)
    assign ip_dsdk_adapt_bitselect77_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[336:336];
    ...
    // ip_dsdk_adapt_bitselect75(BITSELECT,93)
    assign ip_dsdk_adapt_bitselect75_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[328:328];
    ...
    // ip_dsdk_adapt_bitselect73(BITSELECT,92)
    assign ip_dsdk_adapt_bitselect73_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[320:320];
    ...
    // ip_dsdk_adapt_bitselect71(BITSELECT,91)
    assign ip_dsdk_adapt_bitselect71_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[319:288];

    // ip_dsdk_adapt_bitselect69(BITSELECT,90)
    assign ip_dsdk_adapt_bitselect69_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[256:256];

    // adapt_scalar_trunc70(ROUND,14)
    assign adapt_scalar_trunc70_in = ip_dsdk_adapt_bitselect69_b;
    assign adapt_scalar_trunc70_q = adapt_scalar_trunc70_in[0:0];

    // ip_dsdk_adapt_bitselect67(BITSELECT,89)
    assign ip_dsdk_adapt_bitselect67_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[255:192];

    // ip_dsdk_adapt_bitselect65(BITSELECT,88)
    assign ip_dsdk_adapt_bitselect65_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[128:128];

    // adapt_scalar_trunc66(ROUND,13)
    assign adapt_scalar_trunc66_in = ip_dsdk_adapt_bitselect65_b;
    assign adapt_scalar_trunc66_q = adapt_scalar_trunc66_in[0:0];

    // ip_dsdk_adapt_bitselect63(BITSELECT,87)
    assign ip_dsdk_adapt_bitselect63_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[127:64];

    // ip_dsdk_adapt_bitselect61(BITSELECT,86)
    assign ip_dsdk_adapt_bitselect61_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[32:32];

    // adapt_scalar_trunc62(ROUND,12)
    assign adapt_scalar_trunc62_in = ip_dsdk_adapt_bitselect61_b;
    assign adapt_scalar_trunc62_q = adapt_scalar_trunc62_in[0:0];

    // ip_dsdk_adapt_bitselect59(BITSELECT,85)
    assign ip_dsdk_adapt_bitselect59_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[24:24];
    ...
    // ip_dsdk_adapt_bitselect57(BITSELECT,84)
    assign ip_dsdk_adapt_bitselect57_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[16:16];
    ...
    // ip_dsdk_adapt_bitselect55(BITSELECT,83)
    assign ip_dsdk_adapt_bitselect55_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[8:8];
    ...
    // ip_dsdk_adapt_bitselect53(BITSELECT,82)
    assign ip_dsdk_adapt_bitselect53_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data[0:0];
    ...
    // i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0(EXTIFACE,75)
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_data = dsdk_ip_adapt_bitjoin1_q;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_stall = in_i_stall;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_valid = in_i_valid;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_stall_bitsignaltemp = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_stall[0];
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_valid_bitsignaltemp = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_valid[0];
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_almost_full[0] = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_almost_full_bitsignaltemp;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_stall[0] = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_stall_bitsignaltemp;
    assign i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_valid[0] = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_valid_bitsignaltemp;
    hld_fifo #(
        .DEPTH(32),
        .STYLE("ms"),
        .ASYNC_RESET(1),
        ...
        .i_stall(i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_stall_bitsignaltemp),
        .i_valid(i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_i_valid_bitsignaltemp),
        .o_almost_full(i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_almost_full_bitsignaltemp),
        .o_data(i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_data),
        .o_stall(i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_stall_bitsignaltemp),
        .o_valid(i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_valid_bitsignaltemp),
        .clock(clock),
        .resetn(resetn)
    );

    // dupName_0_sync_out_aunroll_x(GPOUT,2)@20000000
    assign out_o_almost_full = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_almost_full;
    ...
    assign out_o_valid = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_valid;

    // sync_out(GPOUT,116)@20000000
    assign out_o_stall = i_llvm_fpga_sfc_exit_s_c0_out_for_body12_stencil_2ds_c0_exit272_stencil_2d0_o_stall;
