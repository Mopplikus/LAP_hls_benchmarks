...
module stencil_2d_bb_B3 (
    ...
    wire [0:0] bb_stencil_2d_B3_stall_region_out_iowr_bl_return_stencil_2d_o_fifodata;
    ...
    // stencil_2d_B3_merge(BLACKBOX,15)
    ...
    // stencil_2d_B3_branch(BLACKBOX,14)
