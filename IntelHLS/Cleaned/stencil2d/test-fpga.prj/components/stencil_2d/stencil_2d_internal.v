...
/////////////////////////////////////////////////////////////////
// MODULE stencil_2d_internal
/////////////////////////////////////////////////////////////////
module stencil_2d_internal
(
   input logic clock,
   input logic resetn,
   input logic [63:0] orig,
   input logic [63:0] sol,
   input logic [63:0] filter,
   input logic start,
   output logic busy,
   output logic done,
   input logic stall,
   ...
   genvar __i;
   logic avmm_1_global_avm_enable [3];
   logic avmm_1_global_avm_read [3];
   logic avmm_1_global_avm_write [3];
   logic [31:0] avmm_1_global_avm_address [3];
   logic [31:0] avmm_1_global_avm_writedata [3];
   logic [3:0] avmm_1_global_avm_byteenable [3];
   logic avmm_1_global_avm_waitrequest [3];
   logic [31:0] avmm_1_global_avm_readdata [3];
   logic avmm_1_global_avm_readdatavalid [3];
   logic avmm_1_global_avm_burstcount [3];
   logic avmm_1_global_avm_writeack [3];
   ...
   (
      ...
      .avm_memdep_stencil_2d_enable(avmm_1_global_avm_enable[0]),
      .avm_memdep_stencil_2d_read(avmm_1_global_avm_read[0]),
      .avm_memdep_stencil_2d_write(avmm_1_global_avm_write[0]),
      .avm_memdep_stencil_2d_address(avmm_1_global_avm_address[0]),
      .avm_memdep_stencil_2d_writedata(avmm_1_global_avm_writedata[0]),
      .avm_memdep_stencil_2d_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_memdep_stencil_2d_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_memdep_stencil_2d_readdata(avmm_1_global_avm_readdata[0]),
      .avm_memdep_stencil_2d_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_memdep_stencil_2d_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_memdep_stencil_2d_writeack(avmm_1_global_avm_writeack[0]),
      // AVM avm_unnamed_stencil_2d10_stencil_2d
      .avm_unnamed_stencil_2d10_stencil_2d_enable(avmm_1_global_avm_enable[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_read(avmm_1_global_avm_read[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_write(avmm_1_global_avm_write[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_address(avmm_1_global_avm_address[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_writedata(avmm_1_global_avm_writedata[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_byteenable(avmm_1_global_avm_byteenable[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_waitrequest(avmm_1_global_avm_waitrequest[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_readdata(avmm_1_global_avm_readdata[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_readdatavalid(avmm_1_global_avm_readdatavalid[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_burstcount(avmm_1_global_avm_burstcount[1]),
      .avm_unnamed_stencil_2d10_stencil_2d_writeack(avmm_1_global_avm_writeack[1]),
      // AVM avm_unnamed_stencil_2d11_stencil_2d
      .avm_unnamed_stencil_2d11_stencil_2d_enable(avmm_1_global_avm_enable[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_read(avmm_1_global_avm_read[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_write(avmm_1_global_avm_write[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_address(avmm_1_global_avm_address[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_writedata(avmm_1_global_avm_writedata[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_byteenable(avmm_1_global_avm_byteenable[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_waitrequest(avmm_1_global_avm_waitrequest[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_readdata(avmm_1_global_avm_readdata[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_readdatavalid(avmm_1_global_avm_readdatavalid[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_burstcount(avmm_1_global_avm_burstcount[2]),
      .avm_unnamed_stencil_2d11_stencil_2d_writeack(avmm_1_global_avm_writeack[2])
   );

   generate
   begin:avmm_1_
      logic avmm_1_icm_in_arb_request [3];
      logic avmm_1_icm_in_arb_enable [3];
      logic avmm_1_icm_in_arb_read [3];
      logic avmm_1_icm_in_arb_write [3];
      logic avmm_1_icm_in_arb_burstcount [3];
      logic [29:0] avmm_1_icm_in_arb_address [3];
      logic [31:0] avmm_1_icm_in_arb_writedata [3];
      logic [3:0] avmm_1_icm_in_arb_byteenable [3];
      logic avmm_1_icm_in_arb_stall [3];
      logic avmm_1_icm_in_wrp_ack [3];
      logic avmm_1_icm_in_rrp_datavalid [3];
      logic [31:0] avmm_1_icm_in_rrp_data [3];
      ...
      logic icm_routedavmm_1_rw_arb_request [3];
      logic icm_routedavmm_1_rw_arb_enable [3];
      logic icm_routedavmm_1_rw_arb_read [3];
      logic icm_routedavmm_1_rw_arb_write [3];
      logic icm_routedavmm_1_rw_arb_burstcount [3];
      logic [29:0] icm_routedavmm_1_rw_arb_address [3];
      logic [31:0] icm_routedavmm_1_rw_arb_writedata [3];
      logic [3:0] icm_routedavmm_1_rw_arb_byteenable [3];
      logic icm_routedavmm_1_rw_arb_stall [3];
      logic icm_routedavmm_1_rw_wrp_ack [3];
      logic icm_routedavmm_1_rw_rrp_datavalid [3];
      logic [31:0] icm_routedavmm_1_rw_rrp_data [3];
      ...
      // INST global_icavmm_1_rw of stencil_2d_internal_ic_18252752692117882361
      stencil_2d_internal_ic_18252752692117882361 global_icavmm_1_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE stencil_2d_internal_ic_18252752692117882361
/////////////////////////////////////////////////////////////////
module stencil_2d_internal_ic_18252752692117882361
(
   input logic clock,
