	mm_agent_if_loop_3_avmm_1_rw #(
		...
		.avs_writedata  (_connected_to_avs_writedata_),  //   input,  width = 256,                 s0.writedata
		.avs_readdata   (_connected_to_avs_readdata_),   //  output,  width = 256,                   .readdata
		...
		.avs_byteenable (_connected_to_avs_byteenable_)  //   input,   width = 32,                   .byteenable
	);
