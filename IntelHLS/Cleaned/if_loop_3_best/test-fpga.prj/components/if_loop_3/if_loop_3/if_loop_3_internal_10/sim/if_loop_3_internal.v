...
(
   ...
   output logic [255:0] avmm_1_rw_writedata,
   output logic [31:0] avmm_1_rw_byteenable,
   input logic [255:0] avmm_1_rw_readdata,
   ...
   output logic [255:0] avmm_4_rw_writedata,
   output logic [31:0] avmm_4_rw_byteenable,
   input logic [255:0] avmm_4_rw_readdata,
   ...
   logic [31:0] avmm_1_global_avm_address [1];
   logic [255:0] avmm_1_global_avm_writedata [1];
   logic [31:0] avmm_1_global_avm_byteenable [1];
   logic avmm_1_global_avm_waitrequest [1];
   logic [255:0] avmm_1_global_avm_readdata [1];
   logic avmm_1_global_avm_readdatavalid [1];
   logic avmm_1_global_avm_burstcount [1];
   logic avmm_1_global_avm_writeack [1];
   ...
   logic [255:0] avmm_4_global_avm_writedata [1];
   logic [31:0] avmm_4_global_avm_byteenable [1];
   logic avmm_4_global_avm_waitrequest [1];
   logic [255:0] avmm_4_global_avm_readdata [1];
   ...
   (
      ...
      .avm_lm22_if_loop_3_enable(avmm_4_global_avm_enable[0]),
      .avm_lm22_if_loop_3_read(avmm_4_global_avm_read[0]),
      .avm_lm22_if_loop_3_write(avmm_4_global_avm_write[0]),
      .avm_lm22_if_loop_3_address(avmm_4_global_avm_address[0]),
      .avm_lm22_if_loop_3_writedata(avmm_4_global_avm_writedata[0]),
      .avm_lm22_if_loop_3_byteenable(avmm_4_global_avm_byteenable[0]),
      .avm_lm22_if_loop_3_waitrequest(avmm_4_global_avm_waitrequest[0]),
      .avm_lm22_if_loop_3_readdata(avmm_4_global_avm_readdata[0]),
   ...
   generate
   begin:avmm_1_
      logic avmm_1_icm_in_arb_request [1];
      logic avmm_1_icm_in_arb_enable [1];
      logic avmm_1_icm_in_arb_read [1];
      logic avmm_1_icm_in_arb_write [1];
      logic avmm_1_icm_in_arb_burstcount [1];
      logic [26:0] avmm_1_icm_in_arb_address [1];
      logic [255:0] avmm_1_icm_in_arb_writedata [1];
      logic [31:0] avmm_1_icm_in_arb_byteenable [1];
      logic avmm_1_icm_in_arb_stall [1];
      logic avmm_1_icm_in_wrp_ack [1];
      logic avmm_1_icm_in_rrp_datavalid [1];
      logic [255:0] avmm_1_icm_in_rrp_data [1];
      ...
      logic [26:0] icm_out_0_rw_arb_address [1];
      ...
      logic icm_routedavmm_1_rw_arb_request [1];
      logic icm_routedavmm_1_rw_arb_enable [1];
      logic icm_routedavmm_1_rw_arb_read [1];
      logic icm_routedavmm_1_rw_arb_write [1];
      logic icm_routedavmm_1_rw_arb_burstcount [1];
      logic [26:0] icm_routedavmm_1_rw_arb_address [1];
      logic [255:0] icm_routedavmm_1_rw_arb_writedata [1];
      logic [31:0] icm_routedavmm_1_rw_arb_byteenable [1];
      logic icm_routedavmm_1_rw_arb_stall [1];
      logic icm_routedavmm_1_rw_wrp_ack [1];
      logic icm_routedavmm_1_rw_rrp_datavalid [1];
      logic [255:0] icm_routedavmm_1_rw_rrp_data [1];
   ...
   begin:avmm_4_
      ...
      logic [26:0] avmm_4_icm_in_arb_address [1];
      logic [255:0] avmm_4_icm_in_arb_writedata [1];
      logic [31:0] avmm_4_icm_in_arb_byteenable [1];
      logic avmm_4_icm_in_arb_stall [1];
      logic avmm_4_icm_in_wrp_ack [1];
      logic avmm_4_icm_in_rrp_datavalid [1];
      logic [255:0] avmm_4_icm_in_rrp_data [1];
      logic icm_out_0_rw_arb_request [1];
      logic icm_out_0_rw_arb_enable [1];
      logic icm_out_0_rw_arb_read [1];
      logic icm_out_0_rw_arb_write [1];
      ...
      logic [26:0] icm_routedavmm_4_rw_arb_address [1];
      logic [255:0] icm_routedavmm_4_rw_arb_writedata [1];
      logic [31:0] icm_routedavmm_4_rw_arb_byteenable [1];
      logic icm_routedavmm_4_rw_arb_stall [1];
      logic icm_routedavmm_4_rw_wrp_ack [1];
      logic icm_routedavmm_4_rw_rrp_datavalid [1];
      logic [255:0] icm_routedavmm_4_rw_rrp_data [1];
