...
module if_loop_3_bb_B1_start_stall_region (
    ...
    reg [31:0] redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0_q;
    reg [31:0] redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_q;
    reg [30:0] redist2_i_smax_if_loop_313_vt_select_30_b_1_0_q;
    reg [0:0] redist3_i_cmp21_if_loop_36_c_2_0_q;
    ...
    reg [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_0;
    reg [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_1;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_v_s_0;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_0;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_1;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_or0;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backStall;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V0;
    wire [0:0] SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V1;
    ...
    wire [0:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_i_valid;
    reg [0:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid;
    reg [31:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data0;
    reg [0:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data1;
    wire [0:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backStall;
    wire [0:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V;
    wire [31:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_D0;
    wire [0:0] SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_D1;
    ...
    // SE_out_if_loop_3_B1_start_merge_reg(STALLENABLE,117)
    // Valid signal propagation
    ...
    // redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0(REG,80)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (SE_i_unnamed_if_loop_38_backEN == 1'b1)
        begin
            redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0_q <= $unsigned(bubble_select_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_d);
        end
    end
    ...
    // i_cmp21_if_loop_36(COMPARE,17)@3 + 1
    assign i_cmp21_if_loop_36_a = $unsigned({{2{c_i32_021_recast_x_q[31]}}, c_i32_021_recast_x_q});
    assign i_cmp21_if_loop_36_b = $unsigned({{2{redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0_q[31]}}, redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0_q});
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // i_unnamed_if_loop_38(COMPARE,33)@2 + 1
    ...
    // i_smax_if_loop_313(MUX,23)@3
    assign i_smax_if_loop_313_s = i_unnamed_if_loop_38_c;
    always @(i_smax_if_loop_313_s or c_i32_122_q or redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0_q)
    begin
        unique case (i_smax_if_loop_313_s)
            1'b0 : i_smax_if_loop_313_q = c_i32_122_q;
            1'b1 : i_smax_if_loop_313_q = redist0_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x_out_o_data_2_tpl_1_0_q;
            default : i_smax_if_loop_313_q = 32'b0;
        endcase
    end

    // i_smax_if_loop_313_vt_select_30(BITSELECT,26)@3
    assign i_smax_if_loop_313_vt_select_30_b = i_smax_if_loop_313_q[30:0];

    // redist2_i_smax_if_loop_313_vt_select_30_b_1_0(REG,82)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist2_i_smax_if_loop_313_vt_select_30_b_1_0_q <= $unsigned(31'b0000000000000000000000000000000);
        end
        else if (SE_i_cmp21_if_loop_36_backEN == 1'b1)
        begin
            redist2_i_smax_if_loop_313_vt_select_30_b_1_0_q <= $unsigned(i_smax_if_loop_313_vt_select_30_b);
        end
    end

    // i_smax_if_loop_313_vt_join(BITJOIN,25)@4
    assign i_smax_if_loop_313_vt_join_q = {GND_q, redist2_i_smax_if_loop_313_vt_select_30_b_1_0_q};

    // i_unnamed_if_loop_314(ADD,27)@4
    ...
    // bgTrunc_i_unnamed_if_loop_314_sel_x(BITSELECT,61)@4
    assign bgTrunc_i_unnamed_if_loop_314_sel_x_b = i_unnamed_if_loop_314_q[31:0];

    // i_unnamed_if_loop_315_sel_x(BITSELECT,72)@4
    assign i_unnamed_if_loop_315_sel_x_b = {1'b0, bgTrunc_i_unnamed_if_loop_314_sel_x_b[31:0]};

    // i_unnamed_if_loop_315_vt_select_31(BITSELECT,31)@4
    assign i_unnamed_if_loop_315_vt_select_31_b = i_unnamed_if_loop_315_sel_x_b[31:0];

    // SE_i_cmp21_if_loop_36(STALLENABLE,97)
    // Valid signal propagation
    assign SE_i_cmp21_if_loop_36_V0 = SE_i_cmp21_if_loop_36_R_v_0;
    // Stall signal propagation
    assign SE_i_cmp21_if_loop_36_s_tv_0 = SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backStall & SE_i_cmp21_if_loop_36_R_v_0;
    ...
    // SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0(STALLREG,155)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid <= 1'b0;
            SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data0 <= 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
            SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data1 <= 1'bx;
        end
        else
        begin
            // Valid
            SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid <= SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backStall & (SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid | SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_i_valid);

            if (SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid == 1'b0)
            begin
                // Data(s)
                SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data0 <= i_unnamed_if_loop_315_vt_select_31_b;
                SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data1 <= i_cmp21_if_loop_36_c;
            end

        end
    end
    // Computing multiple Valid(s)
    assign SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_i_valid = SE_i_cmp21_if_loop_36_V0;
    // Stall signal propagation
    assign SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backStall = SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid | ~ (SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_i_valid);

    // Valid
    assign SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V = SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid == 1'b1 ? SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid : SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_i_valid;

    // Data0
    assign SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_D0 = SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid == 1'b1 ? SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data0 : i_unnamed_if_loop_315_vt_select_31_b;
    // Data1
    assign SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_D1 = SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_valid == 1'b1 ? SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_r_data1 : i_cmp21_if_loop_36_c;

    // SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0(STALLENABLE,128)
    // Valid signal propagation
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V0 = SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_0;
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V1 = SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_1;
    // Stall signal propagation
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_0 = i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_317_out_stall_out & SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_0;
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_1 = i_llvm_fpga_ffwd_source_i1_unnamed_if_loop_35_if_loop_312_out_stall_out & SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_1;
    // Backward Enable generation
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_or0 = SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_0;
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN = ~ (SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_1 | SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_or0);
    // Determine whether to write valid data into the first register stage
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_v_s_0 = SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN & SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V;
    // Backward Stall generation
    assign SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backStall = ~ (SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN);
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_0 <= 1'b0;
            SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_1 <= 1'b0;
        end
        else
        begin
            if (SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN == 1'b0)
            begin
                SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_0 <= SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_0 & SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_0;
            end
            else
            begin
                SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_0 <= SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_v_s_0;
            end

            if (SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN == 1'b0)
            begin
                SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_1 <= SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_1 & SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_s_tv_1;
            end
            else
            begin
                SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_R_v_1 <= SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_v_s_0;
            end

        end
    end

    // redist3_i_cmp21_if_loop_36_c_2_0(REG,83)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist3_i_cmp21_if_loop_36_c_2_0_q <= $unsigned(1'b0);
        end
        else if (SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN == 1'b1)
        begin
            redist3_i_cmp21_if_loop_36_c_2_0_q <= $unsigned(SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_D1);
        end
    end

    // i_llvm_fpga_ffwd_source_i1_unnamed_if_loop_35_if_loop_312(BLACKBOX,18)@5
    // in in_stall_in@20000000
    ...
    if_loop_3_i_llvm_fpga_ffwd_source_i1_unnamed_5_if_loop_30 thei_llvm_fpga_ffwd_source_i1_unnamed_if_loop_35_if_loop_312 (
        ...
        .in_src_data_in_0_0(redist3_i_cmp21_if_loop_36_c_2_0_q),
        .in_stall_in(SE_out_bubble_out_i_llvm_fpga_ffwd_source_p1028i32_unnamed_if_loop_34_if_loop_311_1_backStall),
        .in_valid_in(SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V1),
    ...
    // redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0(REG,81)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_backEN == 1'b1)
        begin
            redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_q <= $unsigned(SR_SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_D0);
        end
    end

    // i_unnamed_if_loop_315_vt_join(BITJOIN,30)@5
    assign i_unnamed_if_loop_315_vt_join_q = {GND_q, redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_q};

    // i_unnamed_if_loop_316(ADD,32)@5
    ...
    // bgTrunc_i_unnamed_if_loop_316_sel_x(BITSELECT,62)@5
    assign bgTrunc_i_unnamed_if_loop_316_sel_x_b = i_unnamed_if_loop_316_q[32:0];

    // i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_317(BLACKBOX,19)@5
    // in in_stall_in@20000000
    ...
    if_loop_3_i_llvm_fpga_ffwd_source_i33_unnamed_6_if_loop_30 thei_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_317 (
        ...
        .in_stall_in(SE_out_bubble_out_i_llvm_fpga_ffwd_source_p1028i32_unnamed_if_loop_34_if_loop_311_1_backStall),
        .in_valid_in(SE_redist1_i_unnamed_if_loop_315_vt_select_31_b_1_0_V0),
    ...
    // SE_out_i_llvm_fpga_ffwd_source_p1025i32_unnamed_if_loop_33_if_loop_310(STALLENABLE,103)
    // Valid signal propagation
    ...
    // SE_out_bubble_out_i_llvm_fpga_ffwd_source_p1028i32_unnamed_if_loop_34_if_loop_311_1(STALLENABLE,138)
    // Valid signal propagation
    ...
    // SE_out_i_llvm_fpga_ffwd_source_p1028i32_unnamed_if_loop_34_if_loop_311(STALLENABLE,105)
    // Valid signal propagation
    ...
    // bubble_join_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x(BITJOIN,94)
    ...
    // bubble_select_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x(BITSELECT,95)
    ...
    // SE_i_unnamed_if_loop_38(STALLENABLE,115)
    // Valid signal propagation
    ...
    // SE_out_i_iord_bl_call_if_loop_3_unnamed_if_loop_32_if_loop_32_aunroll_x(STALLENABLE,123)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // bubble_join_i_llvm_fpga_pop_throttle_i1_throttle_pop_if_loop_31(BITJOIN,89)
    ...
    // bubble_select_i_llvm_fpga_pop_throttle_i1_throttle_pop_if_loop_31(BITSELECT,90)
    ...
    // SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_if_loop_31(STALLENABLE,107)
    // Valid signal propagation
    ...
    // SE_out_i_sfc_s_c0_in_wt_entry_if_loop_3s_c0_enter1_if_loop_30_aunroll_x(STALLENABLE,125)
    // Valid signal propagation
    ...
    // dupName_0_sync_out_x(GPOUT,67)@5
