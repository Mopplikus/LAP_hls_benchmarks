	component mm_agent_if_loop_3_avmm_1_rw is
		generic (
			...
			COMPONENT_NAME             : string  := "if_loop_3";
			INTERFACE_ID               : integer := 1
		);
		port (
			...
			avs_writedata  : in  std_logic_vector(255 downto 0) := (others => 'X'); -- writedata
			avs_readdata   : out std_logic_vector(255 downto 0);                    -- readdata
			avs_address    : in  std_logic_vector(31 downto 0)  := (others => 'X'); -- address
			avs_write      : in  std_logic                      := 'X';             -- write
			avs_read       : in  std_logic                      := 'X';             -- read
			avs_byteenable : in  std_logic_vector(31 downto 0)  := (others => 'X')  -- byteenable
		);
	end component mm_agent_if_loop_3_avmm_1_rw;

	u0 : component mm_agent_if_loop_3_avmm_1_rw
		generic map (
