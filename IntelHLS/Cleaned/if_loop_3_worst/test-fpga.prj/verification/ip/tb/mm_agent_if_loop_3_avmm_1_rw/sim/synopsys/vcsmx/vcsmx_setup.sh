...
# ----------------------------------------
# If mm_agent_if_loop_3_avmm_1_rw is one of several IP cores in your
...
TOP_LEVEL_NAME="mm_agent_if_loop_3_avmm_1_rw.mm_agent_if_loop_3_avmm_1_rw"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set memory_files [concat $memory_files [mm_agent_if_loop_3_avmm_1_rw::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [mm_agent_if_loop_3_avmm_1_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [mm_agent_if_loop_3_avmm_1_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
