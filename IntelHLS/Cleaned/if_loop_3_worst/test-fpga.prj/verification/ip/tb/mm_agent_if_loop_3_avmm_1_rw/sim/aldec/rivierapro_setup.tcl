...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mm_agent_if_loop_3_avmm_1_rw.mm_agent_if_loop_3_avmm_1_rw"
}
...
append ELAB_OPTIONS [subst [mm_agent_if_loop_3_avmm_1_rw::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [mm_agent_if_loop_3_avmm_1_rw::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias com {
  ...
  set design_files [dict merge [mm_agent_if_loop_3_avmm_1_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [mm_agent_if_loop_3_avmm_1_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
