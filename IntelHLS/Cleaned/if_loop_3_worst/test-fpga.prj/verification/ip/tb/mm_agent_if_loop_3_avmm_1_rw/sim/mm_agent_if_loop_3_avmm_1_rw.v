// mm_agent_if_loop_3_avmm_1_rw.v
...
module mm_agent_if_loop_3_avmm_1_rw #(
	...
	hls_sim_mm_agent_dpi_bfm #(
		...
		.avs_writedata     (avs_writedata),  //   input,  width = 256,                 s0.writedata
		.avs_readdata      (avs_readdata),   //  output,  width = 256,                   .readdata
		.avs_address       (avs_address),    //   input,   width = 32,                   .address
		.avs_write         (avs_write),      //   input,    width = 1,                   .write
		.avs_read          (avs_read),       //   input,    width = 1,                   .read
		.avs_byteenable    (avs_byteenable), //   input,   width = 32,                   .byteenable
