...
module if_loop_3_i_llvm_fpga_ffwd_source_i33_unnamed_6_if_loop_30 (
    ...
    wire [0:0] i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_predicate_in;
    wire i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_predicate_in_bitsignaltemp;
    wire [63:0] i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_source_in;
    wire [0:0] i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_valid_in;
    wire i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_valid_in_bitsignaltemp;
    ...
    assign i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_predicate_in_bitsignaltemp = i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_predicate_in[0];
    assign i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_valid_in_bitsignaltemp = i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_valid_in[0];
    acl_ffwdsrc #(
        .MAX_LATENCY(1),
        .MIN_CAPACITY(1),
        .WIDTH(64)
    ) thei_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31 (
        .predicate_in(i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_predicate_in_bitsignaltemp),
        .source_in(element_extension2_q),
        .valid_in(i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_valid_in_bitsignaltemp),
        .source_out(i_llvm_fpga_ffwd_source_i33_unnamed_if_loop_36_if_loop_31_source_out),
        .clock(clock)
    );
