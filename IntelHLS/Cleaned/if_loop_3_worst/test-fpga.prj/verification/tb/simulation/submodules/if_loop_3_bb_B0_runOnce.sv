...
module if_loop_3_bb_B0_runOnce (
    ...
    if_loop_3_B0_runOnce_branch theif_loop_3_B0_runOnce_branch (
        ...
        .out_valid_out_0(if_loop_3_B0_runOnce_branch_out_valid_out_0),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    // if_loop_3_B0_runOnce_merge(BLACKBOX,4)
    ...
    assign out_stall_out_0 = if_loop_3_B0_runOnce_merge_out_stall_out_0;
