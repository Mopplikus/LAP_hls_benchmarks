...
source [file join [file dirname [info script]] ./../../../../components/if_loop_3/if_loop_3/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_if_loop_3_b/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_if_loop_3_a/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/if_loop_3_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/if_loop_3_ir_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_if_loop_3_avmm_1_rw/sim/common/modelsim_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_if_loop_3_avmm_4_rw/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_if_loop_3/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/if_loop_3_en_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_if_loop_3_n/sim/common/modelsim_files.tcl]
...
namespace eval tb {
  proc get_design_libraries {} {
    ...
    set libraries [dict merge $libraries [if_loop_3::get_design_libraries]]
    set libraries [dict merge $libraries [sso_if_loop_3_b::get_design_libraries]]
    set libraries [dict merge $libraries [sso_if_loop_3_a::get_design_libraries]]
    set libraries [dict merge $libraries [if_loop_3_cfan::get_design_libraries]]
    set libraries [dict merge $libraries [if_loop_3_ir_cfan::get_design_libraries]]
    set libraries [dict merge $libraries [mm_agent_if_loop_3_avmm_1_rw::get_design_libraries]]
    ...
    set libraries [dict merge $libraries [mm_agent_if_loop_3_avmm_4_rw::get_design_libraries]]
    set libraries [dict merge $libraries [dpic_if_loop_3::get_design_libraries]]
    set libraries [dict merge $libraries [if_loop_3_en_cfan::get_design_libraries]]
    set libraries [dict merge $libraries [sso_if_loop_3_n::get_design_libraries]]
  ...
  proc get_memory_files {QSYS_SIMDIR} {
    ...
    set memory_files [concat $memory_files [mm_agent_if_loop_3_avmm_1_rw::get_memory_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_if_loop_3_avmm_1_rw/sim/"]]
    ...
    set memory_files [concat $memory_files [mm_agent_if_loop_3_avmm_4_rw::get_memory_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_if_loop_3_avmm_4_rw/sim/"]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [if_loop_3::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../../components/if_loop_3/if_loop_3/sim/"]]
    set design_files [dict merge $design_files [sso_if_loop_3_b::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_3_b/sim/"]]
    set design_files [dict merge $design_files [sso_if_loop_3_a::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_3_a/sim/"]]
    set design_files [dict merge $design_files [if_loop_3_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/if_loop_3_cfan/sim/"]]
    set design_files [dict merge $design_files [if_loop_3_ir_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/if_loop_3_ir_cfan/sim/"]]
    set design_files [dict merge $design_files [mm_agent_if_loop_3_avmm_1_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_if_loop_3_avmm_1_rw/sim/"]]
    ...
    set design_files [dict merge $design_files [mm_agent_if_loop_3_avmm_4_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_if_loop_3_avmm_4_rw/sim/"]]
    set design_files [dict merge $design_files [dpic_if_loop_3::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/dpic_if_loop_3/sim/"]]
    set design_files [dict merge $design_files [if_loop_3_en_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/if_loop_3_en_cfan/sim/"]]
    set design_files [dict merge $design_files [sso_if_loop_3_n::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_3_n/sim/"]]
    return $design_files
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [if_loop_3::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../../components/if_loop_3/if_loop_3/sim/"]]
    set design_files [concat $design_files [sso_if_loop_3_b::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_3_b/sim/"]]
    set design_files [concat $design_files [sso_if_loop_3_a::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_3_a/sim/"]]
    set design_files [concat $design_files [if_loop_3_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/if_loop_3_cfan/sim/"]]
    set design_files [concat $design_files [if_loop_3_ir_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/if_loop_3_ir_cfan/sim/"]]
    set design_files [concat $design_files [mm_agent_if_loop_3_avmm_1_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_if_loop_3_avmm_1_rw/sim/"]]
    ...
    set design_files [concat $design_files [mm_agent_if_loop_3_avmm_4_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_if_loop_3_avmm_4_rw/sim/"]]
    set design_files [concat $design_files [dpic_if_loop_3::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/dpic_if_loop_3/sim/"]]
    set design_files [concat $design_files [if_loop_3_en_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/if_loop_3_en_cfan/sim/"]]
    set design_files [concat $design_files [sso_if_loop_3_n::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_3_n/sim/"]]
  ...
  proc get_elab_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append ELAB_OPTIONS [mm_agent_if_loop_3_avmm_1_rw::get_elab_options $SIMULATOR_TOOL_BITNESS]
    ...
    append ELAB_OPTIONS [mm_agent_if_loop_3_avmm_4_rw::get_elab_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_sim_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append SIM_OPTIONS [mm_agent_if_loop_3_avmm_1_rw::get_sim_options $SIMULATOR_TOOL_BITNESS]
    ...
    append SIM_OPTIONS [mm_agent_if_loop_3_avmm_4_rw::get_sim_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_env_variables {SIMULATOR_TOOL_BITNESS} {
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mm_agent_if_loop_3_avmm_1_rw::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mm_agent_if_loop_3_avmm_4_rw::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
