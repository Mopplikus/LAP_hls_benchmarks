...
module if_loop_3_i_llvm_fpga_push_token_i1_wt_limpush_1_reg (
    ...
    wire [0:0] VCC_q;
    reg [0:0] i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_data_reg_q;
    reg [0:0] i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_q;
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_and_stall_in_q;
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_not_q;
    wire [0:0] stall_in_not_q;
    wire [0:0] stall_in_not_or_i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_q;
    ...
    begin
        if (!resetn)
        begin
            i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_q == 1'b1)
        begin
            i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_q <= in_valid_in;
        end
    end
    ...
    begin
        if (!resetn)
        begin
            i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_data_reg_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_valid_reg_q == 1'b1)
        begin
            i_llvm_fpga_push_token_i1_wt_limpush_if_loop_31_reg_data_reg_q <= in_data_in;
        end
    end
