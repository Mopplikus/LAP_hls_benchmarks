...
module if_loop_3_bb_B1_start (
    ...
    wire [0:0] bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_stall_out;
    wire [0:0] bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_valid_out;
    ...
    wire [0:0] bb_if_loop_3_B1_start_stall_region_out_pipeline_valid_out;
    ...
    wire [0:0] if_loop_3_B1_start_merge_out_stall_out_1;
    wire [0:0] if_loop_3_B1_start_merge_out_valid_out;


    // if_loop_3_B1_start_merge(BLACKBOX,7)
    if_loop_3_B1_start_merge theif_loop_3_B1_start_merge (
        ...
        .out_stall_out_1(if_loop_3_B1_start_merge_out_stall_out_1),
        .out_valid_out(if_loop_3_B1_start_merge_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // if_loop_3_B1_start_branch(BLACKBOX,6)
    ...
    if_loop_3_bb_B1_start_stall_region thebb_if_loop_3_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_stall_out(bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_valid_out(bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_valid_out),
        ...
        .out_pipeline_valid_out(bb_if_loop_3_B1_start_stall_region_out_pipeline_valid_out),
    ...
    assign out_exiting_stall_out = bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,14)
    assign out_exiting_valid_out = bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going12_if_loop_31_exiting_valid_out;
    ...
    // out_iord_bl_call_if_loop_3_o_fifoalmost_full(GPOUT,19)
    ...
    // out_iord_bl_call_if_loop_3_o_fifoready(GPOUT,20)
    ...
    assign out_stall_out_1 = if_loop_3_B1_start_merge_out_stall_out_1;
    ...
    assign out_pipeline_valid_out = bb_if_loop_3_B1_start_stall_region_out_pipeline_valid_out;
