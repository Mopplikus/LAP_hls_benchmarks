...
(
   ...
   genvar __i;
   logic avmm_1_global_avm_enable [6];
   logic avmm_1_global_avm_read [6];
   logic avmm_1_global_avm_write [6];
   logic [31:0] avmm_1_global_avm_address [6];
   logic [31:0] avmm_1_global_avm_writedata [6];
   logic [3:0] avmm_1_global_avm_byteenable [6];
   logic avmm_1_global_avm_waitrequest [6];
   logic [31:0] avmm_1_global_avm_readdata [6];
   logic avmm_1_global_avm_readdatavalid [6];
   logic avmm_1_global_avm_burstcount [6];
   logic avmm_1_global_avm_writeack [6];
   ...
   (
      ...
      .avm_memdep_1_covariance_enable(avmm_1_global_avm_enable[0]),
      .avm_memdep_1_covariance_read(avmm_1_global_avm_read[0]),
      .avm_memdep_1_covariance_write(avmm_1_global_avm_write[0]),
      .avm_memdep_1_covariance_address(avmm_1_global_avm_address[0]),
      .avm_memdep_1_covariance_writedata(avmm_1_global_avm_writedata[0]),
      .avm_memdep_1_covariance_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_memdep_1_covariance_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_memdep_1_covariance_readdata(avmm_1_global_avm_readdata[0]),
      .avm_memdep_1_covariance_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_memdep_1_covariance_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_memdep_1_covariance_writeack(avmm_1_global_avm_writeack[0]),
      // AVM avm_memdep_covariance
      .avm_memdep_covariance_enable(avmm_1_global_avm_enable[1]),
      .avm_memdep_covariance_read(avmm_1_global_avm_read[1]),
      .avm_memdep_covariance_write(avmm_1_global_avm_write[1]),
      .avm_memdep_covariance_address(avmm_1_global_avm_address[1]),
      .avm_memdep_covariance_writedata(avmm_1_global_avm_writedata[1]),
      .avm_memdep_covariance_byteenable(avmm_1_global_avm_byteenable[1]),
      .avm_memdep_covariance_waitrequest(avmm_1_global_avm_waitrequest[1]),
      .avm_memdep_covariance_readdata(avmm_1_global_avm_readdata[1]),
      .avm_memdep_covariance_readdatavalid(avmm_1_global_avm_readdatavalid[1]),
      .avm_memdep_covariance_burstcount(avmm_1_global_avm_burstcount[1]),
      .avm_memdep_covariance_writeack(avmm_1_global_avm_writeack[1]),
      // AVM avm_unnamed_covariance10_covariance
      .avm_unnamed_covariance10_covariance_enable(avmm_1_global_avm_enable[2]),
      .avm_unnamed_covariance10_covariance_read(avmm_1_global_avm_read[2]),
      .avm_unnamed_covariance10_covariance_write(avmm_1_global_avm_write[2]),
      .avm_unnamed_covariance10_covariance_address(avmm_1_global_avm_address[2]),
      .avm_unnamed_covariance10_covariance_writedata(avmm_1_global_avm_writedata[2]),
      .avm_unnamed_covariance10_covariance_byteenable(avmm_1_global_avm_byteenable[2]),
      .avm_unnamed_covariance10_covariance_waitrequest(avmm_1_global_avm_waitrequest[2]),
      .avm_unnamed_covariance10_covariance_readdata(avmm_1_global_avm_readdata[2]),
      .avm_unnamed_covariance10_covariance_readdatavalid(avmm_1_global_avm_readdatavalid[2]),
      .avm_unnamed_covariance10_covariance_burstcount(avmm_1_global_avm_burstcount[2]),
      .avm_unnamed_covariance10_covariance_writeack(avmm_1_global_avm_writeack[2]),
      // AVM avm_unnamed_covariance16_covariance
      .avm_unnamed_covariance16_covariance_enable(avmm_1_global_avm_enable[3]),
      .avm_unnamed_covariance16_covariance_read(avmm_1_global_avm_read[3]),
      .avm_unnamed_covariance16_covariance_write(avmm_1_global_avm_write[3]),
      .avm_unnamed_covariance16_covariance_address(avmm_1_global_avm_address[3]),
      .avm_unnamed_covariance16_covariance_writedata(avmm_1_global_avm_writedata[3]),
      .avm_unnamed_covariance16_covariance_byteenable(avmm_1_global_avm_byteenable[3]),
      .avm_unnamed_covariance16_covariance_waitrequest(avmm_1_global_avm_waitrequest[3]),
      .avm_unnamed_covariance16_covariance_readdata(avmm_1_global_avm_readdata[3]),
      .avm_unnamed_covariance16_covariance_readdatavalid(avmm_1_global_avm_readdatavalid[3]),
      .avm_unnamed_covariance16_covariance_burstcount(avmm_1_global_avm_burstcount[3]),
      .avm_unnamed_covariance16_covariance_writeack(avmm_1_global_avm_writeack[3]),
      // AVM avm_unnamed_covariance17_covariance
      .avm_unnamed_covariance17_covariance_enable(avmm_1_global_avm_enable[4]),
      .avm_unnamed_covariance17_covariance_read(avmm_1_global_avm_read[4]),
      .avm_unnamed_covariance17_covariance_write(avmm_1_global_avm_write[4]),
      .avm_unnamed_covariance17_covariance_address(avmm_1_global_avm_address[4]),
      .avm_unnamed_covariance17_covariance_writedata(avmm_1_global_avm_writedata[4]),
      .avm_unnamed_covariance17_covariance_byteenable(avmm_1_global_avm_byteenable[4]),
      .avm_unnamed_covariance17_covariance_waitrequest(avmm_1_global_avm_waitrequest[4]),
      .avm_unnamed_covariance17_covariance_readdata(avmm_1_global_avm_readdata[4]),
      .avm_unnamed_covariance17_covariance_readdatavalid(avmm_1_global_avm_readdatavalid[4]),
      .avm_unnamed_covariance17_covariance_burstcount(avmm_1_global_avm_burstcount[4]),
      .avm_unnamed_covariance17_covariance_writeack(avmm_1_global_avm_writeack[4]),
      // AVM avm_unnamed_covariance8_covariance
      .avm_unnamed_covariance8_covariance_enable(avmm_1_global_avm_enable[5]),
      .avm_unnamed_covariance8_covariance_read(avmm_1_global_avm_read[5]),
      .avm_unnamed_covariance8_covariance_write(avmm_1_global_avm_write[5]),
      .avm_unnamed_covariance8_covariance_address(avmm_1_global_avm_address[5]),
      .avm_unnamed_covariance8_covariance_writedata(avmm_1_global_avm_writedata[5]),
      .avm_unnamed_covariance8_covariance_byteenable(avmm_1_global_avm_byteenable[5]),
      .avm_unnamed_covariance8_covariance_waitrequest(avmm_1_global_avm_waitrequest[5]),
      .avm_unnamed_covariance8_covariance_readdata(avmm_1_global_avm_readdata[5]),
      .avm_unnamed_covariance8_covariance_readdatavalid(avmm_1_global_avm_readdatavalid[5]),
      .avm_unnamed_covariance8_covariance_burstcount(avmm_1_global_avm_burstcount[5]),
      .avm_unnamed_covariance8_covariance_writeack(avmm_1_global_avm_writeack[5])
   );

   generate
   begin:avmm_1_
      logic avmm_1_icm_in_arb_request [6];
      logic avmm_1_icm_in_arb_enable [6];
      logic avmm_1_icm_in_arb_read [6];
      logic avmm_1_icm_in_arb_write [6];
      logic avmm_1_icm_in_arb_burstcount [6];
      logic [29:0] avmm_1_icm_in_arb_address [6];
      logic [31:0] avmm_1_icm_in_arb_writedata [6];
      logic [3:0] avmm_1_icm_in_arb_byteenable [6];
      logic avmm_1_icm_in_arb_stall [6];
      logic avmm_1_icm_in_wrp_ack [6];
      logic avmm_1_icm_in_rrp_datavalid [6];
      logic [31:0] avmm_1_icm_in_rrp_data [6];
      ...
      logic icm_routedavmm_1_rw_arb_request [6];
      logic icm_routedavmm_1_rw_arb_enable [6];
      logic icm_routedavmm_1_rw_arb_read [6];
      logic icm_routedavmm_1_rw_arb_write [6];
      logic icm_routedavmm_1_rw_arb_burstcount [6];
      logic [29:0] icm_routedavmm_1_rw_arb_address [6];
      logic [31:0] icm_routedavmm_1_rw_arb_writedata [6];
      logic [3:0] icm_routedavmm_1_rw_arb_byteenable [6];
      logic icm_routedavmm_1_rw_arb_stall [6];
      logic icm_routedavmm_1_rw_wrp_ack [6];
      logic icm_routedavmm_1_rw_rrp_datavalid [6];
      logic [31:0] icm_routedavmm_1_rw_rrp_data [6];
      ...
      // INST global_icavmm_1_rw of covariance_internal_ic_5672591296450521419
      covariance_internal_ic_5672591296450521419 global_icavmm_1_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE covariance_internal_ic_5672591296450521419
/////////////////////////////////////////////////////////////////
module covariance_internal_ic_5672591296450521419
(
   input logic clock,
   ...
   input logic [29:0] m_arb_address [6],
   input logic [31:0] m_arb_writedata [6],
   input logic [3:0] m_arb_byteenable [6],
   output logic m_arb_stall [6],
   output logic m_wrp_ack [6],
   output logic m_rrp_datavalid [6],
   output logic [31:0] m_rrp_data [6],
   // ICM mout
