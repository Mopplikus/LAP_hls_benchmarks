...
// SystemVerilog created from i_llvm_fpga_wg_limiter_exit_unnamed_covariance11_covariance0
...
module covariance_i_llvm_fpga_wg_limiter_exit_unnamed_11_covariance0 (
    ...
    covariance_wgl_exit_storage thewgl_exit_storage (
