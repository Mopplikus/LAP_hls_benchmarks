...
module covariance_bb_B2 (
    input wire [31:0] in_c0_exe52638_0,
    ...
    wire [31:0] bb_covariance_B2_stall_region_out_c0_exe52638;
    wire [63:0] bb_covariance_B2_stall_region_out_intel_reserved_ffwd_2_0;
    ...
    wire [0:0] bb_covariance_B2_stall_region_out_wgl_8_enter_exit_stall_out;
    wire [0:0] bb_covariance_B2_stall_region_out_wgl_8_enter_exit_valid_out;
    wire [31:0] covariance_B2_branch_out_c0_exe52638;
    ...
    wire [31:0] covariance_B2_merge_out_c0_exe52638;
    ...
    covariance_B2_merge thecovariance_B2_merge (
        .in_c0_exe52638_0(in_c0_exe52638_0),
        .in_stall_in(bb_covariance_B2_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe52638(covariance_B2_merge_out_c0_exe52638),
    ...
    covariance_bb_B2_stall_region thebb_covariance_B2_stall_region (
        .in_c0_exe52638(covariance_B2_merge_out_c0_exe52638),
        ...
        .out_c0_exe52638(bb_covariance_B2_stall_region_out_c0_exe52638),
        .out_intel_reserved_ffwd_2_0(bb_covariance_B2_stall_region_out_intel_reserved_ffwd_2_0),
        ...
        .out_wgl_8_enter_exit_stall_out(bb_covariance_B2_stall_region_out_wgl_8_enter_exit_stall_out),
        .out_wgl_8_enter_exit_valid_out(bb_covariance_B2_stall_region_out_wgl_8_enter_exit_valid_out),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    covariance_B2_branch thecovariance_B2_branch (
        .in_c0_exe52638(bb_covariance_B2_stall_region_out_c0_exe52638),
        ...
        .out_c0_exe52638(covariance_B2_branch_out_c0_exe52638),
    ...
    // out_c0_exe52638(GPOUT,11)
    assign out_c0_exe52638 = covariance_B2_branch_out_c0_exe52638;

    // out_intel_reserved_ffwd_2_0(GPOUT,12)
    assign out_intel_reserved_ffwd_2_0 = bb_covariance_B2_stall_region_out_intel_reserved_ffwd_2_0;
    ...
    // out_wgl_8_enter_exit_stall_out(GPOUT,16)
    assign out_wgl_8_enter_exit_stall_out = bb_covariance_B2_stall_region_out_wgl_8_enter_exit_stall_out;

    // out_wgl_8_enter_exit_valid_out(GPOUT,17)
    assign out_wgl_8_enter_exit_valid_out = bb_covariance_B2_stall_region_out_wgl_8_enter_exit_valid_out;
