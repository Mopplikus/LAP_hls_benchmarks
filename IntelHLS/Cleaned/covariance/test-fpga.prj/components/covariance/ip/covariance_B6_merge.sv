...
module covariance_B6_merge (
    ...
    output wire [0:0] out_c0_exe626410,
    output wire [0:0] out_c0_exe726511,
    output wire [0:0] out_memdep_12,
    ...
    // out_c0_exe52639(GPOUT,8)
    assign out_c0_exe52639 = in_c0_exe52639_0;

    // out_c0_exe626410(GPOUT,9)
    assign out_c0_exe626410 = in_c0_exe626410_0;

    // out_c0_exe726511(GPOUT,10)
    assign out_c0_exe726511 = in_c0_exe726511_0;

    // out_memdep_12(GPOUT,11)
    assign out_memdep_12 = in_memdep_12_0;
