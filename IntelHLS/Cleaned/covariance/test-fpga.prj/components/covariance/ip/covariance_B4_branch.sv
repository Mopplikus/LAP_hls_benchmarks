...
module covariance_B4_branch (
    ...
    assign out_c0_exe126 = in_c0_exe126;

    // out_c0_exe32231(GPOUT,13)
    assign out_c0_exe32231 = in_c0_exe32231;

    // out_c0_exe42242(GPOUT,14)
    assign out_c0_exe42242 = in_c0_exe42242;

    // out_c0_exe83(GPOUT,15)
    assign out_c0_exe83 = in_c0_exe83;

    // out_c0_exe94(GPOUT,16)
    assign out_c0_exe94 = in_c0_exe94;

    // out_mul6(GPOUT,17)
    assign out_mul6 = in_mul6;
