...
(
   ...
   genvar __i;
   logic avmm_1_global_avm_enable [7];
   logic avmm_1_global_avm_read [7];
   logic avmm_1_global_avm_write [7];
   logic [31:0] avmm_1_global_avm_address [7];
   logic [31:0] avmm_1_global_avm_writedata [7];
   logic [3:0] avmm_1_global_avm_byteenable [7];
   logic avmm_1_global_avm_waitrequest [7];
   logic [31:0] avmm_1_global_avm_readdata [7];
   logic avmm_1_global_avm_readdatavalid [7];
   logic avmm_1_global_avm_burstcount [7];
   logic avmm_1_global_avm_writeack [7];
   ...
   (
      ...
      .avm_memdep_6_bicg_enable(avmm_1_global_avm_enable[0]),
      .avm_memdep_6_bicg_read(avmm_1_global_avm_read[0]),
      .avm_memdep_6_bicg_write(avmm_1_global_avm_write[0]),
      .avm_memdep_6_bicg_address(avmm_1_global_avm_address[0]),
      .avm_memdep_6_bicg_writedata(avmm_1_global_avm_writedata[0]),
      .avm_memdep_6_bicg_byteenable(avmm_1_global_avm_byteenable[0]),
      .avm_memdep_6_bicg_waitrequest(avmm_1_global_avm_waitrequest[0]),
      .avm_memdep_6_bicg_readdata(avmm_1_global_avm_readdata[0]),
      .avm_memdep_6_bicg_readdatavalid(avmm_1_global_avm_readdatavalid[0]),
      .avm_memdep_6_bicg_burstcount(avmm_1_global_avm_burstcount[0]),
      .avm_memdep_6_bicg_writeack(avmm_1_global_avm_writeack[0]),
      // AVM avm_memdep_bicg
      .avm_memdep_bicg_enable(avmm_1_global_avm_enable[1]),
      .avm_memdep_bicg_read(avmm_1_global_avm_read[1]),
      .avm_memdep_bicg_write(avmm_1_global_avm_write[1]),
      .avm_memdep_bicg_address(avmm_1_global_avm_address[1]),
      .avm_memdep_bicg_writedata(avmm_1_global_avm_writedata[1]),
      .avm_memdep_bicg_byteenable(avmm_1_global_avm_byteenable[1]),
      .avm_memdep_bicg_waitrequest(avmm_1_global_avm_waitrequest[1]),
      .avm_memdep_bicg_readdata(avmm_1_global_avm_readdata[1]),
      .avm_memdep_bicg_readdatavalid(avmm_1_global_avm_readdatavalid[1]),
      .avm_memdep_bicg_burstcount(avmm_1_global_avm_burstcount[1]),
      .avm_memdep_bicg_writeack(avmm_1_global_avm_writeack[1]),
      // AVM avm_unnamed_bicg12_bicg
      .avm_unnamed_bicg12_bicg_enable(avmm_1_global_avm_enable[2]),
      .avm_unnamed_bicg12_bicg_read(avmm_1_global_avm_read[2]),
      .avm_unnamed_bicg12_bicg_write(avmm_1_global_avm_write[2]),
      .avm_unnamed_bicg12_bicg_address(avmm_1_global_avm_address[2]),
      .avm_unnamed_bicg12_bicg_writedata(avmm_1_global_avm_writedata[2]),
      .avm_unnamed_bicg12_bicg_byteenable(avmm_1_global_avm_byteenable[2]),
      .avm_unnamed_bicg12_bicg_waitrequest(avmm_1_global_avm_waitrequest[2]),
      .avm_unnamed_bicg12_bicg_readdata(avmm_1_global_avm_readdata[2]),
      .avm_unnamed_bicg12_bicg_readdatavalid(avmm_1_global_avm_readdatavalid[2]),
      .avm_unnamed_bicg12_bicg_burstcount(avmm_1_global_avm_burstcount[2]),
      .avm_unnamed_bicg12_bicg_writeack(avmm_1_global_avm_writeack[2]),
      // AVM avm_unnamed_bicg14_bicg
      .avm_unnamed_bicg14_bicg_enable(avmm_1_global_avm_enable[3]),
      .avm_unnamed_bicg14_bicg_read(avmm_1_global_avm_read[3]),
      .avm_unnamed_bicg14_bicg_write(avmm_1_global_avm_write[3]),
      .avm_unnamed_bicg14_bicg_address(avmm_1_global_avm_address[3]),
      .avm_unnamed_bicg14_bicg_writedata(avmm_1_global_avm_writedata[3]),
      .avm_unnamed_bicg14_bicg_byteenable(avmm_1_global_avm_byteenable[3]),
      .avm_unnamed_bicg14_bicg_waitrequest(avmm_1_global_avm_waitrequest[3]),
      .avm_unnamed_bicg14_bicg_readdata(avmm_1_global_avm_readdata[3]),
      .avm_unnamed_bicg14_bicg_readdatavalid(avmm_1_global_avm_readdatavalid[3]),
      .avm_unnamed_bicg14_bicg_burstcount(avmm_1_global_avm_burstcount[3]),
      .avm_unnamed_bicg14_bicg_writeack(avmm_1_global_avm_writeack[3]),
      // AVM avm_unnamed_bicg15_bicg
      .avm_unnamed_bicg15_bicg_enable(avmm_1_global_avm_enable[4]),
      .avm_unnamed_bicg15_bicg_read(avmm_1_global_avm_read[4]),
      .avm_unnamed_bicg15_bicg_write(avmm_1_global_avm_write[4]),
      .avm_unnamed_bicg15_bicg_address(avmm_1_global_avm_address[4]),
      .avm_unnamed_bicg15_bicg_writedata(avmm_1_global_avm_writedata[4]),
      .avm_unnamed_bicg15_bicg_byteenable(avmm_1_global_avm_byteenable[4]),
      .avm_unnamed_bicg15_bicg_waitrequest(avmm_1_global_avm_waitrequest[4]),
      .avm_unnamed_bicg15_bicg_readdata(avmm_1_global_avm_readdata[4]),
      .avm_unnamed_bicg15_bicg_readdatavalid(avmm_1_global_avm_readdatavalid[4]),
      .avm_unnamed_bicg15_bicg_burstcount(avmm_1_global_avm_burstcount[4]),
      .avm_unnamed_bicg15_bicg_writeack(avmm_1_global_avm_writeack[4]),
      // AVM avm_unnamed_bicg16_bicg
      .avm_unnamed_bicg16_bicg_enable(avmm_1_global_avm_enable[5]),
      .avm_unnamed_bicg16_bicg_read(avmm_1_global_avm_read[5]),
      .avm_unnamed_bicg16_bicg_write(avmm_1_global_avm_write[5]),
      .avm_unnamed_bicg16_bicg_address(avmm_1_global_avm_address[5]),
      .avm_unnamed_bicg16_bicg_writedata(avmm_1_global_avm_writedata[5]),
      .avm_unnamed_bicg16_bicg_byteenable(avmm_1_global_avm_byteenable[5]),
      .avm_unnamed_bicg16_bicg_waitrequest(avmm_1_global_avm_waitrequest[5]),
      .avm_unnamed_bicg16_bicg_readdata(avmm_1_global_avm_readdata[5]),
      .avm_unnamed_bicg16_bicg_readdatavalid(avmm_1_global_avm_readdatavalid[5]),
      .avm_unnamed_bicg16_bicg_burstcount(avmm_1_global_avm_burstcount[5]),
      .avm_unnamed_bicg16_bicg_writeack(avmm_1_global_avm_writeack[5]),
      // AVM avm_unnamed_bicg8_bicg
      .avm_unnamed_bicg8_bicg_enable(avmm_1_global_avm_enable[6]),
      .avm_unnamed_bicg8_bicg_read(avmm_1_global_avm_read[6]),
      .avm_unnamed_bicg8_bicg_write(avmm_1_global_avm_write[6]),
      .avm_unnamed_bicg8_bicg_address(avmm_1_global_avm_address[6]),
      .avm_unnamed_bicg8_bicg_writedata(avmm_1_global_avm_writedata[6]),
      .avm_unnamed_bicg8_bicg_byteenable(avmm_1_global_avm_byteenable[6]),
      .avm_unnamed_bicg8_bicg_waitrequest(avmm_1_global_avm_waitrequest[6]),
      .avm_unnamed_bicg8_bicg_readdata(avmm_1_global_avm_readdata[6]),
      .avm_unnamed_bicg8_bicg_readdatavalid(avmm_1_global_avm_readdatavalid[6]),
      .avm_unnamed_bicg8_bicg_burstcount(avmm_1_global_avm_burstcount[6]),
      .avm_unnamed_bicg8_bicg_writeack(avmm_1_global_avm_writeack[6])
   );

   generate
   begin:avmm_1_
      logic avmm_1_icm_in_arb_request [7];
      logic avmm_1_icm_in_arb_enable [7];
      logic avmm_1_icm_in_arb_read [7];
      logic avmm_1_icm_in_arb_write [7];
      logic avmm_1_icm_in_arb_burstcount [7];
      logic [29:0] avmm_1_icm_in_arb_address [7];
      logic [31:0] avmm_1_icm_in_arb_writedata [7];
      logic [3:0] avmm_1_icm_in_arb_byteenable [7];
      logic avmm_1_icm_in_arb_stall [7];
      logic avmm_1_icm_in_wrp_ack [7];
      logic avmm_1_icm_in_rrp_datavalid [7];
      logic [31:0] avmm_1_icm_in_rrp_data [7];
      ...
      logic icm_routedavmm_1_rw_arb_request [7];
      logic icm_routedavmm_1_rw_arb_enable [7];
      logic icm_routedavmm_1_rw_arb_read [7];
      logic icm_routedavmm_1_rw_arb_write [7];
      logic icm_routedavmm_1_rw_arb_burstcount [7];
      logic [29:0] icm_routedavmm_1_rw_arb_address [7];
      logic [31:0] icm_routedavmm_1_rw_arb_writedata [7];
      logic [3:0] icm_routedavmm_1_rw_arb_byteenable [7];
      logic icm_routedavmm_1_rw_arb_stall [7];
      logic icm_routedavmm_1_rw_wrp_ack [7];
      logic icm_routedavmm_1_rw_rrp_datavalid [7];
      logic [31:0] icm_routedavmm_1_rw_rrp_data [7];
      ...
      // INST global_icavmm_1_rw of bicg_internal_ic_14049998284551828450
      bicg_internal_ic_14049998284551828450 global_icavmm_1_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE bicg_internal_ic_14049998284551828450
/////////////////////////////////////////////////////////////////
module bicg_internal_ic_14049998284551828450
(
   input logic clock,
   ...
   input logic [29:0] m_arb_address [7],
