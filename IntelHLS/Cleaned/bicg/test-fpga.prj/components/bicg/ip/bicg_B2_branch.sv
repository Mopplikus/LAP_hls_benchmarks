...
// SystemVerilog created from bicg_B2_branch
...
module bicg_B2_branch (
    ...
    input wire [0:0] in_memdep_phi5_pop11,
    input wire [0:0] in_memdep_phi7_pop12,
    input wire [0:0] in_memdep_phi_pop10,
    input wire [0:0] in_stall_in_0,
    input wire [31:0] in_unnamed_bicg8,
    ...
    // out_c0_exe155(GPOUT,13)
    assign out_c0_exe155 = in_c0_exe155;
    ...
    // out_memdep_phi5_pop11(GPOUT,18)
    assign out_memdep_phi5_pop11 = in_memdep_phi5_pop11;

    // out_memdep_phi7_pop12(GPOUT,19)
    assign out_memdep_phi7_pop12 = in_memdep_phi7_pop12;

    // out_memdep_phi_pop10(GPOUT,20)
    ...
    // out_unnamed_bicg8(GPOUT,22)
    assign out_unnamed_bicg8 = in_unnamed_bicg8;
