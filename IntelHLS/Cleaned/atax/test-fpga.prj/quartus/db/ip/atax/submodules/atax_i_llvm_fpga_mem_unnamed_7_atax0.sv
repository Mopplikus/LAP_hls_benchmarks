...
module atax_i_llvm_fpga_mem_unnamed_7_atax0 (
    ...
    wire [31:0] readdata_reg_unnamed_atax7_atax0_out_data_out;
    wire [0:0] readdata_reg_unnamed_atax7_atax0_out_stall_out;
    wire [0:0] readdata_reg_unnamed_atax7_atax0_out_valid_out;


    // readdata_reg_unnamed_atax7_atax0(BLACKBOX,21)@19999999
    // in in_stall_in@20000000
    // out out_data_out@20000000
    // out out_stall_out@20000000
    // out out_valid_out@20000000
    atax_readdata_reg_unnamed_7_atax0 thereaddata_reg_unnamed_atax7_atax0 (
        .in_data_in(i_llvm_fpga_mem_unnamed_atax7_atax1_o_readdata),
        .in_stall_in(in_i_stall),
        .in_valid_in(i_llvm_fpga_mem_unnamed_atax7_atax1_o_valid),
        .out_data_out(readdata_reg_unnamed_atax7_atax0_out_data_out),
        .out_stall_out(readdata_reg_unnamed_atax7_atax0_out_stall_out),
        .out_valid_out(readdata_reg_unnamed_atax7_atax0_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    // i_llvm_fpga_mem_unnamed_atax7_atax1(EXTIFACE,19)
    ...
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_address = addr_trunc_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_atomic_op = c_i3_010_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_bitwiseor = c_i32_011_q;
    ...
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_stall = readdata_reg_unnamed_atax7_atax0_out_stall_out;
    ...
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_stream_base_addr = c_i32_011_q;
    ...
    assign out_o_readdata = readdata_reg_unnamed_atax7_atax0_out_data_out;
    assign out_o_valid = readdata_reg_unnamed_atax7_atax0_out_valid_out;
