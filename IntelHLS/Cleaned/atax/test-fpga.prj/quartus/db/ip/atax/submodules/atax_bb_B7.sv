...
module atax_bb_B7 (
    ...
    wire [0:0] bb_atax_B7_stall_region_out_feedback_out_1;
    wire [0:0] bb_atax_B7_stall_region_out_feedback_valid_out_1;
    wire [0:0] bb_atax_B7_stall_region_out_iowr_bl_return_atax_o_fifodata;
    wire [0:0] bb_atax_B7_stall_region_out_iowr_bl_return_atax_o_fifovalid;
    ...
    atax_bb_B7_stall_region thebb_atax_B7_stall_region (
        ...
        .out_feedback_out_1(bb_atax_B7_stall_region_out_feedback_out_1),
        .out_feedback_valid_out_1(bb_atax_B7_stall_region_out_feedback_valid_out_1),
        .out_iowr_bl_return_atax_o_fifodata(bb_atax_B7_stall_region_out_iowr_bl_return_atax_o_fifodata),
        .out_iowr_bl_return_atax_o_fifovalid(bb_atax_B7_stall_region_out_iowr_bl_return_atax_o_fifovalid),
    ...
    assign out_feedback_out_1 = bb_atax_B7_stall_region_out_feedback_out_1;

    // feedback_valid_out_1_sync(GPOUT,7)
    assign out_feedback_valid_out_1 = bb_atax_B7_stall_region_out_feedback_valid_out_1;

    // out_iowr_bl_return_atax_o_fifodata(GPOUT,11)
    assign out_iowr_bl_return_atax_o_fifodata = bb_atax_B7_stall_region_out_iowr_bl_return_atax_o_fifodata;

    // out_iowr_bl_return_atax_o_fifovalid(GPOUT,12)
    assign out_iowr_bl_return_atax_o_fifovalid = bb_atax_B7_stall_region_out_iowr_bl_return_atax_o_fifovalid;
