...
module kernel_3mm_bb_B2 (
    ...
    wire [0:0] bb_kernel_3mm_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_stall_out;
    wire [0:0] bb_kernel_3mm_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_valid_out;
    wire [0:0] bb_kernel_3mm_B2_stall_region_out_c0_exe2;
    wire [31:0] bb_kernel_3mm_B2_stall_region_out_c0_exe3;
    ...
    // kernel_3mm_B2_merge(BLACKBOX,9)
    kernel_3mm_B2_merge thekernel_3mm_B2_merge (
        ...
        .out_forked147(kernel_3mm_B2_merge_out_forked147),
    ...
    kernel_3mm_bb_B2_stall_region thebb_kernel_3mm_B2_stall_region (
        .in_forked147(kernel_3mm_B2_merge_out_forked147),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(kernel_3mm_B2_branch_out_stall_out),
        .in_valid_in(kernel_3mm_B2_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_stall_out(bb_kernel_3mm_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_valid_out(bb_kernel_3mm_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_valid_out),
    ...
    // kernel_3mm_B2_branch(BLACKBOX,8)
    ...
    assign out_exiting_stall_out = bb_kernel_3mm_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,13)
    assign out_exiting_valid_out = bb_kernel_3mm_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going140_kernel_3mm2_exiting_valid_out;
