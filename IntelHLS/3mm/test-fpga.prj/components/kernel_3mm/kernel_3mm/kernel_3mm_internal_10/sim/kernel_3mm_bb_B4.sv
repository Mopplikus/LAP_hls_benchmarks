...
module kernel_3mm_bb_B4 (
    ...
    wire [0:0] bb_kernel_3mm_B4_stall_region_out_c0_exe181;
    ...
    wire [0:0] kernel_3mm_B4_merge_out_c0_exe181;
    ...
    // kernel_3mm_B4_branch(BLACKBOX,7)
    kernel_3mm_B4_branch thekernel_3mm_B4_branch (
        .in_c0_exe181(bb_kernel_3mm_B4_stall_region_out_c0_exe181),
    ...
    kernel_3mm_bb_B4_stall_region thebb_kernel_3mm_B4_stall_region (
        .in_c0_exe181(kernel_3mm_B4_merge_out_c0_exe181),
        .in_stall_in(kernel_3mm_B4_branch_out_stall_out),
        .in_valid_in(kernel_3mm_B4_merge_out_valid_out),
        .out_c0_exe181(bb_kernel_3mm_B4_stall_region_out_c0_exe181),
    ...
    // kernel_3mm_B4_merge(BLACKBOX,8)
    kernel_3mm_B4_merge thekernel_3mm_B4_merge (
        .in_c0_exe181_0(in_c0_exe181_0),
        .in_stall_in(bb_kernel_3mm_B4_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe181(kernel_3mm_B4_merge_out_c0_exe181),
