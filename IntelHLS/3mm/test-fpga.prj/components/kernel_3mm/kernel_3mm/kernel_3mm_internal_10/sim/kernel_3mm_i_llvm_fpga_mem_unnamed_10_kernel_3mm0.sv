...
module kernel_3mm_i_llvm_fpga_mem_unnamed_10_kernel_3mm0 (
    ...
    reg [31:0] readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_data_reg_x_q;
    reg [0:0] readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_valid_reg_x_q;
    ...
    // i_llvm_fpga_mem_unnamed_kernel_3mm10_kernel_3mm1(EXTIFACE,15)@3 + 3
    ...
    assign i_llvm_fpga_mem_unnamed_kernel_3mm10_kernel_3mm1_i_stall = GND_q;
    ...
    // readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_valid_reg_x(REG,26)@6 + 1
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_valid_reg_x_q <= $unsigned(1'b0);
        end
        else
        begin
            readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_valid_reg_x_q <= i_llvm_fpga_mem_unnamed_kernel_3mm10_kernel_3mm1_o_valid;
        end
    end

    // readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_data_reg_x(REG,25)@6 + 1
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_data_reg_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else
        begin
            readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_data_reg_x_q <= i_llvm_fpga_mem_unnamed_kernel_3mm10_kernel_3mm1_o_readdata;
        end
    end

    // dupName_0_sync_out_x(GPOUT,22)@7
    assign out_o_readdata = readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_data_reg_x_q;
    assign out_o_valid = readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_readdata_reg_unnamed_kernel_3mm10_kernel_3mm6_valid_reg_x_q;
