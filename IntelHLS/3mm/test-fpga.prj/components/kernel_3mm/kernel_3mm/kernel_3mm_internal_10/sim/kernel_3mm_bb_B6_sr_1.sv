...
// SystemVerilog created from bb_kernel_3mm_B6_sr_1
...
module kernel_3mm_bb_B6_sr_1 (
    ...
    // out_o_stall(GPOUT,61)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,62)
