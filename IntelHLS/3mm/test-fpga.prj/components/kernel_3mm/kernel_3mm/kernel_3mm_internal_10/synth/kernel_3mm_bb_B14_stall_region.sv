...
module kernel_3mm_bb_B14_stall_region (
    ...
    begin
        ...
        begin
            stall_entry_o6_reg0_q <= $unsigned(in_c0_exe660640);
        end
    end
    ...
    begin
        ...
        begin
            stall_entry_o5_reg0_q <= $unsigned(in_c0_exe162045);
        end
    end
    ...
    begin
        ...
        begin
            stall_entry_o4_reg0_q <= $unsigned(in_c0_exe160137);
        end
    end
    ...
    assign out_c0_exe160137 = bubble_select_stall_entry_b;
    assign out_c0_exe162045 = bubble_select_stall_entry_c;
    assign out_c0_exe660640 = bubble_select_stall_entry_d;
