...
module kernel_3mm_bb_B12 (
    input wire [0:0] in_c0_exe436112_0,
    ...
    wire [0:0] bb_kernel_3mm_B12_stall_region_out_c0_exe436112;
    ...
    wire [0:0] kernel_3mm_B12_merge_out_c0_exe436112;
    ...
    // kernel_3mm_B12_branch(BLACKBOX,7)
    kernel_3mm_B12_branch thekernel_3mm_B12_branch (
        .in_c0_exe436112(bb_kernel_3mm_B12_stall_region_out_c0_exe436112),
    ...
    kernel_3mm_bb_B12_stall_region thebb_kernel_3mm_B12_stall_region (
        .in_c0_exe436112(kernel_3mm_B12_merge_out_c0_exe436112),
        .in_stall_in(kernel_3mm_B12_branch_out_stall_out),
        .in_valid_in(kernel_3mm_B12_merge_out_valid_out),
        .out_c0_exe436112(bb_kernel_3mm_B12_stall_region_out_c0_exe436112),
    ...
    // kernel_3mm_B12_merge(BLACKBOX,8)
    kernel_3mm_B12_merge thekernel_3mm_B12_merge (
        .in_c0_exe436112_0(in_c0_exe436112_0),
        .in_stall_in(bb_kernel_3mm_B12_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe436112(kernel_3mm_B12_merge_out_c0_exe436112),
