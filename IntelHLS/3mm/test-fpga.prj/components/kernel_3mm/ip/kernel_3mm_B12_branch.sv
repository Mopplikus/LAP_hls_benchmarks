...
module kernel_3mm_B12_branch (
    input wire [0:0] in_c0_exe436112,
    ...
    // c0_exe436112_cmp(LOGICAL,2)
    assign c0_exe436112_cmp_q = ~ (in_c0_exe436112);

    // valid_out_1_and(LOGICAL,21)
    assign valid_out_1_and_q = in_valid_in & c0_exe436112_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe436112;
