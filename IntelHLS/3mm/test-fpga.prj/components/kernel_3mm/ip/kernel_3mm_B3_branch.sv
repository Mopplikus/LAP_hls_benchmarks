...
module kernel_3mm_B3_branch (
    ...
    wire [0:0] VCC_q;
    wire [0:0] c0_exe17_cmp_q;
    reg [0:0] c0_exe18_reg_q;
    wire [0:0] kernel_3mm_B3_branch_enable_q;
    wire [0:0] kernel_3mm_B3_branch_enable_not_q;
    ...
    // c0_exe17_cmp(LOGICAL,2)
    assign c0_exe17_cmp_q = ~ (in_c0_exe17);

    // valid_out_1_and(LOGICAL,24)
    assign valid_out_1_and_q = in_valid_in & c0_exe17_cmp_q;
    ...
    begin
        ...
        else if (kernel_3mm_B3_branch_enable_q == 1'b1)
        begin
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe17;
    ...
    // kernel_3mm_B3_branch_enable(LOGICAL,9)
    assign kernel_3mm_B3_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // kernel_3mm_B3_branch_enable_not(LOGICAL,10)
    assign kernel_3mm_B3_branch_enable_not_q = ~ (kernel_3mm_B3_branch_enable_q);

    // out_stall_out(GPOUT,18)
    assign out_stall_out = kernel_3mm_B3_branch_enable_not_q;
