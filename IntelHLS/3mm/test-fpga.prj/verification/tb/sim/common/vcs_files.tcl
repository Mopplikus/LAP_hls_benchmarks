...
source [file join [file dirname [info script]] ./../../../ip/tb/kernel_3mm_en_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_kernel_3mm_C/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_kernel_3mm_F/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/kernel_3mm_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_kernel_3mm_D/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_kernel_3mm_E/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_kernel_3mm_B/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_kernel_3mm_A/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_cwfsw/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_kernel_3mm_avmm_0_rw/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sp_cstart/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/kernel_3mm_ir_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_kernel_3mm/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_kernel_3mm_G/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/kernel_3mm/kernel_3mm/sim/common/vcs_files.tcl]
...
namespace eval tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [kernel_3mm_en_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/kernel_3mm_en_cfan/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_C::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_C/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_F::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_F/sim/"]]
    set design_files [dict merge $design_files [kernel_3mm_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/kernel_3mm_cfan/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_D::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_D/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_E::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_E/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_B::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_B/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_A::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_A/sim/"]]
    set design_files [dict merge $design_files [cat_cwfsw::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/cat_cwfsw/sim/"]]
    set design_files [dict merge $design_files [mm_agent_kernel_3mm_avmm_0_rw::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_kernel_3mm_avmm_0_rw/sim/"]]
    set design_files [dict merge $design_files [sp_cstart::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sp_cstart/sim/"]]
    set design_files [dict merge $design_files [kernel_3mm_ir_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/kernel_3mm_ir_cfan/sim/"]]
    set design_files [dict merge $design_files [dpic_kernel_3mm::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/dpic_kernel_3mm/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_G::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_G/sim/"]]
    set design_files [dict merge $design_files [kernel_3mm::get_common_design_files "$QSYS_SIMDIR/../../../components/kernel_3mm/kernel_3mm/sim/"]]
    return $design_files
  }
  ...
  proc get_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [kernel_3mm_en_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/kernel_3mm_en_cfan/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_C::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_C/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_F::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_F/sim/"]]
    set design_files [dict merge $design_files [kernel_3mm_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/kernel_3mm_cfan/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_D::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_D/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_E::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_E/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_B::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_B/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_A::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_A/sim/"]]
    set design_files [dict merge $design_files [cat_cwfsw::get_design_files "$QSYS_SIMDIR/../../ip/tb/cat_cwfsw/sim/"]]
    set design_files [dict merge $design_files [mm_agent_kernel_3mm_avmm_0_rw::get_design_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_kernel_3mm_avmm_0_rw/sim/"]]
    set design_files [dict merge $design_files [sp_cstart::get_design_files "$QSYS_SIMDIR/../../ip/tb/sp_cstart/sim/"]]
    set design_files [dict merge $design_files [kernel_3mm_ir_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/kernel_3mm_ir_cfan/sim/"]]
    set design_files [dict merge $design_files [dpic_kernel_3mm::get_design_files "$QSYS_SIMDIR/../../ip/tb/dpic_kernel_3mm/sim/"]]
    set design_files [dict merge $design_files [sso_kernel_3mm_G::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_kernel_3mm_G/sim/"]]
    set design_files [dict merge $design_files [kernel_3mm::get_design_files "$QSYS_SIMDIR/../../../components/kernel_3mm/kernel_3mm/sim/"]]
