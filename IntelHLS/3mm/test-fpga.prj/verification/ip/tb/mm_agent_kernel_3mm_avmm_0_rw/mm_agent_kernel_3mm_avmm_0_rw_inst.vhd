	component mm_agent_kernel_3mm_avmm_0_rw is
		generic (
			...
			COMPONENT_NAME             : string  := "kernel_3mm";
	...
	end component mm_agent_kernel_3mm_avmm_0_rw;

	u0 : component mm_agent_kernel_3mm_avmm_0_rw
		generic map (
