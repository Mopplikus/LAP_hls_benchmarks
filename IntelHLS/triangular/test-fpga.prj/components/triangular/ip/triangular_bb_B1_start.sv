...
module triangular_bb_B1_start (
    ...
    wire [0:0] bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_stall_out;
    wire [0:0] bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_valid_out;
    ...
    wire [0:0] triangular_B1_start_merge_out_forked27;
    ...
    // triangular_B1_start_branch(BLACKBOX,34)
    ...
    // triangular_B1_start_merge(BLACKBOX,35)
    triangular_B1_start_merge thetriangular_B1_start_merge (
        ...
        .out_forked27(triangular_B1_start_merge_out_forked27),
    ...
    triangular_bb_B1_start_stall_region thebb_triangular_B1_start_stall_region (
        ...
        .in_forked27(triangular_B1_start_merge_out_forked27),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_stall_out(bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_valid_out(bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,17)
    assign out_exiting_valid_out = bb_triangular_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going25_triangular2_exiting_valid_out;
    ...
    // out_iord_bl_call_triangular_o_fifoalmost_full(GPOUT,22)
    ...
    // out_iord_bl_call_triangular_o_fifoready(GPOUT,23)
    ...
    // out_reorder_limiter_enter(GPOUT,24)
