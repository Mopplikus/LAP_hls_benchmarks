...
// SystemVerilog created from i_llvm_fpga_wg_limiter_exit_unnamed_triangular6_triangular0
...
module triangular_i_llvm_fpga_wg_limiter_exit_unnamed_6_triangular0 (
