...
namespace eval mm_agent_triangular_avmm_0_rw {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "xmvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/mm_agent_triangular_avmm_0_rw.v\"  -work mm_agent_triangular_avmm_0_rw"                                                                                 
    return $design_files
  }
