	component mm_agent_triangular_avmm_0_rw is
		generic (
			...
			COMPONENT_NAME             : string  := "triangular";
	...
	end component mm_agent_triangular_avmm_0_rw;

	u0 : component mm_agent_triangular_avmm_0_rw
		generic map (
