...
source [file join [file dirname [info script]] ./../../../ip/tb/sso_triangular_A/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/triangular/triangular/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_cwfsw/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/triangular_ir_cfan/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_triangular/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_triangular_x/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/triangular_cfan/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_triangular_n/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_triangular_avmm_0_rw/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/triangular_en_cfan/sim/common/vcsmx_files.tcl]
