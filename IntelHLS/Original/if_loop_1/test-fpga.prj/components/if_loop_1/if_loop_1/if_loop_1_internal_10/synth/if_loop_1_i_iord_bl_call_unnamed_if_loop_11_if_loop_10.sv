...
// SystemVerilog created from i_iord_bl_call_if_loop_1_unnamed_if_loop_11_if_loop_10
...
module if_loop_1_i_iord_bl_call_unnamed_if_loop_11_if_loop_10 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_if_loop_1_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_if_loop_1_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_if_loop_1_i_fifodata),
    ...
    assign out_iord_bl_call_if_loop_1_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,14)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,16)
    assign out_iord_bl_call_if_loop_1_o_fifoready = iord_o_fifoready;
