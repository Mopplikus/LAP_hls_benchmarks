...
module atax_B2_merge (
    ...
    output wire [0:0] out_c0_exe112611,
    ...
    wire [7:0] atax_B2_merge_data_pack_0_q;
    wire [0:0] atax_B2_merge_storage_out_o_almost_empty;
    wire [7:0] atax_B2_merge_storage_out_o_data;
    ...
    assign element_extension0_q = {c_i7_01_q, in_c0_exe112611_0};

    // atax_B2_merge_data_pack_0(BITJOIN,3)
    assign atax_B2_merge_data_pack_0_q = element_extension0_q;

    // c_i2_03(CONSTANT,6)
    assign c_i2_03_q = $unsigned(2'b00);

    // atax_B2_merge_storage(BLACKBOX,5)
    atax_B2_merge_storage theatax_B2_merge_storage (
        .in_almost_empty_in(c_i2_03_q),
        .in_empty_in(c_i2_03_q),
        .in_i_data(atax_B2_merge_data_pack_0_q),
        .in_i_stall(in_stall_in),
        .in_i_valid(in_valid_in_0),
        .out_o_almost_empty(atax_B2_merge_storage_out_o_almost_empty),
        .out_o_data(atax_B2_merge_storage_out_o_data),
    ...
    assign adapt_scalar_trunc2_in = atax_B2_merge_storage_out_o_data[0:0];
    assign adapt_scalar_trunc2_q = adapt_scalar_trunc2_in[0:0];

    // out_c0_exe112611(GPOUT,13)
    assign out_c0_exe112611 = adapt_scalar_trunc2_q;
