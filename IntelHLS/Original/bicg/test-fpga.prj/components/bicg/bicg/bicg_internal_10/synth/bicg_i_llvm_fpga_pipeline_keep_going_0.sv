...
module bicg_i_llvm_fpga_pipeline_keep_going_0 (
    ...
    wire [0:0] i_llvm_fpga_pipeline_keep_going_bicg1_dummy_in;
    wire i_llvm_fpga_pipeline_keep_going_bicg1_dummy_in_bitsignaltemp;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_bicg1_forked_in;
    wire i_llvm_fpga_pipeline_keep_going_bicg1_forked_in_bitsignaltemp;
    ...
    wire [0:0] i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_dummy_out;
    wire i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_dummy_out_bitsignaltemp;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_forked_out;
    wire i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_forked_out_bitsignaltemp;
    ...
    // i_llvm_fpga_pipeline_keep_going_bicg1(EXTIFACE,2)@4
    assign i_llvm_fpga_pipeline_keep_going_bicg1_data_in = in_data_in;
    assign i_llvm_fpga_pipeline_keep_going_bicg1_dummy_in = in_dummy_in;
    assign i_llvm_fpga_pipeline_keep_going_bicg1_forked_in = in_forked_in;
    ...
    assign i_llvm_fpga_pipeline_keep_going_bicg1_stall_in = in_stall_in;
    ...
    assign i_llvm_fpga_pipeline_keep_going_bicg1_dummy_in_bitsignaltemp = i_llvm_fpga_pipeline_keep_going_bicg1_dummy_in[0];
    assign i_llvm_fpga_pipeline_keep_going_bicg1_forked_in_bitsignaltemp = i_llvm_fpga_pipeline_keep_going_bicg1_forked_in[0];
    ...
    assign i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_dummy_out[0] = i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_dummy_out_bitsignaltemp;
    assign i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_forked_out[0] = i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_forked_out_bitsignaltemp;
    ...
    acl_fast_pipeline #(
        ...
        .dummy_in(i_llvm_fpga_pipeline_keep_going_bicg1_dummy_in_bitsignaltemp),
        .forked_in(i_llvm_fpga_pipeline_keep_going_bicg1_forked_in_bitsignaltemp),
        ...
        .pipeline_dummy_out(i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_dummy_out_bitsignaltemp),
        .pipeline_forked_out(i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_forked_out_bitsignaltemp),
    ...
    assign out_pipeline_dummy_out = i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_dummy_out;
    assign out_pipeline_forked_out = i_llvm_fpga_pipeline_keep_going_bicg1_pipeline_forked_out;
    ...
    assign out_data_out = i_llvm_fpga_pipeline_keep_going_bicg1_data_out;
    assign out_valid_out = i_llvm_fpga_pipeline_keep_going_bicg1_valid_out;
