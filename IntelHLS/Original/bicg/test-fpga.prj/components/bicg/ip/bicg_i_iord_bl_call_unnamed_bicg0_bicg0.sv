...
// SystemVerilog created from i_iord_bl_call_bicg_unnamed_bicg0_bicg0
...
module bicg_i_iord_bl_call_unnamed_bicg0_bicg0 (
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,23)@59
