...
source [file join [file dirname [info script]] ./../../../ip/tb/sso_if_loop_2_a/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_done/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_if_loop_2_n/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/if_loop_2_en_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/if_loop_2/if_loop_2/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/if_loop_2_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/if_loop_2_ir_cfan/sim/common/vcs_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_if_loop_2/sim/common/vcs_files.tcl]
...
namespace eval tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_if_loop_2_a::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_2_a/sim/"]]
    set design_files [dict merge $design_files [cat_done::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/cat_done/sim/"]]
    set design_files [dict merge $design_files [sso_if_loop_2_n::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_2_n/sim/"]]
    set design_files [dict merge $design_files [clock_reset::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/clock_reset/sim/"]]
    set design_files [dict merge $design_files [if_loop_2_en_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/if_loop_2_en_cfan/sim/"]]
    set design_files [dict merge $design_files [if_loop_2::get_common_design_files "$QSYS_SIMDIR/../../../components/if_loop_2/if_loop_2/sim/"]]
    set design_files [dict merge $design_files [if_loop_2_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/if_loop_2_cfan/sim/"]]
    set design_files [dict merge $design_files [if_loop_2_ir_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/if_loop_2_ir_cfan/sim/"]]
    ...
    set design_files [dict merge $design_files [dpic_if_loop_2::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/dpic_if_loop_2/sim/"]]
    return $design_files
  }
  ...
  proc get_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_if_loop_2_a::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_2_a/sim/"]]
    set design_files [dict merge $design_files [cat_done::get_design_files "$QSYS_SIMDIR/../../ip/tb/cat_done/sim/"]]
    set design_files [dict merge $design_files [sso_if_loop_2_n::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_if_loop_2_n/sim/"]]
    set design_files [dict merge $design_files [clock_reset::get_design_files "$QSYS_SIMDIR/../../ip/tb/clock_reset/sim/"]]
    set design_files [dict merge $design_files [if_loop_2_en_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/if_loop_2_en_cfan/sim/"]]
    set design_files [dict merge $design_files [if_loop_2::get_design_files "$QSYS_SIMDIR/../../../components/if_loop_2/if_loop_2/sim/"]]
    set design_files [dict merge $design_files [if_loop_2_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/if_loop_2_cfan/sim/"]]
    set design_files [dict merge $design_files [if_loop_2_ir_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/if_loop_2_ir_cfan/sim/"]]
    ...
    set design_files [dict merge $design_files [dpic_if_loop_2::get_design_files "$QSYS_SIMDIR/../../ip/tb/dpic_if_loop_2/sim/"]]
