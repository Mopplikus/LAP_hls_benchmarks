...
// SystemVerilog created from i_iord_bl_call_fir_unnamed_fir1_fir0
...
module fir_i_iord_bl_call_unnamed_fir1_fir0 (
    ...
    assign out_iord_bl_call_fir_o_fifoalmost_full = iord_o_fifoalmost_full;
