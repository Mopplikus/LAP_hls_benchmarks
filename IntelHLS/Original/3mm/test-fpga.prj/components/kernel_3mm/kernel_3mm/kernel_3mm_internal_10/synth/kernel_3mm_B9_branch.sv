...
module kernel_3mm_B9_branch (
    ...
    wire [7:0] kernel_3mm_B9_branch_data_pack_q;
    ...
    assign element_extension0_q = {c_i7_01_q, in_memdep_phi7_pop21};

    // kernel_3mm_B9_branch_data_pack(BITJOIN,10)
    assign kernel_3mm_B9_branch_data_pack_q = element_extension0_q;

    // adapt_scalar_trunc2(ROUND,2)
    assign adapt_scalar_trunc2_in = kernel_3mm_B9_branch_data_pack_q[0:0];
    assign adapt_scalar_trunc2_q = adapt_scalar_trunc2_in[0:0];

    // out_memdep_phi7_pop21(GPOUT,12)
    assign out_memdep_phi7_pop21 = adapt_scalar_trunc2_q;
