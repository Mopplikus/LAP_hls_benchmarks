...
// SystemVerilog created from i_iord_bl_call_kernel_3mm_unnamed_kernel_3mm0_kernel_3mm0
...
module kernel_3mm_i_iord_bl_call_unnamed_kernel_3mm0_kernel_3mm0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_kernel_3mm_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_kernel_3mm_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_kernel_3mm_i_fifodata),
    ...
    assign out_iord_bl_call_kernel_3mm_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,24)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,26)
    assign out_iord_bl_call_kernel_3mm_o_fifoready = iord_o_fifoready;

    // ip_dsdk_adapt_bitselect14(BITSELECT,8)
    assign ip_dsdk_adapt_bitselect14_b = iord_o_data[447:384];

    // ip_dsdk_adapt_bitselect12(BITSELECT,7)
