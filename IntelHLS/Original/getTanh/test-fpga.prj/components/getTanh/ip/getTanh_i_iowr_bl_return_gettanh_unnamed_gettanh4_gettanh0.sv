...
// SystemVerilog created from i_iowr_bl_return_gettanh_unnamed_gettanh4_gettanh0
...
module getTanh_i_iowr_bl_return_gettanh_unnamed_gettanh4_gettanh0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_getTanh_i_fifoready;
    ...
    assign out_iowr_bl_return_getTanh_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,10)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,13)
    assign out_iowr_bl_return_getTanh_o_fifovalid = iowr_o_fifovalid;

    // dupName_0_sync_out_x(GPOUT,14)@56
