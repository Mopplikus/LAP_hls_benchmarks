...
module kernel_2mm_bb_B8 (
    ...
    wire [0:0] bb_kernel_2mm_B8_stall_region_out_almost_empty_out;
    wire [0:0] bb_kernel_2mm_B8_stall_region_out_c0_exe42059;
    wire [0:0] bb_kernel_2mm_B8_stall_region_out_empty_out;
    ...
    wire [0:0] kernel_2mm_B8_merge_out_almost_empty_out;
    wire [0:0] kernel_2mm_B8_merge_out_c0_exe42059;
    wire [0:0] kernel_2mm_B8_merge_out_empty_out;
    ...
    // kernel_2mm_B8_branch(BLACKBOX,6)
    kernel_2mm_B8_branch thekernel_2mm_B8_branch (
        .in_almost_empty_in(bb_kernel_2mm_B8_stall_region_out_almost_empty_out),
        .in_c0_exe42059(bb_kernel_2mm_B8_stall_region_out_c0_exe42059),
        .in_empty_in(bb_kernel_2mm_B8_stall_region_out_empty_out),
    ...
    kernel_2mm_bb_B8_stall_region thebb_kernel_2mm_B8_stall_region (
        .in_almost_empty_in(kernel_2mm_B8_merge_out_almost_empty_out),
        .in_c0_exe42059(kernel_2mm_B8_merge_out_c0_exe42059),
        .in_empty_in(kernel_2mm_B8_merge_out_empty_out),
        .in_stall_in(kernel_2mm_B8_branch_out_stall_out),
        .in_valid_in(kernel_2mm_B8_merge_out_valid_out),
        .out_almost_empty_out(bb_kernel_2mm_B8_stall_region_out_almost_empty_out),
        .out_c0_exe42059(bb_kernel_2mm_B8_stall_region_out_c0_exe42059),
        .out_empty_out(bb_kernel_2mm_B8_stall_region_out_empty_out),
    ...
    // kernel_2mm_B8_merge(BLACKBOX,7)
    kernel_2mm_B8_merge thekernel_2mm_B8_merge (
        .in_c0_exe42059_0(in_c0_exe42059_0),
        .in_stall_in(bb_kernel_2mm_B8_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_almost_empty_out(kernel_2mm_B8_merge_out_almost_empty_out),
        .out_c0_exe42059(kernel_2mm_B8_merge_out_c0_exe42059),
        .out_empty_out(kernel_2mm_B8_merge_out_empty_out),
