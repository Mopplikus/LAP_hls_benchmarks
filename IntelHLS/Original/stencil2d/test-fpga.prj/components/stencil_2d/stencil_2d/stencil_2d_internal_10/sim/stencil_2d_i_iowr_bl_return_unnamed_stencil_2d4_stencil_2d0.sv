...
// SystemVerilog created from i_iowr_bl_return_stencil_2d_unnamed_stencil_2d4_stencil_2d0
...
module stencil_2d_i_iowr_bl_return_unnamed_stencil_2d4_stencil_2d0 (
