...
module stencil_2d_B4_branch (
    input wire [0:0] in_c0_exe2122,
    input wire [31:0] in_c0_exe3123,
    input wire [31:0] in_c0_exe4124,
    ...
    assign out_c0_exe2122 = in_c0_exe2122;

    // out_c0_exe3123(GPOUT,13)
    assign out_c0_exe3123 = in_c0_exe3123;

    // out_c0_exe4124(GPOUT,14)
    assign out_c0_exe4124 = in_c0_exe4124;
