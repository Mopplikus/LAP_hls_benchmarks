...
module stencil_2d_B7_merge (
    ...
    output wire [31:0] out_c0_exe11971,
    output wire [31:0] out_c0_exe42003,
    output wire [0:0] out_c0_exe52016,
    output wire [0:0] out_c0_exe62028,
    output wire [31:0] out_c0_exe720310,
    ...
    // out_c0_exe11971(GPOUT,9)
    assign out_c0_exe11971 = in_c0_exe11971_0;

    // out_c0_exe42003(GPOUT,10)
    assign out_c0_exe42003 = in_c0_exe42003_0;

    // out_c0_exe52016(GPOUT,11)
    assign out_c0_exe52016 = in_c0_exe52016_0;

    // out_c0_exe62028(GPOUT,12)
    assign out_c0_exe62028 = in_c0_exe62028_0;

    // out_c0_exe720310(GPOUT,13)
    assign out_c0_exe720310 = in_c0_exe720310_0;
