...
module matvec_bb_B3 (
    ...
    wire [0:0] bb_matvec_B3_stall_region_out_almost_empty_out;
    wire [63:0] bb_matvec_B3_stall_region_out_c0_exe132;
    wire [31:0] bb_matvec_B3_stall_region_out_c0_exe233;
    wire [0:0] bb_matvec_B3_stall_region_out_c0_exe4;
    wire [0:0] bb_matvec_B3_stall_region_out_c0_exe5;
    wire [0:0] bb_matvec_B3_stall_region_out_empty_out;
    wire [0:0] bb_matvec_B3_stall_region_out_profile_loop_o_valid;
    wire [0:0] bb_matvec_B3_stall_region_out_stall_out;
    wire [31:0] bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_address;
    wire [0:0] bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_burstcount;
    wire [3:0] bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_byteenable;
    wire [0:0] bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_enable;
    wire [0:0] bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_read;
    wire [0:0] bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_write;
    wire [31:0] bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_writedata;
    ...
    wire [63:0] matvec_B3_branch_out_c0_exe132;
    wire [31:0] matvec_B3_branch_out_c0_exe233;
    wire [0:0] matvec_B3_branch_out_c0_exe5;
    wire [0:0] matvec_B3_branch_out_stall_out;
    wire [0:0] matvec_B3_branch_out_valid_out_0;
    wire [0:0] matvec_B3_merge_out_almost_empty_out;
    wire [0:0] matvec_B3_merge_out_empty_out;
    ...
    matvec_B3_merge thematvec_B3_merge (
        ...
        .out_almost_empty_out(matvec_B3_merge_out_almost_empty_out),
        .out_empty_out(matvec_B3_merge_out_empty_out),
    ...
    matvec_bb_B3_stall_region thebb_matvec_B3_stall_region (
        .in_almost_empty_in(matvec_B3_merge_out_almost_empty_out),
        .in_empty_in(matvec_B3_merge_out_empty_out),
        .in_flush(in_flush),
        ...
        .out_almost_empty_out(bb_matvec_B3_stall_region_out_almost_empty_out),
        .out_c0_exe132(bb_matvec_B3_stall_region_out_c0_exe132),
        ...
        .out_empty_out(bb_matvec_B3_stall_region_out_empty_out),
        .out_profile_loop_o_valid(bb_matvec_B3_stall_region_out_profile_loop_o_valid),
        .out_stall_out(bb_matvec_B3_stall_region_out_stall_out),
        .out_unnamed_matvec2_matvec_avm_address(bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_address),
        .out_unnamed_matvec2_matvec_avm_burstcount(bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_burstcount),
        .out_unnamed_matvec2_matvec_avm_byteenable(bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_byteenable),
        .out_unnamed_matvec2_matvec_avm_enable(bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_enable),
        .out_unnamed_matvec2_matvec_avm_read(bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_read),
        .out_unnamed_matvec2_matvec_avm_write(bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_write),
        .out_unnamed_matvec2_matvec_avm_writedata(bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_writedata),
    ...
    // matvec_B3_branch(BLACKBOX,16)
    matvec_B3_branch thematvec_B3_branch (
        .in_almost_empty_in(bb_matvec_B3_stall_region_out_almost_empty_out),
        .in_c0_exe132(bb_matvec_B3_stall_region_out_c0_exe132),
        ...
        .in_empty_in(bb_matvec_B3_stall_region_out_empty_out),
        .in_stall_in_0(in_stall_in_0),
        .in_valid_in(bb_matvec_B3_stall_region_out_valid_out),
        .out_c0_exe132(matvec_B3_branch_out_c0_exe132),
    ...
    // out_c0_exe132(GPOUT,18)
    assign out_c0_exe132 = matvec_B3_branch_out_c0_exe132;

    // out_c0_exe233(GPOUT,19)
    ...
    assign out_profile_loop_o_valid = bb_matvec_B3_stall_region_out_profile_loop_o_valid;
    ...
    // out_unnamed_matvec2_matvec_avm_address(GPOUT,24)
    assign out_unnamed_matvec2_matvec_avm_address = bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_address;

    // out_unnamed_matvec2_matvec_avm_burstcount(GPOUT,25)
    assign out_unnamed_matvec2_matvec_avm_burstcount = bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_burstcount;

    // out_unnamed_matvec2_matvec_avm_byteenable(GPOUT,26)
    assign out_unnamed_matvec2_matvec_avm_byteenable = bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_byteenable;

    // out_unnamed_matvec2_matvec_avm_enable(GPOUT,27)
    assign out_unnamed_matvec2_matvec_avm_enable = bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_enable;

    // out_unnamed_matvec2_matvec_avm_read(GPOUT,28)
    assign out_unnamed_matvec2_matvec_avm_read = bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_read;

    // out_unnamed_matvec2_matvec_avm_write(GPOUT,29)
    assign out_unnamed_matvec2_matvec_avm_write = bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_write;

    // out_unnamed_matvec2_matvec_avm_writedata(GPOUT,30)
    assign out_unnamed_matvec2_matvec_avm_writedata = bb_matvec_B3_stall_region_out_unnamed_matvec2_matvec_avm_writedata;

    // out_unnamed_matvec3_matvec_avm_address(GPOUT,31)
    assign out_unnamed_matvec3_matvec_avm_address = bb_matvec_B3_stall_region_out_unnamed_matvec3_matvec_avm_address;

    // out_unnamed_matvec3_matvec_avm_burstcount(GPOUT,32)
    assign out_unnamed_matvec3_matvec_avm_burstcount = bb_matvec_B3_stall_region_out_unnamed_matvec3_matvec_avm_burstcount;

    // out_unnamed_matvec3_matvec_avm_byteenable(GPOUT,33)
    assign out_unnamed_matvec3_matvec_avm_byteenable = bb_matvec_B3_stall_region_out_unnamed_matvec3_matvec_avm_byteenable;

    // out_unnamed_matvec3_matvec_avm_enable(GPOUT,34)
    assign out_unnamed_matvec3_matvec_avm_enable = bb_matvec_B3_stall_region_out_unnamed_matvec3_matvec_avm_enable;

    // out_unnamed_matvec3_matvec_avm_read(GPOUT,35)
    assign out_unnamed_matvec3_matvec_avm_read = bb_matvec_B3_stall_region_out_unnamed_matvec3_matvec_avm_read;

    // out_unnamed_matvec3_matvec_avm_write(GPOUT,36)
    assign out_unnamed_matvec3_matvec_avm_write = bb_matvec_B3_stall_region_out_unnamed_matvec3_matvec_avm_write;

    // out_unnamed_matvec3_matvec_avm_writedata(GPOUT,37)
