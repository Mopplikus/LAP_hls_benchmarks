...
module matvec_bb_B2 (
    ...
    wire [0:0] bb_matvec_B2_stall_region_out_almost_empty_out;
    wire [0:0] bb_matvec_B2_stall_region_out_c0_exe2;
    wire [31:0] bb_matvec_B2_stall_region_out_c0_exe3;
    wire [0:0] bb_matvec_B2_stall_region_out_empty_out;
    ...
    wire [0:0] matvec_B2_merge_out_almost_empty_out;
    wire [0:0] matvec_B2_merge_out_empty_out;
    wire [0:0] matvec_B2_merge_out_stall_out_0;
    wire [0:0] matvec_B2_merge_out_valid_out;
    reg [0:0] rst_sync_rst_sclrn;


    // matvec_B2_merge(BLACKBOX,6)
    matvec_B2_merge thematvec_B2_merge (
        .in_stall_in(bb_matvec_B2_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_almost_empty_out(matvec_B2_merge_out_almost_empty_out),
        .out_empty_out(matvec_B2_merge_out_empty_out),
    ...
    matvec_bb_B2_stall_region thebb_matvec_B2_stall_region (
        .in_almost_empty_in(matvec_B2_merge_out_almost_empty_out),
        .in_empty_in(matvec_B2_merge_out_empty_out),
        .in_stall_in(matvec_B2_branch_out_stall_out),
        .in_valid_in(matvec_B2_merge_out_valid_out),
        .out_almost_empty_out(bb_matvec_B2_stall_region_out_almost_empty_out),
        .out_c0_exe2(bb_matvec_B2_stall_region_out_c0_exe2),
        .out_c0_exe3(bb_matvec_B2_stall_region_out_c0_exe3),
        .out_empty_out(bb_matvec_B2_stall_region_out_empty_out),
    ...
    // matvec_B2_branch(BLACKBOX,5)
    matvec_B2_branch thematvec_B2_branch (
        .in_almost_empty_in(bb_matvec_B2_stall_region_out_almost_empty_out),
        .in_c0_exe2(bb_matvec_B2_stall_region_out_c0_exe2),
        .in_c0_exe3(bb_matvec_B2_stall_region_out_c0_exe3),
        .in_empty_in(bb_matvec_B2_stall_region_out_empty_out),
