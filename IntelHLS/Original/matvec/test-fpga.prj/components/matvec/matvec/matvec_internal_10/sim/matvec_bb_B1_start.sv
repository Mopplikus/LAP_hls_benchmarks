...
module matvec_bb_B1_start (
    ...
    wire [0:0] bb_matvec_B1_start_stall_region_out_almost_empty_out;
    wire [0:0] bb_matvec_B1_start_stall_region_out_empty_out;
    ...
    wire [0:0] matvec_B1_start_merge_out_almost_empty_out;
    wire [0:0] matvec_B1_start_merge_out_empty_out;
    wire [0:0] matvec_B1_start_merge_out_stall_out_0;
    wire [0:0] matvec_B1_start_merge_out_valid_out;
    reg [0:0] rst_sync_rst_sclrn;


    // matvec_B1_start_branch(BLACKBOX,7)
    matvec_B1_start_branch thematvec_B1_start_branch (
        .in_almost_empty_in(bb_matvec_B1_start_stall_region_out_almost_empty_out),
        .in_empty_in(bb_matvec_B1_start_stall_region_out_empty_out),
    ...
    // matvec_B1_start_merge(BLACKBOX,8)
    matvec_B1_start_merge thematvec_B1_start_merge (
        .in_stall_in(bb_matvec_B1_start_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_almost_empty_out(matvec_B1_start_merge_out_almost_empty_out),
        .out_empty_out(matvec_B1_start_merge_out_empty_out),
    ...
    matvec_bb_B1_start_stall_region thebb_matvec_B1_start_stall_region (
        .in_almost_empty_in(matvec_B1_start_merge_out_almost_empty_out),
        .in_empty_in(matvec_B1_start_merge_out_empty_out),
        ...
        .out_almost_empty_out(bb_matvec_B1_start_stall_region_out_almost_empty_out),
        .out_empty_out(bb_matvec_B1_start_stall_region_out_empty_out),
    ...
    // out_iord_bl_call_matvec_o_fifoalmost_full(GPOUT,9)
    ...
    // out_iord_bl_call_matvec_o_fifoready(GPOUT,10)
