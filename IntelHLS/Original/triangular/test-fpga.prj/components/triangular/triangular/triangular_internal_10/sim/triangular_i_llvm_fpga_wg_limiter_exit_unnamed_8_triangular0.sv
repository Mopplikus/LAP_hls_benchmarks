...
// SystemVerilog created from i_llvm_fpga_wg_limiter_exit_unnamed_triangular8_triangular0
...
module triangular_i_llvm_fpga_wg_limiter_exit_unnamed_8_triangular0 (
