...
module covariance_bb_B2 (
    ...
    input wire [0:0] in_c0_exe127614_0,
    input wire [31:0] in_c0_exe427915_0,
    ...
    wire [31:0] bb_covariance_B2_stall_region_out_c0_exe427915;
    ...
    wire [31:0] covariance_B2_branch_out_c0_exe427915;
    ...
    wire [0:0] covariance_B2_merge_out_c0_exe127614;
    wire [31:0] covariance_B2_merge_out_c0_exe427915;
    ...
    covariance_B2_branch thecovariance_B2_branch (
        .in_c0_exe427915(bb_covariance_B2_stall_region_out_c0_exe427915),
        ...
        .out_c0_exe427915(covariance_B2_branch_out_c0_exe427915),
    ...
    covariance_B2_merge thecovariance_B2_merge (
        .in_c0_exe127614_0(in_c0_exe127614_0),
        .in_c0_exe427915_0(in_c0_exe427915_0),
        .in_stall_in(bb_covariance_B2_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe127614(covariance_B2_merge_out_c0_exe127614),
        .out_c0_exe427915(covariance_B2_merge_out_c0_exe427915),
    ...
    covariance_bb_B2_stall_region thebb_covariance_B2_stall_region (
        .in_c0_exe127614(covariance_B2_merge_out_c0_exe127614),
        .in_c0_exe427915(covariance_B2_merge_out_c0_exe427915),
        ...
        .out_c0_exe427915(bb_covariance_B2_stall_region_out_c0_exe427915),
    ...
    // out_c0_exe427915(GPOUT,14)
    assign out_c0_exe427915 = covariance_B2_branch_out_c0_exe427915;
