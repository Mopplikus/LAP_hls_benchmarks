...
module covariance_B2_merge (
    ...
    output wire [0:0] out_c0_exe127614,
    ...
    // out_c0_exe127614(GPOUT,6)
    assign out_c0_exe127614 = in_c0_exe127614_0;

    // out_c0_exe427915(GPOUT,7)
    assign out_c0_exe427915 = in_c0_exe427915_0;
