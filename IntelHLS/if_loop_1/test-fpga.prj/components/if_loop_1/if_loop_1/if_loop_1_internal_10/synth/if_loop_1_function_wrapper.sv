...
module if_loop_1_function_wrapper (
    ...
    wire [0:0] if_loop_1_function_out_stall_out;
    ...
    if_loop_1_wait_pulse_extender_inst thewait_pulse_extender_inst (
    ...
    if_loop_1_start_pulse thestart_pulse (
        .in_i_stall(if_loop_1_function_out_stall_out),
    ...
    if_loop_1_function theif_loop_1_function (
        ...
        .in_iord_bl_call_if_loop_1_i_fifovalid(start_mask_and_q),
