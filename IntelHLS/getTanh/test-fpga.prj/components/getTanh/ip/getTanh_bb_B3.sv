...
module getTanh_bb_B3 (
    ...
    wire [0:0] bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_stall_out;
    wire [0:0] bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_valid_out;
    ...
    wire [31:0] bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_address;
    wire [0:0] bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_burstcount;
    wire [3:0] bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_byteenable;
    wire [0:0] bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_enable;
    wire [0:0] bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_read;
    wire [0:0] bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_write;
    wire [31:0] bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_writedata;
    ...
    getTanh_bb_B3_stall_region thebb_getTanh_B3_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_stall_out(bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_valid_out(bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_valid_out),
        ...
        .out_unnamed_getTanh4_getTanh_avm_address(bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_address),
        .out_unnamed_getTanh4_getTanh_avm_burstcount(bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_burstcount),
        .out_unnamed_getTanh4_getTanh_avm_byteenable(bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_byteenable),
        .out_unnamed_getTanh4_getTanh_avm_enable(bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_enable),
        .out_unnamed_getTanh4_getTanh_avm_read(bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_read),
        .out_unnamed_getTanh4_getTanh_avm_write(bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_write),
        .out_unnamed_getTanh4_getTanh_avm_writedata(bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_writedata),
    ...
    assign out_exiting_stall_out = bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,25)
    assign out_exiting_valid_out = bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_gettanh6_exiting_valid_out;
    ...
    assign out_unnamed_getTanh4_getTanh_avm_address = bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_address;

    // out_unnamed_getTanh4_getTanh_avm_burstcount(GPOUT,38)
    assign out_unnamed_getTanh4_getTanh_avm_burstcount = bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_burstcount;

    // out_unnamed_getTanh4_getTanh_avm_byteenable(GPOUT,39)
    assign out_unnamed_getTanh4_getTanh_avm_byteenable = bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_byteenable;

    // out_unnamed_getTanh4_getTanh_avm_enable(GPOUT,40)
    assign out_unnamed_getTanh4_getTanh_avm_enable = bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_enable;

    // out_unnamed_getTanh4_getTanh_avm_read(GPOUT,41)
    assign out_unnamed_getTanh4_getTanh_avm_read = bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_read;

    // out_unnamed_getTanh4_getTanh_avm_write(GPOUT,42)
    assign out_unnamed_getTanh4_getTanh_avm_write = bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_write;

    // out_unnamed_getTanh4_getTanh_avm_writedata(GPOUT,43)
    assign out_unnamed_getTanh4_getTanh_avm_writedata = bb_getTanh_B3_stall_region_out_unnamed_getTanh4_getTanh_avm_writedata;
