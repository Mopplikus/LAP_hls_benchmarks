...
// SystemVerilog created from i_iord_bl_call_gettanh_unnamed_gettanh1_gettanh0
...
module getTanh_i_iord_bl_call_gettanh_unnamed_gettanh1_gettanh0 (
    ...
    // dupName_0_sync_out_x(GPOUT,14)@76
