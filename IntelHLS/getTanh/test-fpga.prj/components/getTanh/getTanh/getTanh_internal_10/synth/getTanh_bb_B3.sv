...
module getTanh_bb_B3 (
    ...
    wire [0:0] bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_stall_out;
    wire [0:0] bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_valid_out;
    wire [0:0] bb_getTanh_B3_stall_region_out_c0_exe2;
    wire [31:0] bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_address;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_burstcount;
    wire [3:0] bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_byteenable;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_enable;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_read;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_write;
    wire [31:0] bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_writedata;
    wire [31:0] bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_address;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_burstcount;
    wire [3:0] bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_byteenable;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_enable;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_read;
    wire [0:0] bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_write;
    wire [31:0] bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_writedata;
    ...
    wire [0:0] getTanh_B3_merge_out_forked10;
    ...
    getTanh_B3_merge thegetTanh_B3_merge (
        ...
        .out_forked10(getTanh_B3_merge_out_forked10),
    ...
    getTanh_bb_B3_stall_region thebb_getTanh_B3_stall_region (
        .in_flush(in_flush),
        .in_forked10(getTanh_B3_merge_out_forked10),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_stall_out(bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_valid_out(bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_valid_out),
        .out_c0_exe2(bb_getTanh_B3_stall_region_out_c0_exe2),
        .out_memdep_1_getTanh_avm_address(bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_address),
        .out_memdep_1_getTanh_avm_burstcount(bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_burstcount),
        .out_memdep_1_getTanh_avm_byteenable(bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_byteenable),
        .out_memdep_1_getTanh_avm_enable(bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_enable),
        .out_memdep_1_getTanh_avm_read(bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_read),
        .out_memdep_1_getTanh_avm_write(bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_write),
        .out_memdep_1_getTanh_avm_writedata(bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_writedata),
        .out_memdep_2_getTanh_avm_address(bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_address),
        .out_memdep_2_getTanh_avm_burstcount(bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_burstcount),
        .out_memdep_2_getTanh_avm_byteenable(bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_byteenable),
        .out_memdep_2_getTanh_avm_enable(bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_enable),
        .out_memdep_2_getTanh_avm_read(bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_read),
        .out_memdep_2_getTanh_avm_write(bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_write),
        .out_memdep_2_getTanh_avm_writedata(bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_writedata),
    ...
    assign out_exiting_stall_out = bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,25)
    assign out_exiting_valid_out = bb_getTanh_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going13_gettanh6_exiting_valid_out;

    // out_memdep_1_getTanh_avm_address(GPOUT,26)
    assign out_memdep_1_getTanh_avm_address = bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_address;

    // out_memdep_1_getTanh_avm_burstcount(GPOUT,27)
    assign out_memdep_1_getTanh_avm_burstcount = bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_burstcount;

    // out_memdep_1_getTanh_avm_byteenable(GPOUT,28)
    assign out_memdep_1_getTanh_avm_byteenable = bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_byteenable;

    // out_memdep_1_getTanh_avm_enable(GPOUT,29)
    assign out_memdep_1_getTanh_avm_enable = bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_enable;

    // out_memdep_1_getTanh_avm_read(GPOUT,30)
    assign out_memdep_1_getTanh_avm_read = bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_read;

    // out_memdep_1_getTanh_avm_write(GPOUT,31)
    assign out_memdep_1_getTanh_avm_write = bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_write;

    // out_memdep_1_getTanh_avm_writedata(GPOUT,32)
    assign out_memdep_1_getTanh_avm_writedata = bb_getTanh_B3_stall_region_out_memdep_1_getTanh_avm_writedata;

    // out_memdep_2_getTanh_avm_address(GPOUT,33)
    assign out_memdep_2_getTanh_avm_address = bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_address;

    // out_memdep_2_getTanh_avm_burstcount(GPOUT,34)
    assign out_memdep_2_getTanh_avm_burstcount = bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_burstcount;

    // out_memdep_2_getTanh_avm_byteenable(GPOUT,35)
    assign out_memdep_2_getTanh_avm_byteenable = bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_byteenable;

    // out_memdep_2_getTanh_avm_enable(GPOUT,36)
    assign out_memdep_2_getTanh_avm_enable = bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_enable;

    // out_memdep_2_getTanh_avm_read(GPOUT,37)
    assign out_memdep_2_getTanh_avm_read = bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_read;

    // out_memdep_2_getTanh_avm_write(GPOUT,38)
    assign out_memdep_2_getTanh_avm_write = bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_write;

    // out_memdep_2_getTanh_avm_writedata(GPOUT,39)
    assign out_memdep_2_getTanh_avm_writedata = bb_getTanh_B3_stall_region_out_memdep_2_getTanh_avm_writedata;

    // out_memdep_getTanh_avm_address(GPOUT,40)
    assign out_memdep_getTanh_avm_address = bb_getTanh_B3_stall_region_out_memdep_getTanh_avm_address;

    // out_memdep_getTanh_avm_burstcount(GPOUT,41)
    assign out_memdep_getTanh_avm_burstcount = bb_getTanh_B3_stall_region_out_memdep_getTanh_avm_burstcount;

    // out_memdep_getTanh_avm_byteenable(GPOUT,42)
    assign out_memdep_getTanh_avm_byteenable = bb_getTanh_B3_stall_region_out_memdep_getTanh_avm_byteenable;

    // out_memdep_getTanh_avm_enable(GPOUT,43)
    assign out_memdep_getTanh_avm_enable = bb_getTanh_B3_stall_region_out_memdep_getTanh_avm_enable;

    // out_memdep_getTanh_avm_read(GPOUT,44)
    assign out_memdep_getTanh_avm_read = bb_getTanh_B3_stall_region_out_memdep_getTanh_avm_read;

    // out_memdep_getTanh_avm_write(GPOUT,45)
    assign out_memdep_getTanh_avm_write = bb_getTanh_B3_stall_region_out_memdep_getTanh_avm_write;

    // out_memdep_getTanh_avm_writedata(GPOUT,46)
