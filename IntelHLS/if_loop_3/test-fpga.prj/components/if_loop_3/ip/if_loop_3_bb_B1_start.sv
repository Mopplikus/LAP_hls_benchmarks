...
module if_loop_3_bb_B1_start (
    ...
    wire [0:0] bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_stall_out;
    wire [0:0] bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_valid_out;
    ...
    wire [32:0] bb_if_loop_3_B1_start_stall_region_out_intel_reserved_ffwd_1_0;
    ...
    if_loop_3_bb_B1_start_stall_region thebb_if_loop_3_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_stall_out(bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_valid_out(bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,14)
    assign out_exiting_valid_out = bb_if_loop_3_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_if_loop_31_exiting_valid_out;
