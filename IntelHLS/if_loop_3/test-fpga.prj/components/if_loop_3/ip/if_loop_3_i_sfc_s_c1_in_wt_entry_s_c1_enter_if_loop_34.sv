...
module if_loop_3_i_sfc_s_c1_in_wt_entry_s_c1_enter_if_loop_34 (
    ...
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_almost_empty_out;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_empty_out;
    ...
    wire [32:0] i_sfc_logic_s_c1_in_wt_entry_if_loop_3s_c1_enter_if_loop_30_aunroll_x_out_intel_reserved_ffwd_1_0;
    ...
    // i_sfc_logic_s_c1_in_wt_entry_if_loop_3s_c1_enter_if_loop_30_aunroll_x(BLACKBOX,10)@76
    // out out_intel_reserved_ffwd_0_0@20000000
    // out out_intel_reserved_ffwd_1_0@20000000
    // out out_o_valid@79
    // out out_unnamed_if_loop_35@79
    // out out_unnamed_if_loop_34_0_tpl@79
    if_loop_3_i_sfc_logic_s_c1_in_wt_entry_s_c1_enter_if_loop_30 thei_sfc_logic_s_c1_in_wt_entry_if_loop_3s_c1_enter_if_loop_30_aunroll_x (
        ...
        .out_unnamed_if_loop_34_0_tpl(),
        .clock(clock),
        .resetn(rst_sync_rst_sclrn[0])
    );

    // regfree_osync(GPOUT,5)
    assign out_intel_reserved_ffwd_0_0 = i_sfc_logic_s_c1_in_wt_entry_if_loop_3s_c1_enter_if_loop_30_aunroll_x_out_intel_reserved_ffwd_0_0;

    // GND(CONSTANT,0)
    assign GND_q = $unsigned(1'b0);

    // i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x(BLACKBOX,9)@79
    ...
    if_loop_3_i_llvm_fpga_sfc_exit_s_c1_out_0000s_c1_exit_if_loop_30 thei_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x (
        ...
        .in_valid_in(i_sfc_logic_s_c1_in_wt_entry_if_loop_3s_c1_enter_if_loop_30_aunroll_x_out_o_valid),
        .in_data_in_0_tpl(GND_q),
        .out_almost_empty_out(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_almost_empty_out),
        .out_empty_out(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_empty_out),
        .out_stall_entry(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_stall_entry),
        .out_valid_out(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_valid_out),
        .out_data_out_0_tpl(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_data_out_0_tpl),
        .clock(clock),
        .resetn(rst_sync_rst_sclrn[0])
    );

    // sync_out(GPOUT,7)@20000000
    assign out_o_stall = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_if_loop_3s_c1_exit_if_loop_31_aunroll_x_out_stall_entry;

    // dupName_0_regfree_osync_x(GPOUT,8)
    assign out_intel_reserved_ffwd_1_0 = i_sfc_logic_s_c1_in_wt_entry_if_loop_3s_c1_enter_if_loop_30_aunroll_x_out_intel_reserved_ffwd_1_0;
