...
module if_loop_3_function (
    ...
    wire [32:0] bb_if_loop_3_B1_start_out_intel_reserved_ffwd_1_0;
    ...
    wire [31:0] bb_if_loop_3_B2_out_lm1_if_loop_3_avm_writedata;
    wire [31:0] bb_if_loop_3_B2_out_lm42_if_loop_3_avm_address;
    wire [0:0] bb_if_loop_3_B2_out_lm42_if_loop_3_avm_burstcount;
    wire [3:0] bb_if_loop_3_B2_out_lm42_if_loop_3_avm_byteenable;
    wire [0:0] bb_if_loop_3_B2_out_lm42_if_loop_3_avm_enable;
    wire [0:0] bb_if_loop_3_B2_out_lm42_if_loop_3_avm_read;
    wire [0:0] bb_if_loop_3_B2_out_lm42_if_loop_3_avm_write;
    wire [31:0] bb_if_loop_3_B2_out_lm42_if_loop_3_avm_writedata;
    ...
    wire [1:0] c_i2_010_q;
    wire [0:0] i_llvm_fpga_pipeline_keep_going10_if_loop_31_sr_out_o_stall;
    wire [0:0] i_llvm_fpga_pipeline_keep_going10_if_loop_31_sr_out_o_valid;
    wire [0:0] i_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo_out_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo_out_valid_out;
    ...
    // i_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo(BLACKBOX,22)
    if_loop_3_i_llvm_fpga_pipeline_keep_going10_1_valid_fifo thei_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo (
        .in_data_in(c_i2_010_q),
        .in_stall_in(bb_if_loop_3_B1_start_out_stall_out_0),
        .in_valid_in(i_llvm_fpga_pipeline_keep_going10_if_loop_31_sr_out_o_valid),
        .out_almost_full(),
        .out_data_out(),
        .out_stall_out(i_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo_out_stall_out),
        .out_valid_out(i_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // i_llvm_fpga_pipeline_keep_going_if_loop_36_valid_fifo(BLACKBOX,24)
    ...
    // bb_if_loop_3_B3_sr_0_aunroll_x(BLACKBOX,67)
    ...
    // i_llvm_fpga_pipeline_keep_going_if_loop_36_sr(BLACKBOX,23)
    ...
    if_loop_3_bb_B2 thebb_if_loop_3_B2 (
        ...
        .out_intel_reserved_ffwd_2_0(bb_if_loop_3_B2_out_intel_reserved_ffwd_2_0),
        ...
        .out_lm42_if_loop_3_avm_address(bb_if_loop_3_B2_out_lm42_if_loop_3_avm_address),
        .out_lm42_if_loop_3_avm_burstcount(bb_if_loop_3_B2_out_lm42_if_loop_3_avm_burstcount),
        .out_lm42_if_loop_3_avm_byteenable(bb_if_loop_3_B2_out_lm42_if_loop_3_avm_byteenable),
        .out_lm42_if_loop_3_avm_enable(bb_if_loop_3_B2_out_lm42_if_loop_3_avm_enable),
        .out_lm42_if_loop_3_avm_read(bb_if_loop_3_B2_out_lm42_if_loop_3_avm_read),
        .out_lm42_if_loop_3_avm_write(bb_if_loop_3_B2_out_lm42_if_loop_3_avm_write),
        .out_lm42_if_loop_3_avm_writedata(bb_if_loop_3_B2_out_lm42_if_loop_3_avm_writedata),
    ...
    // bb_if_loop_3_B2_sr_1_aunroll_x(BLACKBOX,66)
    ...
    // loop_limiter_if_loop_30(BLACKBOX,45)
    ...
    // i_llvm_fpga_pipeline_keep_going10_if_loop_31_sr(BLACKBOX,21)
    if_loop_3_i_llvm_fpga_pipeline_keep_going10_1_sr thei_llvm_fpga_pipeline_keep_going10_if_loop_31_sr (
        .in_i_data(GND_q),
        .in_i_stall(i_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo_out_stall_out),
        .in_i_valid(bb_if_loop_3_B1_start_out_pipeline_valid_out),
        .out_o_data(),
        .out_o_stall(i_llvm_fpga_pipeline_keep_going10_if_loop_31_sr_out_o_stall),
        .out_o_valid(i_llvm_fpga_pipeline_keep_going10_if_loop_31_sr_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    if_loop_3_bb_B1_start thebb_if_loop_3_B1_start (
        ...
        .in_pipeline_stall_in(i_llvm_fpga_pipeline_keep_going10_if_loop_31_sr_out_o_stall),
        .in_stall_in_0(loop_limiter_if_loop_30_out_o_stall),
        .in_valid_in_0(i_llvm_fpga_pipeline_keep_going10_if_loop_31_valid_fifo_out_valid_out),
    ...
    if_loop_3_bb_B3 thebb_if_loop_3_B3 (
        ...
        .in_intel_reserved_ffwd_0_0(bb_if_loop_3_B1_start_out_intel_reserved_ffwd_0_0),
        .in_intel_reserved_ffwd_2_0(bb_if_loop_3_B2_out_intel_reserved_ffwd_2_0),
    ...
    // if_loop_3_B1_start_x(EXTIFACE,25)
    ...
    // out_iord_bl_call_if_loop_3_o_fifoalmost_full(GPOUT,46)
    assign out_iord_bl_call_if_loop_3_o_fifoalmost_full = bb_if_loop_3_B1_start_out_iord_bl_call_if_loop_3_o_fifoalmost_full;

    // out_iord_bl_call_if_loop_3_o_fifoready(GPOUT,47)
    assign out_iord_bl_call_if_loop_3_o_fifoready = bb_if_loop_3_B1_start_out_iord_bl_call_if_loop_3_o_fifoready;

    // out_iowr_bl_return_if_loop_3_o_fifodata(GPOUT,48)
    assign out_iowr_bl_return_if_loop_3_o_fifodata = bb_if_loop_3_B3_out_iowr_bl_return_if_loop_3_o_fifodata;

    // out_iowr_bl_return_if_loop_3_o_fifovalid(GPOUT,49)
    assign out_iowr_bl_return_if_loop_3_o_fifovalid = bb_if_loop_3_B3_out_iowr_bl_return_if_loop_3_o_fifovalid;

    // out_lm1_if_loop_3_avm_address(GPOUT,50)
    assign out_lm1_if_loop_3_avm_address = bb_if_loop_3_B2_out_lm1_if_loop_3_avm_address;

    // out_lm1_if_loop_3_avm_burstcount(GPOUT,51)
    assign out_lm1_if_loop_3_avm_burstcount = bb_if_loop_3_B2_out_lm1_if_loop_3_avm_burstcount;

    // out_lm1_if_loop_3_avm_byteenable(GPOUT,52)
    assign out_lm1_if_loop_3_avm_byteenable = bb_if_loop_3_B2_out_lm1_if_loop_3_avm_byteenable;

    // out_lm1_if_loop_3_avm_enable(GPOUT,53)
    assign out_lm1_if_loop_3_avm_enable = bb_if_loop_3_B2_out_lm1_if_loop_3_avm_enable;

    // out_lm1_if_loop_3_avm_read(GPOUT,54)
    assign out_lm1_if_loop_3_avm_read = bb_if_loop_3_B2_out_lm1_if_loop_3_avm_read;

    // out_lm1_if_loop_3_avm_write(GPOUT,55)
    assign out_lm1_if_loop_3_avm_write = bb_if_loop_3_B2_out_lm1_if_loop_3_avm_write;

    // out_lm1_if_loop_3_avm_writedata(GPOUT,56)
    assign out_lm1_if_loop_3_avm_writedata = bb_if_loop_3_B2_out_lm1_if_loop_3_avm_writedata;

    // out_lm42_if_loop_3_avm_address(GPOUT,57)
    assign out_lm42_if_loop_3_avm_address = bb_if_loop_3_B2_out_lm42_if_loop_3_avm_address;

    // out_lm42_if_loop_3_avm_burstcount(GPOUT,58)
    assign out_lm42_if_loop_3_avm_burstcount = bb_if_loop_3_B2_out_lm42_if_loop_3_avm_burstcount;

    // out_lm42_if_loop_3_avm_byteenable(GPOUT,59)
    assign out_lm42_if_loop_3_avm_byteenable = bb_if_loop_3_B2_out_lm42_if_loop_3_avm_byteenable;

    // out_lm42_if_loop_3_avm_enable(GPOUT,60)
    assign out_lm42_if_loop_3_avm_enable = bb_if_loop_3_B2_out_lm42_if_loop_3_avm_enable;

    // out_lm42_if_loop_3_avm_read(GPOUT,61)
    assign out_lm42_if_loop_3_avm_read = bb_if_loop_3_B2_out_lm42_if_loop_3_avm_read;

    // out_lm42_if_loop_3_avm_write(GPOUT,62)
    assign out_lm42_if_loop_3_avm_write = bb_if_loop_3_B2_out_lm42_if_loop_3_avm_write;

    // out_lm42_if_loop_3_avm_writedata(GPOUT,63)
    assign out_lm42_if_loop_3_avm_writedata = bb_if_loop_3_B2_out_lm42_if_loop_3_avm_writedata;
