...
module if_loop_3_bb_B2 (
    ...
    wire [31:0] bb_if_loop_3_B2_stall_region_out_intel_reserved_ffwd_2_0;
    ...
    wire [31:0] bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_address;
    wire [0:0] bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_burstcount;
    wire [3:0] bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_byteenable;
    wire [0:0] bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_enable;
    wire [0:0] bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_read;
    wire [0:0] bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_write;
    wire [31:0] bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_writedata;
    ...
    if_loop_3_bb_B2_stall_region thebb_if_loop_3_B2_stall_region (
        ...
        .out_intel_reserved_ffwd_2_0(bb_if_loop_3_B2_stall_region_out_intel_reserved_ffwd_2_0),
        ...
        .out_lm42_if_loop_3_avm_address(bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_address),
        .out_lm42_if_loop_3_avm_burstcount(bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_burstcount),
        .out_lm42_if_loop_3_avm_byteenable(bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_byteenable),
        .out_lm42_if_loop_3_avm_enable(bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_enable),
        .out_lm42_if_loop_3_avm_read(bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_read),
        .out_lm42_if_loop_3_avm_write(bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_write),
        .out_lm42_if_loop_3_avm_writedata(bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_writedata),
    ...
    assign out_intel_reserved_ffwd_2_0 = bb_if_loop_3_B2_stall_region_out_intel_reserved_ffwd_2_0;

    // out_lm1_if_loop_3_avm_address(GPOUT,25)
    assign out_lm1_if_loop_3_avm_address = bb_if_loop_3_B2_stall_region_out_lm1_if_loop_3_avm_address;

    // out_lm1_if_loop_3_avm_burstcount(GPOUT,26)
    assign out_lm1_if_loop_3_avm_burstcount = bb_if_loop_3_B2_stall_region_out_lm1_if_loop_3_avm_burstcount;

    // out_lm1_if_loop_3_avm_byteenable(GPOUT,27)
    assign out_lm1_if_loop_3_avm_byteenable = bb_if_loop_3_B2_stall_region_out_lm1_if_loop_3_avm_byteenable;

    // out_lm1_if_loop_3_avm_enable(GPOUT,28)
    assign out_lm1_if_loop_3_avm_enable = bb_if_loop_3_B2_stall_region_out_lm1_if_loop_3_avm_enable;

    // out_lm1_if_loop_3_avm_read(GPOUT,29)
    assign out_lm1_if_loop_3_avm_read = bb_if_loop_3_B2_stall_region_out_lm1_if_loop_3_avm_read;

    // out_lm1_if_loop_3_avm_write(GPOUT,30)
    assign out_lm1_if_loop_3_avm_write = bb_if_loop_3_B2_stall_region_out_lm1_if_loop_3_avm_write;

    // out_lm1_if_loop_3_avm_writedata(GPOUT,31)
    assign out_lm1_if_loop_3_avm_writedata = bb_if_loop_3_B2_stall_region_out_lm1_if_loop_3_avm_writedata;

    // out_lm42_if_loop_3_avm_address(GPOUT,32)
    assign out_lm42_if_loop_3_avm_address = bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_address;

    // out_lm42_if_loop_3_avm_burstcount(GPOUT,33)
    assign out_lm42_if_loop_3_avm_burstcount = bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_burstcount;

    // out_lm42_if_loop_3_avm_byteenable(GPOUT,34)
    assign out_lm42_if_loop_3_avm_byteenable = bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_byteenable;

    // out_lm42_if_loop_3_avm_enable(GPOUT,35)
    assign out_lm42_if_loop_3_avm_enable = bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_enable;

    // out_lm42_if_loop_3_avm_read(GPOUT,36)
    assign out_lm42_if_loop_3_avm_read = bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_read;

    // out_lm42_if_loop_3_avm_write(GPOUT,37)
    assign out_lm42_if_loop_3_avm_write = bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_write;

    // out_lm42_if_loop_3_avm_writedata(GPOUT,38)
    assign out_lm42_if_loop_3_avm_writedata = bb_if_loop_3_B2_stall_region_out_lm42_if_loop_3_avm_writedata;
