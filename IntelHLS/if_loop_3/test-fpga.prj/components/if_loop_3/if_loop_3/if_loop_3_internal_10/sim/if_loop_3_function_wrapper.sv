...
module if_loop_3_function_wrapper (
    ...
    input wire [31:0] avm_lm42_if_loop_3_readdata,
    input wire [0:0] avm_lm42_if_loop_3_readdatavalid,
    input wire [0:0] avm_lm42_if_loop_3_waitrequest,
    input wire [0:0] avm_lm42_if_loop_3_writeack,
    ...
    output wire [31:0] avm_lm42_if_loop_3_address,
    output wire [0:0] avm_lm42_if_loop_3_burstcount,
    output wire [3:0] avm_lm42_if_loop_3_byteenable,
    output wire [0:0] avm_lm42_if_loop_3_enable,
    output wire [0:0] avm_lm42_if_loop_3_read,
    output wire [0:0] avm_lm42_if_loop_3_write,
    output wire [31:0] avm_lm42_if_loop_3_writedata,
    ...
    wire [31:0] if_loop_3_function_out_lm42_if_loop_3_avm_address;
    wire [0:0] if_loop_3_function_out_lm42_if_loop_3_avm_burstcount;
    wire [3:0] if_loop_3_function_out_lm42_if_loop_3_avm_byteenable;
    wire [0:0] if_loop_3_function_out_lm42_if_loop_3_avm_enable;
    wire [0:0] if_loop_3_function_out_lm42_if_loop_3_avm_read;
    wire [0:0] if_loop_3_function_out_lm42_if_loop_3_avm_write;
    wire [31:0] if_loop_3_function_out_lm42_if_loop_3_avm_writedata;
    ...
    if_loop_3_function theif_loop_3_function (
        ...
        .in_lm42_if_loop_3_avm_readdata(avm_lm42_if_loop_3_readdata),
        .in_lm42_if_loop_3_avm_readdatavalid(avm_lm42_if_loop_3_readdatavalid),
        .in_lm42_if_loop_3_avm_waitrequest(avm_lm42_if_loop_3_waitrequest),
        .in_lm42_if_loop_3_avm_writeack(avm_lm42_if_loop_3_writeack),
        .in_stall_in(GND_q),
        .in_start(GND_q),
        .in_valid_in(VCC_q),
        ...
        .out_lm42_if_loop_3_avm_address(if_loop_3_function_out_lm42_if_loop_3_avm_address),
        .out_lm42_if_loop_3_avm_burstcount(if_loop_3_function_out_lm42_if_loop_3_avm_burstcount),
        .out_lm42_if_loop_3_avm_byteenable(if_loop_3_function_out_lm42_if_loop_3_avm_byteenable),
        .out_lm42_if_loop_3_avm_enable(if_loop_3_function_out_lm42_if_loop_3_avm_enable),
        .out_lm42_if_loop_3_avm_read(if_loop_3_function_out_lm42_if_loop_3_avm_read),
        .out_lm42_if_loop_3_avm_write(if_loop_3_function_out_lm42_if_loop_3_avm_write),
        .out_lm42_if_loop_3_avm_writedata(if_loop_3_function_out_lm42_if_loop_3_avm_writedata),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // avm_lm42_if_loop_3_address(GPOUT,40)
    assign avm_lm42_if_loop_3_address = if_loop_3_function_out_lm42_if_loop_3_avm_address;

    // avm_lm42_if_loop_3_burstcount(GPOUT,41)
    assign avm_lm42_if_loop_3_burstcount = if_loop_3_function_out_lm42_if_loop_3_avm_burstcount;

    // avm_lm42_if_loop_3_byteenable(GPOUT,42)
    assign avm_lm42_if_loop_3_byteenable = if_loop_3_function_out_lm42_if_loop_3_avm_byteenable;

    // avm_lm42_if_loop_3_enable(GPOUT,43)
    assign avm_lm42_if_loop_3_enable = if_loop_3_function_out_lm42_if_loop_3_avm_enable;

    // avm_lm42_if_loop_3_read(GPOUT,44)
    assign avm_lm42_if_loop_3_read = if_loop_3_function_out_lm42_if_loop_3_avm_read;

    // avm_lm42_if_loop_3_write(GPOUT,45)
    assign avm_lm42_if_loop_3_write = if_loop_3_function_out_lm42_if_loop_3_avm_write;

    // avm_lm42_if_loop_3_writedata(GPOUT,46)
    assign avm_lm42_if_loop_3_writedata = if_loop_3_function_out_lm42_if_loop_3_avm_writedata;
