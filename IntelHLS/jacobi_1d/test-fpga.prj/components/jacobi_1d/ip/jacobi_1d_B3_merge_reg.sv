...
module jacobi_1d_B3_merge_reg (
    ...
    wire [0:0] VCC_q;
    reg [0:0] jacobi_1d_B3_merge_reg_valid_reg_q;
    wire [0:0] jacobi_1d_B3_merge_reg_valid_reg_and_stall_in_q;
    wire [0:0] jacobi_1d_B3_merge_reg_valid_reg_not_q;
    ...
    // jacobi_1d_B3_merge_reg_valid_reg_not(LOGICAL,4)
    assign jacobi_1d_B3_merge_reg_valid_reg_not_q = ~ (jacobi_1d_B3_merge_reg_valid_reg_q);

    // stall_in_not_or_jacobi_1d_B3_merge_reg_valid_reg(LOGICAL,7)
    assign stall_in_not_or_jacobi_1d_B3_merge_reg_valid_reg_q = jacobi_1d_B3_merge_reg_valid_reg_not_q | stall_in_not_q;

    // jacobi_1d_B3_merge_reg_valid_reg(REG,2)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            jacobi_1d_B3_merge_reg_valid_reg_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_jacobi_1d_B3_merge_reg_valid_reg_q == 1'b1)
        begin
            jacobi_1d_B3_merge_reg_valid_reg_q <= in_valid_in;
        end
    end

    // jacobi_1d_B3_merge_reg_valid_reg_and_stall_in(LOGICAL,3)
    assign jacobi_1d_B3_merge_reg_valid_reg_and_stall_in_q = jacobi_1d_B3_merge_reg_valid_reg_q & in_stall_in;
    ...
    begin
        if (!resetn)
        begin
            jacobi_1d_B3_merge_reg_data_reg_0_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_jacobi_1d_B3_merge_reg_valid_reg_q == 1'b1)
        begin
            jacobi_1d_B3_merge_reg_data_reg_0_x_q <= in_data_in_0_tpl;
        end
    end
