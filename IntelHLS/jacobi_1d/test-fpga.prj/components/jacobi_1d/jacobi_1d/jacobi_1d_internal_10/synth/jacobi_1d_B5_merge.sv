...
module jacobi_1d_B5_merge (
    ...
    output wire [0:0] out_notcmp4168,
    ...
    wire [0:0] notcmp4168_mux_s;
    reg [0:0] notcmp4168_mux_q;
    ...
    // notcmp4168_mux(MUX,10)
    assign notcmp4168_mux_s = in_valid_in_0;
    always @(notcmp4168_mux_s or in_notcmp4168_1 or in_notcmp4168_0)
    begin
        unique case (notcmp4168_mux_s)
            1'b0 : notcmp4168_mux_q = in_notcmp4168_1;
            1'b1 : notcmp4168_mux_q = in_notcmp4168_0;
            default : notcmp4168_mux_q = 1'b0;
        endcase
    end

    // out_notcmp4168(GPOUT,12)
    assign out_notcmp4168 = notcmp4168_mux_q;
