...
module jacobi_1d_bb_B2 (
    ...
    wire [0:0] bb_jacobi_1d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_stall_out;
    wire [0:0] bb_jacobi_1d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_valid_out;
    ...
    wire [0:0] jacobi_1d_B2_merge_out_forked17;
    ...
    jacobi_1d_B2_merge thejacobi_1d_B2_merge (
        ...
        .out_forked17(jacobi_1d_B2_merge_out_forked17),
    ...
    jacobi_1d_bb_B2_stall_region thebb_jacobi_1d_B2_stall_region (
        .in_forked17(jacobi_1d_B2_merge_out_forked17),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(jacobi_1d_B2_branch_out_stall_out),
        .in_valid_in(jacobi_1d_B2_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_stall_out(bb_jacobi_1d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_valid_out(bb_jacobi_1d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_valid_out),
    ...
    // jacobi_1d_B2_branch(BLACKBOX,8)
    ...
    assign out_exiting_stall_out = bb_jacobi_1d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,12)
    assign out_exiting_valid_out = bb_jacobi_1d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going10_jacobi_1d2_exiting_valid_out;
