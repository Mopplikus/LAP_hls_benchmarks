...
module jacobi_1d_B3_merge (
    ...
    wire [0:0] notcmp819_mux_s;
    reg [0:0] notcmp819_mux_q;
    ...
    // notcmp819_mux(MUX,10)
    assign notcmp819_mux_s = in_valid_in_0;
    always @(notcmp819_mux_s or in_notcmp819_1 or in_notcmp819_0)
    begin
        unique case (notcmp819_mux_s)
            1'b0 : notcmp819_mux_q = in_notcmp819_1;
            1'b1 : notcmp819_mux_q = in_notcmp819_0;
            default : notcmp819_mux_q = 1'b0;
        endcase
    end

    // out_notcmp819(GPOUT,12)
    assign out_notcmp819 = notcmp819_mux_q;
