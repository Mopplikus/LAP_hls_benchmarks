	component mm_agent_jacobi_1d_avmm_0_rw is
		generic (
			...
			COMPONENT_NAME             : string  := "jacobi_1d";
	...
	end component mm_agent_jacobi_1d_avmm_0_rw;

	u0 : component mm_agent_jacobi_1d_avmm_0_rw
		generic map (
