...
source [file join [file dirname [info script]] ./../../../ip/tb/sso_jacobi_1d_B/sim/common/vcs_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/jacobi_1d_en_cfan/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_jacobi_1d_A_2/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_jacobi_1d_A_1/sim/common/vcs_files.tcl]
...
namespace eval tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_jacobi_1d_B::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_jacobi_1d_B/sim/"]]
    ...
    set design_files [dict merge $design_files [jacobi_1d_en_cfan::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/jacobi_1d_en_cfan/sim/"]]
    set design_files [dict merge $design_files [sso_jacobi_1d_A_2::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_jacobi_1d_A_2/sim/"]]
    set design_files [dict merge $design_files [sso_jacobi_1d_A_1::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_jacobi_1d_A_1/sim/"]]
  ...
  proc get_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_jacobi_1d_B::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_jacobi_1d_B/sim/"]]
    ...
    set design_files [dict merge $design_files [jacobi_1d_en_cfan::get_design_files "$QSYS_SIMDIR/../../ip/tb/jacobi_1d_en_cfan/sim/"]]
    set design_files [dict merge $design_files [sso_jacobi_1d_A_2::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_jacobi_1d_A_2/sim/"]]
    set design_files [dict merge $design_files [sso_jacobi_1d_A_1::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_jacobi_1d_A_1/sim/"]]
