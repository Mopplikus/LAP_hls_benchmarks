...
module covariance_bb_B3 (
    ...
    wire [0:0] bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_stall_out;
    wire [0:0] bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_valid_out;
    ...
    wire [0:0] bb_covariance_B3_stall_region_out_c0_exe1214;
    wire [0:0] bb_covariance_B3_stall_region_out_c0_exe2215;
    ...
    wire [0:0] covariance_B3_branch_out_c0_exe1214;
    wire [0:0] covariance_B3_branch_out_c0_exe2215;
    ...
    wire [0:0] covariance_B3_merge_out_forked74;
    wire [31:0] covariance_B3_merge_out_lim_ext109;
    wire [0:0] covariance_B3_merge_out_memdep_phi1_pop16114;
    wire [0:0] covariance_B3_merge_out_memdep_phi2_pop17119;
    wire [0:0] covariance_B3_merge_out_memdep_phi4_pop18124;
    ...
    covariance_B3_branch thecovariance_B3_branch (
        ...
        .in_c0_exe1214(bb_covariance_B3_stall_region_out_c0_exe1214),
        .in_c0_exe2215(bb_covariance_B3_stall_region_out_c0_exe2215),
        ...
        .out_c0_exe1214(covariance_B3_branch_out_c0_exe1214),
        .out_c0_exe2215(covariance_B3_branch_out_c0_exe2215),
    ...
    covariance_B3_merge thecovariance_B3_merge (
        ...
        .in_memdep_phi1_pop16114_0(in_memdep_phi1_pop16114_0),
        .in_memdep_phi1_pop16114_1(in_memdep_phi1_pop16114_1),
        .in_memdep_phi2_pop17119_0(in_memdep_phi2_pop17119_0),
        .in_memdep_phi2_pop17119_1(in_memdep_phi2_pop17119_1),
        .in_memdep_phi4_pop18124_0(in_memdep_phi4_pop18124_0),
        .in_memdep_phi4_pop18124_1(in_memdep_phi4_pop18124_1),
        .in_stall_in(bb_covariance_B3_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .in_valid_in_1(in_valid_in_1),
        .out_forked74(covariance_B3_merge_out_forked74),
        .out_lim_ext109(covariance_B3_merge_out_lim_ext109),
        .out_memdep_phi1_pop16114(covariance_B3_merge_out_memdep_phi1_pop16114),
        .out_memdep_phi2_pop17119(covariance_B3_merge_out_memdep_phi2_pop17119),
        .out_memdep_phi4_pop18124(covariance_B3_merge_out_memdep_phi4_pop18124),
    ...
    covariance_bb_B3_stall_region thebb_covariance_B3_stall_region (
        ...
        .in_forked74(covariance_B3_merge_out_forked74),
        .in_lim_ext109(covariance_B3_merge_out_lim_ext109),
        .in_memdep_phi1_pop16114(covariance_B3_merge_out_memdep_phi1_pop16114),
        .in_memdep_phi2_pop17119(covariance_B3_merge_out_memdep_phi2_pop17119),
        .in_memdep_phi4_pop18124(covariance_B3_merge_out_memdep_phi4_pop18124),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(covariance_B3_branch_out_stall_out),
        .in_valid_in(covariance_B3_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_stall_out(bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_valid_out(bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_valid_out),
        ...
        .out_c0_exe1214(bb_covariance_B3_stall_region_out_c0_exe1214),
        .out_c0_exe2215(bb_covariance_B3_stall_region_out_c0_exe2215),
    ...
    // out_c0_exe1214(GPOUT,24)
    assign out_c0_exe1214 = covariance_B3_branch_out_c0_exe1214;

    // out_c0_exe2215(GPOUT,25)
    assign out_c0_exe2215 = covariance_B3_branch_out_c0_exe2215;
    ...
    assign out_exiting_stall_out = bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,33)
    assign out_exiting_valid_out = bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going67_covariance2_exiting_valid_out;

    // out_memdep_phi_pop22(GPOUT,34)
