...
module covariance_bb_B6 (
    ...
    input wire [0:0] in_c0_exe127613_0,
    input wire [31:0] in_c0_exe427916_0,
    input wire [0:0] in_c0_exe528017_0,
    input wire [0:0] in_c0_exe628118_0,
    ...
    wire [0:0] bb_covariance_B6_stall_region_out_c0_exe127613;
    wire [31:0] bb_covariance_B6_stall_region_out_c0_exe427916;
    wire [0:0] bb_covariance_B6_stall_region_out_c0_exe628118;
    ...
    wire [0:0] covariance_B6_branch_out_c0_exe127613;
    wire [31:0] covariance_B6_branch_out_c0_exe427916;
    ...
    wire [0:0] covariance_B6_merge_out_c0_exe127613;
    wire [31:0] covariance_B6_merge_out_c0_exe427916;
    wire [0:0] covariance_B6_merge_out_c0_exe528017;
    wire [0:0] covariance_B6_merge_out_c0_exe628118;
    ...
    covariance_B6_branch thecovariance_B6_branch (
        .in_c0_exe127613(bb_covariance_B6_stall_region_out_c0_exe127613),
        .in_c0_exe427916(bb_covariance_B6_stall_region_out_c0_exe427916),
        .in_c0_exe628118(bb_covariance_B6_stall_region_out_c0_exe628118),
        .in_stall_in_0(in_stall_in_0),
        .in_stall_in_1(in_stall_in_1),
        .in_valid_in(bb_covariance_B6_stall_region_out_valid_out),
        .out_c0_exe127613(covariance_B6_branch_out_c0_exe127613),
        .out_c0_exe427916(covariance_B6_branch_out_c0_exe427916),
    ...
    covariance_B6_merge thecovariance_B6_merge (
        .in_c0_exe127613_0(in_c0_exe127613_0),
        .in_c0_exe427916_0(in_c0_exe427916_0),
        .in_c0_exe528017_0(in_c0_exe528017_0),
        .in_c0_exe628118_0(in_c0_exe628118_0),
        .in_stall_in(bb_covariance_B6_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe127613(covariance_B6_merge_out_c0_exe127613),
        .out_c0_exe427916(covariance_B6_merge_out_c0_exe427916),
        .out_c0_exe528017(covariance_B6_merge_out_c0_exe528017),
        .out_c0_exe628118(covariance_B6_merge_out_c0_exe628118),
    ...
    covariance_bb_B6_stall_region thebb_covariance_B6_stall_region (
        .in_c0_exe127613(covariance_B6_merge_out_c0_exe127613),
        .in_c0_exe427916(covariance_B6_merge_out_c0_exe427916),
        .in_c0_exe528017(covariance_B6_merge_out_c0_exe528017),
        .in_c0_exe628118(covariance_B6_merge_out_c0_exe628118),
        ...
        .out_c0_exe127613(bb_covariance_B6_stall_region_out_c0_exe127613),
        .out_c0_exe427916(bb_covariance_B6_stall_region_out_c0_exe427916),
        .out_c0_exe628118(bb_covariance_B6_stall_region_out_c0_exe628118),
    ...
    // out_c0_exe127613(GPOUT,15)
    assign out_c0_exe127613 = covariance_B6_branch_out_c0_exe127613;

    // out_c0_exe427916(GPOUT,16)
    assign out_c0_exe427916 = covariance_B6_branch_out_c0_exe427916;
