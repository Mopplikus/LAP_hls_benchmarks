...
module covariance_B3_merge (
    ...
    output wire [31:0] out_lim_ext165,
    ...
    wire [0:0] lim_ext165_mux_s;
    reg [31:0] lim_ext165_mux_q;
    ...
    // lim_ext165_mux(MUX,10)
    assign lim_ext165_mux_s = in_valid_in_0;
    always @(lim_ext165_mux_s or in_lim_ext165_1 or in_lim_ext165_0)
    begin
        unique case (lim_ext165_mux_s)
            1'b0 : lim_ext165_mux_q = in_lim_ext165_1;
            1'b1 : lim_ext165_mux_q = in_lim_ext165_0;
            default : lim_ext165_mux_q = 32'b0;
        endcase
    end

    // out_lim_ext165(GPOUT,12)
    assign out_lim_ext165 = lim_ext165_mux_q;
