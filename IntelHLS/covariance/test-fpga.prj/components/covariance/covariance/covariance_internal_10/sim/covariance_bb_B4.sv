...
module covariance_bb_B4 (
    ...
    wire [31:0] bb_covariance_B4_stall_region_out_c0_exe82;
    wire [0:0] bb_covariance_B4_stall_region_out_c0_exe93;
    wire [0:0] bb_covariance_B4_stall_region_out_stall_out;
    wire [0:0] bb_covariance_B4_stall_region_out_valid_out;
    wire [31:0] covariance_B4_branch_out_c0_exe82;
    wire [0:0] covariance_B4_branch_out_stall_out;
    wire [0:0] covariance_B4_branch_out_valid_out_0;
    wire [0:0] covariance_B4_branch_out_valid_out_1;
    wire [31:0] covariance_B4_merge_out_c0_exe82;
    wire [0:0] covariance_B4_merge_out_c0_exe93;
    ...
    covariance_B4_merge thecovariance_B4_merge (
        ...
        .out_c0_exe82(covariance_B4_merge_out_c0_exe82),
        .out_c0_exe93(covariance_B4_merge_out_c0_exe93),
    ...
    covariance_bb_B4_stall_region thebb_covariance_B4_stall_region (
        .in_c0_exe82(covariance_B4_merge_out_c0_exe82),
        .in_c0_exe93(covariance_B4_merge_out_c0_exe93),
        .in_stall_in(covariance_B4_branch_out_stall_out),
        .in_valid_in(covariance_B4_merge_out_valid_out),
        .out_c0_exe82(bb_covariance_B4_stall_region_out_c0_exe82),
        .out_c0_exe93(bb_covariance_B4_stall_region_out_c0_exe93),
    ...
    covariance_B4_branch thecovariance_B4_branch (
        .in_c0_exe82(bb_covariance_B4_stall_region_out_c0_exe82),
        .in_c0_exe93(bb_covariance_B4_stall_region_out_c0_exe93),
        .in_stall_in_0(in_stall_in_0),
        .in_stall_in_1(in_stall_in_1),
        .in_valid_in(bb_covariance_B4_stall_region_out_valid_out),
        .out_c0_exe82(covariance_B4_branch_out_c0_exe82),
        .out_stall_out(covariance_B4_branch_out_stall_out),
        .out_valid_out_0(covariance_B4_branch_out_valid_out_0),
        .out_valid_out_1(covariance_B4_branch_out_valid_out_1),
        .clock(clock),
        .resetn(resetn)
    );

    // out_c0_exe82(GPOUT,10)
    assign out_c0_exe82 = covariance_B4_branch_out_c0_exe82;
    ...
    assign out_valid_out_1 = covariance_B4_branch_out_valid_out_1;
