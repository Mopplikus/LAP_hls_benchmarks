...
// SystemVerilog created from i_llvm_fpga_wg_limiter_exit_unnamed_covariance10_covariance0
...
module covariance_i_llvm_fpga_wg_limiter_exit_unnamed_10_covariance0 (
