...
module covariance_B9_merge_reg (
    ...
    wire [0:0] VCC_q;
    reg [0:0] covariance_B9_merge_reg_valid_reg_q;
    wire [0:0] covariance_B9_merge_reg_valid_reg_and_stall_in_q;
    wire [0:0] covariance_B9_merge_reg_valid_reg_not_q;
    ...
    // covariance_B9_merge_reg_valid_reg_not(LOGICAL,4)
    assign covariance_B9_merge_reg_valid_reg_not_q = ~ (covariance_B9_merge_reg_valid_reg_q);

    // stall_in_not_or_covariance_B9_merge_reg_valid_reg(LOGICAL,7)
    assign stall_in_not_or_covariance_B9_merge_reg_valid_reg_q = covariance_B9_merge_reg_valid_reg_not_q | stall_in_not_q;

    // covariance_B9_merge_reg_valid_reg(REG,2)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            covariance_B9_merge_reg_valid_reg_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_covariance_B9_merge_reg_valid_reg_q == 1'b1)
        begin
            covariance_B9_merge_reg_valid_reg_q <= in_valid_in;
        end
    end

    // covariance_B9_merge_reg_valid_reg_and_stall_in(LOGICAL,3)
    assign covariance_B9_merge_reg_valid_reg_and_stall_in_q = covariance_B9_merge_reg_valid_reg_q & in_stall_in;
    ...
    begin
        if (!resetn)
        begin
            covariance_B9_merge_reg_data_reg_6_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_covariance_B9_merge_reg_valid_reg_q == 1'b1)
        begin
            covariance_B9_merge_reg_data_reg_6_x_q <= in_data_in_6_tpl;
        end
    end

    // covariance_B9_merge_reg_data_reg_5_x(REG,14)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
        ...
        begin
            covariance_B9_merge_reg_data_reg_5_x_q <= in_data_in_5_tpl;
        end
    end

    // covariance_B9_merge_reg_data_reg_4_x(REG,13)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
        ...
        begin
            covariance_B9_merge_reg_data_reg_4_x_q <= in_data_in_4_tpl;
        end
    end

    // covariance_B9_merge_reg_data_reg_3_x(REG,12)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
        ...
        begin
            covariance_B9_merge_reg_data_reg_3_x_q <= in_data_in_3_tpl;
        end
    end

    // covariance_B9_merge_reg_data_reg_2_x(REG,11)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
        ...
        begin
            covariance_B9_merge_reg_data_reg_2_x_q <= in_data_in_2_tpl;
        end
    end

    // covariance_B9_merge_reg_data_reg_1_x(REG,10)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            covariance_B9_merge_reg_data_reg_1_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_covariance_B9_merge_reg_valid_reg_q == 1'b1)
        begin
            covariance_B9_merge_reg_data_reg_1_x_q <= in_data_in_1_tpl;
        end
    end

    // covariance_B9_merge_reg_data_reg_0_x(REG,9)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            covariance_B9_merge_reg_data_reg_0_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_covariance_B9_merge_reg_valid_reg_q == 1'b1)
        begin
            covariance_B9_merge_reg_data_reg_0_x_q <= in_data_in_0_tpl;
        end
    end
    ...
    assign out_data_out_3_tpl = covariance_B9_merge_reg_data_reg_3_x_q;
