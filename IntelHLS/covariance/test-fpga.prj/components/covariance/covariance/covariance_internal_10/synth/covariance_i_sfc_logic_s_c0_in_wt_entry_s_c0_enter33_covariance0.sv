...
module covariance_i_sfc_logic_s_c0_in_wt_entry_s_c0_enter33_covariance0 (
    ...
    wire [0:0] i_llvm_fpga_push_i1_notexitcond72_covariance3_out_data_out;
    wire [0:0] i_llvm_fpga_push_i1_notexitcond72_covariance3_out_feedback_out_15;
    wire [0:0] i_llvm_fpga_push_i1_notexitcond72_covariance3_out_feedback_valid_out_15;
    ...
    // i_llvm_fpga_push_i1_notexitcond72_covariance3(BLACKBOX,10)@1
    // out out_feedback_out_15@20000000
    // out out_feedback_valid_out_15@20000000
    covariance_i_llvm_fpga_push_i1_notexitcond72_0 thei_llvm_fpga_push_i1_notexitcond72_covariance3 (
        .in_data_in(VCC_q),
        .in_feedback_stall_in_15(i_llvm_fpga_pipeline_keep_going71_covariance2_out_not_exitcond_stall_out),
        .in_stall_in(enable_stall_connector_not_enable_q),
        .in_valid_in(in_i_valid),
        .out_data_out(i_llvm_fpga_push_i1_notexitcond72_covariance3_out_data_out),
        .out_feedback_out_15(i_llvm_fpga_push_i1_notexitcond72_covariance3_out_feedback_out_15),
        .out_feedback_valid_out_15(i_llvm_fpga_push_i1_notexitcond72_covariance3_out_feedback_valid_out_15),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pipeline_keep_going71_covariance2(BLACKBOX,9)@1
    ...
    covariance_i_llvm_fpga_pipeline_keep_going71_0 thei_llvm_fpga_pipeline_keep_going71_covariance2 (
        ...
        .in_not_exitcond_in(i_llvm_fpga_push_i1_notexitcond72_covariance3_out_feedback_out_15),
        .in_not_exitcond_valid_in(i_llvm_fpga_push_i1_notexitcond72_covariance3_out_feedback_valid_out_15),
    ...
    assign out_c0_exi2_1_tpl = i_llvm_fpga_push_i1_notexitcond72_covariance3_out_data_out;
