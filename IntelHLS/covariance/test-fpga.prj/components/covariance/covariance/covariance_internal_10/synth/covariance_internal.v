...
(
   ...
   logic [31:0] local_avm_aspace64_writedata [1][5];
   logic [3:0] local_avm_aspace64_byteenable [1][5];
   logic local_avm_aspace64_waitrequest [1][5];
   logic [31:0] local_avm_aspace64_readdata [1][5];
   ...
   (
      ...
      .avm_memdep_covariance_enable(local_avm_aspace64_enable[0][0]),
      .avm_memdep_covariance_read(local_avm_aspace64_read[0][0]),
      .avm_memdep_covariance_write(local_avm_aspace64_write[0][0]),
      .avm_memdep_covariance_address(local_avm_aspace64_address[0][0]),
      .avm_memdep_covariance_writedata(local_avm_aspace64_writedata[0][0]),
      .avm_memdep_covariance_byteenable(local_avm_aspace64_byteenable[0][0]),
      .avm_memdep_covariance_waitrequest(local_avm_aspace64_waitrequest[0][0]),
      .avm_memdep_covariance_readdata(local_avm_aspace64_readdata[0][0]),
      .avm_memdep_covariance_readdatavalid(local_avm_aspace64_readdatavalid[0][0]),
      .avm_memdep_covariance_burstcount(local_avm_aspace64_burstcount[0][0]),
      .avm_memdep_covariance_writeack(local_avm_aspace64_writeack[0][0]),
      // AVM avm_unnamed_covariance2_covariance
      .avm_unnamed_covariance2_covariance_enable(local_avm_aspace64_enable[0][1]),
      .avm_unnamed_covariance2_covariance_read(local_avm_aspace64_read[0][1]),
      .avm_unnamed_covariance2_covariance_write(local_avm_aspace64_write[0][1]),
      .avm_unnamed_covariance2_covariance_address(local_avm_aspace64_address[0][1]),
      .avm_unnamed_covariance2_covariance_writedata(local_avm_aspace64_writedata[0][1]),
      .avm_unnamed_covariance2_covariance_byteenable(local_avm_aspace64_byteenable[0][1]),
      .avm_unnamed_covariance2_covariance_waitrequest(local_avm_aspace64_waitrequest[0][1]),
      .avm_unnamed_covariance2_covariance_readdata(local_avm_aspace64_readdata[0][1]),
      .avm_unnamed_covariance2_covariance_readdatavalid(local_avm_aspace64_readdatavalid[0][1]),
      .avm_unnamed_covariance2_covariance_burstcount(local_avm_aspace64_burstcount[0][1]),
      .avm_unnamed_covariance2_covariance_writeack(local_avm_aspace64_writeack[0][1]),
      // AVM avm_unnamed_covariance3_covariance
      .avm_unnamed_covariance3_covariance_enable(local_avm_aspace64_enable[0][2]),
      .avm_unnamed_covariance3_covariance_read(local_avm_aspace64_read[0][2]),
      .avm_unnamed_covariance3_covariance_write(local_avm_aspace64_write[0][2]),
      .avm_unnamed_covariance3_covariance_address(local_avm_aspace64_address[0][2]),
      .avm_unnamed_covariance3_covariance_writedata(local_avm_aspace64_writedata[0][2]),
      .avm_unnamed_covariance3_covariance_byteenable(local_avm_aspace64_byteenable[0][2]),
      .avm_unnamed_covariance3_covariance_waitrequest(local_avm_aspace64_waitrequest[0][2]),
      .avm_unnamed_covariance3_covariance_readdata(local_avm_aspace64_readdata[0][2]),
      .avm_unnamed_covariance3_covariance_readdatavalid(local_avm_aspace64_readdatavalid[0][2]),
      .avm_unnamed_covariance3_covariance_burstcount(local_avm_aspace64_burstcount[0][2]),
      .avm_unnamed_covariance3_covariance_writeack(local_avm_aspace64_writeack[0][2]),
      // AVM avm_unnamed_covariance5_covariance
      .avm_unnamed_covariance5_covariance_enable(local_avm_aspace64_enable[0][3]),
      .avm_unnamed_covariance5_covariance_read(local_avm_aspace64_read[0][3]),
      .avm_unnamed_covariance5_covariance_write(local_avm_aspace64_write[0][3]),
      .avm_unnamed_covariance5_covariance_address(local_avm_aspace64_address[0][3]),
      .avm_unnamed_covariance5_covariance_writedata(local_avm_aspace64_writedata[0][3]),
      .avm_unnamed_covariance5_covariance_byteenable(local_avm_aspace64_byteenable[0][3]),
      .avm_unnamed_covariance5_covariance_waitrequest(local_avm_aspace64_waitrequest[0][3]),
      .avm_unnamed_covariance5_covariance_readdata(local_avm_aspace64_readdata[0][3]),
      .avm_unnamed_covariance5_covariance_readdatavalid(local_avm_aspace64_readdatavalid[0][3]),
      .avm_unnamed_covariance5_covariance_burstcount(local_avm_aspace64_burstcount[0][3]),
      .avm_unnamed_covariance5_covariance_writeack(local_avm_aspace64_writeack[0][3]),
      // AVM avm_unnamed_covariance6_covariance
      .avm_unnamed_covariance6_covariance_enable(local_avm_aspace64_enable[0][4]),
      .avm_unnamed_covariance6_covariance_read(local_avm_aspace64_read[0][4]),
      .avm_unnamed_covariance6_covariance_write(local_avm_aspace64_write[0][4]),
      .avm_unnamed_covariance6_covariance_address(local_avm_aspace64_address[0][4]),
      .avm_unnamed_covariance6_covariance_writedata(local_avm_aspace64_writedata[0][4]),
      .avm_unnamed_covariance6_covariance_byteenable(local_avm_aspace64_byteenable[0][4]),
      .avm_unnamed_covariance6_covariance_waitrequest(local_avm_aspace64_waitrequest[0][4]),
      .avm_unnamed_covariance6_covariance_readdata(local_avm_aspace64_readdata[0][4]),
      .avm_unnamed_covariance6_covariance_readdatavalid(local_avm_aspace64_readdatavalid[0][4]),
      .avm_unnamed_covariance6_covariance_burstcount(local_avm_aspace64_burstcount[0][4]),
      .avm_unnamed_covariance6_covariance_writeack(local_avm_aspace64_writeack[0][4]),
      // AVM avm_unnamed_covariance4_covariance
      .avm_unnamed_covariance4_covariance_enable(local_avm_aspace65_enable[0][0]),
      .avm_unnamed_covariance4_covariance_read(local_avm_aspace65_read[0][0]),
      .avm_unnamed_covariance4_covariance_write(local_avm_aspace65_write[0][0]),
      .avm_unnamed_covariance4_covariance_address(local_avm_aspace65_address[0][0]),
      .avm_unnamed_covariance4_covariance_writedata(local_avm_aspace65_writedata[0][0]),
      .avm_unnamed_covariance4_covariance_byteenable(local_avm_aspace65_byteenable[0][0]),
      .avm_unnamed_covariance4_covariance_waitrequest(local_avm_aspace65_waitrequest[0][0]),
      .avm_unnamed_covariance4_covariance_readdata(local_avm_aspace65_readdata[0][0]),
      .avm_unnamed_covariance4_covariance_readdatavalid(local_avm_aspace65_readdatavalid[0][0]),
      .avm_unnamed_covariance4_covariance_burstcount(local_avm_aspace65_burstcount[0][0]),
      .avm_unnamed_covariance4_covariance_writeack(local_avm_aspace65_writeack[0][0])
   );
   ...
   begin:local_mem_system_aspace64
      ...
      logic [9:0] local_icm_arb_address [1][5];
      ...
      begin:local_mem_group
         ...
         begin:port1bank0
            ...
            // INST data_ic of covariance_internal_ic_13830461541539336706
            covariance_internal_ic_13830461541539336706 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE covariance_internal_ic_13830461541539336706
/////////////////////////////////////////////////////////////////
module covariance_internal_ic_13830461541539336706
(
   input logic clock,
