...
// SystemVerilog created from i_llvm_fpga_wg_limiter_exit_unnamed_covariance7_covariance0
...
module covariance_i_llvm_fpga_wg_limiter_exit_unnamed_7_covariance0 (
