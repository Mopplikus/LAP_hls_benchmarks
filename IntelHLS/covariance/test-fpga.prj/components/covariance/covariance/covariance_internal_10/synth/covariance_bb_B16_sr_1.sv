...
// SystemVerilog created from bb_covariance_B16_sr_1
...
module covariance_bb_B16_sr_1 (
    ...
    begin
        if (!resetn)
        begin
            sr_3_x_q <= $unsigned(33'b000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
