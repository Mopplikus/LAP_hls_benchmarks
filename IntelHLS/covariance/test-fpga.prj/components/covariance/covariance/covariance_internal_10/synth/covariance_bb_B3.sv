...
module covariance_bb_B3 (
    ...
    input wire [31:0] in_lim_ext165_0,
    input wire [31:0] in_lim_ext165_1,
    ...
    wire [0:0] bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_stall_out;
    wire [0:0] bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_valid_out;
    wire [0:0] bb_covariance_B3_stall_region_out_c0_exe2252;
    wire [31:0] bb_covariance_B3_stall_region_out_c0_exe3;
    wire [31:0] bb_covariance_B3_stall_region_out_c0_exe4;
    wire [31:0] bb_covariance_B3_stall_region_out_c0_exe5;
    ...
    wire [0:0] covariance_B3_branch_out_c0_exe2252;
    wire [31:0] covariance_B3_branch_out_c0_exe3;
    wire [31:0] covariance_B3_branch_out_c0_exe4;
    wire [31:0] covariance_B3_branch_out_c0_exe5;
    wire [0:0] covariance_B3_branch_out_stall_out;
    wire [0:0] covariance_B3_branch_out_valid_out_0;
    wire [0:0] covariance_B3_merge_out_forked131;
    wire [31:0] covariance_B3_merge_out_lim_ext165;
    ...
    covariance_B3_merge thecovariance_B3_merge (
        .in_forked131_0(in_forked131_0),
        .in_forked131_1(in_forked131_1),
        .in_lim_ext165_0(in_lim_ext165_0),
        .in_lim_ext165_1(in_lim_ext165_1),
        .in_stall_in(bb_covariance_B3_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .in_valid_in_1(in_valid_in_1),
        .out_forked131(covariance_B3_merge_out_forked131),
        .out_lim_ext165(covariance_B3_merge_out_lim_ext165),
    ...
    covariance_bb_B3_stall_region thebb_covariance_B3_stall_region (
        .in_forked131(covariance_B3_merge_out_forked131),
        .in_lim_ext165(covariance_B3_merge_out_lim_ext165),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(covariance_B3_branch_out_stall_out),
        .in_valid_in(covariance_B3_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_stall_out(bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_valid_out(bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_valid_out),
        .out_c0_exe2252(bb_covariance_B3_stall_region_out_c0_exe2252),
    ...
    covariance_B3_branch thecovariance_B3_branch (
        .in_c0_exe2252(bb_covariance_B3_stall_region_out_c0_exe2252),
        ...
        .out_c0_exe2252(covariance_B3_branch_out_c0_exe2252),
    ...
    // out_c0_exe2252(GPOUT,12)
    assign out_c0_exe2252 = covariance_B3_branch_out_c0_exe2252;
    ...
    assign out_exiting_stall_out = bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,17)
    assign out_exiting_valid_out = bb_covariance_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going124_covariance2_exiting_valid_out;
