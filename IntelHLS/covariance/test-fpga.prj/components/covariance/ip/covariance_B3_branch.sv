...
module covariance_B3_branch (
    ...
    input wire [0:0] in_memdep_phi_pop22,
    ...
    // out_c0_exe1214(GPOUT,19)
    assign out_c0_exe1214 = in_c0_exe1214;

    // out_c0_exe2215(GPOUT,20)
    assign out_c0_exe2215 = in_c0_exe2215;
    ...
    // out_memdep_phi_pop22(GPOUT,27)
    assign out_memdep_phi_pop22 = in_memdep_phi_pop22;
