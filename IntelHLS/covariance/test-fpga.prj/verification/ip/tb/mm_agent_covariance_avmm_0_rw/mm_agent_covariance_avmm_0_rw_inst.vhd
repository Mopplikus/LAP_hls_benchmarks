	component mm_agent_covariance_avmm_0_rw is
		generic (
			...
			COMPONENT_NAME             : string  := "covariance";
	...
	end component mm_agent_covariance_avmm_0_rw;

	u0 : component mm_agent_covariance_avmm_0_rw
		generic map (
