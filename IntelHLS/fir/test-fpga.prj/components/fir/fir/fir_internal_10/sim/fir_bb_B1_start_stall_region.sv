...
module fir_bb_B1_start_stall_region (
    ...
    wire [63:0] i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_intel_reserved_ffwd_0_0;
    wire [0:0] i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_stall_out;
    wire [0:0] i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_valid_out;
    wire [63:0] i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_intel_reserved_ffwd_1_0;
    wire [0:0] i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_stall_out;
    wire [0:0] i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_valid_out;
    ...
    wire [0:0] i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_stall_out;
    wire [0:0] i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_valid_out;
    ...
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_wireValid;
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_and0;
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_backStall;
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_V0;
    ...
    // SE_out_fir_B1_start_merge_reg(STALLENABLE,53)
    // Valid signal propagation
    ...
    // SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5(STALLENABLE,57)
    // Valid signal propagation
    assign SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_V0 = SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_wireValid;
    // Backward Stall generation
    assign SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_backStall = in_stall_in | ~ (SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_and0 = i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_valid_out;
    assign SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_wireValid = i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_valid_out & SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_and0;
    ...
    // i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5(BLACKBOX,14)@2
    // in in_stall_in@20000000
    // out out_intel_reserved_ffwd_1_0@20000000
    // out out_stall_out@20000000
    fir_i_llvm_fpga_ffwd_source_p1024i32_unnamed_4_fir0 thei_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5 (
        .in_predicate_in(GND_q),
        .in_src_data_in_1_0(bubble_select_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_c),
        .in_stall_in(SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_backStall),
        .in_valid_in(SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_V1),
        .out_intel_reserved_ffwd_1_0(i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_intel_reserved_ffwd_1_0),
        .out_stall_out(i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_stall_out),
        .out_valid_out(i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4(BLACKBOX,13)@2
    // in in_stall_in@20000000
    // out out_intel_reserved_ffwd_0_0@20000000
    // out out_stall_out@20000000
    fir_i_llvm_fpga_ffwd_source_p1024i32_unnamed_3_fir0 thei_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4 (
        .in_predicate_in(GND_q),
        .in_src_data_in_0_0(bubble_select_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_b),
        .in_stall_in(SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_backStall),
        .in_valid_in(SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_V0),
        .out_intel_reserved_ffwd_0_0(i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_intel_reserved_ffwd_0_0),
        .out_stall_out(i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_stall_out),
        .out_valid_out(i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x(STALLENABLE,63)
    ...
    assign SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_consumed0 = (~ (i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_stall_out) & SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_wireValid) | SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_fromReg0;
    assign SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_consumed1 = (~ (i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_stall_out) & SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_wireValid) | SE_out_i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x_fromReg1;
    // Consuming
    ...
    // i_iord_bl_call_fir_unnamed_fir2_fir2_aunroll_x(BLACKBOX,39)@2
    ...
    // SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_fir1(STALLENABLE,59)
    // Valid signal propagation
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_fir1(BLACKBOX,15)@1
    // in in_stall_in@20000000
    // out out_data_out@2
    ...
    // SE_out_i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x(STALLENABLE,65)
    // Valid signal propagation
    ...
    // i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x(BLACKBOX,40)@1
    // in in_i_stall@20000000
    // out out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_stall_out@20000000
    // out out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_valid_out@20000000
    // out out_o_stall@20000000
    ...
    fir_i_sfc_s_c0_in_wt_entry_s_c0_enter1_fir0 thei_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_stall_out(i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_valid_out(i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_valid_out),
    ...
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_valid_out = i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_valid_out;
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_stall_out = i_sfc_s_c0_in_wt_entry_firs_c0_enter1_fir0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going26_fir1_exiting_stall_out;
    ...
    assign out_intel_reserved_ffwd_0_0 = i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir3_fir4_out_intel_reserved_ffwd_0_0;
    ...
    assign out_intel_reserved_ffwd_1_0 = i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_out_intel_reserved_ffwd_1_0;

    // dupName_0_sync_out_x(GPOUT,38)@2
    assign out_valid_out = SE_out_i_llvm_fpga_ffwd_source_p1024i32_unnamed_fir4_fir5_V0;
