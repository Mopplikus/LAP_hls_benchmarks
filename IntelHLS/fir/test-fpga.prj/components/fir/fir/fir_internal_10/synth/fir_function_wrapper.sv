...
module fir_function_wrapper (
    input wire [31:0] avm_memdep_1_fir_readdata,
    input wire [0:0] avm_memdep_1_fir_readdatavalid,
    input wire [0:0] avm_memdep_1_fir_waitrequest,
    input wire [0:0] avm_memdep_1_fir_writeack,
    input wire [31:0] avm_memdep_fir_readdata,
    ...
    input wire [63:0] avm_unnamed_fir5_fir_readdata,
    ...
    input wire [63:0] avm_unnamed_fir6_fir_readdata,
    ...
    input wire [31:0] avm_unnamed_fir9_fir_readdata,
    input wire [0:0] avm_unnamed_fir9_fir_readdatavalid,
    input wire [0:0] avm_unnamed_fir9_fir_waitrequest,
    input wire [0:0] avm_unnamed_fir9_fir_writeack,
    ...
    output wire [31:0] avm_memdep_1_fir_address,
    output wire [0:0] avm_memdep_1_fir_burstcount,
    output wire [3:0] avm_memdep_1_fir_byteenable,
    output wire [0:0] avm_memdep_1_fir_enable,
    output wire [0:0] avm_memdep_1_fir_read,
    output wire [0:0] avm_memdep_1_fir_write,
    output wire [31:0] avm_memdep_1_fir_writedata,
    output wire [31:0] avm_memdep_fir_address,
    output wire [0:0] avm_memdep_fir_burstcount,
    output wire [3:0] avm_memdep_fir_byteenable,
    output wire [0:0] avm_memdep_fir_enable,
    output wire [0:0] avm_memdep_fir_read,
    output wire [0:0] avm_memdep_fir_write,
    output wire [31:0] avm_memdep_fir_writedata,
    output wire [63:0] avm_unnamed_fir5_fir_address,
    output wire [0:0] avm_unnamed_fir5_fir_burstcount,
    output wire [7:0] avm_unnamed_fir5_fir_byteenable,
    ...
    output wire [63:0] avm_unnamed_fir5_fir_writedata,
    output wire [63:0] avm_unnamed_fir6_fir_address,
    output wire [0:0] avm_unnamed_fir6_fir_burstcount,
    output wire [7:0] avm_unnamed_fir6_fir_byteenable,
    ...
    output wire [63:0] avm_unnamed_fir6_fir_writedata,
    ...
    output wire [31:0] avm_unnamed_fir9_fir_address,
    output wire [0:0] avm_unnamed_fir9_fir_burstcount,
    output wire [3:0] avm_unnamed_fir9_fir_byteenable,
    output wire [0:0] avm_unnamed_fir9_fir_enable,
    output wire [0:0] avm_unnamed_fir9_fir_read,
    output wire [0:0] avm_unnamed_fir9_fir_write,
    output wire [31:0] avm_unnamed_fir9_fir_writedata,
    ...
    wire [31:0] fir_function_out_memdep_1_fir_avm_address;
    wire [0:0] fir_function_out_memdep_1_fir_avm_burstcount;
    wire [3:0] fir_function_out_memdep_1_fir_avm_byteenable;
    wire [0:0] fir_function_out_memdep_1_fir_avm_enable;
    wire [0:0] fir_function_out_memdep_1_fir_avm_read;
    wire [0:0] fir_function_out_memdep_1_fir_avm_write;
    wire [31:0] fir_function_out_memdep_1_fir_avm_writedata;
    wire [31:0] fir_function_out_memdep_fir_avm_address;
    wire [0:0] fir_function_out_memdep_fir_avm_burstcount;
    wire [3:0] fir_function_out_memdep_fir_avm_byteenable;
    ...
    wire [31:0] fir_function_out_memdep_fir_avm_writedata;
    wire [63:0] fir_function_out_unnamed_fir5_fir_avm_address;
    wire [0:0] fir_function_out_unnamed_fir5_fir_avm_burstcount;
    wire [7:0] fir_function_out_unnamed_fir5_fir_avm_byteenable;
    ...
    wire [63:0] fir_function_out_unnamed_fir5_fir_avm_writedata;
    wire [63:0] fir_function_out_unnamed_fir6_fir_avm_address;
    wire [0:0] fir_function_out_unnamed_fir6_fir_avm_burstcount;
    wire [7:0] fir_function_out_unnamed_fir6_fir_avm_byteenable;
    ...
    wire [63:0] fir_function_out_unnamed_fir6_fir_avm_writedata;
    ...
    wire [31:0] fir_function_out_unnamed_fir9_fir_avm_address;
    wire [0:0] fir_function_out_unnamed_fir9_fir_avm_burstcount;
    wire [3:0] fir_function_out_unnamed_fir9_fir_avm_byteenable;
    wire [0:0] fir_function_out_unnamed_fir9_fir_avm_enable;
    wire [0:0] fir_function_out_unnamed_fir9_fir_avm_read;
    wire [0:0] fir_function_out_unnamed_fir9_fir_avm_write;
    wire [31:0] fir_function_out_unnamed_fir9_fir_avm_writedata;
    ...
    fir_function thefir_function (
        ...
        .in_memdep_1_fir_avm_readdata(avm_memdep_1_fir_readdata),
        .in_memdep_1_fir_avm_readdatavalid(avm_memdep_1_fir_readdatavalid),
        .in_memdep_1_fir_avm_waitrequest(avm_memdep_1_fir_waitrequest),
        .in_memdep_1_fir_avm_writeack(avm_memdep_1_fir_writeack),
        ...
        .in_unnamed_fir9_fir_avm_readdata(avm_unnamed_fir9_fir_readdata),
        .in_unnamed_fir9_fir_avm_readdatavalid(avm_unnamed_fir9_fir_readdatavalid),
        .in_unnamed_fir9_fir_avm_waitrequest(avm_unnamed_fir9_fir_waitrequest),
        .in_unnamed_fir9_fir_avm_writeack(avm_unnamed_fir9_fir_writeack),
        .in_valid_in(VCC_q),
        ...
        .out_memdep_1_fir_avm_address(fir_function_out_memdep_1_fir_avm_address),
        .out_memdep_1_fir_avm_burstcount(fir_function_out_memdep_1_fir_avm_burstcount),
        .out_memdep_1_fir_avm_byteenable(fir_function_out_memdep_1_fir_avm_byteenable),
        .out_memdep_1_fir_avm_enable(fir_function_out_memdep_1_fir_avm_enable),
        .out_memdep_1_fir_avm_read(fir_function_out_memdep_1_fir_avm_read),
        .out_memdep_1_fir_avm_write(fir_function_out_memdep_1_fir_avm_write),
        .out_memdep_1_fir_avm_writedata(fir_function_out_memdep_1_fir_avm_writedata),
        ...
        .out_unnamed_fir9_fir_avm_address(fir_function_out_unnamed_fir9_fir_avm_address),
        .out_unnamed_fir9_fir_avm_burstcount(fir_function_out_unnamed_fir9_fir_avm_burstcount),
        .out_unnamed_fir9_fir_avm_byteenable(fir_function_out_unnamed_fir9_fir_avm_byteenable),
        .out_unnamed_fir9_fir_avm_enable(fir_function_out_unnamed_fir9_fir_avm_enable),
        .out_unnamed_fir9_fir_avm_read(fir_function_out_unnamed_fir9_fir_avm_read),
        .out_unnamed_fir9_fir_avm_write(fir_function_out_unnamed_fir9_fir_avm_write),
        .out_unnamed_fir9_fir_avm_writedata(fir_function_out_unnamed_fir9_fir_avm_writedata),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    );

    // avm_memdep_1_fir_address(GPOUT,47)
    assign avm_memdep_1_fir_address = fir_function_out_memdep_1_fir_avm_address;

    // avm_memdep_1_fir_burstcount(GPOUT,48)
    assign avm_memdep_1_fir_burstcount = fir_function_out_memdep_1_fir_avm_burstcount;

    // avm_memdep_1_fir_byteenable(GPOUT,49)
    assign avm_memdep_1_fir_byteenable = fir_function_out_memdep_1_fir_avm_byteenable;

    // avm_memdep_1_fir_enable(GPOUT,50)
    assign avm_memdep_1_fir_enable = fir_function_out_memdep_1_fir_avm_enable;

    // avm_memdep_1_fir_read(GPOUT,51)
    assign avm_memdep_1_fir_read = fir_function_out_memdep_1_fir_avm_read;

    // avm_memdep_1_fir_write(GPOUT,52)
    assign avm_memdep_1_fir_write = fir_function_out_memdep_1_fir_avm_write;

    // avm_memdep_1_fir_writedata(GPOUT,53)
    assign avm_memdep_1_fir_writedata = fir_function_out_memdep_1_fir_avm_writedata;

    // avm_memdep_fir_address(GPOUT,54)
    assign avm_memdep_fir_address = fir_function_out_memdep_fir_avm_address;

    // avm_memdep_fir_burstcount(GPOUT,55)
    assign avm_memdep_fir_burstcount = fir_function_out_memdep_fir_avm_burstcount;

    // avm_memdep_fir_byteenable(GPOUT,56)
    assign avm_memdep_fir_byteenable = fir_function_out_memdep_fir_avm_byteenable;

    // avm_memdep_fir_enable(GPOUT,57)
    assign avm_memdep_fir_enable = fir_function_out_memdep_fir_avm_enable;

    // avm_memdep_fir_read(GPOUT,58)
    assign avm_memdep_fir_read = fir_function_out_memdep_fir_avm_read;

    // avm_memdep_fir_write(GPOUT,59)
    assign avm_memdep_fir_write = fir_function_out_memdep_fir_avm_write;

    // avm_memdep_fir_writedata(GPOUT,60)
    assign avm_memdep_fir_writedata = fir_function_out_memdep_fir_avm_writedata;

    // avm_unnamed_fir5_fir_address(GPOUT,61)
    assign avm_unnamed_fir5_fir_address = fir_function_out_unnamed_fir5_fir_avm_address;

    // avm_unnamed_fir5_fir_burstcount(GPOUT,62)
    assign avm_unnamed_fir5_fir_burstcount = fir_function_out_unnamed_fir5_fir_avm_burstcount;

    // avm_unnamed_fir5_fir_byteenable(GPOUT,63)
    assign avm_unnamed_fir5_fir_byteenable = fir_function_out_unnamed_fir5_fir_avm_byteenable;

    // avm_unnamed_fir5_fir_enable(GPOUT,64)
    assign avm_unnamed_fir5_fir_enable = fir_function_out_unnamed_fir5_fir_avm_enable;

    // avm_unnamed_fir5_fir_read(GPOUT,65)
    assign avm_unnamed_fir5_fir_read = fir_function_out_unnamed_fir5_fir_avm_read;

    // avm_unnamed_fir5_fir_write(GPOUT,66)
    assign avm_unnamed_fir5_fir_write = fir_function_out_unnamed_fir5_fir_avm_write;

    // avm_unnamed_fir5_fir_writedata(GPOUT,67)
    assign avm_unnamed_fir5_fir_writedata = fir_function_out_unnamed_fir5_fir_avm_writedata;

    // avm_unnamed_fir6_fir_address(GPOUT,68)
    assign avm_unnamed_fir6_fir_address = fir_function_out_unnamed_fir6_fir_avm_address;

    // avm_unnamed_fir6_fir_burstcount(GPOUT,69)
    assign avm_unnamed_fir6_fir_burstcount = fir_function_out_unnamed_fir6_fir_avm_burstcount;

    // avm_unnamed_fir6_fir_byteenable(GPOUT,70)
    assign avm_unnamed_fir6_fir_byteenable = fir_function_out_unnamed_fir6_fir_avm_byteenable;

    // avm_unnamed_fir6_fir_enable(GPOUT,71)
    assign avm_unnamed_fir6_fir_enable = fir_function_out_unnamed_fir6_fir_avm_enable;

    // avm_unnamed_fir6_fir_read(GPOUT,72)
    assign avm_unnamed_fir6_fir_read = fir_function_out_unnamed_fir6_fir_avm_read;

    // avm_unnamed_fir6_fir_write(GPOUT,73)
    assign avm_unnamed_fir6_fir_write = fir_function_out_unnamed_fir6_fir_avm_write;

    // avm_unnamed_fir6_fir_writedata(GPOUT,74)
    assign avm_unnamed_fir6_fir_writedata = fir_function_out_unnamed_fir6_fir_avm_writedata;

    // avm_unnamed_fir8_fir_address(GPOUT,75)
    assign avm_unnamed_fir8_fir_address = fir_function_out_unnamed_fir8_fir_avm_address;

    // avm_unnamed_fir8_fir_burstcount(GPOUT,76)
    assign avm_unnamed_fir8_fir_burstcount = fir_function_out_unnamed_fir8_fir_avm_burstcount;

    // avm_unnamed_fir8_fir_byteenable(GPOUT,77)
    assign avm_unnamed_fir8_fir_byteenable = fir_function_out_unnamed_fir8_fir_avm_byteenable;

    // avm_unnamed_fir8_fir_enable(GPOUT,78)
    assign avm_unnamed_fir8_fir_enable = fir_function_out_unnamed_fir8_fir_avm_enable;

    // avm_unnamed_fir8_fir_read(GPOUT,79)
    assign avm_unnamed_fir8_fir_read = fir_function_out_unnamed_fir8_fir_avm_read;

    // avm_unnamed_fir8_fir_write(GPOUT,80)
    assign avm_unnamed_fir8_fir_write = fir_function_out_unnamed_fir8_fir_avm_write;

    // avm_unnamed_fir8_fir_writedata(GPOUT,81)
    assign avm_unnamed_fir8_fir_writedata = fir_function_out_unnamed_fir8_fir_avm_writedata;

    // avm_unnamed_fir9_fir_address(GPOUT,82)
    assign avm_unnamed_fir9_fir_address = fir_function_out_unnamed_fir9_fir_avm_address;

    // avm_unnamed_fir9_fir_burstcount(GPOUT,83)
    assign avm_unnamed_fir9_fir_burstcount = fir_function_out_unnamed_fir9_fir_avm_burstcount;

    // avm_unnamed_fir9_fir_byteenable(GPOUT,84)
    assign avm_unnamed_fir9_fir_byteenable = fir_function_out_unnamed_fir9_fir_avm_byteenable;

    // avm_unnamed_fir9_fir_enable(GPOUT,85)
    assign avm_unnamed_fir9_fir_enable = fir_function_out_unnamed_fir9_fir_avm_enable;

    // avm_unnamed_fir9_fir_read(GPOUT,86)
    assign avm_unnamed_fir9_fir_read = fir_function_out_unnamed_fir9_fir_avm_read;

    // avm_unnamed_fir9_fir_write(GPOUT,87)
    assign avm_unnamed_fir9_fir_write = fir_function_out_unnamed_fir9_fir_avm_write;

    // avm_unnamed_fir9_fir_writedata(GPOUT,88)
    assign avm_unnamed_fir9_fir_writedata = fir_function_out_unnamed_fir9_fir_avm_writedata;

    // avst_iord_bl_call_fir_almost_full(GPOUT,89)
    assign avst_iord_bl_call_fir_almost_full = fir_function_out_iord_bl_call_fir_o_fifoalmost_full;

    // avst_iord_bl_call_fir_ready(GPOUT,90)
    assign avst_iord_bl_call_fir_ready = fir_function_out_iord_bl_call_fir_o_fifoready;

    // avst_iowr_bl_return_fir_data(GPOUT,91)
    assign avst_iowr_bl_return_fir_data = fir_function_out_iowr_bl_return_fir_o_fifodata;

    // avst_iowr_bl_return_fir_valid(GPOUT,92)
