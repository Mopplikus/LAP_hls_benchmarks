...
module fir_bb_B2 (
    ...
    wire [0:0] bb_fir_B2_stall_region_out_feedback_out_1;
    wire [0:0] bb_fir_B2_stall_region_out_feedback_valid_out_1;
    ...
    fir_bb_B2_stall_region thebb_fir_B2_stall_region (
        ...
        .out_feedback_out_1(bb_fir_B2_stall_region_out_feedback_out_1),
        .out_feedback_valid_out_1(bb_fir_B2_stall_region_out_feedback_valid_out_1),
    ...
    assign out_feedback_out_1 = bb_fir_B2_stall_region_out_feedback_out_1;

    // feedback_valid_out_1_sync(GPOUT,5)
    assign out_feedback_valid_out_1 = bb_fir_B2_stall_region_out_feedback_valid_out_1;

    // out_iowr_bl_return_fir_o_fifodata(GPOUT,12)
    assign out_iowr_bl_return_fir_o_fifodata = bb_fir_B2_stall_region_out_iowr_bl_return_fir_o_fifodata;

    // out_iowr_bl_return_fir_o_fifovalid(GPOUT,13)
