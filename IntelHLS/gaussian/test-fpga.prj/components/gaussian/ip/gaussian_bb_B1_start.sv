...
module gaussian_bb_B1_start (
    ...
    wire [0:0] bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_stall_out;
    wire [0:0] bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_valid_out;
    wire [0:0] bb_gaussian_B1_start_stall_region_out_feedback_stall_out_1;
    wire [63:0] bb_gaussian_B1_start_stall_region_out_intel_reserved_ffwd_0_0;
    wire [63:0] bb_gaussian_B1_start_stall_region_out_intel_reserved_ffwd_1_0;
    ...
    wire [0:0] bb_gaussian_B1_start_stall_region_out_pipeline_valid_out;
    ...
    gaussian_bb_B1_start_stall_region thebb_gaussian_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_stall_out(bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_valid_out(bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_valid_out),
        .out_feedback_stall_out_1(bb_gaussian_B1_start_stall_region_out_feedback_stall_out_1),
        .out_intel_reserved_ffwd_0_0(bb_gaussian_B1_start_stall_region_out_intel_reserved_ffwd_0_0),
        .out_intel_reserved_ffwd_1_0(bb_gaussian_B1_start_stall_region_out_intel_reserved_ffwd_1_0),
        ...
        .out_pipeline_valid_out(bb_gaussian_B1_start_stall_region_out_pipeline_valid_out),
    ...
    assign out_feedback_stall_out_1 = bb_gaussian_B1_start_stall_region_out_feedback_stall_out_1;

    // out_exiting_stall_out(GPOUT,13)
    assign out_exiting_stall_out = bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,14)
    assign out_exiting_valid_out = bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going36_gaussian1_exiting_valid_out;

    // out_intel_reserved_ffwd_0_0(GPOUT,15)
    assign out_intel_reserved_ffwd_0_0 = bb_gaussian_B1_start_stall_region_out_intel_reserved_ffwd_0_0;

    // out_intel_reserved_ffwd_1_0(GPOUT,16)
    assign out_intel_reserved_ffwd_1_0 = bb_gaussian_B1_start_stall_region_out_intel_reserved_ffwd_1_0;

    // out_iord_bl_call_gaussian_o_fifoalmost_full(GPOUT,17)
    ...
    // out_iord_bl_call_gaussian_o_fifoready(GPOUT,18)
    ...
    assign out_pipeline_valid_out = bb_gaussian_B1_start_stall_region_out_pipeline_valid_out;
