...
module gaussian_bb_B1_start (
    ...
    wire [0:0] bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_stall_out;
    wire [0:0] bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_valid_out;
    ...
    wire [0:0] gaussian_B1_start_merge_out_forked25;
    ...
    gaussian_B1_start_merge thegaussian_B1_start_merge (
        ...
        .out_forked25(gaussian_B1_start_merge_out_forked25),
    ...
    gaussian_bb_B1_start_stall_region thebb_gaussian_B1_start_stall_region (
        ...
        .in_forked25(gaussian_B1_start_merge_out_forked25),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_stall_out(bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_valid_out(bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,16)
    assign out_exiting_valid_out = bb_gaussian_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going23_gaussian2_exiting_valid_out;
