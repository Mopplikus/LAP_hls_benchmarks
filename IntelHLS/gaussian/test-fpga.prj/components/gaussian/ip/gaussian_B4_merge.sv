...
module gaussian_B4_merge (
    ...
    wire [0:0] j_020_mux_s;
    reg [31:0] j_020_mux_q;
    ...
    // j_020_mux(MUX,10)
    assign j_020_mux_s = in_valid_in_0;
    always @(j_020_mux_s or in_j_020_1 or in_j_020_0)
    begin
        unique case (j_020_mux_s)
            1'b0 : j_020_mux_q = in_j_020_1;
            1'b1 : j_020_mux_q = in_j_020_0;
            default : j_020_mux_q = 32'b0;
        endcase
    end

    // out_j_020(GPOUT,12)
    assign out_j_020 = j_020_mux_q;
