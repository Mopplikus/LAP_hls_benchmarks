...
// SystemVerilog created from gaussian_B8_merge
...
module gaussian_B8_merge (
    ...
    wire [0:0] j_035_mux_s;
    reg [31:0] j_035_mux_q;
    ...
    // j_035_mux(MUX,10)
    assign j_035_mux_s = in_valid_in_0;
    always @(j_035_mux_s or in_j_035_1 or in_j_035_0)
    begin
        unique case (j_035_mux_s)
            1'b0 : j_035_mux_q = in_j_035_1;
            1'b1 : j_035_mux_q = in_j_035_0;
            default : j_035_mux_q = 32'b0;
        endcase
    end

    // out_j_035(GPOUT,12)
    assign out_j_035 = j_035_mux_q;
