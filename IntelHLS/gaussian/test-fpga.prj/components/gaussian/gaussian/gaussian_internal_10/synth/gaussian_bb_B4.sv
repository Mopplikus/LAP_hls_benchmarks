...
module gaussian_bb_B4 (
    input wire [0:0] in_c0_exe31341_0,
    ...
    wire [0:0] bb_gaussian_B4_stall_region_out_c0_exe31341;
    ...
    wire [0:0] gaussian_B4_branch_out_valid_out_1;
    wire [0:0] gaussian_B4_merge_out_c0_exe31341;
    ...
    gaussian_B4_branch thegaussian_B4_branch (
        .in_c0_exe31341(bb_gaussian_B4_stall_region_out_c0_exe31341),
        ...
        .out_valid_out_1(gaussian_B4_branch_out_valid_out_1),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    gaussian_bb_B4_stall_region thebb_gaussian_B4_stall_region (
        .in_c0_exe31341(gaussian_B4_merge_out_c0_exe31341),
        .in_stall_in(gaussian_B4_branch_out_stall_out),
        .in_valid_in(gaussian_B4_merge_out_valid_out),
        .out_c0_exe31341(bb_gaussian_B4_stall_region_out_c0_exe31341),
    ...
    gaussian_B4_merge thegaussian_B4_merge (
        .in_c0_exe31341_0(in_c0_exe31341_0),
        .in_stall_in(bb_gaussian_B4_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe31341(gaussian_B4_merge_out_c0_exe31341),
    ...
    assign out_valid_out_1 = gaussian_B4_branch_out_valid_out_1;
