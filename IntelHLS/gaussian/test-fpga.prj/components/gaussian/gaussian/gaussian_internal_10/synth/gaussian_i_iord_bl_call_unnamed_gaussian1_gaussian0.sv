...
// SystemVerilog created from i_iord_bl_call_gaussian_unnamed_gaussian1_gaussian0
...
module gaussian_i_iord_bl_call_unnamed_gaussian1_gaussian0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_gaussian_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_gaussian_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_gaussian_i_fifodata),
