...
module gaussian_B5_branch (
    ...
    // out_c0_exe1108(GPOUT,22)
    assign out_c0_exe1108 = in_c0_exe1108;
    ...
    // out_c0_exe2109(GPOUT,29)
    assign out_c0_exe2109 = in_c0_exe2109;
