...
module gaussian_bb_B6_stall_region (
    ...
    output wire [0:0] out_notcmp3142_pop205,
    ...
    assign bubble_join_stall_entry_q = {in_pop194, in_notcmp3142_pop205, in_memdep_1, in_add40_push173};
    ...
    assign out_add40_push173 = bubble_select_stall_entry_b;
    assign out_notcmp3142_pop205 = bubble_select_stall_entry_d;
