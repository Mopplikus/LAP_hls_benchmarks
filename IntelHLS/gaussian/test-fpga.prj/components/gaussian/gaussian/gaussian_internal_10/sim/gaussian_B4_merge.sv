...
module gaussian_B4_merge (
    ...
    wire [0:0] memdep_phi4_pop725_mux_s;
    reg [0:0] memdep_phi4_pop725_mux_q;
    ...
    // memdep_phi4_pop725_mux(MUX,16)
    assign memdep_phi4_pop725_mux_s = in_valid_in_0;
    always @(memdep_phi4_pop725_mux_s or in_memdep_phi4_pop725_1 or in_memdep_phi4_pop725_0)
    begin
        unique case (memdep_phi4_pop725_mux_s)
            1'b0 : memdep_phi4_pop725_mux_q = in_memdep_phi4_pop725_1;
            1'b1 : memdep_phi4_pop725_mux_q = in_memdep_phi4_pop725_0;
            default : memdep_phi4_pop725_mux_q = 1'b0;
        endcase
    end

    // out_memdep_phi4_pop725(GPOUT,20)
    assign out_memdep_phi4_pop725 = memdep_phi4_pop725_mux_q;
