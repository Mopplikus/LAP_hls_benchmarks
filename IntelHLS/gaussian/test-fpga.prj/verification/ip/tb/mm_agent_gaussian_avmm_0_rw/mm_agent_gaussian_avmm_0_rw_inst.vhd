	component mm_agent_gaussian_avmm_0_rw is
		generic (
			...
			COMPONENT_NAME             : string  := "gaussian";
	...
	end component mm_agent_gaussian_avmm_0_rw;

	u0 : component mm_agent_gaussian_avmm_0_rw
		generic map (
