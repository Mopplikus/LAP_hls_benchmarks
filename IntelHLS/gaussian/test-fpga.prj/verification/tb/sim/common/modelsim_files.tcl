source [file join [file dirname [info script]] ./../../../ip/tb/gaussian_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_gaussian_A_r/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_done/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/gaussian_en_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/main_dpi_controller/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_gaussian_avmm_0_rw/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/gaussian/gaussian/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_cwfsw/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/gaussian_ir_cfan/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_gaussian/sim/common/modelsim_files.tcl]
...
namespace eval tb {
  proc get_design_libraries {} {
    ...
    set libraries [dict merge $libraries [sso_gaussian_A_r::get_design_libraries]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_gaussian_A_r::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_gaussian_A_r/sim/"]]
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [sso_gaussian_A_r::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/sso_gaussian_A_r/sim/"]]
