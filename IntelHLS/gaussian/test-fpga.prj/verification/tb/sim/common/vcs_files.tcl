...
source [file join [file dirname [info script]] ./../../../ip/tb/sso_gaussian_c/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_done/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_gaussian_avmm_0_rw/sim/common/vcs_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/sso_gaussian_A/sim/common/vcs_files.tcl]
...
namespace eval tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_gaussian_c::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_gaussian_c/sim/"]]
    set design_files [dict merge $design_files [cat_done::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/cat_done/sim/"]]
    set design_files [dict merge $design_files [mm_agent_gaussian_avmm_0_rw::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_gaussian_avmm_0_rw/sim/"]]
    ...
    set design_files [dict merge $design_files [sso_gaussian_A::get_common_design_files "$QSYS_SIMDIR/../../ip/tb/sso_gaussian_A/sim/"]]
    return $design_files
  }
  ...
  proc get_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [sso_gaussian_c::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_gaussian_c/sim/"]]
    set design_files [dict merge $design_files [cat_done::get_design_files "$QSYS_SIMDIR/../../ip/tb/cat_done/sim/"]]
    set design_files [dict merge $design_files [mm_agent_gaussian_avmm_0_rw::get_design_files "$QSYS_SIMDIR/../../ip/tb/mm_agent_gaussian_avmm_0_rw/sim/"]]
    ...
    set design_files [dict merge $design_files [sso_gaussian_A::get_design_files "$QSYS_SIMDIR/../../ip/tb/sso_gaussian_A/sim/"]]
