source [file join [file dirname [info script]] ./../../../ip/tb/gaussian_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_gaussian_A_r/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_done/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/gaussian_en_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/main_dpi_controller/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_gaussian_avmm_0_rw/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/gaussian/gaussian/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_cwfsw/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/gaussian_ir_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_gaussian/sim/common/riviera_files.tcl]
