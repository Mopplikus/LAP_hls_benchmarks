...
module kernel_2mm_bb_B4 (
    ...
    wire [0:0] bb_kernel_2mm_B4_stall_region_out_c0_exe121;
    ...
    wire [0:0] kernel_2mm_B4_merge_out_c0_exe121;
    ...
    kernel_2mm_B4_branch thekernel_2mm_B4_branch (
        .in_c0_exe121(bb_kernel_2mm_B4_stall_region_out_c0_exe121),
    ...
    kernel_2mm_bb_B4_stall_region thebb_kernel_2mm_B4_stall_region (
        .in_c0_exe121(kernel_2mm_B4_merge_out_c0_exe121),
        .in_stall_in(kernel_2mm_B4_branch_out_stall_out),
        .in_valid_in(kernel_2mm_B4_merge_out_valid_out),
        .out_c0_exe121(bb_kernel_2mm_B4_stall_region_out_c0_exe121),
    ...
    kernel_2mm_B4_merge thekernel_2mm_B4_merge (
        .in_c0_exe121_0(in_c0_exe121_0),
        .in_stall_in(bb_kernel_2mm_B4_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe121(kernel_2mm_B4_merge_out_c0_exe121),
