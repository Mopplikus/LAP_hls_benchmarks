...
module kernel_2mm_B16_merge (
    ...
    wire [0:0] VCC_q;
    wire [0:0] forked118_mux_s;
    reg [0:0] forked118_mux_q;
    ...
    // forked118_mux(MUX,2)
    assign forked118_mux_s = in_valid_in_0;
    always @(forked118_mux_s or in_forked118_1 or in_forked118_0)
    begin
        unique case (forked118_mux_s)
            1'b0 : forked118_mux_q = in_forked118_1;
            1'b1 : forked118_mux_q = in_forked118_0;
            default : forked118_mux_q = 1'b0;
        endcase
    end

    // out_forked118(GPOUT,8)
    assign out_forked118 = forked118_mux_q;
