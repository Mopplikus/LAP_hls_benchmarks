...
module kernel_2mm_bb_B10_stall_region (
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe620412, in_c0_exe520311, in_c0_exe420210, in_c0_exe22008};
    ...
    // i_llvm_fpga_mem_memdep_1_kernel_2mm0(BLACKBOX,7)@0
    ...
    assign out_c0_exe420210 = sel_for_coalesced_delay_0_b;
    assign out_c0_exe620412 = sel_for_coalesced_delay_0_c;
