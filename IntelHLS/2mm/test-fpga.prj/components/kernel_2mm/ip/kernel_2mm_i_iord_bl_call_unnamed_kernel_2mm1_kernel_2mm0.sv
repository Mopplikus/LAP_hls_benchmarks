...
// SystemVerilog created from i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm1_kernel_2mm0
...
module kernel_2mm_i_iord_bl_call_unnamed_kernel_2mm1_kernel_2mm0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_kernel_2mm_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_kernel_2mm_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_kernel_2mm_i_fifodata),
    ...
    assign out_iord_bl_call_kernel_2mm_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,22)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,24)
    assign out_iord_bl_call_kernel_2mm_o_fifoready = iord_o_fifoready;
    ...
    assign ip_dsdk_adapt_bitselect6_b = iord_o_data[127:64];
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,25)@76
