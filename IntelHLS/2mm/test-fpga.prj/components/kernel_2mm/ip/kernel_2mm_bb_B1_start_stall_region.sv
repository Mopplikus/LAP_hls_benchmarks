...
module kernel_2mm_bb_B1_start_stall_region (
    ...
    output wire [0:0] out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_valid_out,
    output wire [0:0] out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_stall_out,
    ...
    wire [0:0] i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_stall_out;
    wire [0:0] i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_valid_out;
    ...
    wire [0:0] i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_pipeline_valid_out;
    ...
    wire [63:0] bubble_join_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x_q;
    ...
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_wireValid;
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_and0;
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_backStall;
    wire [0:0] SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_V0;
    ...
    wire [0:0] SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_wireValid;
    wire [0:0] SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_backStall;
    wire [0:0] SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_V0;
    ...
    // kernel_2mm_B1_start_merge_reg(BLACKBOX,21)@0
    ...
    // SE_out_kernel_2mm_B1_start_merge_reg(STALLENABLE,59)
    // Valid signal propagation
    assign SE_out_kernel_2mm_B1_start_merge_reg_V0 = SE_out_kernel_2mm_B1_start_merge_reg_wireValid;
    // Backward Stall generation
    assign SE_out_kernel_2mm_B1_start_merge_reg_backStall = i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_o_stall | ~ (SE_out_kernel_2mm_B1_start_merge_reg_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_kernel_2mm_B1_start_merge_reg_wireValid = kernel_2mm_B1_start_merge_reg_out_valid_out;

    // SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5(STALLENABLE,55)
    // Valid signal propagation
    assign SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_V0 = SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_wireValid;
    // Backward Stall generation
    assign SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_backStall = in_stall_in | ~ (SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_and0 = i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_out_valid_out;
    assign SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_wireValid = i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm3_kernel_2mm4_out_valid_out & SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_and0;

    // bubble_join_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x(BITJOIN,49)
    assign bubble_join_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x_q = {i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x_out_o_data_1_tpl, i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x_out_o_data_0_tpl};

    // bubble_select_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x(BITSELECT,50)
    ...
    kernel_2mm_i_llvm_fpga_ffwd_source_i32_unnamed_4_kernel_2mm0 thei_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5 (
        ...
        .in_stall_in(SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_backStall),
    ...
    // SE_out_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x(STALLENABLE,63)
    ...
    assign SE_out_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x_wireStall = ~ (SE_out_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x_consumed1 & SE_out_i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x_or0);
    ...
    // bubble_join_i_llvm_fpga_pop_throttle_i1_throttle_pop_kernel_2mm1(BITJOIN,44)
    ...
    // bubble_select_i_llvm_fpga_pop_throttle_i1_throttle_pop_kernel_2mm1(BITSELECT,45)
    ...
    // i_iord_bl_call_kernel_2mm_unnamed_kernel_2mm2_kernel_2mm2_aunroll_x(BLACKBOX,39)@2
    ...
    // SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_kernel_2mm1(STALLENABLE,57)
    // Valid signal propagation
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_kernel_2mm1(BLACKBOX,14)@1
    // in in_stall_in@20000000
    // out out_data_out@2
    ...
    kernel_2mm_i_llvm_fpga_pop_throttle_i1_throttle_pop_0 thei_llvm_fpga_pop_throttle_i1_throttle_pop_kernel_2mm1 (
        ...
        .in_valid_in(SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_V0),
    ...
    // SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x(STALLENABLE,65)
    // Valid signal propagation
    assign SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_V0 = SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_wireValid;
    // Backward Stall generation
    assign SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_backStall = i_llvm_fpga_pop_throttle_i1_throttle_pop_kernel_2mm1_out_stall_out | ~ (SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_wireValid = i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_o_valid;

    // i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x(BLACKBOX,40)@1
    // in in_i_stall@20000000
    // out out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_stall_out@20000000
    // out out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_valid_out@20000000
    // out out_o_stall@20000000
    ...
    kernel_2mm_i_sfc_s_c0_in_wt_entry_s_c0_enter13_kernel_2mm0 thei_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x (
        .in_i_stall(SE_out_i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_backStall),
        .in_i_valid(SE_out_kernel_2mm_B1_start_merge_reg_V0),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_unnamed_kernel_2mm0_0_tpl(GND_q),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_stall_out(i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_valid_out(i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_valid_out),
        ...
        .out_pipeline_valid_out(i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_pipeline_valid_out),
        .out_c0_exit_0_tpl(),
        .out_c0_exit_1_tpl(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_valid_out = i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_valid_out;
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_stall_out = i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going48_kernel_2mm1_exiting_stall_out;
    ...
    assign out_pipeline_valid_out = i_sfc_s_c0_in_wt_entry_kernel_2mms_c0_enter13_kernel_2mm0_aunroll_x_out_pipeline_valid_out;
    ...
    assign out_valid_out = SE_out_i_llvm_fpga_ffwd_source_i32_unnamed_kernel_2mm4_kernel_2mm5_V0;
