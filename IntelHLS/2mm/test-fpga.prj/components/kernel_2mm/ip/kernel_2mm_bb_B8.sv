...
module kernel_2mm_bb_B8 (
    input wire [0:0] in_c0_exe42029_0,
    ...
    wire [0:0] bb_kernel_2mm_B8_stall_region_out_c0_exe42029;
    ...
    wire [0:0] kernel_2mm_B8_merge_out_c0_exe42029;
    ...
    kernel_2mm_B8_branch thekernel_2mm_B8_branch (
        .in_c0_exe42029(bb_kernel_2mm_B8_stall_region_out_c0_exe42029),
    ...
    kernel_2mm_bb_B8_stall_region thebb_kernel_2mm_B8_stall_region (
        .in_c0_exe42029(kernel_2mm_B8_merge_out_c0_exe42029),
        .in_stall_in(kernel_2mm_B8_branch_out_stall_out),
        .in_valid_in(kernel_2mm_B8_merge_out_valid_out),
        .out_c0_exe42029(bb_kernel_2mm_B8_stall_region_out_c0_exe42029),
    ...
    kernel_2mm_B8_merge thekernel_2mm_B8_merge (
        .in_c0_exe42029_0(in_c0_exe42029_0),
        .in_stall_in(bb_kernel_2mm_B8_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe42029(kernel_2mm_B8_merge_out_c0_exe42029),
