...
module kernel_2mm_bb_B1_start (
    ...
    wire [0:0] bb_kernel_2mm_B1_start_stall_region_out_almost_empty_out;
    wire [0:0] bb_kernel_2mm_B1_start_stall_region_out_empty_out;
    ...
    wire [0:0] kernel_2mm_B1_start_merge_out_almost_empty_out;
    wire [0:0] kernel_2mm_B1_start_merge_out_empty_out;
    ...
    kernel_2mm_B1_start_branch thekernel_2mm_B1_start_branch (
        .in_almost_empty_in(bb_kernel_2mm_B1_start_stall_region_out_almost_empty_out),
        .in_empty_in(bb_kernel_2mm_B1_start_stall_region_out_empty_out),
    ...
    kernel_2mm_B1_start_merge thekernel_2mm_B1_start_merge (
        ...
        .out_almost_empty_out(kernel_2mm_B1_start_merge_out_almost_empty_out),
        .out_empty_out(kernel_2mm_B1_start_merge_out_empty_out),
    ...
    kernel_2mm_bb_B1_start_stall_region thebb_kernel_2mm_B1_start_stall_region (
        .in_almost_empty_in(kernel_2mm_B1_start_merge_out_almost_empty_out),
        .in_empty_in(kernel_2mm_B1_start_merge_out_empty_out),
        ...
        .out_almost_empty_out(bb_kernel_2mm_B1_start_stall_region_out_almost_empty_out),
        .out_empty_out(bb_kernel_2mm_B1_start_stall_region_out_empty_out),
    ...
    // out_iord_bl_call_kernel_2mm_o_fifoalmost_full(GPOUT,15)
    ...
    // out_iord_bl_call_kernel_2mm_o_fifoready(GPOUT,16)
