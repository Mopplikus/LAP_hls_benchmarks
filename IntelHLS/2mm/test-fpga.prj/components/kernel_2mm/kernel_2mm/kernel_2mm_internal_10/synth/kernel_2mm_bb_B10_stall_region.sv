...
module kernel_2mm_bb_B10_stall_region (
    ...
    input wire [31:0] in_c0_exe12028,
    input wire [0:0] in_c0_exe420510,
    input wire [63:0] in_c0_exe520611,
    input wire [0:0] in_c0_exe620712,
    input wire [0:0] in_empty_in,
    input wire [0:0] in_valid_in,
    output wire [0:0] out_almost_empty_out,
    output wire [0:0] out_c0_exe420510,
    output wire [0:0] out_c0_exe620712,
    ...
    wire [0:0] GND_q;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out;
    wire [31:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_address;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_burstcount;
    wire [3:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_byteenable;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_enable;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_read;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_write;
    wire [31:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_writedata;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_stall;
    wire [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid;
    ...
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg0_q;
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg1_q;
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg1_q;
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg0_q;
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg1_q;
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg0_q;
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid_reg1_q;
    reg [0:0] i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid_reg0_q;
    ...
    begin
        ...
        begin
            stall_entry_o7_reg0_q <= $unsigned(in_c0_exe620712);
        end
    end

    // stall_entry_o7_reg1(REG,74)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    begin
        ...
        begin
            stall_entry_o6_reg0_q <= $unsigned(in_c0_exe520611);
        end
    end

    // stall_entry_o6_reg1(REG,72)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    begin
        ...
        begin
            stall_entry_o5_reg0_q <= $unsigned(in_c0_exe420510);
        end
    end

    // stall_entry_o5_reg1(REG,70)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    begin
        ...
        begin
            stall_entry_o4_reg0_q <= $unsigned(in_c0_exe12028);
        end
    end

    // stall_entry_o4_reg1(REG,68)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg0(REG,79)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg0_q <= $unsigned(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out);
        end
    end

    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg1(REG,78)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg1_q <= $unsigned(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg0_q);
        end
    end

    // join_for_coalesced_delay_0(BITJOIN,20)
    assign join_for_coalesced_delay_0_q = {bubble_select_stall_entry_e, bubble_select_stall_entry_c};

    // coalesced_delay_0_fifo_i_stall_reg0(REG,84)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // coalesced_delay_0_fifo_i_stall_reg1(REG,85)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // coalesced_delay_0_fifo_o_almost_empty_reg0(REG,93)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // coalesced_delay_0_fifo_o_almost_empty_reg1(REG,92)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg0(REG,81)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg0_q <= $unsigned(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out);
        end
    end

    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg1(REG,80)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg1_q <= $unsigned(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg0_q);
        end
    end

    // coalesced_delay_0_fifo_o_empty_reg0(REG,91)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // coalesced_delay_0_fifo_o_empty_reg1(REG,90)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid_reg0(REG,83)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid_reg0_q <= $unsigned(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid);
        end
    end

    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid_reg1(REG,82)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid_reg1_q <= $unsigned(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid_reg0_q);
        end
    end

    // coalesced_delay_0_fifo_o_valid_reg0(REG,87)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // coalesced_delay_0_fifo_o_valid_reg1(REG,86)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0(STALLENABLE,52)
    // Sync
    assign merged_in_SE_sel_for_coalesced_delay_0_temp_back_stall = in_stall_in;
    assign merged_in_SE_sel_for_coalesced_delay_0_can_fast_read = ~ ((coalesced_delay_0_fifo_o_almost_empty_reg1_q | i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out_reg1_q));
    assign merged_in_SE_sel_for_coalesced_delay_0_can_slow_read = ~ ((coalesced_delay_0_fifo_o_empty_reg1_q | i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out_reg1_q));
    ...
    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg0(REG,76)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg0_q <= $unsigned(merged_in_SE_sel_for_coalesced_delay_0_backStall);
        end
    end

    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg1(REG,77)
    always @ (posedge clock)
    begin
        if (0)
        begin
        ...
        begin
            i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg1_q <= $unsigned(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg0_q);
        end
    end

    // stall_entry_frontAlmostEmpty_reg0(REG,67)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // stall_entry_frontAlmostEmpty_reg1(REG,66)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // stall_entry_frontEmpty_reg0(REG,65)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // stall_entry_frontEmpty_reg1(REG,64)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // stall_entry_frontValid_reg0(REG,63)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // stall_entry_frontValid_reg1(REG,62)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_bubble_join_stall_entry(STALLENABLE,51)
    // Desync
    assign merged_in_SE_bubble_join_stall_entry_temp_back_stall = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_stall | coalesced_delay_0_fifo_o_stall;
    ...
    // i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x(BLACKBOX,16)@0
    ...
    // out out_o_valid@33
    // out out_c0_exit173_0_tpl@33
    kernel_2mm_i_sfc_s_c0_in_for_cond_cleanu0000enter170_kernel_2mm2 thei_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x (
        .in_almost_empty_in(merged_in_SE_bubble_join_stall_entry_V4),
        .in_empty_in(merged_in_SE_bubble_join_stall_entry_V2),
        .in_flush(in_flush),
        .in_i_stall(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_in_i_stall_reg1_q),
        ...
        .in_c0_eni2169_0_tpl(GND_q),
        .in_c0_eni2169_1_tpl(bubble_select_stall_entry_b),
        .in_c0_eni2169_2_tpl(bubble_select_stall_entry_d),
        .out_almost_empty_out(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_almost_empty_out),
        .out_empty_out(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_empty_out),
        .out_memdep_1_kernel_2mm_avm_address(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_address),
        .out_memdep_1_kernel_2mm_avm_burstcount(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_burstcount),
        .out_memdep_1_kernel_2mm_avm_byteenable(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_byteenable),
        .out_memdep_1_kernel_2mm_avm_enable(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_enable),
        .out_memdep_1_kernel_2mm_avm_read(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_read),
        .out_memdep_1_kernel_2mm_avm_write(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_write),
        .out_memdep_1_kernel_2mm_avm_writedata(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_writedata),
        .out_o_stall(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_stall),
        .out_o_valid(i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_o_valid),
        .out_c0_exit173_0_tpl(),
        .clock(clock),
        .resetn(resetn)
    );

    // ext_sig_sync_out(GPOUT,6)
    assign out_memdep_1_kernel_2mm_avm_address = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_address;
    assign out_memdep_1_kernel_2mm_avm_enable = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_enable;
    assign out_memdep_1_kernel_2mm_avm_read = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_read;
    assign out_memdep_1_kernel_2mm_avm_write = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_write;
    assign out_memdep_1_kernel_2mm_avm_writedata = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_writedata;
    assign out_memdep_1_kernel_2mm_avm_byteenable = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_byteenable;
    assign out_memdep_1_kernel_2mm_avm_burstcount = i_sfc_s_c0_in_for_cond_cleanup54_kernel_2mms_c0_enter170_kernel_2mm2_aunroll_x_out_memdep_1_kernel_2mm_avm_burstcount;

    // stall_entry_frontStall_reg0(REG,60)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // stall_entry_frontStall_reg1(REG,61)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0_V0_sync_valid_reg0(REG,59)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0_V0_sync_valid_reg1(REG,58)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0_V0_sync_valid_reg2(REG,57)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0_V0_sync_valid_reg3(REG,56)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0_V0_sync_valid_reg4(REG,55)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0_V0_sync_valid_reg5(REG,54)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // merged_in_SE_sel_for_coalesced_delay_0_V0_sync_valid_reg6(REG,53)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // coalesced_delay_0_fifo_o_data_reg0(REG,89)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // coalesced_delay_0_fifo_o_data_reg1(REG,88)
    always @ (posedge clock)
    begin
        if (0)
        begin
    ...
    // bubble_join_coalesced_delay_0_fifo(BITJOIN,29)
    assign bubble_join_coalesced_delay_0_fifo_q = coalesced_delay_0_fifo_o_data_reg1_q;

    // bubble_select_coalesced_delay_0_fifo(BITSELECT,30)
    ...
    assign out_c0_exe420510 = sel_for_coalesced_delay_0_b;
    assign out_c0_exe620712 = sel_for_coalesced_delay_0_c;
