...
module kernel_2mm_bb_B3_stall_region (
    ...
    input wire [63:0] in_c0_exe21371,
    input wire [0:0] in_c0_exe51404,
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe51404, in_c0_exe21371};
    ...
    assign out_c0_exe21371 = bubble_select_stall_entry_b;
    assign out_c0_exe51404 = bubble_select_stall_entry_c;
