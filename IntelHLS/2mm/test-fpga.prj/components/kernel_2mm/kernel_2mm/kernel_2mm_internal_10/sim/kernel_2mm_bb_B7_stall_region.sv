...
module kernel_2mm_bb_B7_stall_region (
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe52555, in_c0_exe22522};
    ...
    assign out_c0_exe22522 = bubble_select_stall_entry_b;
    assign out_c0_exe52555 = bubble_select_stall_entry_c;
