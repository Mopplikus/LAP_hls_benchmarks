...
module kernel_2mm_bb_B5 (
    ...
    wire [0:0] bb_kernel_2mm_B5_stall_region_out_almost_empty_out;
    wire [63:0] bb_kernel_2mm_B5_stall_region_out_c0_exe11332;
    wire [0:0] bb_kernel_2mm_B5_stall_region_out_c0_exe51375;
    wire [0:0] bb_kernel_2mm_B5_stall_region_out_c0_exe71397;
    wire [0:0] bb_kernel_2mm_B5_stall_region_out_empty_out;
    ...
    wire [63:0] kernel_2mm_B5_branch_out_c0_exe11332;
    wire [0:0] kernel_2mm_B5_branch_out_c0_exe51375;
    wire [0:0] kernel_2mm_B5_branch_out_stall_out;
    wire [0:0] kernel_2mm_B5_branch_out_valid_out_0;
    wire [0:0] kernel_2mm_B5_merge_out_almost_empty_out;
    wire [63:0] kernel_2mm_B5_merge_out_c0_exe11332;
    wire [31:0] kernel_2mm_B5_merge_out_c0_exe21343;
    wire [0:0] kernel_2mm_B5_merge_out_c0_exe51375;
    wire [63:0] kernel_2mm_B5_merge_out_c0_exe61386;
    wire [0:0] kernel_2mm_B5_merge_out_c0_exe71397;
    wire [0:0] kernel_2mm_B5_merge_out_empty_out;
    wire [0:0] kernel_2mm_B5_merge_out_stall_out_0;
    wire [0:0] kernel_2mm_B5_merge_out_valid_out;
    reg [0:0] rst_sync_rst_sclrn;


    // kernel_2mm_B5_merge(BLACKBOX,16)
    kernel_2mm_B5_merge thekernel_2mm_B5_merge (
        .in_c0_exe11332_0(in_c0_exe11332_0),
        .in_c0_exe21343_0(in_c0_exe21343_0),
        .in_c0_exe51375_0(in_c0_exe51375_0),
        .in_c0_exe61386_0(in_c0_exe61386_0),
        .in_c0_exe71397_0(in_c0_exe71397_0),
        .in_stall_in(bb_kernel_2mm_B5_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_almost_empty_out(kernel_2mm_B5_merge_out_almost_empty_out),
        .out_c0_exe11332(kernel_2mm_B5_merge_out_c0_exe11332),
        .out_c0_exe21343(kernel_2mm_B5_merge_out_c0_exe21343),
        .out_c0_exe51375(kernel_2mm_B5_merge_out_c0_exe51375),
        .out_c0_exe61386(kernel_2mm_B5_merge_out_c0_exe61386),
        .out_c0_exe71397(kernel_2mm_B5_merge_out_c0_exe71397),
        .out_empty_out(kernel_2mm_B5_merge_out_empty_out),
    ...
    kernel_2mm_bb_B5_stall_region thebb_kernel_2mm_B5_stall_region (
        .in_almost_empty_in(kernel_2mm_B5_merge_out_almost_empty_out),
        .in_c0_exe11332(kernel_2mm_B5_merge_out_c0_exe11332),
        .in_c0_exe21343(kernel_2mm_B5_merge_out_c0_exe21343),
        .in_c0_exe51375(kernel_2mm_B5_merge_out_c0_exe51375),
        .in_c0_exe61386(kernel_2mm_B5_merge_out_c0_exe61386),
        .in_c0_exe71397(kernel_2mm_B5_merge_out_c0_exe71397),
        .in_empty_in(kernel_2mm_B5_merge_out_empty_out),
        .in_flush(in_flush),
        ...
        .out_almost_empty_out(bb_kernel_2mm_B5_stall_region_out_almost_empty_out),
        .out_c0_exe11332(bb_kernel_2mm_B5_stall_region_out_c0_exe11332),
        .out_c0_exe51375(bb_kernel_2mm_B5_stall_region_out_c0_exe51375),
        .out_c0_exe71397(bb_kernel_2mm_B5_stall_region_out_c0_exe71397),
        .out_empty_out(bb_kernel_2mm_B5_stall_region_out_empty_out),
    ...
    // kernel_2mm_B5_branch(BLACKBOX,15)
    kernel_2mm_B5_branch thekernel_2mm_B5_branch (
        .in_almost_empty_in(bb_kernel_2mm_B5_stall_region_out_almost_empty_out),
        .in_c0_exe11332(bb_kernel_2mm_B5_stall_region_out_c0_exe11332),
        .in_c0_exe51375(bb_kernel_2mm_B5_stall_region_out_c0_exe51375),
        .in_c0_exe71397(bb_kernel_2mm_B5_stall_region_out_c0_exe71397),
        .in_empty_in(bb_kernel_2mm_B5_stall_region_out_empty_out),
        .in_stall_in_0(in_stall_in_0),
        .in_valid_in(bb_kernel_2mm_B5_stall_region_out_valid_out),
        .out_c0_exe11332(kernel_2mm_B5_branch_out_c0_exe11332),
        .out_c0_exe51375(kernel_2mm_B5_branch_out_c0_exe51375),
