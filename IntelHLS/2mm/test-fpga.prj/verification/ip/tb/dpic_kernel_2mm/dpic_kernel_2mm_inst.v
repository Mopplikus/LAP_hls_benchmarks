	dpic_kernel_2mm u0 (
		...
		.agent_busy                       (_connected_to_agent_busy_),                       //   input,   width = 1,                       agent_busy.conduit
		.read_implicit_streams            (_connected_to_read_implicit_streams_),            //  output,   width = 1,            read_implicit_streams.conduit
		.readback_from_agents             (_connected_to_readback_from_agents_),             //  output,   width = 1,             readback_from_agents.conduit
