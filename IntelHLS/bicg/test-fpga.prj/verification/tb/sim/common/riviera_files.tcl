source [file join [file dirname [info script]] ./../../../ip/tb/mm_agent_bicg_avmm_0_rw/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/bicg/bicg/sim/common/riviera_files.tcl]
...
source [file join [file dirname [info script]] ./../../../ip/tb/sso_bicg_s/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/clock_reset/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_bicg_q/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_bicg_r/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/bicg_en_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_bicg_A/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_bicg/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sp_cstart/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_bicg_p/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/bicg_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/bicg_ir_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/main_dpi_controller/sim/common/riviera_files.tcl]

namespace eval tb {
  proc get_design_libraries {} {
    set libraries [dict create]
    set libraries [dict merge $libraries [mm_agent_bicg_avmm_0_rw::get_design_libraries]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [mm_agent_bicg_avmm_0_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_bicg_avmm_0_rw/sim/"]]
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [mm_agent_bicg_avmm_0_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/tb/mm_agent_bicg_avmm_0_rw/sim/"]]
