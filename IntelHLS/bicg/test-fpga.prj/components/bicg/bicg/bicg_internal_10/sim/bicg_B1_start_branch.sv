...
// SystemVerilog created from bicg_B1_start_branch
...
module bicg_B1_start_branch (
    ...
    wire [7:0] bicg_B1_start_branch_data_pack_q;
    wire [6:0] c_i7_01_q;
    ...
    assign element_extension0_q = {c_i7_01_q, in_memdep_phi_pop7};

    // bicg_B1_start_branch_data_pack(BITJOIN,3)
    assign bicg_B1_start_branch_data_pack_q = element_extension0_q;

    // adapt_scalar_trunc2(ROUND,2)
    assign adapt_scalar_trunc2_in = bicg_B1_start_branch_data_pack_q[0:0];
    assign adapt_scalar_trunc2_q = adapt_scalar_trunc2_in[0:0];

    // out_memdep_phi_pop7(GPOUT,12)
    assign out_memdep_phi_pop7 = adapt_scalar_trunc2_q;
