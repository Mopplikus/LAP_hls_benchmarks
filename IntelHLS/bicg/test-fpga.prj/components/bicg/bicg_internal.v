...
(
   ...
   logic local_avm_aspace68_enable [1][1];
   logic local_avm_aspace68_read [1][1];
   logic local_avm_aspace68_write [1][1];
   logic [31:0] local_avm_aspace68_address [1][1];
   logic [31:0] local_avm_aspace68_writedata [1][1];
   logic [3:0] local_avm_aspace68_byteenable [1][1];
   logic local_avm_aspace68_waitrequest [1][1];
   logic [31:0] local_avm_aspace68_readdata [1][1];
   logic local_avm_aspace68_readdatavalid [1][1];
   logic local_avm_aspace68_burstcount [1][1];
   logic local_avm_aspace68_writeack [1][1];
   ...
   (
      ...
      .done(done),
      .stall(stall),
      // AVM avm_unnamed_bicg6_bicg
      .avm_unnamed_bicg6_bicg_enable(local_avm_aspace64_enable[0][0]),
      .avm_unnamed_bicg6_bicg_read(local_avm_aspace64_read[0][0]),
      .avm_unnamed_bicg6_bicg_write(local_avm_aspace64_write[0][0]),
      .avm_unnamed_bicg6_bicg_address(local_avm_aspace64_address[0][0]),
      .avm_unnamed_bicg6_bicg_writedata(local_avm_aspace64_writedata[0][0]),
      .avm_unnamed_bicg6_bicg_byteenable(local_avm_aspace64_byteenable[0][0]),
      .avm_unnamed_bicg6_bicg_waitrequest(local_avm_aspace64_waitrequest[0][0]),
      .avm_unnamed_bicg6_bicg_readdata(local_avm_aspace64_readdata[0][0]),
      .avm_unnamed_bicg6_bicg_readdatavalid(local_avm_aspace64_readdatavalid[0][0]),
      .avm_unnamed_bicg6_bicg_burstcount(local_avm_aspace64_burstcount[0][0]),
      .avm_unnamed_bicg6_bicg_writeack(local_avm_aspace64_writeack[0][0]),
      // AVM avm_memdep_1_bicg
      .avm_memdep_1_bicg_enable(local_avm_aspace65_enable[0][0]),
      .avm_memdep_1_bicg_read(local_avm_aspace65_read[0][0]),
      .avm_memdep_1_bicg_write(local_avm_aspace65_write[0][0]),
      .avm_memdep_1_bicg_address(local_avm_aspace65_address[0][0]),
      .avm_memdep_1_bicg_writedata(local_avm_aspace65_writedata[0][0]),
      .avm_memdep_1_bicg_byteenable(local_avm_aspace65_byteenable[0][0]),
      .avm_memdep_1_bicg_waitrequest(local_avm_aspace65_waitrequest[0][0]),
      .avm_memdep_1_bicg_readdata(local_avm_aspace65_readdata[0][0]),
      .avm_memdep_1_bicg_readdatavalid(local_avm_aspace65_readdatavalid[0][0]),
      .avm_memdep_1_bicg_burstcount(local_avm_aspace65_burstcount[0][0]),
      .avm_memdep_1_bicg_writeack(local_avm_aspace65_writeack[0][0]),
      // AVM avm_unnamed_bicg7_bicg
      .avm_unnamed_bicg7_bicg_enable(local_avm_aspace65_enable[0][1]),
      .avm_unnamed_bicg7_bicg_read(local_avm_aspace65_read[0][1]),
      .avm_unnamed_bicg7_bicg_write(local_avm_aspace65_write[0][1]),
      .avm_unnamed_bicg7_bicg_address(local_avm_aspace65_address[0][1]),
      .avm_unnamed_bicg7_bicg_writedata(local_avm_aspace65_writedata[0][1]),
      .avm_unnamed_bicg7_bicg_byteenable(local_avm_aspace65_byteenable[0][1]),
      .avm_unnamed_bicg7_bicg_waitrequest(local_avm_aspace65_waitrequest[0][1]),
      .avm_unnamed_bicg7_bicg_readdata(local_avm_aspace65_readdata[0][1]),
      .avm_unnamed_bicg7_bicg_readdatavalid(local_avm_aspace65_readdatavalid[0][1]),
      .avm_unnamed_bicg7_bicg_burstcount(local_avm_aspace65_burstcount[0][1]),
      .avm_unnamed_bicg7_bicg_writeack(local_avm_aspace65_writeack[0][1]),
      // AVM avm_memdep_bicg
      .avm_memdep_bicg_enable(local_avm_aspace66_enable[0][0]),
      .avm_memdep_bicg_read(local_avm_aspace66_read[0][0]),
      .avm_memdep_bicg_write(local_avm_aspace66_write[0][0]),
      .avm_memdep_bicg_address(local_avm_aspace66_address[0][0]),
      .avm_memdep_bicg_writedata(local_avm_aspace66_writedata[0][0]),
      .avm_memdep_bicg_byteenable(local_avm_aspace66_byteenable[0][0]),
      .avm_memdep_bicg_waitrequest(local_avm_aspace66_waitrequest[0][0]),
      .avm_memdep_bicg_readdata(local_avm_aspace66_readdata[0][0]),
      .avm_memdep_bicg_readdatavalid(local_avm_aspace66_readdatavalid[0][0]),
      .avm_memdep_bicg_burstcount(local_avm_aspace66_burstcount[0][0]),
      .avm_memdep_bicg_writeack(local_avm_aspace66_writeack[0][0]),
      // AVM avm_unnamed_bicg3_bicg
      .avm_unnamed_bicg3_bicg_enable(local_avm_aspace66_enable[0][1]),
      .avm_unnamed_bicg3_bicg_read(local_avm_aspace66_read[0][1]),
      .avm_unnamed_bicg3_bicg_write(local_avm_aspace66_write[0][1]),
      .avm_unnamed_bicg3_bicg_address(local_avm_aspace66_address[0][1]),
      .avm_unnamed_bicg3_bicg_writedata(local_avm_aspace66_writedata[0][1]),
      .avm_unnamed_bicg3_bicg_byteenable(local_avm_aspace66_byteenable[0][1]),
      .avm_unnamed_bicg3_bicg_waitrequest(local_avm_aspace66_waitrequest[0][1]),
      .avm_unnamed_bicg3_bicg_readdata(local_avm_aspace66_readdata[0][1]),
      .avm_unnamed_bicg3_bicg_readdatavalid(local_avm_aspace66_readdatavalid[0][1]),
      .avm_unnamed_bicg3_bicg_burstcount(local_avm_aspace66_burstcount[0][1]),
      .avm_unnamed_bicg3_bicg_writeack(local_avm_aspace66_writeack[0][1]),
      // AVM avm_unnamed_bicg8_bicg
      .avm_unnamed_bicg8_bicg_enable(local_avm_aspace67_enable[0][0]),
      .avm_unnamed_bicg8_bicg_read(local_avm_aspace67_read[0][0]),
      .avm_unnamed_bicg8_bicg_write(local_avm_aspace67_write[0][0]),
      .avm_unnamed_bicg8_bicg_address(local_avm_aspace67_address[0][0]),
      .avm_unnamed_bicg8_bicg_writedata(local_avm_aspace67_writedata[0][0]),
      .avm_unnamed_bicg8_bicg_byteenable(local_avm_aspace67_byteenable[0][0]),
      .avm_unnamed_bicg8_bicg_waitrequest(local_avm_aspace67_waitrequest[0][0]),
      .avm_unnamed_bicg8_bicg_readdata(local_avm_aspace67_readdata[0][0]),
      .avm_unnamed_bicg8_bicg_readdatavalid(local_avm_aspace67_readdatavalid[0][0]),
      .avm_unnamed_bicg8_bicg_burstcount(local_avm_aspace67_burstcount[0][0]),
      .avm_unnamed_bicg8_bicg_writeack(local_avm_aspace67_writeack[0][0]),
      // AVM avm_unnamed_bicg5_bicg
      .avm_unnamed_bicg5_bicg_enable(local_avm_aspace68_enable[0][0]),
      .avm_unnamed_bicg5_bicg_read(local_avm_aspace68_read[0][0]),
      .avm_unnamed_bicg5_bicg_write(local_avm_aspace68_write[0][0]),
      .avm_unnamed_bicg5_bicg_address(local_avm_aspace68_address[0][0]),
      .avm_unnamed_bicg5_bicg_writedata(local_avm_aspace68_writedata[0][0]),
      .avm_unnamed_bicg5_bicg_byteenable(local_avm_aspace68_byteenable[0][0]),
      .avm_unnamed_bicg5_bicg_waitrequest(local_avm_aspace68_waitrequest[0][0]),
      .avm_unnamed_bicg5_bicg_readdata(local_avm_aspace68_readdata[0][0]),
      .avm_unnamed_bicg5_bicg_readdatavalid(local_avm_aspace68_readdatavalid[0][0]),
      .avm_unnamed_bicg5_bicg_burstcount(local_avm_aspace68_burstcount[0][0]),
      .avm_unnamed_bicg5_bicg_writeack(local_avm_aspace68_writeack[0][0])
   );
   ...
   begin:local_mem_system_aspace67
      ...
      logic local_icm_arb_write [1][1];
      logic local_icm_arb_burstcount [1][1];
      logic [4:0] local_icm_arb_address [1][1];
      logic [31:0] local_icm_arb_writedata [1][1];
      logic [3:0] local_icm_arb_byteenable [1][1];
      logic local_icm_arb_stall [1][1];
      logic local_icm_wrp_ack [1][1];
