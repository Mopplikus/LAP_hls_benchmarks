	component sso_stencil_2d_filter is
		generic (
			COMPONENT_NAME                  : string  := "stencil_2d";
			INTERFACE_NAME                  : string  := "filter";
	...
	end component sso_stencil_2d_filter;

	u0 : component sso_stencil_2d_filter
		generic map (
