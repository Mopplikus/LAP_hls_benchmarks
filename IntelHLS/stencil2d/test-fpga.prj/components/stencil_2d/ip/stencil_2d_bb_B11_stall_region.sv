...
// SystemVerilog created from bb_stencil_2d_B11_stall_region
...
module stencil_2d_bb_B11_stall_region (
    ...
    input wire [31:0] in_c0_exe22581,
    input wire [31:0] in_c0_exe42603,
    input wire [0:0] in_c0_exe52616,
    input wire [0:0] in_c0_exe62628,
    input wire [31:0] in_c0_exe726310,
    ...
    wire [32:0] i_add51_stencil_2d0_a;
    wire [32:0] i_add51_stencil_2d0_b;
    logic [32:0] i_add51_stencil_2d0_o;
    wire [32:0] i_add51_stencil_2d0_q;
    wire [1:0] i_arrayidx535_stencil_2d2_vt_const_1_q;
    wire [63:0] i_arrayidx535_stencil_2d2_vt_join_q;
    wire [61:0] i_arrayidx535_stencil_2d2_vt_select_63_b;
    wire [31:0] i_idxprom52_stencil_2d1_vt_const_63_q;
    wire [63:0] i_idxprom52_stencil_2d1_vt_join_q;
    wire [31:0] i_idxprom52_stencil_2d1_vt_select_31_b;
    ...
    wire [31:0] bgTrunc_i_add51_stencil_2d0_sel_x_b;
    wire [12:0] i_arrayidx535_stencil_2d0_add_x_a;
    wire [12:0] i_arrayidx535_stencil_2d0_add_x_b;
    logic [12:0] i_arrayidx535_stencil_2d0_add_x_o;
    wire [12:0] i_arrayidx535_stencil_2d0_add_x_q;
    wire [63:0] i_arrayidx535_stencil_2d0_append_upper_bits_x_q;
    wire [9:0] i_arrayidx535_stencil_2d0_narrow_x_b;
    wire [11:0] i_arrayidx535_stencil_2d0_shift_join_x_q;
    wire [11:0] i_arrayidx535_stencil_2d0_dupName_0_trunc_sel_x_b;
    wire [11:0] i_arrayidx535_stencil_2d0_dupName_2_trunc_sel_x_b;
    wire [63:0] i_idxprom52_stencil_2d1_sel_x_b;
    wire [51:0] i_arrayidx535_stencil_2d0_upper_bits_x_merged_bit_select_b;
    wire [11:0] i_arrayidx535_stencil_2d0_upper_bits_x_merged_bit_select_c;
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe726310, in_c0_exe62628, in_c0_exe52616, in_c0_exe42603, in_c0_exe22581};
    ...
    // i_arrayidx535_stencil_2d0_upper_bits_x_merged_bit_select(BITSELECT,43)@0
    assign i_arrayidx535_stencil_2d0_upper_bits_x_merged_bit_select_b = c_stencil_2d_sol_pmem_q[63:12];
    assign i_arrayidx535_stencil_2d0_upper_bits_x_merged_bit_select_c = c_stencil_2d_sol_pmem_q[11:0];

    // i_idxprom52_stencil_2d1_vt_const_63(CONSTANT,14)
    assign i_idxprom52_stencil_2d1_vt_const_63_q = $unsigned(32'b00000000000000000000000000000000);

    // i_add51_stencil_2d0(ADD,9)@0
    assign i_add51_stencil_2d0_a = {1'b0, bubble_select_stall_entry_f};
    assign i_add51_stencil_2d0_b = {1'b0, bubble_select_stall_entry_c};
    assign i_add51_stencil_2d0_o = $unsigned(i_add51_stencil_2d0_a) + $unsigned(i_add51_stencil_2d0_b);
    assign i_add51_stencil_2d0_q = i_add51_stencil_2d0_o[32:0];

    // bgTrunc_i_add51_stencil_2d0_sel_x(BITSELECT,26)@0
    assign bgTrunc_i_add51_stencil_2d0_sel_x_b = i_add51_stencil_2d0_q[31:0];

    // i_idxprom52_stencil_2d1_sel_x(BITSELECT,40)@0
    assign i_idxprom52_stencil_2d1_sel_x_b = {32'b00000000000000000000000000000000, bgTrunc_i_add51_stencil_2d0_sel_x_b[31:0]};

    // i_idxprom52_stencil_2d1_vt_select_31(BITSELECT,16)@0
    assign i_idxprom52_stencil_2d1_vt_select_31_b = i_idxprom52_stencil_2d1_sel_x_b[31:0];

    // i_idxprom52_stencil_2d1_vt_join(BITJOIN,15)@0
    assign i_idxprom52_stencil_2d1_vt_join_q = {i_idxprom52_stencil_2d1_vt_const_63_q, i_idxprom52_stencil_2d1_vt_select_31_b};

    // i_arrayidx535_stencil_2d0_dupName_0_trunc_sel_x(BITSELECT,38)@0
    assign i_arrayidx535_stencil_2d0_dupName_0_trunc_sel_x_b = i_idxprom52_stencil_2d1_vt_join_q[11:0];

    // i_arrayidx535_stencil_2d0_narrow_x(BITSELECT,31)@0
    assign i_arrayidx535_stencil_2d0_narrow_x_b = i_arrayidx535_stencil_2d0_dupName_0_trunc_sel_x_b[9:0];

    // i_arrayidx535_stencil_2d0_shift_join_x(BITJOIN,32)@0
    assign i_arrayidx535_stencil_2d0_shift_join_x_q = {i_arrayidx535_stencil_2d0_narrow_x_b, i_arrayidx535_stencil_2d2_vt_const_1_q};

    // i_arrayidx535_stencil_2d0_add_x(ADD,28)@0
    assign i_arrayidx535_stencil_2d0_add_x_a = {1'b0, i_arrayidx535_stencil_2d0_upper_bits_x_merged_bit_select_c};
    assign i_arrayidx535_stencil_2d0_add_x_b = {1'b0, i_arrayidx535_stencil_2d0_shift_join_x_q};
    assign i_arrayidx535_stencil_2d0_add_x_o = $unsigned(i_arrayidx535_stencil_2d0_add_x_a) + $unsigned(i_arrayidx535_stencil_2d0_add_x_b);
    assign i_arrayidx535_stencil_2d0_add_x_q = i_arrayidx535_stencil_2d0_add_x_o[12:0];

    // i_arrayidx535_stencil_2d0_dupName_2_trunc_sel_x(BITSELECT,39)@0
    assign i_arrayidx535_stencil_2d0_dupName_2_trunc_sel_x_b = i_arrayidx535_stencil_2d0_add_x_q[11:0];

    // i_arrayidx535_stencil_2d0_append_upper_bits_x(BITJOIN,29)@0
    assign i_arrayidx535_stencil_2d0_append_upper_bits_x_q = {i_arrayidx535_stencil_2d0_upper_bits_x_merged_bit_select_b, i_arrayidx535_stencil_2d0_dupName_2_trunc_sel_x_b};

    // i_arrayidx535_stencil_2d2_vt_select_63(BITSELECT,12)@0
    assign i_arrayidx535_stencil_2d2_vt_select_63_b = i_arrayidx535_stencil_2d0_append_upper_bits_x_q[63:2];

    // i_arrayidx535_stencil_2d2_vt_const_1(CONSTANT,10)
    assign i_arrayidx535_stencil_2d2_vt_const_1_q = $unsigned(2'b00);

    // i_arrayidx535_stencil_2d2_vt_join(BITJOIN,11)@0
    assign i_arrayidx535_stencil_2d2_vt_join_q = {i_arrayidx535_stencil_2d2_vt_select_63_b, i_arrayidx535_stencil_2d2_vt_const_1_q};
    ...
    stencil_2d_i_llvm_fpga_mem_unnamed_4_stencil_2d0 thei_llvm_fpga_mem_unnamed_stencil_2d4_stencil_2d3 (
        .in_flush(in_flush),
        .in_i_address(i_arrayidx535_stencil_2d2_vt_join_q),
    ...
    assign out_c0_exe52616 = sel_for_coalesced_delay_0_b;
    assign out_c0_exe62628 = sel_for_coalesced_delay_0_c;
