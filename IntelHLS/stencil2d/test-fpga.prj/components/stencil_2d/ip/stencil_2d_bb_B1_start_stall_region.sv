...
module stencil_2d_bb_B1_start_stall_region (
    ...
    wire [0:0] GND_q;
    wire [0:0] i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_iord_bl_call_stencil_2d_o_fifoalmost_full;
    wire [0:0] i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_iord_bl_call_stencil_2d_o_fifoready;
    wire [0:0] i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_o_stall;
    wire [0:0] i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_o_valid;
    ...
    wire [0:0] SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_wireValid;
    wire [0:0] SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_backStall;
    wire [0:0] SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_V0;
    ...
    // stencil_2d_B1_start_merge_reg(BLACKBOX,27)@0
    ...
    // SE_out_stencil_2d_B1_start_merge_reg(STALLENABLE,47)
    // Valid signal propagation
    assign SE_out_stencil_2d_B1_start_merge_reg_V0 = SE_out_stencil_2d_B1_start_merge_reg_wireValid;
    // Backward Stall generation
    assign SE_out_stencil_2d_B1_start_merge_reg_backStall = i_sfc_s_c0_in_wt_entry_stencil_2ds_c0_enter13_stencil_2d0_aunroll_x_out_o_stall | ~ (SE_out_stencil_2d_B1_start_merge_reg_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_stencil_2d_B1_start_merge_reg_wireValid = stencil_2d_B1_start_merge_reg_out_valid_out;

    // SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2(STALLENABLE,41)
    // Valid signal propagation
    assign SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_V0 = SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_wireValid;
    // Backward Stall generation
    assign SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_backStall = in_stall_in | ~ (SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_wireValid = i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_o_valid;

    // bubble_join_i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1(BITJOIN,35)
    ...
    // bubble_select_i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1(BITSELECT,36)
    ...
    // i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2(BLACKBOX,12)@2
    // in in_i_stall@20000000
    // out out_iord_bl_call_stencil_2d_o_fifoalmost_full@20000000
    // out out_iord_bl_call_stencil_2d_o_fifoready@20000000
    // out out_o_stall@20000000
    stencil_2d_i_iord_bl_call_unnamed_stencil_2d2_stencil_2d0 thei_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2 (
        .in_i_dependence(bubble_select_i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1_b),
        .in_i_stall(SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_backStall),
        ...
        .out_iord_bl_call_stencil_2d_o_fifoalmost_full(i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_iord_bl_call_stencil_2d_o_fifoalmost_full),
        .out_iord_bl_call_stencil_2d_o_fifoready(i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_iord_bl_call_stencil_2d_o_fifoready),
        .out_o_data(),
        .out_o_stall(i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_o_stall),
        .out_o_valid(i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1(STALLENABLE,43)
    // Valid signal propagation
    ...
    // Backward Stall generation
    assign SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1_backStall = i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_o_stall | ~ (SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1_wireValid);
    // Computing multiple Valid(s)
    ...
    // i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1(BLACKBOX,13)@1
    // in in_stall_in@20000000
    // out out_data_out@2
    ...
    // SE_out_i_sfc_s_c0_in_wt_entry_stencil_2ds_c0_enter13_stencil_2d0_aunroll_x(STALLENABLE,49)
    // Valid signal propagation
    assign SE_out_i_sfc_s_c0_in_wt_entry_stencil_2ds_c0_enter13_stencil_2d0_aunroll_x_V0 = SE_out_i_sfc_s_c0_in_wt_entry_stencil_2ds_c0_enter13_stencil_2d0_aunroll_x_wireValid;
    // Backward Stall generation
    assign SE_out_i_sfc_s_c0_in_wt_entry_stencil_2ds_c0_enter13_stencil_2d0_aunroll_x_backStall = i_llvm_fpga_pop_throttle_i1_throttle_pop_stencil_2d1_out_stall_out | ~ (SE_out_i_sfc_s_c0_in_wt_entry_stencil_2ds_c0_enter13_stencil_2d0_aunroll_x_wireValid);
    // Computing multiple Valid(s)
    ...
    assign out_pipeline_valid_out = i_sfc_s_c0_in_wt_entry_stencil_2ds_c0_enter13_stencil_2d0_aunroll_x_out_pipeline_valid_out;

    // sync_out(GPOUT,28)@0
    assign out_stall_out = SE_stall_entry_backStall;

    // dupName_0_ext_sig_sync_out_x(GPOUT,30)
    assign out_iord_bl_call_stencil_2d_o_fifoready = i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_iord_bl_call_stencil_2d_o_fifoready;
    assign out_iord_bl_call_stencil_2d_o_fifoalmost_full = i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_out_iord_bl_call_stencil_2d_o_fifoalmost_full;

    // dupName_0_sync_out_x(GPOUT,31)@2
    assign out_valid_out = SE_out_i_iord_bl_call_stencil_2d_unnamed_stencil_2d2_stencil_2d2_V0;
