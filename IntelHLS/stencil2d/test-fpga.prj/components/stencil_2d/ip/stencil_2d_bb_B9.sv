...
module stencil_2d_bb_B9 (
    input wire [0:0] in_c0_exe52615_0,
    ...
    wire [0:0] bb_stencil_2d_B9_stall_region_out_c0_exe52615;
    ...
    wire [0:0] stencil_2d_B9_merge_out_c0_exe52615;
    ...
    // stencil_2d_B9_branch(BLACKBOX,11)
    stencil_2d_B9_branch thestencil_2d_B9_branch (
        .in_c0_exe52615(bb_stencil_2d_B9_stall_region_out_c0_exe52615),
    ...
    stencil_2d_bb_B9_stall_region thebb_stencil_2d_B9_stall_region (
        .in_c0_exe52615(stencil_2d_B9_merge_out_c0_exe52615),
        .in_stall_in(stencil_2d_B9_branch_out_stall_out),
        .in_valid_in(stencil_2d_B9_merge_out_valid_out),
        .out_c0_exe52615(bb_stencil_2d_B9_stall_region_out_c0_exe52615),
    ...
    // stencil_2d_B9_merge(BLACKBOX,12)
    stencil_2d_B9_merge thestencil_2d_B9_merge (
        .in_c0_exe52615_0(in_c0_exe52615_0),
        .in_stall_in(bb_stencil_2d_B9_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe52615(stencil_2d_B9_merge_out_c0_exe52615),
