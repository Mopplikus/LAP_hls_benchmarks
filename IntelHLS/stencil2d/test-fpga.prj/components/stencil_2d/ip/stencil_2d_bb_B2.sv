...
module stencil_2d_bb_B2 (
    ...
    wire [0:0] bb_stencil_2d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_stall_out;
    wire [0:0] bb_stencil_2d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_valid_out;
    wire [31:0] bb_stencil_2d_B2_stall_region_out_c0_exe1158;
    ...
    wire [31:0] stencil_2d_B2_branch_out_c0_exe1158;
    ...
    wire [0:0] stencil_2d_B2_merge_out_forked39;
    ...
    stencil_2d_B2_branch thestencil_2d_B2_branch (
        .in_c0_exe1158(bb_stencil_2d_B2_stall_region_out_c0_exe1158),
        ...
        .out_c0_exe1158(stencil_2d_B2_branch_out_c0_exe1158),
    ...
    stencil_2d_B2_merge thestencil_2d_B2_merge (
        ...
        .out_forked39(stencil_2d_B2_merge_out_forked39),
    ...
    stencil_2d_bb_B2_stall_region thebb_stencil_2d_B2_stall_region (
        ...
        .in_forked39(stencil_2d_B2_merge_out_forked39),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(stencil_2d_B2_branch_out_stall_out),
        .in_valid_in(stencil_2d_B2_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_stall_out(bb_stencil_2d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_valid_out(bb_stencil_2d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_valid_out),
        .out_c0_exe1158(bb_stencil_2d_B2_stall_region_out_c0_exe1158),
    ...
    // out_c0_exe1158(GPOUT,11)
    assign out_c0_exe1158 = stencil_2d_B2_branch_out_c0_exe1158;
    ...
    assign out_exiting_stall_out = bb_stencil_2d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,16)
    assign out_exiting_valid_out = bb_stencil_2d_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going31_stencil_2d2_exiting_valid_out;
