...
module stencil_2d_B8_branch (
    input wire [0:0] in_c0_exe2190,
    input wire [31:0] in_c0_exe3191,
    input wire [31:0] in_c0_exe4192,
    ...
    // out_c0_exe2190(GPOUT,12)
    assign out_c0_exe2190 = in_c0_exe2190;

    // out_c0_exe3191(GPOUT,13)
    assign out_c0_exe3191 = in_c0_exe3191;

    // out_c0_exe4192(GPOUT,14)
    assign out_c0_exe4192 = in_c0_exe4192;
