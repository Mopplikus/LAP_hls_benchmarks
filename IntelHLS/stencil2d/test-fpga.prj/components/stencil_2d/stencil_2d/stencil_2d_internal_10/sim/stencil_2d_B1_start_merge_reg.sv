...
module stencil_2d_B1_start_merge_reg (
    ...
    // stencil_2d_B1_start_merge_reg_valid_reg_not(LOGICAL,8)
    assign stencil_2d_B1_start_merge_reg_valid_reg_not_q = ~ (stencil_2d_B1_start_merge_reg_valid_reg_q);

    // stall_in_not_or_stencil_2d_B1_start_merge_reg_valid_reg(LOGICAL,4)
    ...
    // stencil_2d_B1_start_merge_reg_valid_reg(REG,6)
    ...
    // stencil_2d_B1_start_merge_reg_valid_reg_and_stall_in(LOGICAL,7)
    ...
    // stencil_2d_B1_start_merge_reg_data_reg(REG,5)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
