...
module stencil_2d_bb_B1_start (
    ...
    wire [0:0] bb_stencil_2d_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_stall_out;
    wire [0:0] bb_stencil_2d_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_valid_out;
    wire [0:0] bb_stencil_2d_B1_start_stall_region_out_feedback_stall_out_1;
    wire [63:0] bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_0_0;
    wire [63:0] bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_1_0;
    wire [63:0] bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_2_0;
    ...
    wire [0:0] bb_stencil_2d_B1_start_stall_region_out_pipeline_valid_out;
    ...
    // stencil_2d_B1_start_merge(BLACKBOX,26)
    ...
    // stencil_2d_B1_start_branch(BLACKBOX,25)
    ...
    stencil_2d_bb_B1_start_stall_region thebb_stencil_2d_B1_start_stall_region (
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_stall_out(bb_stencil_2d_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_valid_out(bb_stencil_2d_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_valid_out),
        .out_feedback_stall_out_1(bb_stencil_2d_B1_start_stall_region_out_feedback_stall_out_1),
        .out_intel_reserved_ffwd_0_0(bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_0_0),
        .out_intel_reserved_ffwd_1_0(bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_1_0),
        .out_intel_reserved_ffwd_2_0(bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_2_0),
        ...
        .out_pipeline_valid_out(bb_stencil_2d_B1_start_stall_region_out_pipeline_valid_out),
    ...
    assign out_exiting_stall_out = bb_stencil_2d_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,12)
    assign out_exiting_valid_out = bb_stencil_2d_B1_start_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going35_stencil_2d1_exiting_valid_out;

    // out_intel_reserved_ffwd_0_0(GPOUT,13)
    assign out_intel_reserved_ffwd_0_0 = bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_0_0;

    // out_intel_reserved_ffwd_1_0(GPOUT,14)
    assign out_intel_reserved_ffwd_1_0 = bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_1_0;

    // out_intel_reserved_ffwd_2_0(GPOUT,15)
    assign out_intel_reserved_ffwd_2_0 = bb_stencil_2d_B1_start_stall_region_out_intel_reserved_ffwd_2_0;

    // out_iord_bl_call_stencil_2d_o_fifoalmost_full(GPOUT,16)
    ...
    // out_iord_bl_call_stencil_2d_o_fifoready(GPOUT,17)
    ...
    assign out_pipeline_valid_out = bb_stencil_2d_B1_start_stall_region_out_pipeline_valid_out;
