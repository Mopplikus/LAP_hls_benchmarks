...
module stencil_2d_B8_merge (
    ...
    // out_c0_exe102846(GPOUT,12)
    assign out_c0_exe102846 = in_c0_exe102846_0;

    // out_c0_exe112859(GPOUT,13)
    assign out_c0_exe112859 = in_c0_exe112859_0;

    // out_c0_exe1228611(GPOUT,14)
    assign out_c0_exe1228611 = in_c0_exe1228611_0;

    // out_c0_exe1328713(GPOUT,15)
    assign out_c0_exe1328713 = in_c0_exe1328713_0;

    // out_c0_exe1428815(GPOUT,16)
    assign out_c0_exe1428815 = in_c0_exe1428815_0;

    // out_c0_exe1528916(GPOUT,17)
    assign out_c0_exe1528916 = in_c0_exe1528916_0;

    // out_c0_exe92833(GPOUT,18)
    assign out_c0_exe92833 = in_c0_exe92833_0;
