...
module stencil_2d_B8_merge (
    ...
    // out_c0_exe21892(GPOUT,10)
    assign out_c0_exe21892 = in_c0_exe21892_0;

    // out_c0_exe41914(GPOUT,11)
    assign out_c0_exe41914 = in_c0_exe41914_0;

    // out_c0_exe51927(GPOUT,12)
    assign out_c0_exe51927 = in_c0_exe51927_0;

    // out_c0_exe61939(GPOUT,13)
    assign out_c0_exe61939 = in_c0_exe61939_0;

    // out_c0_exe719411(GPOUT,14)
    assign out_c0_exe719411 = in_c0_exe719411_0;

    // out_c0_exe819512(GPOUT,15)
    assign out_c0_exe819512 = in_c0_exe819512_0;
