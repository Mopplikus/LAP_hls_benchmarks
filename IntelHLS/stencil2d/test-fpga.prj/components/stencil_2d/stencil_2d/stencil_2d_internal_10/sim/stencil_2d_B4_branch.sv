...
module stencil_2d_B4_branch (
    ...
    input wire [31:0] in_c0_exe3122,
    input wire [31:0] in_c0_exe4123,
    ...
    // out_c0_exe2121(GPOUT,12)
    assign out_c0_exe2121 = in_c0_exe2121;

    // out_c0_exe3122(GPOUT,13)
    assign out_c0_exe3122 = in_c0_exe3122;

    // out_c0_exe4123(GPOUT,14)
    assign out_c0_exe4123 = in_c0_exe4123;
