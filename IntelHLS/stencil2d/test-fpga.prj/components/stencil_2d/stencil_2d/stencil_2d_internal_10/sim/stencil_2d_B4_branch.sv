...
module stencil_2d_B4_branch (
    ...
    input wire [0:0] in_c0_exe1168,
    input wire [0:0] in_c0_exe12,
    input wire [0:0] in_c0_exe13,
    input wire [0:0] in_c0_exe14,
    input wire [0:0] in_c0_exe2169,
    input wire [31:0] in_c0_exe3170,
    input wire [31:0] in_c0_exe4171,
    input wire [31:0] in_c0_exe5172,
    ...
    // out_c0_exe1168(GPOUT,20)
    assign out_c0_exe1168 = in_c0_exe1168;
    ...
    // out_c0_exe2169(GPOUT,24)
    assign out_c0_exe2169 = in_c0_exe2169;

    // out_c0_exe3170(GPOUT,25)
    assign out_c0_exe3170 = in_c0_exe3170;

    // out_c0_exe4171(GPOUT,26)
    assign out_c0_exe4171 = in_c0_exe4171;

    // out_c0_exe5172(GPOUT,27)
    assign out_c0_exe5172 = in_c0_exe5172;
