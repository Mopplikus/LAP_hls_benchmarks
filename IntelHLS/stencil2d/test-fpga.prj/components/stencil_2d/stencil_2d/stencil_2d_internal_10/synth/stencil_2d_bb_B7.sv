...
module stencil_2d_bb_B7 (
    ...
    wire [0:0] bb_stencil_2d_B7_stall_region_out_feedback_out_1;
    wire [0:0] bb_stencil_2d_B7_stall_region_out_feedback_valid_out_1;
    wire [31:0] bb_stencil_2d_B7_stall_region_out_iowr_bl_return_stencil_2d_o_fifodata;
    wire [0:0] bb_stencil_2d_B7_stall_region_out_iowr_bl_return_stencil_2d_o_fifovalid;
    ...
    // stencil_2d_B7_merge(BLACKBOX,16)
    ...
    // stencil_2d_B7_branch(BLACKBOX,15)
    ...
    stencil_2d_bb_B7_stall_region thebb_stencil_2d_B7_stall_region (
        ...
        .out_feedback_out_1(bb_stencil_2d_B7_stall_region_out_feedback_out_1),
        .out_feedback_valid_out_1(bb_stencil_2d_B7_stall_region_out_feedback_valid_out_1),
        .out_iowr_bl_return_stencil_2d_o_fifodata(bb_stencil_2d_B7_stall_region_out_iowr_bl_return_stencil_2d_o_fifodata),
        .out_iowr_bl_return_stencil_2d_o_fifovalid(bb_stencil_2d_B7_stall_region_out_iowr_bl_return_stencil_2d_o_fifovalid),
    ...
    assign out_feedback_out_1 = bb_stencil_2d_B7_stall_region_out_feedback_out_1;

    // feedback_valid_out_1_sync(GPOUT,5)
    assign out_feedback_valid_out_1 = bb_stencil_2d_B7_stall_region_out_feedback_valid_out_1;

    // out_iowr_bl_return_stencil_2d_o_fifodata(GPOUT,10)
    assign out_iowr_bl_return_stencil_2d_o_fifodata = bb_stencil_2d_B7_stall_region_out_iowr_bl_return_stencil_2d_o_fifodata;

    // out_iowr_bl_return_stencil_2d_o_fifovalid(GPOUT,11)
    assign out_iowr_bl_return_stencil_2d_o_fifovalid = bb_stencil_2d_B7_stall_region_out_iowr_bl_return_stencil_2d_o_fifovalid;
