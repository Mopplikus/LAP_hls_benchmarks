...
// SystemVerilog created from stencil_2d_B2_branch
...
module stencil_2d_B2_branch (
    input wire [31:0] in_c0_exe1158,
    input wire [31:0] in_c0_exe2,
    input wire [0:0] in_c0_exe3,
    input wire [0:0] in_c0_exe4,
    input wire [0:0] in_memdep_phi1_pop14,
    ...
    // out_c0_exe1158(GPOUT,9)
    assign out_c0_exe1158 = in_c0_exe1158;
    ...
    // out_memdep_phi1_pop14(GPOUT,13)
    assign out_memdep_phi1_pop14 = in_memdep_phi1_pop14;
