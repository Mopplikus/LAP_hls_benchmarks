...
(
   ...
   (
      ...
      // AVM avm_unnamed_stencil_2d8_stencil_2d
      .avm_unnamed_stencil_2d8_stencil_2d_enable(local_avm_aspace64_enable[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_read(local_avm_aspace64_read[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_write(local_avm_aspace64_write[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_address(local_avm_aspace64_address[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_writedata(local_avm_aspace64_writedata[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_byteenable(local_avm_aspace64_byteenable[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_waitrequest(local_avm_aspace64_waitrequest[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_readdata(local_avm_aspace64_readdata[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_readdatavalid(local_avm_aspace64_readdatavalid[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_burstcount(local_avm_aspace64_burstcount[0][0]),
      .avm_unnamed_stencil_2d8_stencil_2d_writeack(local_avm_aspace64_writeack[0][0]),
      // AVM avm_unnamed_stencil_2d5_stencil_2d
      .avm_unnamed_stencil_2d5_stencil_2d_enable(local_avm_aspace65_enable[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_read(local_avm_aspace65_read[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_write(local_avm_aspace65_write[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_address(local_avm_aspace65_address[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_writedata(local_avm_aspace65_writedata[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_byteenable(local_avm_aspace65_byteenable[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_waitrequest(local_avm_aspace65_waitrequest[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_readdata(local_avm_aspace65_readdata[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_readdatavalid(local_avm_aspace65_readdatavalid[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_burstcount(local_avm_aspace65_burstcount[0][0]),
      .avm_unnamed_stencil_2d5_stencil_2d_writeack(local_avm_aspace65_writeack[0][0]),
      // AVM avm_unnamed_stencil_2d7_stencil_2d
      .avm_unnamed_stencil_2d7_stencil_2d_enable(local_avm_aspace66_enable[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_read(local_avm_aspace66_read[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_write(local_avm_aspace66_write[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_address(local_avm_aspace66_address[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_writedata(local_avm_aspace66_writedata[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_byteenable(local_avm_aspace66_byteenable[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_waitrequest(local_avm_aspace66_waitrequest[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_readdata(local_avm_aspace66_readdata[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_readdatavalid(local_avm_aspace66_readdatavalid[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_burstcount(local_avm_aspace66_burstcount[0][0]),
      .avm_unnamed_stencil_2d7_stencil_2d_writeack(local_avm_aspace66_writeack[0][0])
   );
   ...
   begin:local_mem_system_aspace64
      ...
      begin:local_mem_group
         ...
         begin:port2bank0
            ...
            // INST data_ic of stencil_2d_internal_ic_2063673880803286865
            stencil_2d_internal_ic_2063673880803286865 data_ic
            (
               .clock(clock),
               .resetn(resetn_extended),
               // ICM m
   ...
   begin:local_mem_system_aspace65
      ...
      begin:local_mem_group
         ...
         begin:port1bank0
            ...
            assign router[0].b_rrp_datavalid[0] = icm_in_rrp_datavalid[0];
            assign router[0].b_rrp_data[0] = icm_in_rrp_data[0];
            // INST data_ic of stencil_2d_internal_ic_265458854438429209
            stencil_2d_internal_ic_265458854438429209 data_ic
            (
               .clock(clock),
               .resetn(resetn_extended),
               // ICM m
   ...
   begin:local_mem_system_aspace66
      ...
      begin:local_mem_group
         ...
         begin:port2bank0
            ...
            assign router[0].b_rrp_datavalid[0] = icm_in_rrp_datavalid[0];
            assign router[0].b_rrp_data[0] = icm_in_rrp_data[0];
            // INST data_ic of stencil_2d_internal_ic_14760272268607154640
            stencil_2d_internal_ic_14760272268607154640 data_ic
            (
               .clock(clock),
               .resetn(resetn_extended),
               // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE stencil_2d_internal_ic_2063673880803286865
/////////////////////////////////////////////////////////////////
module stencil_2d_internal_ic_2063673880803286865
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE stencil_2d_internal_ic_265458854438429209
/////////////////////////////////////////////////////////////////
module stencil_2d_internal_ic_265458854438429209
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE stencil_2d_internal_ic_14760272268607154640
/////////////////////////////////////////////////////////////////
module stencil_2d_internal_ic_14760272268607154640
(
   input logic clock,
