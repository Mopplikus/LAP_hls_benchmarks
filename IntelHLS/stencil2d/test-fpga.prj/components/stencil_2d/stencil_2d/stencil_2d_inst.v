	stencil_2d u0 (
		...
		.orig                 (_connected_to_orig_),                 //   input,  width = 64,       orig.data
		.sol                  (_connected_to_sol_),                  //   input,  width = 64,        sol.data
		.filter               (_connected_to_filter_),               //   input,  width = 64,     filter.data
