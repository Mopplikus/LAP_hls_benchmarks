...
(
   ...
   (
      ...
      .avm_memdep_stencil_2d_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_stencil_2d_read(avmm_0_global_avm_read[0]),
      .avm_memdep_stencil_2d_write(avmm_0_global_avm_write[0]),
      .avm_memdep_stencil_2d_address(avmm_0_global_avm_address[0]),
      .avm_memdep_stencil_2d_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_stencil_2d_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_stencil_2d_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_stencil_2d_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_stencil_2d_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_stencil_2d_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_stencil_2d_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_stencil_2d7_stencil_2d
      .avm_unnamed_stencil_2d7_stencil_2d_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_stencil_2d7_stencil_2d_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_unnamed_stencil_2d8_stencil_2d
      .avm_unnamed_stencil_2d8_stencil_2d_enable(avmm_0_global_avm_enable[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_read(avmm_0_global_avm_read[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_write(avmm_0_global_avm_write[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_address(avmm_0_global_avm_address[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_writedata(avmm_0_global_avm_writedata[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_readdata(avmm_0_global_avm_readdata[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_unnamed_stencil_2d8_stencil_2d_writeack(avmm_0_global_avm_writeack[2])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of stencil_2d_internal_ic_10208102479396287920
      stencil_2d_internal_ic_10208102479396287920 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE stencil_2d_internal_ic_10208102479396287920
/////////////////////////////////////////////////////////////////
module stencil_2d_internal_ic_10208102479396287920
(
   input logic clock,
