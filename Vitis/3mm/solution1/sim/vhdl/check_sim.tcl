...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kernel_3mm.autotvin_A.dat"
         "c.kernel_3mm.autotvin_B.dat"
         "c.kernel_3mm.autotvin_C.dat"
         "c.kernel_3mm.autotvin_D.dat"
         "c.kernel_3mm.autotvin_E.dat"
         "c.kernel_3mm.autotvin_F.dat"
         "c.kernel_3mm.autotvin_G.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kernel_3mm.autotvout_E.dat"
         "rtl.kernel_3mm.autotvout_F.dat"
         "rtl.kernel_3mm.autotvout_G.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
