...
// wrapc file define:
#define AUTOTB_TVIN_A_1 "../tv/cdatafile/c.jacobi_1d.autotvin_A_1.dat"
#define AUTOTB_TVOUT_A_1 "../tv/cdatafile/c.jacobi_1d.autotvout_A_1.dat"
#define AUTOTB_TVIN_A_2 "../tv/cdatafile/c.jacobi_1d.autotvin_A_2.dat"
#define AUTOTB_TVOUT_A_2 "../tv/cdatafile/c.jacobi_1d.autotvout_A_2.dat"
#define AUTOTB_TVIN_B "../tv/cdatafile/c.jacobi_1d.autotvin_B.dat"
#define AUTOTB_TVOUT_B "../tv/cdatafile/c.jacobi_1d.autotvout_B.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.jacobi_1d.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_A_2 "../tv/rtldatafile/rtl.jacobi_1d.autotvout_A_2.dat"
#define AUTOTB_TVOUT_PC_B "../tv/rtldatafile/rtl.jacobi_1d.autotvout_B.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.jacobi_1d.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> jacobi_1d_hw_stub_wrapper(void*, void*, void*);

extern "C"
hls::sim::Byte<4> apatb_jacobi_1d_hw(void* __xlx_apatb_param_A_1, void* __xlx_apatb_param_A_2, void* __xlx_apatb_param_B)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_A_2),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_A_2),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_A_2),
#else
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_B),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_B),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_B),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_B),
#endif
#ifdef USE_BINARY_TV_FILE
  ...
  port3.param = { __xlx_apatb_param_B };
  port3.depth = { 100 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  try {
    ...
    ap_return = jacobi_1d_hw_stub_wrapper(__xlx_apatb_param_A_1, __xlx_apatb_param_A_2, __xlx_apatb_param_B);
