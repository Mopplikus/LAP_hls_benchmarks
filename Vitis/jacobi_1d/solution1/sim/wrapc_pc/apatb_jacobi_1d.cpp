...
extern "C"
void jacobi_1d_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_jacobi_1d_hw(void* __xlx_apatb_param_A_1, void* __xlx_apatb_param_A_2, void* __xlx_apatb_param_B)
{
#ifdef USE_BINARY_TV_FILE
  ...
  port0.param = { __xlx_apatb_param_A_1 };
  port0.depth = { 100 };
  port0.offset = {  };
  ...
  port1.param = { __xlx_apatb_param_A_2 };
  port1.depth = { 100 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    jacobi_1d_hw_stub_wrapper(__xlx_apatb_param_A_1, __xlx_apatb_param_A_2, __xlx_apatb_param_B);
