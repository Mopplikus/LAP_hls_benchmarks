...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.jacobi_1d.autotvin_A_1.dat"
         "c.jacobi_1d.autotvin_A_2.dat"
         "c.jacobi_1d.autotvin_B.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.jacobi_1d.autotvout_A_2.dat"
         "rtl.jacobi_1d.autotvout_B.dat"
         "rtl.jacobi_1d.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
