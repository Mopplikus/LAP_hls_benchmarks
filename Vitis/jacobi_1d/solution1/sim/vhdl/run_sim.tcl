...
if {[file isfile jacobi_1d.autotvin.dat]} {
	file delete -force jacobi_1d.autotvin.dat
}

if {[file isfile jacobi_1d.autotvout.dat]} {
	file delete -force jacobi_1d.autotvout.dat
}
