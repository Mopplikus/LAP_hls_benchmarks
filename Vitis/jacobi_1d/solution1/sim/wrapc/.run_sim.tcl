...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "jacobi_1d.autotvin.dat"
	set constFileTvOut       "jacobi_1d.autotvout.dat"
	set constFileHdlTvIn     "jacobi_1d.autohdltvin.dat"
	set constFileHdlTvOut    "jacobi_1d.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
