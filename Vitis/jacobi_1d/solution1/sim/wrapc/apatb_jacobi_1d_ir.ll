...
define void @apatb_jacobi_1d_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" %A_1, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" %A_2, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" %B) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_jacobi_1d_hw(i32* %3, i32* %4, i32* %5)
...
declare void @apatb_jacobi_1d_hw(i32*, i32*, i32*)
...
define void @jacobi_1d_hw_stub_wrapper(i32*, i32*, i32*) #4 {
entry:
