# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/jacobi_1d/jacobi_1d.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/jacobi_1d/jacobi_1d.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/jacobi_1d/jacobi_1d.h" 1
...
using std::wcstombs;
using std::wctomb;
# 5 "../../../../Documents/LAP_hls_benchmarks/Vitis/jacobi_1d/jacobi_1d.h" 2
...
# 6 "../../../../Documents/LAP_hls_benchmarks/Vitis/jacobi_1d/jacobi_1d.h" 2



__attribute__((sdx_kernel("jacobi_1d", 0))) void jacobi_1d(int A_1[100], int A_2[100], int B[100]);
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/jacobi_1d/jacobi_1d.cpp" 2

__attribute__((sdx_kernel("jacobi_1d", 0))) void jacobi_1d(int A_1[100], int A_2[100], int B[100])
{
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/jacobi_1d/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=jacobi_1d
# 4 "../../../../Documents/LAP_hls_benchmarks/Vitis/jacobi_1d/jacobi_1d.cpp"


 int t, i, j;

 VITIS_LOOP_8_1: for (t = 0; t < 3; t++)
 {

  VITIS_LOOP_11_2: for (i = 1; i < 100 - 1; i++) {
      B[i] = 3 * (A_1[i-1] + A_1[i] + A_1[i + 1]);
  }

  VITIS_LOOP_15_3: for (j = 1; j < 100 - 1; j++) {
      A_2[j] = B[j];
  }
