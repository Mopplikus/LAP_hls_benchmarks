...
using hls::sim::Byte;
extern "C" void jacobi_1d(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_jacobi_1d_hw(volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_A_2, volatile void * __xlx_apatb_param_B) {
...
__xlx_B__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_B)[i]);
  ...
  // DUT call
  jacobi_1d(__xlx_A_1__tmp_vec.data(), __xlx_A_2__tmp_vec.data(), __xlx_B__tmp_vec.data());
