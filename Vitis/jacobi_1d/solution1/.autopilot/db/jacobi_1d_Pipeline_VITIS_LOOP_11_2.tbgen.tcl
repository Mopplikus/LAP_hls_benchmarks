set moduleName jacobi_1d_Pipeline_VITIS_LOOP_11_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {jacobi_1d_Pipeline_VITIS_LOOP_11_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ A_1 int 32 regular {array 100 { 1 1 } 1 1 }  }
	{ B int 32 regular {array 100 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	A_1 { ap_memory {  { A_1_address0 mem_address 1 7 }  { A_1_ce0 mem_ce 1 1 }  { A_1_q0 in_data 0 32 }  { A_1_address1 MemPortADDR2 1 7 }  { A_1_ce1 MemPortCE2 1 1 }  { A_1_q1 MemPortDOUT2 0 32 } } }
	B { ap_memory {  { B_address0 mem_address 1 7 }  { B_ce0 mem_ce 1 1 }  { B_we0 mem_we 1 1 }  { B_d0 mem_din 1 32 } } }
}
