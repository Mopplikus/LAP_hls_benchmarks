...
if {[file isfile kernel_2mm.autotvin.dat]} {
	file delete -force kernel_2mm.autotvin.dat
}

if {[file isfile kernel_2mm.autotvout.dat]} {
	file delete -force kernel_2mm.autotvout.dat
}
