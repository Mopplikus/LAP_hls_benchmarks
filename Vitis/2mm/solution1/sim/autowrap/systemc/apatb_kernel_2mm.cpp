...
extern "C"
void kernel_2mm_hw_stub_wrapper(hls::sim::Byte<4>, hls::sim::Byte<4>, void*, void*, void*, void*, void*);

extern "C"
void apatb_kernel_2mm_hw(hls::sim::Byte<4> __xlx_apatb_param_alpha, hls::sim::Byte<4> __xlx_apatb_param_beta, void* __xlx_apatb_param_tmp, void* __xlx_apatb_param_A, void* __xlx_apatb_param_B, void* __xlx_apatb_param_C, void* __xlx_apatb_param_D)
{
  ...
  port0.param = &__xlx_apatb_param_alpha;
  ...
  port1.param = &__xlx_apatb_param_beta;
  ...
  port2.param = { __xlx_apatb_param_tmp };
  port2.depth = { 100 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  port6.param = { __xlx_apatb_param_D };
  port6.depth = { 100 };
  port6.offset = {  };
  port6.hasWrite = { true };
  ...
  try {
    ...
    kernel_2mm_hw_stub_wrapper(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_apatb_param_tmp, __xlx_apatb_param_A, __xlx_apatb_param_B, __xlx_apatb_param_C, __xlx_apatb_param_D);
