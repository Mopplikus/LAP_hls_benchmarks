...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "kernel_2mm.autotvin.dat"
	set constFileTvOut       "kernel_2mm.autotvout.dat"
	set constFileHdlTvIn     "kernel_2mm.autohdltvin.dat"
	set constFileHdlTvOut    "kernel_2mm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
