...
using hls::sim::Byte;
extern "C" void kernel_2mm(int, int, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_kernel_2mm_hw(int __xlx_apatb_param_alpha, int __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_tmp, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_D) {
...
__xlx_D__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D)[i]);
  ...
  // DUT call
  kernel_2mm(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_tmp__tmp_vec.data(), __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_D__tmp_vec.data());
