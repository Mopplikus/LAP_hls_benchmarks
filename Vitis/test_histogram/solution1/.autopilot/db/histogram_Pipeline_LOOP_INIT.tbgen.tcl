set moduleName histogram_Pipeline_LOOP_INIT
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {histogram_Pipeline_LOOP_INIT}
set C_modelType { void 0 }
set C_modelArgList {
	{ hist int 32 regular {array 100 { 1 3 } 1 1 }  }
	{ hist_local float 32 regular {array 100 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "hist", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "hist_local", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ hist_address0 sc_out sc_lv 7 signal 0 } 
	{ hist_ce0 sc_out sc_logic 1 signal 0 } 
	{ hist_q0 sc_in sc_lv 32 signal 0 } 
	{ hist_local_address0 sc_out sc_lv 7 signal 1 } 
	{ hist_local_ce0 sc_out sc_logic 1 signal 1 } 
	{ hist_local_we0 sc_out sc_logic 1 signal 1 } 
	{ hist_local_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	hist { ap_memory {  { hist_address0 mem_address 1 7 }  { hist_ce0 mem_ce 1 1 }  { hist_q0 in_data 0 32 } } }
	hist_local { ap_memory {  { hist_local_address0 mem_address 1 7 }  { hist_local_ce0 mem_ce 1 1 }  { hist_local_we0 mem_we 1 1 }  { hist_local_d0 mem_din 1 32 } } }
}
