...
// wrapc file define:
#define AUTOTB_TVIN_d_i "../tv/cdatafile/c.fir.autotvin_d_i.dat"
#define AUTOTB_TVOUT_d_i "../tv/cdatafile/c.fir.autotvout_d_i.dat"
#define AUTOTB_TVIN_idx "../tv/cdatafile/c.fir.autotvin_idx.dat"
#define AUTOTB_TVOUT_idx "../tv/cdatafile/c.fir.autotvout_idx.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.fir.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.fir.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> fir_hw_stub_wrapper(void*, void*);

extern "C"
hls::sim::Byte<4> apatb_fir_hw(void* __xlx_apatb_param_d_i, void* __xlx_apatb_param_idx)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_d_i),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_d_i),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_d_i };
  port1.depth = { 1000 };
  port1.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_idx),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_idx),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_idx };
  port2.depth = { 1000 };
  port2.offset = {  };
  ...
  try {
    ...
    ap_return = fir_hw_stub_wrapper(__xlx_apatb_param_d_i, __xlx_apatb_param_idx);
