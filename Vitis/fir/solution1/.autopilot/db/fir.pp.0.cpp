# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/fir/fir.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/fir/fir.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/fir/fir.h" 1
...
using std::wcstombs;
using std::wctomb;
# 5 "../../../../Documents/LAP_hls_benchmarks/Vitis/fir/fir.h" 2
...
# 6 "../../../../Documents/LAP_hls_benchmarks/Vitis/fir/fir.h" 2



__attribute__((sdx_kernel("fir", 0))) int fir (int d_i[1000], int idx[1000] );
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/fir/fir.cpp" 2

__attribute__((sdx_kernel("fir", 0))) int fir (int d_i[1000], int idx[1000] ) {
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/fir/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 3 "../../../../Documents/LAP_hls_benchmarks/Vitis/fir/fir.cpp"

 int i;
 int tmp=0;

 For_Loop: for (i=0;i<1000;i++) {
  tmp += idx [i] * d_i[1000 -1-i];
 }
