; ModuleID = 'C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/fir/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define i32 @apatb_fir_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1000" %d_i, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1000" %idx) local_unnamed_addr #0 {
entry:
  %d_i_copy = alloca [1000 x i32], align 512
  %idx_copy = alloca [1000 x i32], align 512
  %0 = bitcast i32* %d_i to [1000 x i32]*
  %1 = bitcast i32* %idx to [1000 x i32]*
  call fastcc void @copy_in([1000 x i32]* nonnull %0, [1000 x i32]* nonnull align 512 %d_i_copy, [1000 x i32]* nonnull %1, [1000 x i32]* nonnull align 512 %idx_copy)
  %2 = getelementptr inbounds [1000 x i32], [1000 x i32]* %d_i_copy, i32 0, i32 0
  %3 = getelementptr inbounds [1000 x i32], [1000 x i32]* %idx_copy, i32 0, i32 0
  %4 = call i32 @apatb_fir_hw(i32* %2, i32* %3)
  call void @copy_back([1000 x i32]* %0, [1000 x i32]* %d_i_copy, [1000 x i32]* %1, [1000 x i32]* %idx_copy)
  ret i32 %4
}
...
declare i32 @apatb_fir_hw(i32*, i32*)
...
define i32 @fir_hw_stub_wrapper(i32*, i32*) #4 {
entry:
