...
// ==============================================================
# 1 "C:/Users/Elija/Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/Elija/Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp"
...
# 2 "C:/Users/Elija/Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp" 2
...
extern "C"
#endif
int apatb_kernel_2mm_ir(int, int, int (*)[10], int (*)[10], int (*)[10], int (*)[10], int (*)[10]);
#ifdef __cplusplus
extern "C"
#endif
int kernel_2mm_hw_stub(int alpha, int beta, int (*tmp)[10], int (*A)[10], int (*B)[10], int (*C)[10], int (*D)[10]){
int _ret = kernel_2mm(alpha, beta, tmp, A, B, C, D);
return _ret;
}
#ifdef __cplusplus
extern "C"
#endif
int apatb_kernel_2mm_sw(int alpha, int beta, int (*tmp)[10], int (*A)[10], int (*B)[10], int (*C)[10], int (*D)[10]){
int _ret = apatb_kernel_2mm_ir(alpha, beta, tmp, A, B, C, D);
return _ret;
}
#endif
# 25 "C:/Users/Elija/Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp"
