...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kernel_2mm.autotvin_alpha.dat"
         "c.kernel_2mm.autotvin_beta.dat"
         "c.kernel_2mm.autotvin_tmp.dat"
         "c.kernel_2mm.autotvin_A.dat"
         "c.kernel_2mm.autotvin_B.dat"
         "c.kernel_2mm.autotvin_C.dat"
         "c.kernel_2mm.autotvin_D.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kernel_2mm.autotvout_tmp.dat"
         "rtl.kernel_2mm.autotvout_D.dat"
         "rtl.kernel_2mm.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
