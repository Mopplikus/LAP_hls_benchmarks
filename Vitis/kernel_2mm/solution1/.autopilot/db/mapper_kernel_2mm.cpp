...
using hls::sim::Byte;
extern "C" int kernel_2mm(int, int, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" int apatb_kernel_2mm_hw(int __xlx_apatb_param_alpha, int __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_tmp, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_D) {
using hls::sim::createStream;
  // Collect __xlx_tmp__tmp_vec
std::vector<Byte<4>> __xlx_tmp__tmp_vec;
for (size_t i = 0; i < 100; ++i){
__xlx_tmp__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_tmp)[i]);
}
  int __xlx_size_param_tmp = 100;
  int __xlx_offset_param_tmp = 0;
  int __xlx_offset_byte_param_tmp = 0*4;
...
__xlx_D__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D)[i]);
  ...
  // DUT call
  int ap_return = kernel_2mm(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_tmp__tmp_vec.data(), __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_D__tmp_vec.data());
// print __xlx_apatb_param_tmp
for (size_t i = 0; i < __xlx_size_param_tmp; ++i) {
((Byte<4>*)__xlx_apatb_param_tmp)[i] = __xlx_tmp__tmp_vec[__xlx_offset_param_tmp+i];
}
