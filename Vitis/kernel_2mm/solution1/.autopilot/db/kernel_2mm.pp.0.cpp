# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.h" 1
...
# 5 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.h" 2
...
using std::wcstombs;
using std::wctomb;
# 6 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.h" 2
# 15 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.h"
__attribute__((sdx_kernel("kernel_2mm", 0))) int kernel_2mm(int alpha, int beta, int tmp[10][10], int A[10][10], int B[10][10], int C[10][10], int D[10][10]);
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp" 2

__attribute__((sdx_kernel("kernel_2mm", 0))) int kernel_2mm(int alpha, int beta, int tmp[10][10], int A[10][10], int B[10][10], int C[10][10], int D[10][10])
{
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/kernel_2mm/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=kernel_2mm
# 4 "../../../../Documents/LAP_hls_benchmarks/Vitis/2mm/kernel_2mm.cpp"
    ...
    VITIS_LOOP_7_1: for (i = 0; i < 10; i++)
        VITIS_LOOP_8_2: for (j = 0; j < 10; j++) {
            int x = tmp[i][j];
            VITIS_LOOP_10_3: for (k = 0; k < 10; ++k)
                x += alpha * A[i][k] * B[k][j];
            tmp[i][j] = x;
        }

    VITIS_LOOP_15_4: for (i = 0; i < 10; i++)
        VITIS_LOOP_16_5: for (j = 0; j < 10; j++) {
            int x = D[i][j]*beta;
            VITIS_LOOP_18_6: for (k = 0; k < 10; ++k)
                x += tmp[i][k] * C[k][j];
            D[i][j] = x;
        }
