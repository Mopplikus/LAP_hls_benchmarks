...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.stencil_2d.autotvin_orig.dat"
         "c.stencil_2d.autotvin_sol.dat"
         "c.stencil_2d.autotvin_filter.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.stencil_2d.autotvout_sol.dat"
         "rtl.stencil_2d.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
