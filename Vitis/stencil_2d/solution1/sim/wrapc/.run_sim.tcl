...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "stencil_2d.autotvin.dat"
	set constFileTvOut       "stencil_2d.autotvout.dat"
	set constFileHdlTvIn     "stencil_2d.autohdltvin.dat"
	set constFileHdlTvOut    "stencil_2d.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
