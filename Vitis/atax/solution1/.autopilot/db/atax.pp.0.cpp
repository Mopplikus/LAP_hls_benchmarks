# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.cpp" 2
...
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.h" 1
...
# 6 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.h" 2
...
# 28 "C:/Xilinx/Vitis_HLS/2022.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdint.h" 3
...
#pragma pack(pop)
# 29 "C:/Xilinx/Vitis_HLS/2022.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdint.h" 2 3
...
# 7 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.h" 2
...
# 8 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.h" 2
...
__attribute__((sdx_kernel("atax", 0))) int atax(in_float_t A[20][20], in_float_t x[20], inout_float_t y[20], inout_float_t tmp[20]);
# 9 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.cpp" 2

__attribute__((sdx_kernel("atax", 0))) int atax(in_float_t A[20][20], in_float_t x[20], inout_float_t y[20], inout_float_t tmp[20])
{
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/atax/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=atax
# 11 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.cpp"

  int i, j;

  VITIS_LOOP_14_1: for (i = 0; i < 20; i++)
    {
      int t = tmp[i];
      VITIS_LOOP_17_2: for (j = 0; j < 20; j++)
         t = t + A[i][j] * x[j];
      VITIS_LOOP_19_3: for (j = 0; j < 20; j++)
         y[j] = y[j] + A[i][j] * t;
    tmp[i] = t;
    }

    return i;
# 40 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/src/atax.cpp"
}
