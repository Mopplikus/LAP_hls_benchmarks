# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.h" 1
...
using std::wcstombs;
using std::wctomb;
# 9 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.h" 2
...
# 10 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.h" 2

__attribute__((sdx_kernel("atax", 0))) void atax(int A[20][20], int x[20], int y[20], int tmp[20]);
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.cpp" 2

__attribute__((sdx_kernel("atax", 0))) void atax(int A[20][20], int x[20], int y[20], int tmp[20])
{
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/atax/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=atax
# 4 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.cpp"

  int i, j;

  VITIS_LOOP_7_1: for (i = 0; i < 20; i++)
    {
      int t = tmp[i];
      VITIS_LOOP_10_2: for (j = 0; j < 20; j++)
         t = t + A[i][j] * x[j];
      VITIS_LOOP_12_3: for (j = 0; j < 20; j++)
         y[j] = y[j] + A[i][j] * t;
    tmp[i] = t;
    }
# 28 "../../../../Documents/LAP_hls_benchmarks/Vitis/atax/atax.cpp"
}
