...
using hls::sim::Byte;
extern "C" int atax(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" int apatb_atax_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_tmp) {
...
__xlx_tmp__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_tmp)[i]);
  ...
  int __xlx_size_param_tmp = 20;
  int __xlx_offset_param_tmp = 0;
  int __xlx_offset_byte_param_tmp = 0*4;
  // DUT call
  int ap_return = atax(__xlx_A__tmp_vec.data(), __xlx_x__tmp_vec.data(), __xlx_y__tmp_vec.data(), __xlx_tmp__tmp_vec.data());
