...
define void @apatb_atax_ir([20 x i32]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="20" %A, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="20" %x, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="20" %y, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="20" %tmp) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_atax_hw([20 x i32]* %4, i32* %5, i32* %6, i32* %7)
...
declare void @apatb_atax_hw([20 x i32]*, i32*, i32*, i32*)
...
define void @atax_hw_stub_wrapper([20 x i32]*, i32*, i32*, i32*) #4 {
entry:
  ...
  call void @atax_hw_stub([20 x i32]* %8, i32* %9, i32* %10, i32* %11)
...
declare void @atax_hw_stub([20 x i32]*, i32*, i32*, i32*)
