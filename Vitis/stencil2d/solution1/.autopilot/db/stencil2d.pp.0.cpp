# 1 "../../../../Documents/LAP/Vitis/stencil2d/stencil2d.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP/Vitis/stencil2d/stencil2d.cpp" 2
# 1 "../../../../Documents/LAP/Vitis/stencil2d/stencil2d.h" 1
...
# 5 "../../../../Documents/LAP/Vitis/stencil2d/stencil2d.h" 2
...
using std::wcstombs;
using std::wctomb;
# 6 "../../../../Documents/LAP/Vitis/stencil2d/stencil2d.h" 2

__attribute__((sdx_kernel("stencil_2d", 0))) int stencil_2d (int orig[900], int sol[900], int filter[10]);
# 2 "../../../../Documents/LAP/Vitis/stencil2d/stencil2d.cpp" 2

__attribute__((sdx_kernel("stencil_2d", 0))) int stencil_2d (int orig[900], int sol[900], int filter[10])
{
#line 16 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/stencil2d/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=stencil_2d
# 4 "../../../../Documents/LAP/Vitis/stencil2d/stencil2d.cpp"

    int temp = 0;
 int mul = 0;

 VITIS_LOOP_8_1: for (int r=0; r < 28; r++)
 {
  VITIS_LOOP_10_2: for (int c=0; c< 28; c++)
  {
   temp = 0;
   VITIS_LOOP_13_3: for (int k1=0;k1<3;k1++)
   {
    VITIS_LOOP_15_4: for (int k2=0;k2<3;k2++)
    {
