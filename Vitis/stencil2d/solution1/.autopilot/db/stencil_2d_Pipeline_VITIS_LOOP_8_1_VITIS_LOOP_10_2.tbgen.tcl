set moduleName stencil_2d_Pipeline_VITIS_LOOP_8_1_VITIS_LOOP_10_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {stencil_2d_Pipeline_VITIS_LOOP_8_1_VITIS_LOOP_10_2}
...
set C_modelArgList {
	...
	{ add21_lcssa_lcssa_phi_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "orig", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add21_lcssa_lcssa_phi_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sol_address0 sc_out sc_lv 10 signal 10 } 
	{ sol_ce0 sc_out sc_logic 1 signal 10 } 
	{ sol_we0 sc_out sc_logic 1 signal 10 } 
	{ sol_d0 sc_out sc_lv 32 signal 10 } 
	{ add21_lcssa_lcssa_phi_out sc_out sc_lv 32 signal 11 } 
	{ add21_lcssa_lcssa_phi_out_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add21_lcssa_lcssa_phi_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add21_lcssa_lcssa_phi_out", "role": "default" }} , 
 	{ "name": "add21_lcssa_lcssa_phi_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add21_lcssa_lcssa_phi_out", "role": "ap_vld" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3923", "Max" : "3923"}
...
set Spec2ImplPortList { 
	orig { ap_memory {  { orig_address0 mem_address 1 10 }  { orig_ce0 mem_ce 1 1 }  { orig_q0 in_data 0 32 }  { orig_address1 MemPortADDR2 1 10 }  { orig_ce1 MemPortCE2 1 1 }  { orig_q1 in_data 0 32 } } }
	...
	add21_lcssa_lcssa_phi_out { ap_vld {  { add21_lcssa_lcssa_phi_out out_data 1 32 }  { add21_lcssa_lcssa_phi_out_ap_vld out_vld 1 1 } } }
}
