...
// wrapc file define:
#define AUTOTB_TVIN_orig "../tv/cdatafile/c.stencil_2d.autotvin_orig.dat"
#define AUTOTB_TVOUT_orig "../tv/cdatafile/c.stencil_2d.autotvout_orig.dat"
#define AUTOTB_TVIN_sol "../tv/cdatafile/c.stencil_2d.autotvin_sol.dat"
#define AUTOTB_TVOUT_sol "../tv/cdatafile/c.stencil_2d.autotvout_sol.dat"
#define AUTOTB_TVIN_filter "../tv/cdatafile/c.stencil_2d.autotvin_filter.dat"
#define AUTOTB_TVOUT_filter "../tv/cdatafile/c.stencil_2d.autotvout_filter.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.stencil_2d.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_sol "../tv/rtldatafile/rtl.stencil_2d.autotvout_sol.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.stencil_2d.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> stencil_2d_hw_stub_wrapper(void*, void*, void*);

extern "C"
hls::sim::Byte<4> apatb_stencil_2d_hw(void* __xlx_apatb_param_orig, void* __xlx_apatb_param_sol, void* __xlx_apatb_param_filter)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_orig),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_orig),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_orig };
  port1.depth = { 900 };
  port1.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_sol),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_sol),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_sol),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_sol),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_sol),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_sol),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_sol };
  port2.depth = { 900 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port3 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_filter),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_filter),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_filter };
  port3.depth = { 10 };
  port3.offset = {  };
  ...
  try {
    ...
    ap_return = stencil_2d_hw_stub_wrapper(__xlx_apatb_param_orig, __xlx_apatb_param_sol, __xlx_apatb_param_filter);
