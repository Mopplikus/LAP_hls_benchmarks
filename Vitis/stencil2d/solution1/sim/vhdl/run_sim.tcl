...
if {[file isfile stencil_2d.autotvin.dat]} {
	file delete -force stencil_2d.autotvin.dat
}

if {[file isfile stencil_2d.autotvout.dat]} {
	file delete -force stencil_2d.autotvout.dat
}
