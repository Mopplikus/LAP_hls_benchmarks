...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "histogram.autotvin.dat"
	set constFileTvOut       "histogram.autotvout.dat"
	set constFileHdlTvIn     "histogram.autohdltvin.dat"
	set constFileHdlTvOut    "histogram.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
