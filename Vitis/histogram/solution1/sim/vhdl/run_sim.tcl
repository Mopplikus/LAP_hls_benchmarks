...
if {[file isfile histogram.autotvin.dat]} {
	file delete -force histogram.autotvin.dat
}

if {[file isfile histogram.autotvout.dat]} {
	file delete -force histogram.autotvout.dat
}
