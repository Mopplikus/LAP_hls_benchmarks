...
// wrapc file define:
#define AUTOTB_TVIN_feature "../tv/cdatafile/c.histogram.autotvin_feature.dat"
#define AUTOTB_TVOUT_feature "../tv/cdatafile/c.histogram.autotvout_feature.dat"
#define AUTOTB_TVIN_weight "../tv/cdatafile/c.histogram.autotvin_weight.dat"
#define AUTOTB_TVOUT_weight "../tv/cdatafile/c.histogram.autotvout_weight.dat"
...
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.histogram.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_hist "../tv/rtldatafile/rtl.histogram.autotvout_hist.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.histogram.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> histogram_hw_stub_wrapper(void*, void*, void*, hls::sim::Byte<4>);

extern "C"
hls::sim::Byte<4> apatb_histogram_hw(void* __xlx_apatb_param_feature, void* __xlx_apatb_param_weight, void* __xlx_apatb_param_hist, hls::sim::Byte<4> __xlx_apatb_param_n)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_feature),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_feature),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_feature };
  port2.depth = { 1000 };
  port2.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port3 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_weight),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_weight),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_weight };
  port3.depth = { 1000 };
  port3.offset = {  };
...
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_hist),
#endif
#endif
  };
  port4.param = { __xlx_apatb_param_hist };
  port4.depth = { 1000 };
  port4.offset = {  };
  port4.hasWrite = { true };
  ...
  try {
    ...
    ap_return = histogram_hw_stub_wrapper(__xlx_apatb_param_feature, __xlx_apatb_param_weight, __xlx_apatb_param_hist, __xlx_apatb_param_n);
