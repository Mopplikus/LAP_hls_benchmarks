...
using hls::sim::Byte;
extern "C" int histogram(Byte<4>*, Byte<4>*, Byte<4>*, int);
extern "C" int apatb_histogram_hw(volatile void * __xlx_apatb_param_feature, volatile void * __xlx_apatb_param_weight, volatile void * __xlx_apatb_param_hist, int __xlx_apatb_param_n) {
...
__xlx_hist__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_hist)[i]);
  ...
  // DUT call
  int ap_return = histogram(__xlx_feature__tmp_vec.data(), __xlx_weight__tmp_vec.data(), __xlx_hist__tmp_vec.data(), __xlx_apatb_param_n);
