...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "if_loop_1.autotvin.dat"
	set constFileTvOut       "if_loop_1.autotvout.dat"
	set constFileHdlTvIn     "if_loop_1.autohdltvin.dat"
	set constFileHdlTvOut    "if_loop_1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
