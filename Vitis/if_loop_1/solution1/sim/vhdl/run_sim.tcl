...
if {[file isfile if_loop_1.autotvin.dat]} {
	file delete -force if_loop_1.autotvin.dat
}

if {[file isfile if_loop_1.autotvout.dat]} {
	file delete -force if_loop_1.autotvout.dat
}
