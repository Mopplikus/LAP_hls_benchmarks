...
using hls::sim::Byte;
extern "C" int if_loop_1(Byte<4>*, int);
extern "C" int apatb_if_loop_1_hw(volatile void * __xlx_apatb_param_a, int __xlx_apatb_param_n) {
...
__xlx_a__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_a)[i]);
  ...
  // DUT call
  int ap_return = if_loop_1(__xlx_a__tmp_vec.data(), __xlx_apatb_param_n);
