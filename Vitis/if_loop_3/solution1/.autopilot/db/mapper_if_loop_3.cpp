...
using hls::sim::Byte;
extern "C" int if_loop_3(Byte<4>*, Byte<4>*, int);
extern "C" int apatb_if_loop_3_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, int __xlx_apatb_param_n) {
...
__xlx_b__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_b)[i]);
  ...
  // DUT call
  int ap_return = if_loop_3(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_apatb_param_n);
