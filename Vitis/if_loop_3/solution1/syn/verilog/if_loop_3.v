...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_188)) begin
        if ((icmp_ln12_fu_105_p2 == 1'd1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        sum_fu_52 <= 32'd1000;
    end else if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (tmp_reg_200_pp0_iter1_reg == 1'd0))) begin
        sum_fu_52 <= grp_fu_143_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln12_reg_171 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        a_load_reg_185 <= a_q0;
        b_load_reg_190 <= b_q0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln12_reg_171 == 1'd1) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        dist_reg_195 <= dist_fu_128_p2;
        tmp_reg_200 <= dist_fu_128_p2[32'd31];
    end
end
...
always @ (*) begin
    if (((icmp_ln12_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage3_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (tmp_reg_200_pp0_iter1_reg == 1'd0))) begin
...
assign add_ln12_fu_111_p2 = (ap_sig_allocacmp_i_1 + 31'd1);
...
assign dist_fu_128_p2 = (a_load_reg_185 - b_load_reg_190);

assign i_cast1_fu_117_p1 = ap_sig_allocacmp_i_1;

assign i_cast_fu_101_p1 = ap_sig_allocacmp_i_1;

assign icmp_ln12_fu_105_p2 = (($signed(i_cast_fu_101_p1) < $signed(n)) ? 1'b1 : 1'b0);
