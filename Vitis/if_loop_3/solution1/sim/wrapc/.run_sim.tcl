...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "if_loop_3.autotvin.dat"
	set constFileTvOut       "if_loop_3.autotvout.dat"
	set constFileHdlTvIn     "if_loop_3.autohdltvin.dat"
	set constFileHdlTvOut    "if_loop_3.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
