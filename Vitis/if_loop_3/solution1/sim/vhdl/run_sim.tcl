...
if {[file isfile if_loop_3.autotvin.dat]} {
	file delete -force if_loop_3.autotvin.dat
}

if {[file isfile if_loop_3.autotvout.dat]} {
	file delete -force if_loop_3.autotvout.dat
}
