# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.h" 1
...
using std::wcstombs;
using std::wctomb;
# 9 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.h" 2
...
# 10 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.h" 2
...
# 11 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.h" 2
...
using std::tgamma;
using std::trunc;
# 12 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.h" 2

__attribute__((sdx_kernel("bicg", 0))) void bicg(int A[30][30], int s[30], int q[30], int p[30], int r[30]);
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.cpp" 2

__attribute__((sdx_kernel("bicg", 0))) void bicg(int A[30][30], int s[30], int q[30], int p[30], int r[30])
{
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/bicg/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=bicg
# 4 "../../../../Documents/LAP_hls_benchmarks/Vitis/bicg/bicg.cpp"

  int i, j;

  int tmp_q = 0;

  VITIS_LOOP_9_1: for (i = 0; i < 30; i++)
    {
      tmp_q = q[i];
      VITIS_LOOP_12_2: for (j = 0; j < 30; j++)
        {
            int tmp = A[i][j];
          s[j] = s[j] + r[i] * tmp;
          tmp_q = tmp_q + tmp * p[j];
