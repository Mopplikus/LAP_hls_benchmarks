set moduleName bicg_Pipeline_VITIS_LOOP_9_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {bicg_Pipeline_VITIS_LOOP_9_1}
...
set Spec2ImplPortList { 
	s { ap_memory {  { s_address0 mem_address 1 5 }  { s_ce0 mem_ce 1 1 }  { s_we0 mem_we 1 1 }  { s_d0 mem_din 1 32 }  { s_q0 in_data 0 32 }  { s_address1 MemPortADDR2 1 5 }  { s_ce1 MemPortCE2 1 1 }  { s_we1 MemPortWE2 1 1 }  { s_d1 MemPortDIN2 1 32 }  { s_q1 in_data 0 32 } } }
