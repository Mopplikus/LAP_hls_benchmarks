...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.bicg.autotvin_A.dat"
         "c.bicg.autotvin_s.dat"
         "c.bicg.autotvin_q.dat"
         "c.bicg.autotvin_p.dat"
         "c.bicg.autotvin_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.bicg.autotvout_s.dat"
         "rtl.bicg.autotvout_q.dat"
         "rtl.bicg.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
