...
define void @apatb_bicg_ir([30 x i32]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="30" %A, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="30" %s, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="30" %q, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="30" %p, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="30" %r) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_bicg_hw([30 x i32]* %5, i32* %6, i32* %7, i32* %8, i32* %9)
...
declare void @apatb_bicg_hw([30 x i32]*, i32*, i32*, i32*, i32*)
...
define void @bicg_hw_stub_wrapper([30 x i32]*, i32*, i32*, i32*, i32*) #4 {
entry:
  ...
  call void @bicg_hw_stub([30 x i32]* %10, i32* %11, i32* %12, i32* %13, i32* %14)
...
declare void @bicg_hw_stub([30 x i32]*, i32*, i32*, i32*, i32*)
