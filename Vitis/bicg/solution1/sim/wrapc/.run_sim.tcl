...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bicg.autotvin.dat"
	set constFileTvOut       "bicg.autotvout.dat"
	set constFileHdlTvIn     "bicg.autohdltvin.dat"
	set constFileHdlTvOut    "bicg.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
