set moduleName triangular_Pipeline_VITIS_LOOP_10_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {triangular_Pipeline_VITIS_LOOP_10_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "select_ln10", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln10 sc_in sc_lv 64 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln10", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "select_ln10", "role": "default" }} , 
 	{ "name": "x_load", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "x_load", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "triangular_Pipeline_VITIS_LOOP_10_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "select_ln10", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	triangular_Pipeline_VITIS_LOOP_10_2 {
		indvars_iv {Type I LastRead 0 FirstWrite -1}
		i_1 {Type I LastRead 0 FirstWrite -1}
		A {Type IO LastRead 6 FirstWrite 13}
		idxprom11 {Type I LastRead 0 FirstWrite -1}
		select_ln10 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	A { ap_memory {  { A_address0 mem_address 1 14 }  { A_ce0 mem_ce 1 1 }  { A_we0 mem_we 1 1 }  { A_d0 mem_din 1 32 }  { A_q0 mem_dout 0 32 }  { A_address1 MemPortADDR2 1 14 }  { A_ce1 MemPortCE2 1 1 }  { A_q1 in_data 0 32 } } }
	idxprom11 { ap_none {  { idxprom11 in_data 0 14 } } }
	select_ln10 { ap_none {  { select_ln10 in_data 0 64 } } }
