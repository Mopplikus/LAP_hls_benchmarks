# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/triangular/triangular.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/triangular/triangular.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/triangular/triangular.h" 1
...
# 7 "../../../../Documents/LAP_hls_benchmarks/Vitis/triangular/triangular.h" 2

__attribute__((sdx_kernel("triangular", 0))) int triangular( int x[100], int A[100][100] , int n);
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/triangular/triangular.cpp" 2

__attribute__((sdx_kernel("triangular", 0))) int triangular( int x[100], int A[100][100] , int n) {
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/triangular/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=triangular
# 3 "../../../../Documents/LAP_hls_benchmarks/Vitis/triangular/triangular.cpp"

 int i;
    VITIS_LOOP_5_1: for (i=n-1; i>=0; i--) {

     VITIS_LOOP_7_2: for (int k=i-1;k>=0; k--) {
            A[k][n] -= A[k][i] * x[i];
        }
 }
