set moduleName triangular_Pipeline_VITIS_LOOP_7_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {triangular_Pipeline_VITIS_LOOP_7_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ indvars_iv int 64 regular  }
	{ i_1 int 14 regular  }
	{ A int 32 regular {array 10000 { 2 1 } 1 1 }  }
	{ idxprom11 int 14 regular  }
	{ select_ln7 int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "idxprom11", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln7", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ idxprom11 sc_in sc_lv 14 signal 3 } 
	{ select_ln7 sc_in sc_lv 64 signal 4 } 
	{ x_load sc_in sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "idxprom11", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "idxprom11", "role": "default" }} , 
 	{ "name": "select_ln7", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "select_ln7", "role": "default" }} , 
 	{ "name": "x_load", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "x_load", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "triangular_Pipeline_VITIS_LOOP_7_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "idxprom11", "Type" : "None", "Direction" : "I"},
			{"Name" : "select_ln7", "Type" : "None", "Direction" : "I"},
			{"Name" : "x_load", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_7_2", "PipelineType" : "UPC",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_14s_7ns_14_4_1_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	triangular_Pipeline_VITIS_LOOP_7_2 {
		indvars_iv {Type I LastRead 0 FirstWrite -1}
		i_1 {Type I LastRead 0 FirstWrite -1}
		A {Type IO LastRead 6 FirstWrite 7}
		idxprom11 {Type I LastRead 0 FirstWrite -1}
		select_ln7 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	i_1 { ap_none {  { i_1 in_data 0 14 } } }
	A { ap_memory {  { A_address0 mem_address 1 14 }  { A_ce0 mem_ce 1 1 }  { A_we0 mem_we 1 1 }  { A_d0 mem_din 1 32 }  { A_q0 in_data 0 32 }  { A_address1 MemPortADDR2 1 14 }  { A_ce1 MemPortCE2 1 1 }  { A_q1 in_data 0 32 } } }
	idxprom11 { ap_none {  { idxprom11 in_data 0 14 } } }
	select_ln7 { ap_none {  { select_ln7 in_data 0 64 } } }
