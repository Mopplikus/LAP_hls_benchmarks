...
using hls::sim::Byte;
extern "C" int triangular(Byte<4>*, Byte<4>*, int);
extern "C" int apatb_triangular_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_A, int __xlx_apatb_param_n) {
...
__xlx_A__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_A)[i]);
  ...
  int __xlx_size_param_A = 10000;
  int __xlx_offset_param_A = 0;
  int __xlx_offset_byte_param_A = 0*4;
  // DUT call
  int ap_return = triangular(__xlx_x__tmp_vec.data(), __xlx_A__tmp_vec.data(), __xlx_apatb_param_n);
