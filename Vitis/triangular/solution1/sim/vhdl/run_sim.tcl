...
if {[file isfile triangular.autotvin.dat]} {
	file delete -force triangular.autotvin.dat
}

if {[file isfile triangular.autotvout.dat]} {
	file delete -force triangular.autotvout.dat
}
