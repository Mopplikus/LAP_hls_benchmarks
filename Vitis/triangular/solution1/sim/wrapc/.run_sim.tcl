...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "triangular.autotvin.dat"
	set constFileTvOut       "triangular.autotvout.dat"
	set constFileHdlTvIn     "triangular.autohdltvin.dat"
	set constFileHdlTvOut    "triangular.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
