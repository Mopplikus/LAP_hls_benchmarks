...
if {[file isfile if_loop_2.autotvin.dat]} {
	file delete -force if_loop_2.autotvin.dat
}

if {[file isfile if_loop_2.autotvout.dat]} {
	file delete -force if_loop_2.autotvout.dat
}
