...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "if_loop_2.autotvin.dat"
	set constFileTvOut       "if_loop_2.autotvout.dat"
	set constFileHdlTvIn     "if_loop_2.autohdltvin.dat"
	set constFileHdlTvOut    "if_loop_2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
