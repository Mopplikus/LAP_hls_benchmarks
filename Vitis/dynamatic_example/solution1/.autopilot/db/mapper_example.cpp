...
using hls::sim::Byte;
extern "C" float example(Byte<4>*, Byte<4>*, int);
extern "C" float apatb_example_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, int __xlx_apatb_param_n) {
...
__xlx_B__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_B)[i]);
  ...
  // DUT call
  float ap_return = example(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_apatb_param_n);
