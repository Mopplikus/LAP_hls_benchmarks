set SynModuleInfo {
  {SRCNAME example MODELNAME example RTLNAME example IS_TOP 1
    SUBMODULES {
      {MODELNAME example_faddfsub_32ns_32ns_32_6_full_dsp_1 RTLNAME example_faddfsub_32ns_32ns_32_6_full_dsp_1 BINDTYPE op TYPE fsub IMPL fulldsp LATENCY 5 ALLOW_PRAGMA 1}
