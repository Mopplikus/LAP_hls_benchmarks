# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/3mm/kernel_3mm.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/3mm/kernel_3mm.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/3mm/kernel_3mm.h" 1
...
# 5 "../../../../Documents/LAP_hls_benchmarks/Vitis/3mm/kernel_3mm.h" 2
...
using std::wcstombs;
using std::wctomb;
# 6 "../../../../Documents/LAP_hls_benchmarks/Vitis/3mm/kernel_3mm.h" 2
...
__attribute__((sdx_kernel("kernel_3mm", 0))) void kernel_3mm(int A[10][10], int B[10][10], int C[10][10], int D[10][10], int E[10][10], int F[10][10], int G[10][10]);
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/3mm/kernel_3mm.cpp" 2

__attribute__((sdx_kernel("kernel_3mm", 0))) void kernel_3mm(int A[10][10], int B[10][10], int C[10][10], int D[10][10], int E[10][10], int F[10][10], int G[10][10])
{
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/kernel_3mm/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=kernel_3mm
# 4 "../../../../Documents/LAP_hls_benchmarks/Vitis/3mm/kernel_3mm.cpp"

    int i,j,k;

  VITIS_LOOP_7_1: for (i = 0; i < 10; i++)
    VITIS_LOOP_8_2: for (j = 0; j < 10; j++)
    {
      int tmp = E[i][j];
      VITIS_LOOP_11_3: for (k = 0; k < 10; ++k)
        tmp += A[i][k] * B[k][j];
      E[i][j] = tmp;
    }

  VITIS_LOOP_16_4: for (i = 0; i < 10; i++)
    VITIS_LOOP_17_5: for (j = 0; j < 10; j++)
    {
      int tmp = F[i][j];
      VITIS_LOOP_20_6: for (k = 0; k < 10; ++k)
        tmp += C[i][k] * D[k][j];
      F[i][j] = tmp;
    }

  VITIS_LOOP_25_7: for (i = 0; i < 10; i++)
    VITIS_LOOP_26_8: for (j = 0; j < 10; j++)
    {
      int tmp = G[i][j];
      VITIS_LOOP_29_9: for (k = 0; k < 10; ++k)
        tmp += E[i][k] * F[k][j];
      G[i][j] = tmp;
    }
}
