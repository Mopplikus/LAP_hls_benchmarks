...
if {[file isfile kernel_3mm.autotvin.dat]} {
	file delete -force kernel_3mm.autotvin.dat
}

if {[file isfile kernel_3mm.autotvout.dat]} {
	file delete -force kernel_3mm.autotvout.dat
}
