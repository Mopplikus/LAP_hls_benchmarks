...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "kernel_3mm.autotvin.dat"
	set constFileTvOut       "kernel_3mm.autotvout.dat"
	set constFileHdlTvIn     "kernel_3mm.autohdltvin.dat"
	set constFileHdlTvOut    "kernel_3mm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
