...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "getTanh.autotvin.dat"
	set constFileTvOut       "getTanh.autotvout.dat"
	set constFileHdlTvIn     "getTanh.autohdltvin.dat"
	set constFileHdlTvOut    "getTanh.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
