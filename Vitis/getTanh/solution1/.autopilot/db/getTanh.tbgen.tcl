...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "6004", "EstimateLatencyMax" : "6004",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	getTanh {
		A {Type IO LastRead 1 FirstWrite 8}
		addr {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6004", "Max" : "6004"}
	, {"Name" : "Interval", "Min" : "6005", "Max" : "6005"}
]}
...
set Spec2ImplPortList { 
	...
	addr { ap_memory {  { addr_address0 mem_address 1 10 }  { addr_ce0 mem_ce 1 1 }  { addr_q0 in_data 0 32 } } }
}
