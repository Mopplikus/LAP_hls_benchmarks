...
using hls::sim::Byte;
extern "C" int matvec(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" int apatb_matvec_hw(volatile void * __xlx_apatb_param_M, volatile void * __xlx_apatb_param_V, volatile void * __xlx_apatb_param_Out_r) {
...
__xlx_M__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_M)[i]);
  ...
  int __xlx_size_param_M = 900;
  int __xlx_offset_param_M = 0;
  int __xlx_offset_byte_param_M = 0*4;
  // Collect __xlx_V__tmp_vec
std::vector<Byte<4>> __xlx_V__tmp_vec;
for (size_t i = 0; i < 30; ++i){
__xlx_V__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_V)[i]);
}
  int __xlx_size_param_V = 30;
  int __xlx_offset_param_V = 0;
  int __xlx_offset_byte_param_V = 0*4;
...
__xlx_Out_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_Out_r)[i]);
  ...
  int __xlx_size_param_Out_r = 30;
  int __xlx_offset_param_Out_r = 0;
  int __xlx_offset_byte_param_Out_r = 0*4;
  // DUT call
  int ap_return = matvec(__xlx_M__tmp_vec.data(), __xlx_V__tmp_vec.data(), __xlx_Out_r__tmp_vec.data());
...
((Byte<4>*)__xlx_apatb_param_V)[i] = __xlx_V__tmp_vec[__xlx_offset_param_V+i];
}
