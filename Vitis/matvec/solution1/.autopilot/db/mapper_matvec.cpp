...
using hls::sim::Byte;
extern "C" void matvec(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_matvec_hw(volatile void * __xlx_apatb_param_M, volatile void * __xlx_apatb_param_V, volatile void * __xlx_apatb_param_Out_r) {
...
__xlx_Out_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_Out_r)[i]);
  ...
  // DUT call
  matvec(__xlx_M__tmp_vec.data(), __xlx_V__tmp_vec.data(), __xlx_Out_r__tmp_vec.data());
