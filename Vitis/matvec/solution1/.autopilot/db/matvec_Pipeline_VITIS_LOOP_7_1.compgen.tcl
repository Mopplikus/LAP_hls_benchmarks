...
set name matvec_mul_32s_32s_32_5_1
...
eval "cg_default_interface_gen_dc { \
    id 64 \
    name add_lcssa_phi_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add_lcssa_phi_out \
    op interface \
    ports { add_lcssa_phi_out { O 32 vector } add_lcssa_phi_out_ap_vld { O 1 bit } } \
} "
}
