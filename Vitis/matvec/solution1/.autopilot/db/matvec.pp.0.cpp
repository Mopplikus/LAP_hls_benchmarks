# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/matvec/matvec.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/matvec/matvec.cpp" 2
# 1 "../../../../Documents/LAP_hls_benchmarks/Vitis/matvec/matvec.h" 1
...
using std::wcstombs;
using std::wctomb;
# 5 "../../../../Documents/LAP_hls_benchmarks/Vitis/matvec/matvec.h" 2
...
# 6 "../../../../Documents/LAP_hls_benchmarks/Vitis/matvec/matvec.h" 2



__attribute__((sdx_kernel("matvec", 0))) void matvec (int M[30][30], int V[30], int Out[30]);
# 2 "../../../../Documents/LAP_hls_benchmarks/Vitis/matvec/matvec.cpp" 2

__attribute__((sdx_kernel("matvec", 0))) void matvec (int M[30][30], int V[30], int Out[30]) {
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/matvec/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=matvec
# 3 "../../../../Documents/LAP_hls_benchmarks/Vitis/matvec/matvec.cpp"

 int i, j;
 int tmp = 0;

 VITIS_LOOP_7_1: for (i=0;i<30;i++) {
  tmp = 0;

  VITIS_LOOP_10_2: for (j=0;j<30;j++) {
   tmp += V[j]* M[i][j];
  }
  Out[i] = tmp;
 }
