...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matvec.autotvin.dat"
	set constFileTvOut       "matvec.autotvout.dat"
	set constFileHdlTvIn     "matvec.autohdltvin.dat"
	set constFileHdlTvOut    "matvec.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
