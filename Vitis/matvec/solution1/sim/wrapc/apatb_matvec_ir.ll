...
define i32 @apatb_matvec_ir([30 x i32]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="30" %M, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="30" %V, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="30" %Out) local_unnamed_addr #0 {
entry:
  ...
  %6 = call i32 @apatb_matvec_hw([30 x i32]* %3, i32* %4, i32* %5)
...
declare i32 @apatb_matvec_hw([30 x i32]*, i32*, i32*)
...
define i32 @matvec_hw_stub_wrapper([30 x i32]*, i32*, i32*) #4 {
entry:
