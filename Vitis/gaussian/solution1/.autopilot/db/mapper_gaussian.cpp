...
using hls::sim::Byte;
extern "C" void gaussian(Byte<4>*, Byte<4>*);
extern "C" void apatb_gaussian_hw(volatile void * __xlx_apatb_param_c, volatile void * __xlx_apatb_param_A) {
...
__xlx_A__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_A)[i]);
  ...
  // DUT call
  gaussian(__xlx_c__tmp_vec.data(), __xlx_A__tmp_vec.data());
