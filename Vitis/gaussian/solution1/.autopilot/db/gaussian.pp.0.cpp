# 1 "../../../../Documents/LAP/Vitis/gaussian/gaussian.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../Documents/LAP/Vitis/gaussian/gaussian.cpp" 2
# 1 "../../../../Documents/LAP/Vitis/gaussian/gaussian.h" 1
...
# 5 "../../../../Documents/LAP/Vitis/gaussian/gaussian.h" 2
...
using std::wcstombs;
using std::wctomb;
# 6 "../../../../Documents/LAP/Vitis/gaussian/gaussian.h" 2

__attribute__((sdx_kernel("gaussian", 0))) void gaussian (int c[20], int A[20][20]);
# 2 "../../../../Documents/LAP/Vitis/gaussian/gaussian.cpp" 2

__attribute__((sdx_kernel("gaussian", 0))) void gaussian (int c[20], int A[20][20]) {
#line 15 "C:/Users/Elija/AppData/Roaming/Xilinx/Vitis/gaussian/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=gaussian
# 3 "../../../../Documents/LAP/Vitis/gaussian/gaussian.cpp"


    VITIS_LOOP_5_1: for(int j=1; j<=18; j++)


        { VITIS_LOOP_8_2: for(int i=j+1; i<=18;i++)

            {

                VITIS_LOOP_12_3: for(int k=1; k<=19; k++)
