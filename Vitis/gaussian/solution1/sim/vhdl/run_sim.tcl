...
if {[file isfile gaussian.autotvin.dat]} {
	file delete -force gaussian.autotvin.dat
}

if {[file isfile gaussian.autotvout.dat]} {
	file delete -force gaussian.autotvout.dat
}
