...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gaussian.autotvin.dat"
	set constFileTvOut       "gaussian.autotvout.dat"
	set constFileHdlTvIn     "gaussian.autohdltvin.dat"
	set constFileHdlTvOut    "gaussian.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
