...
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.covariance.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_data "../tv/rtldatafile/rtl.covariance.autotvout_data.dat"
#define AUTOTB_TVOUT_PC_cov "../tv/rtldatafile/rtl.covariance.autotvout_cov.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.covariance.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> covariance_hw_stub_wrapper(void*, void*);

extern "C"
hls::sim::Byte<4> apatb_covariance_hw(void* __xlx_apatb_param_data, void* __xlx_apatb_param_cov)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_cov),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_cov),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_cov),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_cov),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_cov),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_cov),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_cov };
  port2.depth = { 1024 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  try {
    ...
    ap_return = covariance_hw_stub_wrapper(__xlx_apatb_param_data, __xlx_apatb_param_cov);
