; ModuleID = '.gaussian.cpp_mem2reg.ll'
...
for.body:                                         ; preds = %entry, %for.inc22
  ...
  br i1 %cmp22, label %for.body3.lr.ph, label %for.end21

for.body3.lr.ph:                                  ; preds = %for.body
  br label %for.body3

for.body3:                                        ; preds = %for.body3.lr.ph, %for.inc19
  %i.03 = phi i32 [ %add, %for.body3.lr.ph ], [ %inc20, %for.inc19 ]
  br label %for.body6

for.body6:                                        ; preds = %for.body3, %for.inc
  %k.01 = phi i32 [ 1, %for.body3 ], [ %inc, %for.inc ]
...
for.inc19:                                        ; preds = %for.end
  ...
  br i1 %cmp2, label %for.body3, label %for.cond1.for.end21_crit_edge

for.cond1.for.end21_crit_edge:                    ; preds = %for.inc19
  br label %for.end21

for.end21:                                        ; preds = %for.cond1.for.end21_crit_edge, %for.body
  br label %for.inc22
