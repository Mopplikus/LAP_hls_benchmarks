...
-- File created: Wed Apr 12 17:39:57 2023
...
begin
	...
	branchC_14_clk <= clk;
	branchC_14_rst <= rst;
	Buffer_16_pValidArray_0 <= branchC_14_validArray_0;
	branchC_14_nReadyArray_0 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_14_dataOutArray_0),Buffer_16_dataInArray_0'length));
	...
	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	phiC_8_pValidArray_0 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= phiC_8_readyArray_0;
	phiC_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),phiC_8_dataInArray_0'length));
	...
	Buffer_11_pValidArray_0 <= branch_1_validArray_1;
	branch_1_nReadyArray_1 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_1_dataOutArray_1),Buffer_11_dataInArray_0'length));
	...
	phiC_8_clk <= clk;
	phiC_8_rst <= rst;
	Buffer_17_pValidArray_0 <= phiC_8_validArray_0;
	phiC_8_nReadyArray_0 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_8_dataOutArray_0),Buffer_17_dataInArray_0'length));
	...
	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_n0_pValidArray_0 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_n0_readyArray_0;
	phi_n0_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_n0_dataInArray_0'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	branchC_15_pValidArray_0 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= branchC_15_readyArray_0;
	branchC_15_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),branchC_15_dataInArray_0'length));
	...
	Buffer_2_pValidArray_0 <= getelementptr_11_validArray_0;
	getelementptr_11_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(getelementptr_11_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	load_15_clk <= clk;
	load_15_rst <= rst;
	Buffer_3_pValidArray_0 <= load_15_validArray_0;
	load_15_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(load_15_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n6_dataOutArray_0),Buffer_4_dataInArray_0'length));

	phi_n7_clk <= clk;
	phi_n7_rst <= rst;
	Buffer_5_pValidArray_0 <= phi_n7_validArray_0;
	phi_n7_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n7_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	Buffer_9_pValidArray_0 <= fork_2_validArray_3;
	fork_2_nReadyArray_3 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_3),Buffer_9_dataInArray_0'length));
	...
	Buffer_12_pValidArray_0 <= fork_13_validArray_3;
	fork_13_nReadyArray_3 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_3),Buffer_12_dataInArray_0'length));
	...
	Buffer_18_pValidArray_0 <= forkC_22_validArray_1;
	forkC_22_nReadyArray_1 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_22_dataOutArray_1),Buffer_18_dataInArray_0'length));
	...
	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	load_12_pValidArray_1 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= load_12_readyArray_1;
	load_12_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),load_12_dataInArray_1'length));

	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	mul_20_pValidArray_0 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= mul_20_readyArray_0;
	mul_20_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),mul_20_dataInArray_0'length));

	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	fork_7_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= fork_7_readyArray_0;
	fork_7_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),fork_7_dataInArray_0'length));
	...
	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	zext_10_pValidArray_0 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= zext_10_readyArray_0;
	zext_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),zext_10_dataInArray_0'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	zext_17_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= zext_17_readyArray_0;
	zext_17_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),zext_17_dataInArray_0'length));

	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	zext_23_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= zext_23_readyArray_0;
	zext_23_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),zext_23_dataInArray_0'length));

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	add_25_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= add_25_readyArray_0;
	add_25_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),add_25_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	branchC_18_pValidArray_1 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= branchC_18_readyArray_1;
	branchC_18_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),branchC_18_dataInArray_1'length));
	...
	branch_11_clk <= clk;
	branch_11_rst <= rst;
	Buffer_13_pValidArray_0 <= branch_11_validArray_0;
	branch_11_nReadyArray_0 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_11_dataOutArray_0),Buffer_13_dataInArray_0'length));
	...
	branch_12_clk <= clk;
	branch_12_rst <= rst;
	Buffer_15_pValidArray_0 <= branch_12_validArray_0;
	branch_12_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_0),Buffer_15_dataInArray_0'length));
	Buffer_14_pValidArray_0 <= branch_12_validArray_1;
	branch_12_nReadyArray_1 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_1),Buffer_14_dataInArray_0'length));
	...
	branchC_19_clk <= clk;
	branchC_19_rst <= rst;
	Buffer_19_pValidArray_0 <= branchC_19_validArray_0;
	branchC_19_nReadyArray_0 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_19_dataOutArray_0),Buffer_19_dataInArray_0'length));
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phi_6_pValidArray_2 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phi_6_readyArray_2;
	phi_6_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phi_6_dataInArray_2'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	phi_n0_pValidArray_1 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= phi_n0_readyArray_1;
	phi_n0_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),phi_n0_dataInArray_1'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	phi_n3_pValidArray_1 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= phi_n3_readyArray_1;
	phi_n3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),phi_n3_dataInArray_1'length));

	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	phiC_10_pValidArray_1 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= phiC_10_readyArray_1;
	phiC_10_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),phiC_10_dataInArray_1'length));
	...
	phiC_13_clk <= clk;
	phiC_13_rst <= rst;
	Buffer_20_pValidArray_0 <= phiC_13_validArray_0;
	phiC_13_nReadyArray_0 <= Buffer_20_readyArray_0;
	Buffer_20_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_13_dataOutArray_0),Buffer_20_dataInArray_0'length));
	...
	Buffer_21_pValidArray_0 <= branchC_20_validArray_1;
	branchC_20_nReadyArray_1 <= Buffer_21_readyArray_0;
	Buffer_21_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_20_dataOutArray_1),Buffer_21_dataInArray_0'length));
	...
	Buffer_20_clk <= clk;
	Buffer_20_rst <= rst;
	branchC_20_pValidArray_0 <= Buffer_20_validArray_0;
	Buffer_20_nReadyArray_0 <= branchC_20_readyArray_0;
	branchC_20_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_20_dataOutArray_0),branchC_20_dataInArray_0'length));

	Buffer_21_clk <= clk;
	Buffer_21_rst <= rst;
	phiC_14_pValidArray_0 <= Buffer_21_validArray_0;
	Buffer_21_nReadyArray_0 <= phiC_14_readyArray_0;
	phiC_14_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_21_dataOutArray_0),phiC_14_dataInArray_0'length));
...
Buffer_3: entity work.transpFifo(arch) generic map (1,1,32,32,3)
port map (
	clk => Buffer_3_clk,
	rst => Buffer_3_rst,
