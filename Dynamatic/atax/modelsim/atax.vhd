...
-- File created: Wed Apr 12 11:38:55 2023
...
architecture behavioral of atax is 
	...
	signal buffI_0_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal buffI_0_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal buffI_2_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal buffI_2_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal buffI_3_clk : std_logic;
	signal buffI_3_rst : std_logic;
	signal buffI_3_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal buffI_3_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal buffI_4_clk : std_logic;
	signal buffI_4_rst : std_logic;
	signal buffI_4_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal buffI_4_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal buffI_5_clk : std_logic;
	signal buffI_5_rst : std_logic;
	signal buffI_5_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal buffI_5_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal buffA_7_clk : std_logic;
	signal buffA_7_rst : std_logic;
	signal buffA_7_dataInArray_0 : std_logic_vector(0 downto 0);
	signal buffA_7_pValidArray_0 : std_logic;
	signal buffA_7_readyArray_0 : std_logic;
	signal buffA_7_nReadyArray_0 : std_logic;
	signal buffA_7_validArray_0 : std_logic;
	signal buffA_7_dataOutArray_0 : std_logic_vector(0 downto 0);
...
begin
	...
	phi_6_clk <= clk;
	phi_6_rst <= rst;
	buffI_1_pValidArray_0 <= phi_6_validArray_0;
	phi_6_nReadyArray_0 <= buffI_1_readyArray_0;
	buffI_1_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_6_dataOutArray_0),buffI_1_dataInArray_0'length));
	...
	phi_7_clk <= clk;
	phi_7_rst <= rst;
	buffI_2_pValidArray_0 <= phi_7_validArray_0;
	phi_7_nReadyArray_0 <= buffI_2_readyArray_0;
	buffI_2_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_7_dataOutArray_0),buffI_2_dataInArray_0'length));
	...
	add_17_clk <= clk;
	add_17_rst <= rst;
	fork_3_pValidArray_0 <= add_17_validArray_0;
	add_17_nReadyArray_0 <= fork_3_readyArray_0;
	fork_3_dataInArray_0 <= std_logic_vector (resize(unsigned(add_17_dataOutArray_0),fork_3_dataInArray_0'length));
	...
	phi_21_clk <= clk;
	phi_21_rst <= rst;
	buffI_3_pValidArray_0 <= phi_21_validArray_0;
	phi_21_nReadyArray_0 <= buffI_3_readyArray_0;
	buffI_3_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_21_dataOutArray_0),buffI_3_dataInArray_0'length));
	...
	phi_n2_clk <= clk;
	phi_n2_rst <= rst;
	buffI_4_pValidArray_0 <= phi_n2_validArray_0;
	phi_n2_nReadyArray_0 <= buffI_4_readyArray_0;
	buffI_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n2_dataOutArray_0),buffI_4_dataInArray_0'length));
	...
	phi_n6_clk <= clk;
	phi_n6_rst <= rst;
	buffI_5_pValidArray_0 <= phi_n6_validArray_0;
	phi_n6_nReadyArray_0 <= buffI_5_readyArray_0;
	buffI_5_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n6_dataOutArray_0),buffI_5_dataInArray_0'length));

	phi_n7_clk <= clk;
	phi_n7_rst <= rst;
	buffI_6_pValidArray_0 <= phi_n7_validArray_0;
	phi_n7_nReadyArray_0 <= buffI_6_readyArray_0;
	buffI_6_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n7_dataOutArray_0),buffI_6_dataInArray_0'length));
	...
	branch_1_pValidArray_1 <= fork_12_validArray_2;
	fork_12_nReadyArray_2 <= branch_1_readyArray_1;
	branch_1_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_2),branch_1_dataInArray_1'length));
	...
	branch_4_pValidArray_1 <= fork_13_validArray_2;
	fork_13_nReadyArray_2 <= branch_4_readyArray_1;
	branch_4_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_2),branch_4_dataInArray_1'length));
	...
	fork_14_clk <= clk;
	fork_14_rst <= rst;
	branch_9_pValidArray_1 <= fork_14_validArray_0;
	fork_14_nReadyArray_0 <= branch_9_readyArray_1;
	branch_9_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_0),branch_9_dataInArray_1'length));
	...
	branch_10_clk <= clk;
	branch_10_rst <= rst;
	phi_21_pValidArray_2 <= branch_10_validArray_0;
	branch_10_nReadyArray_0 <= phi_21_readyArray_2;
	phi_21_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_10_dataOutArray_0),phi_21_dataInArray_2'length));
	...
	phi_n7_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_0),phi_n7_dataInArray_1'length));
	...
	fork_15_clk <= clk;
	fork_15_rst <= rst;
	branch_12_pValidArray_1 <= fork_15_validArray_0;
	fork_15_nReadyArray_0 <= branch_12_readyArray_1;
	branch_12_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_15_dataOutArray_0),branch_12_dataInArray_1'length));
	branch_11_pValidArray_1 <= fork_15_validArray_1;
	fork_15_nReadyArray_1 <= branch_11_readyArray_1;
	branch_11_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_15_dataOutArray_1),branch_11_dataInArray_1'length));
	...
	branchC_18_pValidArray_1 <= fork_15_validArray_3;
	fork_15_nReadyArray_3 <= branchC_18_readyArray_1;
	branchC_18_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_15_dataOutArray_3),branchC_18_dataInArray_1'length));
	...
	phiC_8_clk <= clk;
	phiC_8_rst <= rst;
	buffA_7_pValidArray_0 <= phiC_8_validArray_0;
	phiC_8_nReadyArray_0 <= buffA_7_readyArray_0;
	buffA_7_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_8_dataOutArray_0),buffA_7_dataInArray_0'length));
	...
	phiC_9_clk <= clk;
	phiC_9_rst <= rst;
	buffA_8_pValidArray_0 <= phiC_9_validArray_0;
	phiC_9_nReadyArray_0 <= buffA_8_readyArray_0;
	buffA_8_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_9_dataOutArray_0),buffA_8_dataInArray_0'length));
	...
	branchC_16_clk <= clk;
	branchC_16_rst <= rst;
	phiC_9_pValidArray_1 <= branchC_16_validArray_0;
	branchC_16_nReadyArray_0 <= phiC_9_readyArray_1;
	phiC_9_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_16_dataOutArray_0),phiC_9_dataInArray_1'length));
	...
	phiC_11_clk <= clk;
	phiC_11_rst <= rst;
	buffA_9_pValidArray_0 <= phiC_11_validArray_0;
	phiC_11_nReadyArray_0 <= buffA_9_readyArray_0;
	buffA_9_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_0),buffA_9_dataInArray_0'length));
	...
	branchC_18_pValidArray_0 <= forkC_23_validArray_1;
	forkC_23_nReadyArray_1 <= branchC_18_readyArray_0;
	branchC_18_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_23_dataOutArray_1),branchC_18_dataInArray_0'length));
	...
	buffI_1_clk <= clk;
	buffI_1_rst <= rst;
	add_16_pValidArray_0 <= buffI_1_validArray_0;
	buffI_1_nReadyArray_0 <= add_16_readyArray_0;
	add_16_dataInArray_0 <= std_logic_vector (resize(unsigned(buffI_1_dataOutArray_0),add_16_dataInArray_0'length));

	buffI_2_clk <= clk;
	buffI_2_rst <= rst;
	fork_1_pValidArray_0 <= buffI_2_validArray_0;
	buffI_2_nReadyArray_0 <= fork_1_readyArray_0;
	fork_1_dataInArray_0 <= std_logic_vector (resize(unsigned(buffI_2_dataOutArray_0),fork_1_dataInArray_0'length));

	buffI_3_clk <= clk;
	buffI_3_rst <= rst;
	fork_4_pValidArray_0 <= buffI_3_validArray_0;
	buffI_3_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(buffI_3_dataOutArray_0),fork_4_dataInArray_0'length));

	buffI_4_clk <= clk;
	buffI_4_rst <= rst;
	fork_8_pValidArray_0 <= buffI_4_validArray_0;
	buffI_4_nReadyArray_0 <= fork_8_readyArray_0;
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(buffI_4_dataOutArray_0),fork_8_dataInArray_0'length));

	buffI_5_clk <= clk;
	buffI_5_rst <= rst;
	fork_9_pValidArray_0 <= buffI_5_validArray_0;
	buffI_5_nReadyArray_0 <= fork_9_readyArray_0;
	fork_9_dataInArray_0 <= std_logic_vector (resize(unsigned(buffI_5_dataOutArray_0),fork_9_dataInArray_0'length));

	buffI_6_clk <= clk;
	buffI_6_rst <= rst;
	fork_10_pValidArray_0 <= buffI_6_validArray_0;
	buffI_6_nReadyArray_0 <= fork_10_readyArray_0;
	fork_10_dataInArray_0 <= std_logic_vector (resize(unsigned(buffI_6_dataOutArray_0),fork_10_dataInArray_0'length));

	buffA_7_clk <= clk;
	buffA_7_rst <= rst;
	forkC_20_pValidArray_0 <= buffA_7_validArray_0;
	buffA_7_nReadyArray_0 <= forkC_20_readyArray_0;
	forkC_20_dataInArray_0 <= std_logic_vector (resize(unsigned(buffA_7_dataOutArray_0),forkC_20_dataInArray_0'length));

	buffA_8_clk <= clk;
	buffA_8_rst <= rst;
	branchC_16_pValidArray_0 <= buffA_8_validArray_0;
	buffA_8_nReadyArray_0 <= branchC_16_readyArray_0;
	branchC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(buffA_8_dataOutArray_0),branchC_16_dataInArray_0'length));

	buffA_9_clk <= clk;
	buffA_9_rst <= rst;
	forkC_23_pValidArray_0 <= buffA_9_validArray_0;
	buffA_9_nReadyArray_0 <= forkC_23_readyArray_0;
	forkC_23_dataInArray_0 <= std_logic_vector (resize(unsigned(buffA_9_dataOutArray_0),forkC_23_dataInArray_0'length));

	fork_28_clk <= clk;
	fork_28_rst <= rst;
	phi_6_pValidArray_0 <= fork_28_validArray_0;
	fork_28_nReadyArray_0 <= phi_6_readyArray_0;
	phi_6_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_28_dataOutArray_0),phi_6_dataInArray_0'length));
...
buffI_0: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => buffI_0_clk,
	rst => buffI_0_rst,
...
buffI_2: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => buffI_2_clk,
	rst => buffI_2_rst,
...
buffI_3: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => buffI_3_clk,
	rst => buffI_3_rst,
...
buffI_4: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => buffI_4_clk,
	rst => buffI_4_rst,
...
buffI_5: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => buffI_5_clk,
	rst => buffI_5_rst,
...
buffA_7: entity work.elasticBuffer(arch) generic map (1,1,1,1)
port map (
	clk => buffA_7_clk,
	rst => buffA_7_rst,
	dataInArray(0) => buffA_7_dataInArray_0,
	pValidArray(0) => buffA_7_pValidArray_0,
	readyArray(0) => buffA_7_readyArray_0,
	nReadyArray(0) => buffA_7_nReadyArray_0,
	validArray(0) => buffA_7_validArray_0,
	dataOutArray(0) => buffA_7_dataOutArray_0
);
