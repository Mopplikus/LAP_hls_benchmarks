...
-- File created: Thu Mar 16 02:27:25 2023
...
architecture behavioral of example is 
	...
	signal fork_4_dataInArray_0 : std_logic_vector(6 downto 0);
	...
	signal fork_4_dataOutArray_0 : std_logic_vector(6 downto 0);
	signal fork_4_nReadyArray_1 : std_logic;
	signal fork_4_validArray_1 : std_logic;
	signal fork_4_dataOutArray_1 : std_logic_vector(6 downto 0);
	...
	signal sink_3_dataInArray_0 : std_logic_vector(6 downto 0);
...
begin
	...
	fork_5_dataInArray_0 <= std_logic_vector (resize(unsigned(brCst_block1_dataOutArray_0),fork_5_dataInArray_0'length));
	...
	branchC_4_pValidArray_1 <= fork_5_validArray_2;
	fork_5_nReadyArray_2 <= branchC_4_readyArray_1;
	branchC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_2),branchC_4_dataInArray_1'length));
	...
	cst_1_pValidArray_0 <= forkC_8_validArray_1;
	forkC_8_nReadyArray_1 <= cst_1_readyArray_0;
	cst_1_dataInArray_0 <= "00000000000000000000000000000000";
	branchC_4_pValidArray_0 <= forkC_8_validArray_2;
	forkC_8_nReadyArray_2 <= branchC_4_readyArray_0;
	branchC_4_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_8_dataOutArray_2),branchC_4_dataInArray_0'length));
	brCst_block1_pValidArray_0 <= forkC_8_validArray_3;
	forkC_8_nReadyArray_3 <= brCst_block1_readyArray_0;
	...
	add_12_clk <= clk;
	add_12_rst <= rst;
	fork_4_pValidArray_0 <= add_12_validArray_0;
	add_12_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(add_12_dataOutArray_0),fork_4_dataInArray_0'length));
	...
	icmp_13_clk <= clk;
	icmp_13_rst <= rst;
	fork_6_pValidArray_0 <= icmp_13_validArray_0;
	icmp_13_nReadyArray_0 <= fork_6_readyArray_0;
	fork_6_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_13_dataOutArray_0),fork_6_dataInArray_0'length));

	fork_0_clk <= clk;
	fork_0_rst <= rst;
	Buffer_4_pValidArray_0 <= fork_0_validArray_0;
	fork_0_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	fork_4_clk <= clk;
	fork_4_rst <= rst;
	icmp_13_pValidArray_0 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= icmp_13_readyArray_0;
	icmp_13_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_0),icmp_13_dataInArray_0'length));
	...
	Buffer_8_pValidArray_0 <= branch_2_validArray_1;
	branch_2_nReadyArray_1 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_1),Buffer_8_dataInArray_0'length));
	...
	Buffer_9_pValidArray_0 <= fork_6_validArray_1;
	fork_6_nReadyArray_1 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_1),Buffer_9_dataInArray_0'length));
	branchC_5_pValidArray_1 <= fork_6_validArray_2;
	fork_6_nReadyArray_2 <= branchC_5_readyArray_1;
	branchC_5_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_2),branchC_5_dataInArray_1'length));
	...
	fork_11_pValidArray_0 <= phiC_1_validArray_1;
	phiC_1_nReadyArray_1 <= fork_11_readyArray_0;
	fork_11_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_1_dataOutArray_1),fork_11_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	add_12_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= add_12_readyArray_0;
	add_12_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),add_12_dataInArray_0'length));
...
fork_4: entity work.fork(arch) generic map (1,2,7,7)
port map (
	clk => fork_4_clk,
	rst => fork_4_rst,
...
fork_11: entity work.fork(arch) generic map (1,2,1,1)
port map (
	clk => fork_11_clk,
	rst => fork_11_rst,
...
sink_3: entity work.sink(arch) generic map (1,0,7,32)
port map (
	clk => sink_3_clk,
	rst => sink_3_rst,
