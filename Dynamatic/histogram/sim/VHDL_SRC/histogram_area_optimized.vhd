...
-- File created: Thu Mar 16 02:29:15 2023
...
architecture behavioral of histogram is 
	...
	signal Buffer_7_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal Buffer_7_dataOutArray_0 : std_logic_vector(30 downto 0);

	signal phi_3_clk : std_logic;
	signal phi_3_rst : std_logic;
	signal phi_3_dataInArray_0 : std_logic_vector(0 downto 0);
	signal phi_3_dataInArray_1 : std_logic_vector(30 downto 0);
	signal phi_3_dataInArray_2 : std_logic_vector(30 downto 0);
	...
	signal phi_3_dataOutArray_0 : std_logic_vector(30 downto 0);

	signal load_6_clk : std_logic;
	signal load_6_rst : std_logic;
	signal load_6_dataInArray_0 : std_logic_vector(31 downto 0);
	signal load_6_dataInArray_1 : std_logic_vector(30 downto 0);
	...
	signal load_6_dataOutArray_1 : std_logic_vector(30 downto 0);

	signal load_9_clk : std_logic;
	signal load_9_rst : std_logic;
	signal load_9_dataInArray_0 : std_logic_vector(31 downto 0);
	signal load_9_dataInArray_1 : std_logic_vector(30 downto 0);
	...
	signal load_9_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal fadd_13_clk : std_logic;
	signal fadd_13_rst : std_logic;
	signal fadd_13_dataInArray_0 : std_logic_vector(31 downto 0);
	signal fadd_13_dataInArray_1 : std_logic_vector(31 downto 0);
	signal fadd_13_pValidArray_0 : std_logic;
	signal fadd_13_pValidArray_1 : std_logic;
	signal fadd_13_readyArray_0 : std_logic;
	signal fadd_13_readyArray_1 : std_logic;
	signal fadd_13_nReadyArray_0 : std_logic;
	signal fadd_13_validArray_0 : std_logic;
	signal fadd_13_dataOutArray_0 : std_logic_vector(31 downto 0);
	...
	signal add_16_dataInArray_0 : std_logic_vector(30 downto 0);
	signal add_16_dataInArray_1 : std_logic_vector(30 downto 0);
	...
	signal add_16_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal fork_1_dataOutArray_2 : std_logic_vector(30 downto 0);
	...
	signal branch_3_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal branch_3_dataOutArray_0 : std_logic_vector(30 downto 0);
	signal branch_3_nReadyArray_1 : std_logic;
	signal branch_3_validArray_1 : std_logic;
	signal branch_3_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal MC_feature_dataInArray_0 : std_logic_vector(30 downto 0);
	signal MC_feature_dataInArray_1 : std_logic_vector(31 downto 0);
	signal MC_feature_dataInArray_2 : std_logic_vector(30 downto 0);
	...
	signal MC_weight_dataInArray_0 : std_logic_vector(30 downto 0);
	signal MC_weight_dataInArray_1 : std_logic_vector(31 downto 0);
	signal MC_weight_dataInArray_2 : std_logic_vector(30 downto 0);
	...
	signal sink_3_dataInArray_0 : std_logic_vector(30 downto 0);
...
begin
	...
	branch_0_pValidArray_0 <= fork_0_validArray_1;
	fork_0_nReadyArray_1 <= branch_0_readyArray_0;
	branch_0_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_1),branch_0_dataInArray_0'length));

	branch_0_clk <= clk;
	branch_0_rst <= rst;
	phi_n0_pValidArray_0 <= branch_0_validArray_0;
	branch_0_nReadyArray_0 <= phi_n0_readyArray_0;
	phi_n0_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_0),phi_n0_dataInArray_0'length));
	...
	branchC_5_pValidArray_0 <= start_0_validArray_0;
	start_0_nReadyArray_0 <= branchC_5_readyArray_0;
	branchC_5_dataInArray_0 <= std_logic_vector (resize(unsigned(start_0_dataOutArray_0),branchC_5_dataInArray_0'length));

	branchC_5_clk <= clk;
	branchC_5_rst <= rst;
	phiC_2_pValidArray_0 <= branchC_5_validArray_0;
	branchC_5_nReadyArray_0 <= phiC_2_readyArray_0;
	phiC_2_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_5_dataOutArray_0),phiC_2_dataInArray_0'length));
	phiC_4_pValidArray_0 <= branchC_5_validArray_1;
	branchC_5_nReadyArray_1 <= phiC_4_readyArray_0;
	phiC_4_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_5_dataOutArray_1),phiC_4_dataInArray_0'length));

	fork_10_clk <= clk;
	fork_10_rst <= rst;
	branch_0_pValidArray_1 <= fork_10_validArray_0;
	fork_10_nReadyArray_0 <= branch_0_readyArray_1;
	branch_0_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_0),branch_0_dataInArray_1'length));
	branchC_5_pValidArray_1 <= fork_10_validArray_1;
	fork_10_nReadyArray_1 <= branchC_5_readyArray_1;
	branchC_5_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_1),branchC_5_dataInArray_1'length));
	...
	branch_1_clk <= clk;
	branch_1_rst <= rst;
	Buffer_1_pValidArray_0 <= branch_1_validArray_0;
	branch_1_nReadyArray_0 <= Buffer_1_readyArray_0;
	Buffer_1_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_1_dataOutArray_0),Buffer_1_dataInArray_0'length));
	...
	branch_2_clk <= clk;
	branch_2_rst <= rst;
	Buffer_2_pValidArray_0 <= branch_2_validArray_0;
	branch_2_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	fork_6_clk <= clk;
	fork_6_rst <= rst;
	branch_2_pValidArray_1 <= fork_6_validArray_0;
	fork_6_nReadyArray_0 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_0),branch_2_dataInArray_1'length));
	branch_1_pValidArray_1 <= fork_6_validArray_1;
	fork_6_nReadyArray_1 <= branch_1_readyArray_1;
	branch_1_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_1),branch_1_dataInArray_1'length));
	branchC_6_pValidArray_1 <= fork_6_validArray_2;
	fork_6_nReadyArray_2 <= branchC_6_readyArray_1;
	branchC_6_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_2),branchC_6_dataInArray_1'length));
	...
	branchC_6_pValidArray_0 <= forkC_11_validArray_1;
	forkC_11_nReadyArray_1 <= branchC_6_readyArray_0;
	branchC_6_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_11_dataOutArray_1),branchC_6_dataInArray_0'length));
	brCst_block2_pValidArray_0 <= forkC_11_validArray_2;
	forkC_11_nReadyArray_2 <= brCst_block2_readyArray_0;
	brCst_block2_dataInArray_0 <= "1";

	branchC_6_clk <= clk;
	branchC_6_rst <= rst;
	Buffer_3_pValidArray_0 <= branchC_6_validArray_0;
	branchC_6_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_6_dataOutArray_0),Buffer_3_dataInArray_0'length));
	sink_5_pValidArray_0 <= branchC_6_validArray_1;
	branchC_6_nReadyArray_1 <= sink_5_readyArray_0;
	sink_5_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_6_dataOutArray_1),sink_5_dataInArray_0'length));

	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	phiC_3_pValidArray_0 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= phiC_3_readyArray_0;
	phiC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),phiC_3_dataInArray_0'length));

	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	phi_n1_pValidArray_0 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= phi_n1_readyArray_0;
	phi_n1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),phi_n1_dataInArray_0'length));

	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	phi_3_pValidArray_1 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= phi_3_readyArray_1;
	phi_3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),phi_3_dataInArray_1'length));
	...
	phi_3_clk <= clk;
	phi_3_rst <= rst;
	Buffer_7_pValidArray_0 <= phi_3_validArray_0;
	phi_3_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_3_dataOutArray_0),Buffer_7_dataInArray_0'length));

	load_6_clk <= clk;
	load_6_rst <= rst;
	Buffer_4_pValidArray_0 <= load_6_validArray_0;
	load_6_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(load_6_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	load_9_clk <= clk;
	load_9_rst <= rst;
	fadd_13_pValidArray_1 <= load_9_validArray_0;
	load_9_nReadyArray_0 <= fadd_13_readyArray_1;
	fadd_13_dataInArray_1 <= std_logic_vector (resize(unsigned(load_9_dataOutArray_0),fadd_13_dataInArray_1'length));
	...
	load_12_clk <= clk;
	load_12_rst <= rst;
	fadd_13_pValidArray_0 <= load_12_validArray_0;
	load_12_nReadyArray_0 <= fadd_13_readyArray_0;
	fadd_13_dataInArray_0 <= std_logic_vector (resize(unsigned(load_12_dataOutArray_0),fadd_13_dataInArray_0'length));
	...
	fadd_13_clk <= clk;
	fadd_13_rst <= rst;
	store_0_pValidArray_0 <= fadd_13_validArray_0;
	fadd_13_nReadyArray_0 <= store_0_readyArray_0;
	store_0_dataInArray_0 <= std_logic_vector (resize(unsigned(fadd_13_dataOutArray_0),store_0_dataInArray_0'length));
	...
	Buffer_5_pValidArray_0 <= fork_1_validArray_2;
	fork_1_nReadyArray_2 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_2),Buffer_5_dataInArray_0'length));
	...
	branch_4_pValidArray_0 <= fork_4_validArray_1;
	fork_4_nReadyArray_1 <= branch_4_readyArray_0;
	branch_4_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_1),branch_4_dataInArray_0'length));
	...
	branchC_7_pValidArray_1 <= fork_7_validArray_2;
	fork_7_nReadyArray_2 <= branchC_7_readyArray_1;
	branchC_7_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_2),branchC_7_dataInArray_1'length));

	phiC_3_clk <= clk;
	phiC_3_rst <= rst;
	forkC_12_pValidArray_0 <= phiC_3_validArray_0;
	phiC_3_nReadyArray_0 <= forkC_12_readyArray_0;
	forkC_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_3_dataOutArray_0),forkC_12_dataInArray_0'length));
	...
	forkC_12_clk <= clk;
	forkC_12_rst <= rst;
	LSQ_hist_pValidArray_0 <= forkC_12_validArray_0;
	forkC_12_nReadyArray_0 <= LSQ_hist_readyArray_0;
	LSQ_hist_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_12_dataOutArray_0),LSQ_hist_dataInArray_0'length));
	Buffer_9_pValidArray_0 <= forkC_12_validArray_1;
	forkC_12_nReadyArray_1 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_12_dataOutArray_1),Buffer_9_dataInArray_0'length));

	branchC_7_clk <= clk;
	branchC_7_rst <= rst;
	phiC_3_pValidArray_1 <= branchC_7_validArray_0;
	branchC_7_nReadyArray_0 <= phiC_3_readyArray_1;
	phiC_3_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_7_dataOutArray_0),phiC_3_dataInArray_1'length));
	Buffer_10_pValidArray_0 <= branchC_7_validArray_1;
	branchC_7_nReadyArray_1 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_7_dataOutArray_1),Buffer_10_dataInArray_0'length));
	...
	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	load_9_pValidArray_1 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= load_9_readyArray_1;
	load_9_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),load_9_dataInArray_1'length));
	...
	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	branchC_7_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= branchC_7_readyArray_0;
	branchC_7_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),branchC_7_dataInArray_0'length));

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phiC_4_pValidArray_1 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phiC_4_readyArray_1;
	phiC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phiC_4_dataInArray_1'length));
	...
	phiC_4_clk <= clk;
	phiC_4_rst <= rst;
	ret_0_pValidArray_0 <= phiC_4_validArray_0;
	phiC_4_nReadyArray_0 <= ret_0_readyArray_0;
	ret_0_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_4_dataOutArray_0),ret_0_dataInArray_0'length));
...
Buffer_7: entity work.elasticBuffer(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_7_clk,
	rst => Buffer_7_rst,
...
phi_3: entity work.Mux(arch) generic map (3,1,31,31,1)
port map (
	clk => phi_3_clk,
	rst => phi_3_rst,
...
load_6: entity work.mc_load_op(arch) generic map (2,2,31,32)
port map (
	clk => load_6_clk,
	rst => load_6_rst,
...
load_9: entity work.mc_load_op(arch) generic map (2,2,31,32)
port map (
	clk => load_9_clk,
	rst => load_9_rst,
...
fadd_13: entity work.fadd_op(arch) generic map (2,1,32,32)
port map (
	clk => fadd_13_clk,
	rst => fadd_13_rst,
	dataInArray(0) => fadd_13_dataInArray_0,
	dataInArray(1) => fadd_13_dataInArray_1,
	pValidArray(0) => fadd_13_pValidArray_0,
	pValidArray(1) => fadd_13_pValidArray_1,
	readyArray(0) => fadd_13_readyArray_0,
	readyArray(1) => fadd_13_readyArray_1,
	nReadyArray(0) => fadd_13_nReadyArray_0,
	validArray(0) => fadd_13_validArray_0,
	dataOutArray(0) => fadd_13_dataOutArray_0
);
...
add_16: entity work.add_op(arch) generic map (2,1,31,31)
port map (
	clk => add_16_clk,
	rst => add_16_rst,
...
fork_1: entity work.fork(arch) generic map (1,3,31,31)
port map (
	clk => fork_1_clk,
	rst => fork_1_rst,
...
branch_3: entity work.Branch(arch) generic map (2,2,31,31)
port map (
	clk => branch_3_clk,
	rst => branch_3_rst,
...
Buffer_5: entity work.transpFifo(arch) generic map (1,1,31,31,6)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
MC_feature: entity work.MemCont(arch) generic map (32,31,1,1,1)
port map (
	clk => MC_feature_clk,
	rst => MC_feature_rst,
...
MC_weight: entity work.MemCont(arch) generic map (32,31,1,1,1)
port map (
	clk => MC_weight_clk,
	rst => MC_weight_rst,
...
sink_3: entity work.sink(arch) generic map (1,0,31,32)
port map (
	clk => sink_3_clk,
	rst => sink_3_rst,
