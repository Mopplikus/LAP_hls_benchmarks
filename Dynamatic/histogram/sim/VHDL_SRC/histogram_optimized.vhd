...
-- File created: Wed Apr 12 19:59:34 2023
...
architecture behavioral of histogram is 
	...
	signal Buffer_1_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal Buffer_1_dataOutArray_0 : std_logic_vector(30 downto 0);
...
begin
	...
	branchC_7_clk <= clk;
	branchC_7_rst <= rst;
	Buffer_7_pValidArray_0 <= branchC_7_validArray_0;
	branchC_7_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_7_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	phi_n1_pValidArray_0 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= phi_n1_readyArray_0;
	phi_n1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),phi_n1_dataInArray_0'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	phiC_3_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= phiC_3_readyArray_0;
	phiC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),phiC_3_dataInArray_0'length));
	...
	Buffer_6_pValidArray_0 <= branch_4_validArray_1;
	branch_4_nReadyArray_1 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_1),Buffer_6_dataInArray_0'length));
	...
	Buffer_8_pValidArray_0 <= forkC_11_validArray_1;
	forkC_11_nReadyArray_1 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_11_dataOutArray_1),Buffer_8_dataInArray_0'length));
	...
	Buffer_9_pValidArray_0 <= branchC_8_validArray_1;
	branchC_8_nReadyArray_1 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_8_dataOutArray_1),Buffer_9_dataInArray_0'length));
	...
	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	fork_1_pValidArray_0 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= fork_1_readyArray_0;
	fork_1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),fork_1_dataInArray_0'length));
	...
	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	phi_19_pValidArray_2 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= phi_19_readyArray_2;
	phi_19_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),phi_19_dataInArray_2'length));

	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	branchC_8_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= branchC_8_readyArray_0;
	branchC_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),branchC_8_dataInArray_0'length));

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	phiC_4_pValidArray_1 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= phiC_4_readyArray_1;
	phiC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),phiC_4_dataInArray_1'length));
...
Buffer_1: entity work.elasticBuffer(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_1_clk,
	rst => Buffer_1_rst,
