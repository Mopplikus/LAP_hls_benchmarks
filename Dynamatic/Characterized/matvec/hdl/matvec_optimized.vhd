...
-- File created: Wed Jun 14 02:42:16 2023
...
begin
	...
	phiC_4_clk <= clk;
	phiC_4_rst <= rst;
	forkC_14_pValidArray_0 <= phiC_4_validArray_0;
	phiC_4_nReadyArray_0 <= forkC_14_readyArray_0;
	forkC_14_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_4_dataOutArray_0),forkC_14_dataInArray_0'length));
	...
	phi_3_clk <= clk;
	phi_3_rst <= rst;
	add_13_pValidArray_0 <= phi_3_validArray_0;
	phi_3_nReadyArray_0 <= add_13_readyArray_0;
	add_13_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_3_dataOutArray_0),add_13_dataInArray_0'length));
	...
	fork_9_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_15_dataOutArray_0),fork_9_dataInArray_0'length));
	...
	branch_4_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_9_dataOutArray_2),branch_4_dataInArray_1'length));
	...
	phiC_5_clk <= clk;
	phiC_5_rst <= rst;
	branchC_11_pValidArray_0 <= phiC_5_validArray_0;
	phiC_5_nReadyArray_0 <= branchC_11_readyArray_0;
	branchC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_5_dataOutArray_0),branchC_11_dataInArray_0'length));
	...
	fork_5_clk <= clk;
	fork_5_rst <= rst;
	store_0_pValidArray_1 <= fork_5_validArray_0;
	fork_5_nReadyArray_0 <= store_0_readyArray_1;
	store_0_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_0),store_0_dataInArray_1'length));
