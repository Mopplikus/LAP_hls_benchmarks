...
-- File created: Wed Jun 14 02:56:01 2023
...
begin
	...
	phiC_11_clk <= clk;
	phiC_11_rst <= rst;
	branchC_16_pValidArray_0 <= phiC_11_validArray_0;
	phiC_11_nReadyArray_0 <= branchC_16_readyArray_0;
	branchC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_0),branchC_16_dataInArray_0'length));
	...
	add_9_clk <= clk;
	add_9_rst <= rst;
	fork_4_pValidArray_0 <= add_9_validArray_0;
	add_9_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(add_9_dataOutArray_0),fork_4_dataInArray_0'length));
	...
	icmp_23_clk <= clk;
	icmp_23_rst <= rst;
	fork_17_pValidArray_0 <= icmp_23_validArray_0;
	icmp_23_nReadyArray_0 <= fork_17_readyArray_0;
	fork_17_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_23_dataOutArray_0),fork_17_dataInArray_0'length));
	...
	phi_n8_clk <= clk;
	phi_n8_rst <= rst;
	fork_11_pValidArray_0 <= phi_n8_validArray_0;
	phi_n8_nReadyArray_0 <= fork_11_readyArray_0;
	fork_11_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n8_dataOutArray_0),fork_11_dataInArray_0'length));

	phi_n9_clk <= clk;
	phi_n9_rst <= rst;
	fork_12_pValidArray_0 <= phi_n9_validArray_0;
	phi_n9_nReadyArray_0 <= fork_12_readyArray_0;
	fork_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n9_dataOutArray_0),fork_12_dataInArray_0'length));
	...
	branchC_18_pValidArray_0 <= forkC_24_validArray_2;
	forkC_24_nReadyArray_2 <= branchC_18_readyArray_0;
	branchC_18_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_24_dataOutArray_2),branchC_18_dataInArray_0'length));
