...
-- File created: Wed Jun 14 03:36:46 2023
...
begin
	...
	branchC_36_clk <= clk;
	branchC_36_rst <= rst;
	phiC_18_pValidArray_0 <= branchC_36_validArray_0;
	branchC_36_nReadyArray_0 <= phiC_18_readyArray_0;
	phiC_18_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_36_dataOutArray_0),phiC_18_dataInArray_0'length));
	...
	phiC_18_clk <= clk;
	phiC_18_rst <= rst;
	forkC_51_pValidArray_0 <= phiC_18_validArray_0;
	phiC_18_nReadyArray_0 <= forkC_51_readyArray_0;
	forkC_51_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_18_dataOutArray_0),forkC_51_dataInArray_0'length));
	...
	zext_13_clk <= clk;
	zext_13_rst <= rst;
	getelementptr_15_pValidArray_0 <= zext_13_validArray_0;
	zext_13_nReadyArray_0 <= getelementptr_15_readyArray_0;
	getelementptr_15_dataInArray_0 <= std_logic_vector (resize(unsigned(zext_13_dataOutArray_0),getelementptr_15_dataInArray_0'length));
	...
	phi_n4_clk <= clk;
	phi_n4_rst <= rst;
	fork_20_pValidArray_0 <= phi_n4_validArray_0;
	phi_n4_nReadyArray_0 <= fork_20_readyArray_0;
	fork_20_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n4_dataOutArray_0),fork_20_dataInArray_0'length));
	...
	branch_6_clk <= clk;
	branch_6_rst <= rst;
	phi_8_pValidArray_2 <= branch_6_validArray_0;
	branch_6_nReadyArray_0 <= phi_8_readyArray_2;
	phi_8_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_6_dataOutArray_0),phi_8_dataInArray_2'length));
	...
	fork_33_clk <= clk;
	fork_33_rst <= rst;
	branch_8_pValidArray_1 <= fork_33_validArray_0;
	fork_33_nReadyArray_0 <= branch_8_readyArray_1;
	branch_8_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_33_dataOutArray_0),branch_8_dataInArray_1'length));
	branch_7_pValidArray_1 <= fork_33_validArray_1;
	fork_33_nReadyArray_1 <= branch_7_readyArray_1;
	branch_7_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_33_dataOutArray_1),branch_7_dataInArray_1'length));
	...
	branchC_39_pValidArray_1 <= fork_33_validArray_3;
	fork_33_nReadyArray_3 <= branchC_39_readyArray_1;
	branchC_39_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_33_dataOutArray_3),branchC_39_dataInArray_1'length));
	...
	phiC_23_pValidArray_0 <= branchC_41_validArray_1;
	branchC_41_nReadyArray_1 <= phiC_23_readyArray_0;
	phiC_23_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_41_dataOutArray_1),phiC_23_dataInArray_0'length));
	...
	branch_12_clk <= clk;
	branch_12_rst <= rst;
	phi_33_pValidArray_1 <= branch_12_validArray_0;
	branch_12_nReadyArray_0 <= phi_33_readyArray_1;
	phi_33_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_0),phi_33_dataInArray_1'length));
	...
	branchC_42_clk <= clk;
	branchC_42_rst <= rst;
	phiC_24_pValidArray_0 <= branchC_42_validArray_0;
	branchC_42_nReadyArray_0 <= phiC_24_readyArray_0;
	phiC_24_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_42_dataOutArray_0),phiC_24_dataInArray_0'length));
	...
	phi_33_clk <= clk;
	phi_33_rst <= rst;
	branch_14_pValidArray_0 <= phi_33_validArray_0;
	phi_33_nReadyArray_0 <= branch_14_readyArray_0;
	branch_14_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_33_dataOutArray_0),branch_14_dataInArray_0'length));
	...
	phiC_24_clk <= clk;
	phiC_24_rst <= rst;
	forkC_59_pValidArray_0 <= phiC_24_validArray_0;
	phiC_24_nReadyArray_0 <= forkC_59_readyArray_0;
	forkC_59_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_24_dataOutArray_0),forkC_59_dataInArray_0'length));
	...
	zext_45_clk <= clk;
	zext_45_rst <= rst;
	getelementptr_47_pValidArray_0 <= zext_45_validArray_0;
	zext_45_nReadyArray_0 <= getelementptr_47_readyArray_0;
	getelementptr_47_dataInArray_0 <= std_logic_vector (resize(unsigned(zext_45_dataOutArray_0),getelementptr_47_dataInArray_0'length));
	...
	phi_n10_clk <= clk;
	phi_n10_rst <= rst;
	fork_24_pValidArray_0 <= phi_n10_validArray_0;
	phi_n10_nReadyArray_0 <= fork_24_readyArray_0;
	fork_24_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n10_dataOutArray_0),fork_24_dataInArray_0'length));

	phi_n11_clk <= clk;
	phi_n11_rst <= rst;
	fork_25_pValidArray_0 <= phi_n11_validArray_0;
	phi_n11_nReadyArray_0 <= fork_25_readyArray_0;
	fork_25_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n11_dataOutArray_0),fork_25_dataInArray_0'length));

	fork_7_clk <= clk;
	fork_7_rst <= rst;
	zext_42_pValidArray_0 <= fork_7_validArray_0;
	fork_7_nReadyArray_0 <= zext_42_readyArray_0;
	zext_42_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_0),zext_42_dataInArray_0'length));
	...
	branch_18_clk <= clk;
	branch_18_rst <= rst;
	phi_40_pValidArray_2 <= branch_18_validArray_0;
	branch_18_nReadyArray_0 <= phi_40_readyArray_2;
	phi_40_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_18_dataOutArray_0),phi_40_dataInArray_2'length));
	...
	fork_39_clk <= clk;
	fork_39_rst <= rst;
	branch_20_pValidArray_1 <= fork_39_validArray_0;
	fork_39_nReadyArray_0 <= branch_20_readyArray_1;
	branch_20_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_39_dataOutArray_0),branch_20_dataInArray_1'length));
	branch_19_pValidArray_1 <= fork_39_validArray_1;
	fork_39_nReadyArray_1 <= branch_19_readyArray_1;
	branch_19_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_39_dataOutArray_1),branch_19_dataInArray_1'length));
	...
	branchC_45_pValidArray_1 <= fork_39_validArray_3;
	fork_39_nReadyArray_3 <= branchC_45_readyArray_1;
	branchC_45_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_39_dataOutArray_3),branchC_45_dataInArray_1'length));
	...
	phiC_29_pValidArray_0 <= branchC_47_validArray_1;
	branchC_47_nReadyArray_1 <= phiC_29_readyArray_0;
	phiC_29_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_47_dataOutArray_1),phiC_29_dataInArray_0'length));
	...
	branch_24_clk <= clk;
	branch_24_rst <= rst;
	phi_65_pValidArray_1 <= branch_24_validArray_0;
	branch_24_nReadyArray_0 <= phi_65_readyArray_1;
	phi_65_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_24_dataOutArray_0),phi_65_dataInArray_1'length));
	...
	branchC_48_clk <= clk;
	branchC_48_rst <= rst;
	phiC_30_pValidArray_0 <= branchC_48_validArray_0;
	branchC_48_nReadyArray_0 <= phiC_30_readyArray_0;
	phiC_30_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_48_dataOutArray_0),phiC_30_dataInArray_0'length));
	...
	phi_67_clk <= clk;
	phi_67_rst <= rst;
	fork_12_pValidArray_0 <= phi_67_validArray_0;
	phi_67_nReadyArray_0 <= fork_12_readyArray_0;
	fork_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_67_dataOutArray_0),fork_12_dataInArray_0'length));
	...
	phi_n13_clk <= clk;
	phi_n13_rst <= rst;
	fork_26_pValidArray_0 <= phi_n13_validArray_0;
	phi_n13_nReadyArray_0 <= fork_26_readyArray_0;
	fork_26_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n13_dataOutArray_0),fork_26_dataInArray_0'length));
	...
	phiC_31_clk <= clk;
	phiC_31_rst <= rst;
	forkC_68_pValidArray_0 <= phiC_31_validArray_0;
	phiC_31_nReadyArray_0 <= forkC_68_readyArray_0;
	forkC_68_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_31_dataOutArray_0),forkC_68_dataInArray_0'length));
	...
	phiC_34_clk <= clk;
	phiC_34_rst <= rst;
	branchC_53_pValidArray_0 <= phiC_34_validArray_0;
	phiC_34_nReadyArray_0 <= branchC_53_readyArray_0;
	branchC_53_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_34_dataOutArray_0),branchC_53_dataInArray_0'length));
	...
	phiC_35_pValidArray_0 <= branchC_53_validArray_1;
	branchC_53_nReadyArray_1 <= phiC_35_readyArray_0;
	phiC_35_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_53_dataOutArray_1),phiC_35_dataInArray_0'length));
