...
if.then:                                          ; preds = %for.body3
  ...
  %arrayidx6 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %a, i64 0, i64 %idxprom5
...
if.else:                                          ; preds = %for.body3
  ...
  %rem9 = srem i32 %call, 100
  %add = add nsw i32 %rem9, 2
...
for.end16:                                        ; preds = %for.cond
  ...
  %arrayidx19 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %a, i64 0, i64 %idxprom18
  %arraydecay = getelementptr inbounds [100 x i32], [100 x i32]* %arrayidx19, i32 0, i32 0
  %idxprom20 = sext i32 0 to i64
  %arrayidx21 = getelementptr inbounds [1 x i32], [1 x i32]* %n, i64 0, i64 %idxprom20
  %0 = load i32, i32* %arrayidx21, align 4
  %call22 = call i32 @_Z9if_loop_1Pii(i32* %arraydecay, i32 %0)
  ret i32 0
}
