...
-- File created: Wed Jun 14 03:02:34 2023
...
begin
	...
	phi_3_clk <= clk;
	phi_3_rst <= rst;
	add_10_pValidArray_0 <= phi_3_validArray_0;
	phi_3_nReadyArray_0 <= add_10_readyArray_0;
	add_10_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_3_dataOutArray_0),add_10_dataInArray_0'length));
	...
	phi_14_pValidArray_2 <= branch_5_validArray_1;
	branch_5_nReadyArray_1 <= phi_14_readyArray_2;
	phi_14_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_1),phi_14_dataInArray_2'length));
