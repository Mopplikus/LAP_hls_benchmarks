...
-- File created: Wed Jun 14 02:10:25 2023
...
begin
	...
	phi_n1_clk <= clk;
	phi_n1_rst <= rst;
	fork_4_pValidArray_0 <= phi_n1_validArray_0;
	phi_n1_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n1_dataOutArray_0),fork_4_dataInArray_0'length));
	...
	branchC_8_pValidArray_0 <= forkC_11_validArray_1;
	forkC_11_nReadyArray_1 <= branchC_8_readyArray_0;
	branchC_8_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_11_dataOutArray_1),branchC_8_dataInArray_0'length));
