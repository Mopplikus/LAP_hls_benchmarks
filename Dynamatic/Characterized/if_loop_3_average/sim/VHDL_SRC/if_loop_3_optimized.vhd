...
-- File created: Wed Jun 14 03:11:04 2023
...
begin
	...
	branchC_16_clk <= clk;
	branchC_16_rst <= rst;
	phiC_9_pValidArray_0 <= branchC_16_validArray_0;
	branchC_16_nReadyArray_0 <= phiC_9_readyArray_0;
	phiC_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_16_dataOutArray_0),phiC_9_dataInArray_0'length));
	...
	phi_n1_clk <= clk;
	phi_n1_rst <= rst;
	branch_8_pValidArray_0 <= phi_n1_validArray_0;
	phi_n1_nReadyArray_0 <= branch_8_readyArray_0;
	branch_8_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n1_dataOutArray_0),branch_8_dataInArray_0'length));
	...
	branch_6_pValidArray_0 <= fork_2_validArray_2;
	fork_2_nReadyArray_2 <= branch_6_readyArray_0;
	branch_6_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_2),branch_6_dataInArray_0'length));
	...
	branch_7_clk <= clk;
	branch_7_rst <= rst;
	phi_n5_pValidArray_0 <= branch_7_validArray_0;
	branch_7_nReadyArray_0 <= phi_n5_readyArray_0;
	phi_n5_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_7_dataOutArray_0),phi_n5_dataInArray_0'length));
	...
	phi_n7_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_0),phi_n7_dataInArray_0'length));
	...
	phiC_9_clk <= clk;
	phiC_9_rst <= rst;
	branchC_17_pValidArray_0 <= phiC_9_validArray_0;
	phiC_9_nReadyArray_0 <= branchC_17_readyArray_0;
	branchC_17_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_9_dataOutArray_0),branchC_17_dataInArray_0'length));
	...
	branchC_17_clk <= clk;
	branchC_17_rst <= rst;
	phiC_10_pValidArray_0 <= branchC_17_validArray_0;
	branchC_17_nReadyArray_0 <= phiC_10_readyArray_0;
	phiC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_17_dataOutArray_0),phiC_10_dataInArray_0'length));
	...
	branch_9_clk <= clk;
	branch_9_rst <= rst;
	phi_16_pValidArray_2 <= branch_9_validArray_0;
	branch_9_nReadyArray_0 <= phi_16_readyArray_2;
	phi_16_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_9_dataOutArray_0),phi_16_dataInArray_2'length));
	...
	branch_10_clk <= clk;
	branch_10_rst <= rst;
	phi_n2_pValidArray_1 <= branch_10_validArray_0;
	branch_10_nReadyArray_0 <= phi_n2_readyArray_1;
	phi_n2_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_10_dataOutArray_0),phi_n2_dataInArray_1'length));
	...
	branch_11_clk <= clk;
	branch_11_rst <= rst;
	phi_n3_pValidArray_1 <= branch_11_validArray_0;
	branch_11_nReadyArray_0 <= phi_n3_readyArray_1;
	phi_n3_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_11_dataOutArray_0),phi_n3_dataInArray_1'length));
	...
	phi_16_clk <= clk;
	phi_16_rst <= rst;
	branch_12_pValidArray_0 <= phi_16_validArray_0;
	phi_16_nReadyArray_0 <= branch_12_readyArray_0;
	branch_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_16_dataOutArray_0),branch_12_dataInArray_0'length));
	...
	phi_n3_clk <= clk;
	phi_n3_rst <= rst;
	fork_7_pValidArray_0 <= phi_n3_validArray_0;
	phi_n3_nReadyArray_0 <= fork_7_readyArray_0;
	fork_7_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n3_dataOutArray_0),fork_7_dataInArray_0'length));
	...
	phi_20_pValidArray_2 <= branch_12_validArray_1;
	branch_12_nReadyArray_1 <= phi_20_readyArray_2;
	phi_20_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_1),phi_20_dataInArray_2'length));
	...
	branchC_19_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_0),branchC_19_dataInArray_0'length));
	...
	phiC_12_pValidArray_1 <= branchC_19_validArray_1;
	branchC_19_nReadyArray_1 <= phiC_12_readyArray_1;
	phiC_12_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_19_dataOutArray_1),phiC_12_dataInArray_1'length));
