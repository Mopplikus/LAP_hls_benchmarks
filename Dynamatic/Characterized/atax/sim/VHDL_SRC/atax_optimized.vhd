...
-- File created: Tue Jun 13 23:52:59 2023
...
begin
	...
	phiC_8_clk <= clk;
	phiC_8_rst <= rst;
	forkC_20_pValidArray_0 <= phiC_8_validArray_0;
	phiC_8_nReadyArray_0 <= forkC_20_readyArray_0;
	forkC_20_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_8_dataOutArray_0),forkC_20_dataInArray_0'length));
	...
	phi_6_clk <= clk;
	phi_6_rst <= rst;
	add_16_pValidArray_0 <= phi_6_validArray_0;
	phi_6_nReadyArray_0 <= add_16_readyArray_0;
	add_16_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_6_dataOutArray_0),add_16_dataInArray_0'length));
	...
	phiC_9_clk <= clk;
	phiC_9_rst <= rst;
	branchC_16_pValidArray_0 <= phiC_9_validArray_0;
	phiC_9_nReadyArray_0 <= branchC_16_readyArray_0;
	branchC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_9_dataOutArray_0),branchC_16_dataInArray_0'length));
