...
for.body9:                                        ; preds = %for.body9, %for.end
  ...
  %2 = zext i32 %j6.02 to i64
  %3 = getelementptr inbounds [1 x [10 x i32]], [1 x [10 x i32]]* %filter, i64 0, i64 0, i64 %2
  store i32 %rem11, i32* %3, align 4
  %inc17 = add nuw nsw i32 %j6.02, 1
  %cmp8 = icmp ult i32 %inc17, 10
  br i1 %cmp8, label %for.body9, label %for.inc19
...
for.end21:                                        ; preds = %for.inc19
  ...
  %arraydecay27 = getelementptr inbounds [1 x [900 x i32]], [1 x [900 x i32]]* %sol, i64 0, i64 0, i64 0
  %arraydecay30 = getelementptr inbounds [1 x [10 x i32]], [1 x [10 x i32]]* %filter, i64 0, i64 0, i64 0
  %call31 = call i32 @_Z10stencil_2dPiS_S_(i32* nonnull %arraydecay, i32* nonnull %arraydecay27, i32* nonnull %arraydecay30)
  ret i32 0
}
