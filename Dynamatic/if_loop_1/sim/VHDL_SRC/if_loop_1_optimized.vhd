...
-- File created: Thu Apr 20 04:31:36 2023
...
begin
	...
	branch_2_clk <= clk;
	branch_2_rst <= rst;
	Buffer_4_pValidArray_0 <= branch_2_validArray_0;
	branch_2_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	phi_3_pValidArray_1 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= phi_3_readyArray_1;
	phi_3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),phi_3_dataInArray_1'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	phi_4_pValidArray_1 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= phi_4_readyArray_1;
	phi_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),phi_4_dataInArray_1'length));

	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	phi_n1_pValidArray_0 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= phi_n1_readyArray_0;
	phi_n1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),phi_n1_dataInArray_0'length));

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	phiC_3_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= phiC_3_readyArray_0;
	phiC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),phiC_3_dataInArray_0'length));
	...
	phi_4_clk <= clk;
	phi_4_rst <= rst;
	Buffer_2_pValidArray_0 <= phi_4_validArray_0;
	phi_4_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_4_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	select_0_clk <= clk;
	select_0_rst <= rst;
	add_10_pValidArray_1 <= select_0_validArray_0;
	select_0_nReadyArray_0 <= add_10_readyArray_1;
	add_10_dataInArray_1 <= std_logic_vector (resize(unsigned(select_0_dataOutArray_0),add_10_dataInArray_1'length));
	...
	icmp_12_clk <= clk;
	icmp_12_rst <= rst;
	fork_8_pValidArray_0 <= icmp_12_validArray_0;
	icmp_12_nReadyArray_0 <= fork_8_readyArray_0;
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_12_dataOutArray_0),fork_8_dataInArray_0'length));
	...
	fork_4_clk <= clk;
	fork_4_rst <= rst;
	icmp_12_pValidArray_0 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= icmp_12_readyArray_0;
	icmp_12_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_0),icmp_12_dataInArray_0'length));
	...
	Buffer_7_pValidArray_0 <= branch_5_validArray_1;
	branch_5_nReadyArray_1 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_1),Buffer_7_dataInArray_0'length));
	...
	phiC_3_clk <= clk;
	phiC_3_rst <= rst;
	Buffer_10_pValidArray_0 <= phiC_3_validArray_0;
	phiC_3_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_3_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	Buffer_11_pValidArray_0 <= branchC_10_validArray_1;
	branchC_10_nReadyArray_1 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_10_dataOutArray_1),Buffer_11_dataInArray_0'length));
	...
	fork_14_clk <= clk;
	fork_14_rst <= rst;
	Buffer_12_pValidArray_0 <= fork_14_validArray_0;
	fork_14_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	add_10_pValidArray_0 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= add_10_readyArray_0;
	add_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),add_10_dataInArray_0'length));
	...
	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	phi_14_pValidArray_2 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= phi_14_readyArray_2;
	phi_14_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),phi_14_dataInArray_2'length));
	...
	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phiC_4_pValidArray_1 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phiC_4_readyArray_1;
	phiC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phiC_4_dataInArray_1'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phi_3_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phi_3_readyArray_0;
	phi_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phi_3_dataInArray_0'length));
...
Buffer_12: entity work.transpFifo(arch) generic map (1,1,1,1,6)
port map (
	clk => Buffer_12_clk,
	rst => Buffer_12_rst,
