...
-- File created: Wed Apr 12 17:28:36 2023
...
begin
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_1_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_1_readyArray_0;
	phi_1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_1_dataInArray_0'length));

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	phiC_2_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= phiC_2_readyArray_0;
	phiC_2_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),phiC_2_dataInArray_0'length));

	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	branch_2_pValidArray_1 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),branch_2_dataInArray_1'length));
	...
	Buffer_7_pValidArray_0 <= branch_2_validArray_1;
	branch_2_nReadyArray_1 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_1),Buffer_7_dataInArray_0'length));
	...
	Buffer_9_pValidArray_0 <= branchC_5_validArray_1;
	branchC_5_nReadyArray_1 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_5_dataOutArray_1),Buffer_9_dataInArray_0'length));
	...
	fork_9_clk <= clk;
	fork_9_rst <= rst;
	Buffer_10_pValidArray_0 <= fork_9_validArray_0;
	fork_9_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_9_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	phi_n0_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= phi_n0_readyArray_0;
	phi_n0_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),phi_n0_dataInArray_0'length));
	...
	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	phi_1_pValidArray_2 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= phi_1_readyArray_2;
	phi_1_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),phi_1_dataInArray_2'length));
...
Buffer_10: entity work.transpFifo(arch) generic map (1,1,1,1,6)
port map (
	clk => Buffer_10_clk,
	rst => Buffer_10_rst,
