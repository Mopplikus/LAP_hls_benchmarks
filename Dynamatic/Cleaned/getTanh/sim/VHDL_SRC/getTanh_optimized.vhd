...
-- File created: Tue Jun 13 18:55:36 2023
...
architecture behavioral of getTanh is 
	...
	signal phi_1_dataInArray_1 : std_logic_vector(9 downto 0);
	signal phi_1_dataInArray_2 : std_logic_vector(9 downto 0);
	...
	signal phi_1_dataOutArray_0 : std_logic_vector(9 downto 0);

	signal load_4_clk : std_logic;
	signal load_4_rst : std_logic;
	signal load_4_dataInArray_0 : std_logic_vector(31 downto 0);
	signal load_4_dataInArray_1 : std_logic_vector(9 downto 0);
	...
	signal load_4_dataOutArray_1 : std_logic_vector(9 downto 0);
	...
	signal Buffer_5_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_5_dataOutArray_0 : std_logic_vector(9 downto 0);
	...
	signal phi_n4_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal phi_n4_dataOutArray_0 : std_logic_vector(9 downto 0);
	...
	signal branch_7_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal branch_7_dataOutArray_0 : std_logic_vector(9 downto 0);
	signal branch_7_nReadyArray_1 : std_logic;
	signal branch_7_validArray_1 : std_logic;
	signal branch_7_dataOutArray_1 : std_logic_vector(9 downto 0);
	...
	signal add_19_dataInArray_0 : std_logic_vector(9 downto 0);
	signal add_19_dataInArray_1 : std_logic_vector(9 downto 0);
	...
	signal add_19_dataOutArray_0 : std_logic_vector(9 downto 0);

	signal cst_6_clk : std_logic;
	signal cst_6_rst : std_logic;
	signal cst_6_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal cst_6_dataOutArray_0 : std_logic_vector(9 downto 0);

	signal icmp_20_clk : std_logic;
	signal icmp_20_rst : std_logic;
	signal icmp_20_dataInArray_0 : std_logic_vector(9 downto 0);
	signal icmp_20_dataInArray_1 : std_logic_vector(9 downto 0);
	...
	signal phi_n1_dataInArray_0 : std_logic_vector(9 downto 0);
	signal phi_n1_dataInArray_1 : std_logic_vector(9 downto 0);
	...
	signal phi_n1_dataOutArray_0 : std_logic_vector(9 downto 0);
	...
	signal fork_4_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal fork_4_dataOutArray_0 : std_logic_vector(9 downto 0);
	signal fork_4_nReadyArray_1 : std_logic;
	signal fork_4_validArray_1 : std_logic;
	signal fork_4_dataOutArray_1 : std_logic_vector(9 downto 0);
	...
	signal branch_9_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal branch_9_dataOutArray_0 : std_logic_vector(9 downto 0);
	signal branch_9_nReadyArray_1 : std_logic;
	signal branch_9_validArray_1 : std_logic;
	signal branch_9_dataOutArray_1 : std_logic_vector(9 downto 0);
	...
	signal source_4_dataOutArray_0 : std_logic_vector(9 downto 0);

	signal Buffer_2_clk : std_logic;
	signal Buffer_2_rst : std_logic;
	signal Buffer_2_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_2_dataOutArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_4_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_4_dataOutArray_0 : std_logic_vector(9 downto 0);

	signal Buffer_8_clk : std_logic;
	signal Buffer_8_rst : std_logic;
	signal Buffer_8_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_8_dataOutArray_0 : std_logic_vector(9 downto 0);
	...
	signal MC_addr_dataInArray_0 : std_logic_vector(9 downto 0);
	signal MC_addr_dataInArray_1 : std_logic_vector(31 downto 0);
	signal MC_addr_dataInArray_2 : std_logic_vector(9 downto 0);
	...
	signal sink_6_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal sink_8_dataInArray_0 : std_logic_vector(9 downto 0);
...
begin
	...
	branch_0_clk <= clk;
	branch_0_rst <= rst;
	Buffer_11_pValidArray_0 <= branch_0_validArray_0;
	branch_0_nReadyArray_0 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_0),Buffer_11_dataInArray_0'length));
	...
	branchC_10_clk <= clk;
	branchC_10_rst <= rst;
	Buffer_16_pValidArray_0 <= branchC_10_validArray_0;
	branchC_10_nReadyArray_0 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_10_dataOutArray_0),Buffer_16_dataInArray_0'length));
	...
	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_1_pValidArray_1 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_1_readyArray_1;
	phi_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_1_dataInArray_1'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	phiC_6_pValidArray_0 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= phiC_6_readyArray_0;
	phiC_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),phiC_6_dataInArray_0'length));
	...
	icmp_8_clk <= clk;
	icmp_8_rst <= rst;
	Buffer_1_pValidArray_0 <= icmp_8_validArray_0;
	icmp_8_nReadyArray_0 <= Buffer_1_readyArray_0;
	Buffer_1_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_8_dataOutArray_0),Buffer_1_dataInArray_0'length));
	...
	Buffer_5_pValidArray_0 <= fork_0_validArray_1;
	fork_0_nReadyArray_1 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_1),Buffer_5_dataInArray_0'length));
	...
	Buffer_6_pValidArray_0 <= fork_1_validArray_1;
	fork_1_nReadyArray_1 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_1),Buffer_6_dataInArray_0'length));
	...
	branch_1_clk <= clk;
	branch_1_rst <= rst;
	Buffer_12_pValidArray_0 <= branch_1_validArray_0;
	branch_1_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_1_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	phiC_6_clk <= clk;
	phiC_6_rst <= rst;
	Buffer_17_pValidArray_0 <= phiC_6_validArray_0;
	phiC_6_nReadyArray_0 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_6_dataOutArray_0),Buffer_17_dataInArray_0'length));
	...
	forkC_13_clk <= clk;
	forkC_13_rst <= rst;
	cst_4_pValidArray_0 <= forkC_13_validArray_0;
	forkC_13_nReadyArray_0 <= cst_4_readyArray_0;
	cst_4_dataInArray_0 <= "1";
	LSQ_A_pValidArray_0 <= forkC_13_validArray_1;
	forkC_13_nReadyArray_1 <= LSQ_A_readyArray_0;
	LSQ_A_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_13_dataOutArray_1),LSQ_A_dataInArray_0'length));
	Buffer_18_pValidArray_0 <= forkC_13_validArray_2;
	forkC_13_nReadyArray_2 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_13_dataOutArray_2),Buffer_18_dataInArray_0'length));
	...
	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	fork_7_pValidArray_0 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= fork_7_readyArray_0;
	fork_7_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),fork_7_dataInArray_0'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	branch_2_pValidArray_0 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= branch_2_readyArray_0;
	branch_2_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),branch_2_dataInArray_0'length));

	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	branch_3_pValidArray_0 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= branch_3_readyArray_0;
	branch_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),branch_3_dataInArray_0'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	branch_4_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= branch_4_readyArray_0;
	branch_4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),branch_4_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phi_16_pValidArray_1 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phi_16_readyArray_1;
	phi_16_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phi_16_dataInArray_1'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	forkC_13_pValidArray_0 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= forkC_13_readyArray_0;
	forkC_13_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),forkC_13_dataInArray_0'length));

	Buffer_18_clk <= clk;
	Buffer_18_rst <= rst;
	branchC_11_pValidArray_0 <= Buffer_18_validArray_0;
	Buffer_18_nReadyArray_0 <= branchC_11_readyArray_0;
	branchC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_18_dataOutArray_0),branchC_11_dataInArray_0'length));
	...
	Buffer_9_pValidArray_0 <= fork_5_validArray_2;
	fork_5_nReadyArray_2 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_2),Buffer_9_dataInArray_0'length));
	Buffer_10_pValidArray_0 <= fork_5_validArray_3;
	fork_5_nReadyArray_3 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_3),Buffer_10_dataInArray_0'length));
	...
	Buffer_13_pValidArray_0 <= fork_8_validArray_2;
	fork_8_nReadyArray_2 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_2),Buffer_13_dataInArray_0'length));
	...
	forkC_14_clk <= clk;
	forkC_14_rst <= rst;
	branchC_12_pValidArray_0 <= forkC_14_validArray_0;
	forkC_14_nReadyArray_0 <= branchC_12_readyArray_0;
	branchC_12_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_14_dataOutArray_0),branchC_12_dataInArray_0'length));
	brCst_block3_pValidArray_0 <= forkC_14_validArray_1;
	forkC_14_nReadyArray_1 <= brCst_block3_readyArray_0;
	...
	cst_3_dataInArray_0 <= "11";

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	mul_12_pValidArray_1 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= mul_12_readyArray_1;
	mul_12_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),mul_12_dataInArray_1'length));

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	mul_14_pValidArray_1 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= mul_14_readyArray_1;
	mul_14_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),mul_14_dataInArray_1'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	branch_5_pValidArray_1 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= branch_5_readyArray_1;
	branch_5_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),branch_5_dataInArray_1'length));
	...
	add_19_clk <= clk;
	add_19_rst <= rst;
	Buffer_2_pValidArray_0 <= add_19_validArray_0;
	add_19_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(add_19_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	icmp_20_clk <= clk;
	icmp_20_rst <= rst;
	Buffer_3_pValidArray_0 <= icmp_20_validArray_0;
	icmp_20_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_20_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	phi_n1_clk <= clk;
	phi_n1_rst <= rst;
	Buffer_4_pValidArray_0 <= phi_n1_validArray_0;
	phi_n1_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n1_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	Buffer_14_pValidArray_0 <= branch_8_validArray_1;
	branch_8_nReadyArray_1 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_1),Buffer_14_dataInArray_0'length));
	...
	Buffer_19_pValidArray_0 <= phiC_8_validArray_1;
	phiC_8_nReadyArray_1 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_8_dataOutArray_1),Buffer_19_dataInArray_0'length));
	...
	Buffer_20_pValidArray_0 <= forkC_15_validArray_1;
	forkC_15_nReadyArray_1 <= Buffer_20_readyArray_0;
	Buffer_20_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_15_dataOutArray_1),Buffer_20_dataInArray_0'length));
	...
	Buffer_21_pValidArray_0 <= branchC_13_validArray_1;
	branchC_13_nReadyArray_1 <= Buffer_21_readyArray_0;
	Buffer_21_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_13_dataOutArray_1),Buffer_21_dataInArray_0'length));
	...
	cst_6_dataInArray_0 <= "1111101000";
	...
	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	branch_9_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= branch_9_readyArray_0;
	branch_9_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),branch_9_dataInArray_0'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	phi_n5_pValidArray_0 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= phi_n5_readyArray_0;
	phi_n5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),phi_n5_dataInArray_0'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branch_8_pValidArray_1 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branch_8_readyArray_1;
	branch_8_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branch_8_dataInArray_1'length));

	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	phi_16_pValidArray_0 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= phi_16_readyArray_0;
	phi_16_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),phi_16_dataInArray_0'length));

	Buffer_20_clk <= clk;
	Buffer_20_rst <= rst;
	branchC_13_pValidArray_0 <= Buffer_20_validArray_0;
	Buffer_20_nReadyArray_0 <= branchC_13_readyArray_0;
	branchC_13_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_20_dataOutArray_0),branchC_13_dataInArray_0'length));

	Buffer_21_clk <= clk;
	Buffer_21_rst <= rst;
	phiC_9_pValidArray_0 <= Buffer_21_validArray_0;
	Buffer_21_nReadyArray_0 <= phiC_9_readyArray_0;
	phiC_9_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_21_dataOutArray_0),phiC_9_dataInArray_0'length));
...
phi_1: entity work.Mux(arch) generic map (3,1,10,10,1)
port map (
	clk => phi_1_clk,
	rst => phi_1_rst,
...
load_4: entity work.mc_load_op(arch) generic map (2,2,10,32)
port map (
	clk => load_4_clk,
	rst => load_4_rst,
...
fork_0: entity work.fork(arch) generic map (1,2,10,10)
port map (
	clk => fork_0_clk,
	rst => fork_0_rst,
...
Buffer_5: entity work.elasticBuffer(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_12: entity work.TEHB(arch) generic map (1,1,1,1)
port map (
	clk => Buffer_12_clk,
	rst => Buffer_12_rst,
...
phi_n4: entity work.merge(arch) generic map (1,1,10,10)
port map (
	clk => phi_n4_clk,
	rst => phi_n4_rst,
...
branch_7: entity work.Branch(arch) generic map (2,2,10,10)
port map (
	clk => branch_7_clk,
	rst => branch_7_rst,
...
Buffer_13: entity work.transpFifo(arch) generic map (1,1,1,1,2)
port map (
	clk => Buffer_13_clk,
	rst => Buffer_13_rst,
...
add_19: entity work.add_op(arch) generic map (2,1,10,10)
port map (
	clk => add_19_clk,
	rst => add_19_rst,
...
cst_6: entity work.Const(arch) generic map (1,1,10,10)
port map (
	clk => cst_6_clk,
	rst => cst_6_rst,
...
icmp_20: entity work.icmp_ult_op(arch) generic map (2,1,10,1)
port map (
	clk => icmp_20_clk,
	rst => icmp_20_rst,
...
phi_n1: entity work.merge(arch) generic map (2,1,10,10)
port map (
	clk => phi_n1_clk,
	rst => phi_n1_rst,
...
fork_4: entity work.fork(arch) generic map (1,2,10,10)
port map (
	clk => fork_4_clk,
	rst => fork_4_rst,
...
branch_9: entity work.Branch(arch) generic map (2,2,10,10)
port map (
	clk => branch_9_clk,
	rst => branch_9_rst,
...
source_4: entity work.source(arch) generic map (0,1,32,10)
port map (
	clk => source_4_clk,
	rst => source_4_rst,
...
Buffer_2: entity work.elasticBuffer(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_2_clk,
	rst => Buffer_2_rst,
...
Buffer_4: entity work.elasticBuffer(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_4_clk,
	rst => Buffer_4_rst,
...
Buffer_8: entity work.TEHB(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_8_clk,
	rst => Buffer_8_rst,
...
MC_addr: entity work.MemCont(arch) generic map (32,10,1,1,1)
port map (
	clk => MC_addr_clk,
	rst => MC_addr_rst,
...
sink_6: entity work.sink(arch) generic map (1,0,10,32)
port map (
	clk => sink_6_clk,
	rst => sink_6_rst,
...
sink_8: entity work.sink(arch) generic map (1,0,10,32)
port map (
	clk => sink_8_clk,
	rst => sink_8_rst,
