...
if.else:                                          ; preds = %for.body3
  ...
  %9 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %a, i64 0, i64 0, i64 %8
  store i32 %rem5, i32* %9, align 4
  %10 = zext i32 %j.01 to i64
  %11 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %a, i64 0, i64 0, i64 %10
  %12 = load i32, i32* %11, align 4
  %add28 = add nsw i32 %12, 1
  %13 = zext i32 %j.01 to i64
  %14 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %b, i64 0, i64 0, i64 %13
  store i32 %add28, i32* %14, align 4
  br label %for.inc
...
for.inc33:                                        ; preds = %for.inc
  br i1 false, label %for.body, label %for.end35

for.end35:                                        ; preds = %for.inc33
  %arraydecay = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %a, i64 0, i64 0, i64 0
  %arraydecay41 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %b, i64 0, i64 0, i64 0
  %arrayidx43 = getelementptr inbounds [1 x i32], [1 x i32]* %n, i64 0, i64 0
  %15 = load i32, i32* %arrayidx43, align 4
  %call44 = call i32 @_Z9if_loop_3PiS_i(i32* nonnull %arraydecay, i32* nonnull %arraydecay41, i32 %15)
  ret i32 0
}
