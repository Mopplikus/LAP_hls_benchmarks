...
-- File created: Tue Jun 13 20:16:05 2023
...
begin
	...
	branchC_9_clk <= clk;
	branchC_9_rst <= rst;
	Buffer_14_pValidArray_0 <= branchC_9_validArray_0;
	branchC_9_nReadyArray_0 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_9_dataOutArray_0),Buffer_14_dataInArray_0'length));
	...
	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	phiC_3_pValidArray_0 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= phiC_3_readyArray_0;
	phiC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),phiC_3_dataInArray_0'length));
	...
	icmp_8_clk <= clk;
	icmp_8_rst <= rst;
	Buffer_3_pValidArray_0 <= icmp_8_validArray_0;
	icmp_8_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_8_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	add_10_clk <= clk;
	add_10_rst <= rst;
	Buffer_4_pValidArray_0 <= add_10_validArray_0;
	add_10_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(add_10_dataOutArray_0),Buffer_4_dataInArray_0'length));

	icmp_11_clk <= clk;
	icmp_11_rst <= rst;
	Buffer_5_pValidArray_0 <= icmp_11_validArray_0;
	icmp_11_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_11_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	fork_1_clk <= clk;
	fork_1_rst <= rst;
	Buffer_7_pValidArray_0 <= fork_1_validArray_0;
	fork_1_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	phiC_3_clk <= clk;
	phiC_3_rst <= rst;
	Buffer_15_pValidArray_0 <= phiC_3_validArray_0;
	phiC_3_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_3_dataOutArray_0),Buffer_15_dataInArray_0'length));
	...
	Buffer_16_pValidArray_0 <= branchC_10_validArray_1;
	branchC_10_nReadyArray_1 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_10_dataOutArray_1),Buffer_16_dataInArray_0'length));
	...
	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	select_0_pValidArray_0 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= select_0_readyArray_0;
	select_0_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),select_0_dataInArray_0'length));
	...
	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	add_10_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= add_10_readyArray_0;
	add_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),add_10_dataInArray_0'length));
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phi_13_pValidArray_2 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phi_13_readyArray_2;
	phi_13_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phi_13_dataInArray_2'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branchC_10_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branchC_10_readyArray_0;
	branchC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branchC_10_dataInArray_0'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	phiC_4_pValidArray_1 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= phiC_4_readyArray_1;
	phiC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),phiC_4_dataInArray_1'length));
...
Buffer_8: entity work.TEHB(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_8_clk,
	rst => Buffer_8_rst,
