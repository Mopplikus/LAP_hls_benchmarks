...
-- File created: Thu May  4 08:45:52 2023
...
port (
	...
	sum_address0 : out std_logic_vector (31 downto 0);
	sum_ce0 : out std_logic;
	sum_we0 : out std_logic;
	sum_dout0 : out std_logic_vector (31 downto 0);
	sum_din0 : in std_logic_vector (31 downto 0);
	sum_address1 : out std_logic_vector (31 downto 0);
	sum_ce1 : out std_logic;
	sum_we1 : out std_logic;
	sum_dout1 : out std_logic_vector (31 downto 0);
	sum_din1 : in std_logic_vector (31 downto 0));
end;
...
architecture behavioral of if_loop_3 is 
	...
	signal Buffer_6_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_6_dataOutArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_5_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal Buffer_5_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal Buffer_10_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal Buffer_10_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal store_0_dataInArray_1 : std_logic_vector(30 downto 0);
	...
	signal store_0_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal fork_9_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal fork_9_dataOutArray_0 : std_logic_vector(30 downto 0);
	signal fork_9_nReadyArray_1 : std_logic;
	signal fork_9_validArray_1 : std_logic;
	signal fork_9_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal branch_11_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal branch_11_dataOutArray_0 : std_logic_vector(30 downto 0);
	signal branch_11_nReadyArray_1 : std_logic;
	signal branch_11_validArray_1 : std_logic;
	signal branch_11_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal phi_18_clk : std_logic;
	signal phi_18_rst : std_logic;
	signal phi_18_dataInArray_0 : std_logic_vector(0 downto 0);
	signal phi_18_dataInArray_1 : std_logic_vector(31 downto 0);
	signal phi_18_dataInArray_2 : std_logic_vector(31 downto 0);
	signal phi_18_pValidArray_0 : std_logic;
	signal phi_18_pValidArray_1 : std_logic;
	signal phi_18_pValidArray_2 : std_logic;
	signal phi_18_readyArray_0 : std_logic;
	signal phi_18_readyArray_1 : std_logic;
	signal phi_18_readyArray_2 : std_logic;
	signal phi_18_nReadyArray_0 : std_logic;
	signal phi_18_validArray_0 : std_logic;
	signal phi_18_dataOutArray_0 : std_logic_vector(31 downto 0);
	...
	signal add_19_dataInArray_0 : std_logic_vector(30 downto 0);
	signal add_19_dataInArray_1 : std_logic_vector(30 downto 0);
	...
	signal add_19_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal fork_6_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal fork_6_dataOutArray_0 : std_logic_vector(30 downto 0);
	signal fork_6_nReadyArray_1 : std_logic;
	signal fork_6_validArray_1 : std_logic;
	signal fork_6_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal Buffer_3_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal Buffer_3_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal MC_sum_clk : std_logic;
	signal MC_sum_rst : std_logic;
	signal MC_sum_dataInArray_0 : std_logic_vector(31 downto 0);
	signal MC_sum_dataInArray_1 : std_logic_vector(30 downto 0);
	signal MC_sum_dataInArray_2 : std_logic_vector(31 downto 0);
	signal MC_sum_dataInArray_3 : std_logic_vector(30 downto 0);
	signal MC_sum_pValidArray_0 : std_logic;
	signal MC_sum_pValidArray_1 : std_logic;
	signal MC_sum_pValidArray_2 : std_logic;
	signal MC_sum_pValidArray_3 : std_logic;
	signal MC_sum_readyArray_0 : std_logic;
	signal MC_sum_readyArray_1 : std_logic;
	signal MC_sum_readyArray_2 : std_logic;
	signal MC_sum_readyArray_3 : std_logic;
	signal MC_sum_nReadyArray_0 : std_logic;
	signal MC_sum_validArray_0 : std_logic;
	signal MC_sum_dataOutArray_0 : std_logic_vector(0 downto 0);
	signal MC_sum_nReadyArray_1 : std_logic;
	signal MC_sum_validArray_1 : std_logic;
	signal MC_sum_dataOutArray_1 : std_logic_vector(31 downto 0);
	signal MC_sum_we0_ce0 : std_logic;
	...
	signal sink_9_dataInArray_0 : std_logic_vector(30 downto 0);
...
begin
	...
	icmp_0_clk <= clk;
	icmp_0_rst <= rst;
	fork_10_pValidArray_0 <= icmp_0_validArray_0;
	icmp_0_nReadyArray_0 <= fork_10_readyArray_0;
	fork_10_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_0_dataOutArray_0),fork_10_dataInArray_0'length));
	...
	phi_22_pValidArray_1 <= branch_0_validArray_1;
	branch_0_nReadyArray_1 <= phi_22_readyArray_1;
	phi_22_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_1),phi_22_dataInArray_1'length));
	...
	branch_1_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_0),branch_1_dataInArray_1'length));
	branch_0_pValidArray_1 <= fork_10_validArray_1;
	fork_10_nReadyArray_1 <= branch_0_readyArray_1;
	branch_0_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_1),branch_0_dataInArray_1'length));
	...
	forkC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(start_0_dataOutArray_0),forkC_16_dataInArray_0'length));

	forkC_16_clk <= clk;
	forkC_16_rst <= rst;
	cst_5_pValidArray_0 <= forkC_16_validArray_0;
	forkC_16_nReadyArray_0 <= cst_5_readyArray_0;
	cst_5_dataInArray_0 <= "1111101000";
	branchC_15_pValidArray_0 <= forkC_16_validArray_1;
	forkC_16_nReadyArray_1 <= branchC_15_readyArray_0;
	branchC_15_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_16_dataOutArray_1),branchC_15_dataInArray_0'length));
	...
	fork_11_pValidArray_0 <= brCst_block2_validArray_0;
	brCst_block2_nReadyArray_0 <= fork_11_readyArray_0;
	fork_11_dataInArray_0 <= std_logic_vector (resize(unsigned(brCst_block2_dataOutArray_0),fork_11_dataInArray_0'length));
	...
	branch_2_clk <= clk;
	branch_2_rst <= rst;
	Buffer_6_pValidArray_0 <= branch_2_validArray_0;
	branch_2_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_0),Buffer_6_dataInArray_0'length));
	...
	branch_3_clk <= clk;
	branch_3_rst <= rst;
	Buffer_7_pValidArray_0 <= branch_3_validArray_0;
	branch_3_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_3_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	branch_4_clk <= clk;
	branch_4_rst <= rst;
	Buffer_8_pValidArray_0 <= branch_4_validArray_0;
	branch_4_nReadyArray_0 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_0),Buffer_8_dataInArray_0'length));
	...
	branch_2_pValidArray_1 <= fork_11_validArray_2;
	fork_11_nReadyArray_2 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_2),branch_2_dataInArray_1'length));
	branchC_16_pValidArray_1 <= fork_11_validArray_3;
	fork_11_nReadyArray_3 <= branchC_16_readyArray_1;
	branchC_16_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_3),branchC_16_dataInArray_1'length));

	phiC_8_clk <= clk;
	phiC_8_rst <= rst;
	forkC_17_pValidArray_0 <= phiC_8_validArray_0;
	phiC_8_nReadyArray_0 <= forkC_17_readyArray_0;
	forkC_17_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_8_dataOutArray_0),forkC_17_dataInArray_0'length));
	...
	cst_2_pValidArray_0 <= forkC_17_validArray_1;
	forkC_17_nReadyArray_1 <= cst_2_readyArray_0;
	cst_2_dataInArray_0 <= "0";
	branchC_16_pValidArray_0 <= forkC_17_validArray_2;
	forkC_17_nReadyArray_2 <= branchC_16_readyArray_0;
	branchC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_17_dataOutArray_2),branchC_16_dataInArray_0'length));
	brCst_block2_pValidArray_0 <= forkC_17_validArray_3;
	forkC_17_nReadyArray_3 <= brCst_block2_readyArray_0;
	...
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_16_dataOutArray_0),Buffer_17_dataInArray_0'length));
	...
	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	phi_3_pValidArray_1 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= phi_3_readyArray_1;
	phi_3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),phi_3_dataInArray_1'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	phi_4_pValidArray_1 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= phi_4_readyArray_1;
	phi_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),phi_4_dataInArray_1'length));

	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	phi_n1_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= phi_n1_readyArray_0;
	phi_n1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),phi_n1_dataInArray_0'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	phiC_9_pValidArray_0 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= phiC_9_readyArray_0;
	phiC_9_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),phiC_9_dataInArray_0'length));
	...
	icmp_12_clk <= clk;
	icmp_12_rst <= rst;
	fork_12_pValidArray_0 <= icmp_12_validArray_0;
	icmp_12_nReadyArray_0 <= fork_12_readyArray_0;
	fork_12_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_12_dataOutArray_0),fork_12_dataInArray_0'length));
	...
	Buffer_5_pValidArray_0 <= fork_2_validArray_2;
	fork_2_nReadyArray_2 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_2),Buffer_5_dataInArray_0'length));
	...
	branch_5_clk <= clk;
	branch_5_rst <= rst;
	Buffer_9_pValidArray_0 <= branch_5_validArray_0;
	branch_5_nReadyArray_0 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_0),Buffer_9_dataInArray_0'length));
	phi_18_pValidArray_1 <= branch_5_validArray_1;
	branch_5_nReadyArray_1 <= phi_18_readyArray_1;
	phi_18_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_1),phi_18_dataInArray_1'length));

	branch_6_clk <= clk;
	branch_6_rst <= rst;
	Buffer_10_pValidArray_0 <= branch_6_validArray_0;
	branch_6_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_6_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	branch_7_clk <= clk;
	branch_7_rst <= rst;
	Buffer_11_pValidArray_0 <= branch_7_validArray_0;
	branch_7_nReadyArray_0 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_7_dataOutArray_0),Buffer_11_dataInArray_0'length));
	...
	branch_8_clk <= clk;
	branch_8_rst <= rst;
	Buffer_12_pValidArray_0 <= branch_8_validArray_0;
	branch_8_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	branch_6_pValidArray_1 <= fork_12_validArray_2;
	fork_12_nReadyArray_2 <= branch_6_readyArray_1;
	branch_6_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_2),branch_6_dataInArray_1'length));
	branch_5_pValidArray_1 <= fork_12_validArray_3;
	fork_12_nReadyArray_3 <= branch_5_readyArray_1;
	branch_5_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_3),branch_5_dataInArray_1'length));
	branchC_17_pValidArray_1 <= fork_12_validArray_4;
	fork_12_nReadyArray_4 <= branchC_17_readyArray_1;
	branchC_17_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_4),branchC_17_dataInArray_1'length));

	phiC_9_clk <= clk;
	phiC_9_rst <= rst;
	Buffer_18_pValidArray_0 <= phiC_9_validArray_0;
	phiC_9_nReadyArray_0 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_9_dataOutArray_0),Buffer_18_dataInArray_0'length));
	fork_22_pValidArray_0 <= phiC_9_validArray_1;
	phiC_9_nReadyArray_1 <= fork_22_readyArray_0;
	fork_22_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_9_dataOutArray_1),fork_22_dataInArray_0'length));

	branchC_17_clk <= clk;
	branchC_17_rst <= rst;
	Buffer_19_pValidArray_0 <= branchC_17_validArray_0;
	branchC_17_nReadyArray_0 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_17_dataOutArray_0),Buffer_19_dataInArray_0'length));
	...
	fork_22_clk <= clk;
	fork_22_rst <= rst;
	phi_3_pValidArray_0 <= fork_22_validArray_0;
	fork_22_nReadyArray_0 <= phi_3_readyArray_0;
	phi_3_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_22_dataOutArray_0),phi_3_dataInArray_0'length));
	phi_4_pValidArray_0 <= fork_22_validArray_1;
	fork_22_nReadyArray_1 <= phi_4_readyArray_0;
	phi_4_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_22_dataOutArray_1),phi_4_dataInArray_0'length));
	...
	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	branch_6_pValidArray_0 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= branch_6_readyArray_0;
	branch_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),branch_6_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_n6_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_n6_readyArray_0;
	phi_n6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_n6_dataInArray_0'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_n5_pValidArray_0 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_n5_readyArray_0;
	phi_n5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_n5_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phi_n7_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phi_n7_readyArray_0;
	phi_n7_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phi_n7_dataInArray_0'length));

	Buffer_18_clk <= clk;
	Buffer_18_rst <= rst;
	branchC_17_pValidArray_0 <= Buffer_18_validArray_0;
	Buffer_18_nReadyArray_0 <= branchC_17_readyArray_0;
	branchC_17_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_18_dataOutArray_0),branchC_17_dataInArray_0'length));

	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	phiC_10_pValidArray_0 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= phiC_10_readyArray_0;
	phiC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),phiC_10_dataInArray_0'length));

	sdiv_14_clk <= clk;
	sdiv_14_rst <= rst;
	fork_4_pValidArray_0 <= sdiv_14_validArray_0;
	sdiv_14_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(sdiv_14_dataOutArray_0),fork_4_dataInArray_0'length));

	store_0_clk <= clk;
	store_0_rst <= rst;
	MC_sum_pValidArray_2 <= store_0_validArray_0;
	store_0_nReadyArray_0 <= MC_sum_readyArray_2;
	MC_sum_dataInArray_2 <= std_logic_vector (resize(unsigned(store_0_dataOutArray_0),MC_sum_dataInArray_2'length));
	MC_sum_pValidArray_1 <= store_0_validArray_1;
	store_0_nReadyArray_1 <= MC_sum_readyArray_1;
	MC_sum_dataInArray_1 <= std_logic_vector (resize(unsigned(store_0_dataOutArray_1),MC_sum_dataInArray_1'length));

	brCst_block4_clk <= clk;
	brCst_block4_rst <= rst;
	fork_13_pValidArray_0 <= brCst_block4_validArray_0;
	brCst_block4_nReadyArray_0 <= fork_13_readyArray_0;
	fork_13_dataInArray_0 <= std_logic_vector (resize(unsigned(brCst_block4_dataOutArray_0),fork_13_dataInArray_0'length));
	...
	branch_10_pValidArray_0 <= fork_4_validArray_1;
	fork_4_nReadyArray_1 <= branch_10_readyArray_0;
	branch_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_1),branch_10_dataInArray_0'length));

	fork_9_clk <= clk;
	fork_9_rst <= rst;
	store_0_pValidArray_1 <= fork_9_validArray_0;
	fork_9_nReadyArray_0 <= store_0_readyArray_1;
	store_0_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_9_dataOutArray_0),store_0_dataInArray_1'length));
	branch_11_pValidArray_0 <= fork_9_validArray_1;
	fork_9_nReadyArray_1 <= branch_11_readyArray_0;
	branch_11_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_9_dataOutArray_1),branch_11_dataInArray_0'length));

	branch_9_clk <= clk;
	branch_9_rst <= rst;
	Buffer_13_pValidArray_0 <= branch_9_validArray_0;
	branch_9_nReadyArray_0 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_9_dataOutArray_0),Buffer_13_dataInArray_0'length));
	...
	branch_10_clk <= clk;
	branch_10_rst <= rst;
	Buffer_14_pValidArray_0 <= branch_10_validArray_0;
	branch_10_nReadyArray_0 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_10_dataOutArray_0),Buffer_14_dataInArray_0'length));
	...
	branch_11_clk <= clk;
	branch_11_rst <= rst;
	Buffer_15_pValidArray_0 <= branch_11_validArray_0;
	branch_11_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_11_dataOutArray_0),Buffer_15_dataInArray_0'length));
	...
	branch_11_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_0),branch_11_dataInArray_1'length));
	branch_10_pValidArray_1 <= fork_13_validArray_1;
	fork_13_nReadyArray_1 <= branch_10_readyArray_1;
	branch_10_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_1),branch_10_dataInArray_1'length));
	branch_9_pValidArray_1 <= fork_13_validArray_2;
	fork_13_nReadyArray_2 <= branch_9_readyArray_1;
	branch_9_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_2),branch_9_dataInArray_1'length));
	...
	cst_6_clk <= clk;
	cst_6_rst <= rst;
	MC_sum_pValidArray_0 <= cst_6_validArray_0;
	cst_6_nReadyArray_0 <= MC_sum_readyArray_0;
	MC_sum_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_6_dataOutArray_0),MC_sum_dataInArray_0'length));

	phiC_10_clk <= clk;
	phiC_10_rst <= rst;
	forkC_19_pValidArray_0 <= phiC_10_validArray_0;
	phiC_10_nReadyArray_0 <= forkC_19_readyArray_0;
	forkC_19_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_10_dataOutArray_0),forkC_19_dataInArray_0'length));

	forkC_19_clk <= clk;
	forkC_19_rst <= rst;
	cst_6_pValidArray_0 <= forkC_19_validArray_0;
	forkC_19_nReadyArray_0 <= cst_6_readyArray_0;
	...
	brCst_block4_pValidArray_0 <= forkC_19_validArray_2;
	forkC_19_nReadyArray_2 <= brCst_block4_readyArray_0;
	brCst_block4_dataInArray_0 <= "1";

	branchC_18_clk <= clk;
	branchC_18_rst <= rst;
	Buffer_20_pValidArray_0 <= branchC_18_validArray_0;
	branchC_18_nReadyArray_0 <= Buffer_20_readyArray_0;
	Buffer_20_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_18_dataOutArray_0),Buffer_20_dataInArray_0'length));
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phi_n3_pValidArray_1 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phi_n3_readyArray_1;
	phi_n3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phi_n3_dataInArray_1'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	phi_18_pValidArray_2 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= phi_18_readyArray_2;
	phi_18_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),phi_18_dataInArray_2'length));
	...
	phiC_11_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_20_dataOutArray_0),phiC_11_dataInArray_1'length));

	phi_18_clk <= clk;
	phi_18_rst <= rst;
	branch_12_pValidArray_0 <= phi_18_validArray_0;
	phi_18_nReadyArray_0 <= branch_12_readyArray_0;
	branch_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_18_dataOutArray_0),branch_12_dataInArray_0'length));
	...
	add_19_clk <= clk;
	add_19_rst <= rst;
	fork_6_pValidArray_0 <= add_19_validArray_0;
	add_19_nReadyArray_0 <= fork_6_readyArray_0;
	fork_6_dataInArray_0 <= std_logic_vector (resize(unsigned(add_19_dataOutArray_0),fork_6_dataInArray_0'length));

	icmp_20_clk <= clk;
	icmp_20_rst <= rst;
	fork_14_pValidArray_0 <= icmp_20_validArray_0;
	icmp_20_nReadyArray_0 <= fork_14_readyArray_0;
	fork_14_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_20_dataOutArray_0),fork_14_dataInArray_0'length));

	phi_n2_clk <= clk;
	phi_n2_rst <= rst;
	Buffer_3_pValidArray_0 <= phi_n2_validArray_0;
	phi_n2_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n2_dataOutArray_0),Buffer_3_dataInArray_0'length));

	phi_n3_clk <= clk;
	phi_n3_rst <= rst;
	Buffer_4_pValidArray_0 <= phi_n3_validArray_0;
	phi_n3_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n3_dataOutArray_0),Buffer_4_dataInArray_0'length));

	fork_6_clk <= clk;
	fork_6_rst <= rst;
	icmp_20_pValidArray_0 <= fork_6_validArray_0;
	fork_6_nReadyArray_0 <= icmp_20_readyArray_0;
	icmp_20_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_0),icmp_20_dataInArray_0'length));
	...
	branch_14_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_1),branch_14_dataInArray_0'length));
	...
	Buffer_16_pValidArray_0 <= branch_12_validArray_1;
	branch_12_nReadyArray_1 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_1),Buffer_16_dataInArray_0'length));
	...
	fork_14_clk <= clk;
	fork_14_rst <= rst;
	branch_14_pValidArray_1 <= fork_14_validArray_0;
	fork_14_nReadyArray_0 <= branch_14_readyArray_1;
	branch_14_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_0),branch_14_dataInArray_1'length));
	branch_13_pValidArray_1 <= fork_14_validArray_1;
	fork_14_nReadyArray_1 <= branch_13_readyArray_1;
	branch_13_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_1),branch_13_dataInArray_1'length));
	branch_12_pValidArray_1 <= fork_14_validArray_2;
	fork_14_nReadyArray_2 <= branch_12_readyArray_1;
	branch_12_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_2),branch_12_dataInArray_1'length));
	branchC_19_pValidArray_1 <= fork_14_validArray_3;
	fork_14_nReadyArray_3 <= branchC_19_readyArray_1;
	branchC_19_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_3),branchC_19_dataInArray_1'length));

	phiC_11_clk <= clk;
	phiC_11_rst <= rst;
	Buffer_21_pValidArray_0 <= phiC_11_validArray_0;
	phiC_11_nReadyArray_0 <= Buffer_21_readyArray_0;
	Buffer_21_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_0),Buffer_21_dataInArray_0'length));
	phi_18_pValidArray_0 <= phiC_11_validArray_1;
	phiC_11_nReadyArray_1 <= phi_18_readyArray_0;
	phi_18_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_1),phi_18_dataInArray_0'length));
	...
	Buffer_22_pValidArray_0 <= branchC_19_validArray_1;
	branchC_19_nReadyArray_1 <= Buffer_22_readyArray_0;
	Buffer_22_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_19_dataOutArray_1),Buffer_22_dataInArray_0'length));
	...
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),fork_8_dataInArray_0'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	phi_22_pValidArray_2 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= phi_22_readyArray_2;
	phi_22_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),phi_22_dataInArray_2'length));

	Buffer_21_clk <= clk;
	Buffer_21_rst <= rst;
	branchC_19_pValidArray_0 <= Buffer_21_validArray_0;
	Buffer_21_nReadyArray_0 <= branchC_19_readyArray_0;
	branchC_19_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_21_dataOutArray_0),branchC_19_dataInArray_0'length));

	Buffer_22_clk <= clk;
	Buffer_22_rst <= rst;
	phiC_12_pValidArray_1 <= Buffer_22_validArray_0;
	Buffer_22_nReadyArray_0 <= phiC_12_readyArray_1;
	phiC_12_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_22_dataOutArray_0),phiC_12_dataInArray_1'length));
	...
	phi_22_pValidArray_0 <= phiC_12_validArray_1;
	phiC_12_nReadyArray_1 <= phi_22_readyArray_0;
	phi_22_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_12_dataOutArray_1),phi_22_dataInArray_0'length));
	...
	MC_sum_clk <= clk;
	MC_sum_rst <= rst;
	sum_ce0 <= MC_sum_we0_ce0;
	sum_we0 <= MC_sum_we0_ce0;
	end_0_pValidArray_2 <= MC_sum_validArray_0;
	MC_sum_nReadyArray_0 <= end_0_readyArray_2;
	end_0_dataInArray_2 <= std_logic_vector (resize(unsigned(MC_sum_dataOutArray_0),end_0_dataInArray_2'length));
...
forkC_17: entity work.fork(arch) generic map (1,4,1,1)
port map (
	clk => forkC_17_clk,
	rst => forkC_17_rst,
...
Buffer_6: entity work.elasticBuffer(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_6_clk,
	rst => Buffer_6_rst,
...
Buffer_5: entity work.TEHB(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_10: entity work.elasticBuffer(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_10_clk,
	rst => Buffer_10_rst,
...
store_0: entity work.mc_store_op(arch) generic map (2,2,31,32)
port map (
	clk => store_0_clk,
	rst => store_0_rst,
...
fork_9: entity work.fork(arch) generic map (1,2,31,31)
port map (
	clk => fork_9_clk,
	rst => fork_9_rst,
...
branch_11: entity work.Branch(arch) generic map (2,2,31,31)
port map (
	clk => branch_11_clk,
	rst => branch_11_rst,
...
phi_18: entity work.Mux(arch) generic map (3,1,32,32,1)
port map (
	clk => phi_18_clk,
	rst => phi_18_rst,
	Condition(0) => phi_18_dataInArray_0,
	dataInArray(0) => phi_18_dataInArray_1,
	dataInArray(1) => phi_18_dataInArray_2,
	pValidArray(0) => phi_18_pValidArray_0,
	pValidArray(1) => phi_18_pValidArray_1,
	pValidArray(2) => phi_18_pValidArray_2,
	readyArray(0) => phi_18_readyArray_0,
	readyArray(1) => phi_18_readyArray_1,
	readyArray(2) => phi_18_readyArray_2,
	nReadyArray(0) => phi_18_nReadyArray_0,
	validArray(0) => phi_18_validArray_0,
	dataOutArray(0) => phi_18_dataOutArray_0
);
...
add_19: entity work.add_op(arch) generic map (2,1,31,31)
port map (
	clk => add_19_clk,
	rst => add_19_rst,
...
fork_6: entity work.fork(arch) generic map (1,2,31,31)
port map (
	clk => fork_6_clk,
	rst => fork_6_rst,
...
Buffer_3: entity work.elasticBuffer(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_3_clk,
	rst => Buffer_3_rst,
...
MC_sum: entity work.MemCont(arch) generic map (32,31,1,1,1)
port map (
	clk => MC_sum_clk,
	rst => MC_sum_rst,
	io_storeDataOut => sum_dout0,
	io_storeAddrOut => sum_address0,
	io_storeEnable => MC_sum_we0_ce0,
	io_loadDataIn => sum_din1,
	io_loadAddrOut => sum_address1,
	io_loadEnable => sum_ce1,
	io_bbReadyToPrevs(0) => MC_sum_readyArray_0,
	io_bbpValids(0) => MC_sum_pValidArray_0,
	io_bb_stCountArray(0) => MC_sum_dataInArray_0,
	io_rdPortsPrev_ready(0) => MC_sum_readyArray_3,
	io_rdPortsPrev_valid(0) => MC_sum_pValidArray_3,
	io_rdPortsPrev_bits(0) => MC_sum_dataInArray_3,
	io_wrAddrPorts_ready(0) => MC_sum_readyArray_1,
	io_wrAddrPorts_valid(0) => MC_sum_pValidArray_1,
	io_wrAddrPorts_bits(0) => MC_sum_dataInArray_1,
	io_wrDataPorts_ready(0) => MC_sum_readyArray_2,
	io_wrDataPorts_valid(0) => MC_sum_pValidArray_2,
	io_wrDataPorts_bits(0) => MC_sum_dataInArray_2,
	io_rdPortsNext_ready(0) => MC_sum_nReadyArray_1,
	io_rdPortsNext_valid(0) => MC_sum_validArray_1,
	io_rdPortsNext_bits(0) => MC_sum_dataOutArray_1,
	io_Empty_Valid => MC_sum_validArray_0,
	io_Empty_Ready => MC_sum_nReadyArray_0
...
sink_9: entity work.sink(arch) generic map (1,0,31,32)
port map (
	clk => sink_9_clk,
	rst => sink_9_rst,
