; ModuleID = '.if_loop_3.cpp_mem2reg.ll'
...
for.cond.for.end_crit_edge:                       ; preds = %for.inc
  %split = phi i32 [ %sum_local.1, %for.inc ]
  br label %for.end

for.end:                                          ; preds = %for.cond.for.end_crit_edge, %entry
  %sum_local.0.lcssa = phi i32 [ %split, %for.cond.for.end_crit_edge ], [ 1000, %entry ]
...
for.body:                                         ; preds = %entry, %for.inc13
  %i.02 = phi i32 [ 0, %entry ], [ %inc14, %for.inc13 ]
  %idxprom = sext i32 %i.02 to i64
...
for.body3:                                        ; preds = %for.body, %for.inc
  ...
  %idxprom11 = sext i32 %j.01 to i64
...
for.inc13:                                        ; preds = %for.end
  %inc14 = add nsw i32 %i.02, 1
  %cmp = icmp slt i32 %inc14, 1
  br i1 %cmp, label %for.body, label %for.end15

for.end15:                                        ; preds = %for.inc13
  %arrayidx18 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %a, i64 0, i64 0
  %arraydecay = getelementptr inbounds [100 x i32], [100 x i32]* %arrayidx18, i32 0, i32 0
  %arrayidx20 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %b, i64 0, i64 0
  ...
  %arrayidx25 = getelementptr inbounds [1 x [100 x i32]], [1 x [100 x i32]]* %sum, i64 0, i64 0
