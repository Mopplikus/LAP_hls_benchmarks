...
-- File created: Tue Jun 13 18:35:31 2023
...
architecture behavioral of bicg is 
	...
	signal load_4_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal load_4_dataOutArray_1 : std_logic_vector(4 downto 0);
	...
	signal phi_7_dataInArray_1 : std_logic_vector(4 downto 0);
	signal phi_7_dataInArray_2 : std_logic_vector(4 downto 0);
	...
	signal phi_7_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal load_14_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal load_14_dataOutArray_1 : std_logic_vector(4 downto 0);

	signal load_17_clk : std_logic;
	signal load_17_rst : std_logic;
	signal load_17_dataInArray_0 : std_logic_vector(31 downto 0);
	signal load_17_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal load_17_dataOutArray_1 : std_logic_vector(4 downto 0);
	...
	signal load_24_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal load_24_dataOutArray_1 : std_logic_vector(4 downto 0);

	signal mul_25_clk : std_logic;
	signal mul_25_rst : std_logic;
	signal mul_25_dataInArray_0 : std_logic_vector(31 downto 0);
	signal mul_25_dataInArray_1 : std_logic_vector(31 downto 0);
	signal mul_25_pValidArray_0 : std_logic;
	signal mul_25_pValidArray_1 : std_logic;
	signal mul_25_readyArray_0 : std_logic;
	signal mul_25_readyArray_1 : std_logic;
	signal mul_25_nReadyArray_0 : std_logic;
	signal mul_25_validArray_0 : std_logic;
	signal mul_25_dataOutArray_0 : std_logic_vector(31 downto 0);
	...
	signal add_27_dataInArray_0 : std_logic_vector(4 downto 0);
	signal add_27_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal add_27_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal cst_3_clk : std_logic;
	signal cst_3_rst : std_logic;
	signal cst_3_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal cst_3_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal icmp_28_clk : std_logic;
	signal icmp_28_rst : std_logic;
	signal icmp_28_dataInArray_0 : std_logic_vector(4 downto 0);
	signal icmp_28_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal fork_1_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_3_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_3_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_7_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_7_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal Buffer_9_clk : std_logic;
	signal Buffer_9_rst : std_logic;
	signal Buffer_9_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_9_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_13_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_13_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal store_1_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal store_1_dataOutArray_1 : std_logic_vector(4 downto 0);
	...
	signal add_32_dataInArray_0 : std_logic_vector(4 downto 0);
	signal add_32_dataInArray_1 : std_logic_vector(4 downto 0);
	...
	signal add_32_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal icmp_33_clk : std_logic;
	signal icmp_33_rst : std_logic;
	signal icmp_33_dataInArray_0 : std_logic_vector(4 downto 0);
	signal icmp_33_dataInArray_1 : std_logic_vector(4 downto 0);
	signal icmp_33_pValidArray_0 : std_logic;
	signal icmp_33_pValidArray_1 : std_logic;
	signal icmp_33_readyArray_0 : std_logic;
	signal icmp_33_readyArray_1 : std_logic;
	signal icmp_33_nReadyArray_0 : std_logic;
	signal icmp_33_validArray_0 : std_logic;
	signal icmp_33_dataOutArray_0 : std_logic_vector(0 downto 0);
	...
	signal Buffer_8_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_8_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal Buffer_17_clk : std_logic;
	signal Buffer_17_rst : std_logic;
	signal Buffer_17_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_17_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal LSQ_s_clk : std_logic;
	signal LSQ_s_rst : std_logic;
	signal LSQ_s_dataInArray_0 : std_logic_vector(0 downto 0);
	signal LSQ_s_dataInArray_1 : std_logic_vector(4 downto 0);
	signal LSQ_s_dataInArray_2 : std_logic_vector(4 downto 0);
	signal LSQ_s_dataInArray_3 : std_logic_vector(31 downto 0);
	signal LSQ_s_pValidArray_0 : std_logic;
	signal LSQ_s_pValidArray_1 : std_logic;
	signal LSQ_s_pValidArray_2 : std_logic;
	signal LSQ_s_pValidArray_3 : std_logic;
	signal LSQ_s_readyArray_0 : std_logic;
	signal LSQ_s_readyArray_1 : std_logic;
	signal LSQ_s_readyArray_2 : std_logic;
	signal LSQ_s_readyArray_3 : std_logic;
	signal LSQ_s_nReadyArray_0 : std_logic;
	signal LSQ_s_validArray_0 : std_logic;
	signal LSQ_s_dataOutArray_0 : std_logic_vector(31 downto 0);
	signal LSQ_s_nReadyArray_1 : std_logic;
	signal LSQ_s_validArray_1 : std_logic;
	signal LSQ_s_dataOutArray_1 : std_logic_vector(0 downto 0);
	signal LSQ_s_io_queueEmpty : std_logic;
	signal LSQ_s_we0_ce0 : std_logic;
	signal LSQ_s_address0 : std_logic_vector (4 downto 0);
	signal LSQ_s_ce0 : std_logic;
	signal LSQ_s_we0 : std_logic;
	signal LSQ_s_dout0 : std_logic_vector (31 downto 0);
	signal LSQ_s_din0 : std_logic_vector (31 downto 0);
	signal LSQ_s_address1 : std_logic_vector (4 downto 0);
	signal LSQ_s_ce1 : std_logic;
	signal LSQ_s_we1 : std_logic;
	signal LSQ_s_dout1 : std_logic_vector (31 downto 0);
	signal LSQ_s_din1 : std_logic_vector (31 downto 0);
	signal LSQ_s_load_ready : std_logic;
	signal LSQ_s_store_ready : std_logic;

	signal MC_q_clk : std_logic;
	signal MC_q_rst : std_logic;
	signal MC_q_dataInArray_0 : std_logic_vector(31 downto 0);
	signal MC_q_dataInArray_1 : std_logic_vector(4 downto 0);
	signal MC_q_dataInArray_2 : std_logic_vector(4 downto 0);
	signal MC_q_dataInArray_3 : std_logic_vector(31 downto 0);
	signal MC_q_pValidArray_0 : std_logic;
	signal MC_q_pValidArray_1 : std_logic;
	signal MC_q_pValidArray_2 : std_logic;
	signal MC_q_pValidArray_3 : std_logic;
	signal MC_q_readyArray_0 : std_logic;
	signal MC_q_readyArray_1 : std_logic;
	signal MC_q_readyArray_2 : std_logic;
	signal MC_q_readyArray_3 : std_logic;
	signal MC_q_nReadyArray_0 : std_logic;
	signal MC_q_validArray_0 : std_logic;
	signal MC_q_dataOutArray_0 : std_logic_vector(31 downto 0);
	signal MC_q_nReadyArray_1 : std_logic;
	signal MC_q_validArray_1 : std_logic;
	signal MC_q_dataOutArray_1 : std_logic_vector(0 downto 0);
	signal MC_q_we0_ce0 : std_logic;
	...
	signal MC_r_clk : std_logic;
	signal MC_r_rst : std_logic;
	signal MC_r_dataInArray_0 : std_logic_vector(4 downto 0);
	signal MC_r_dataInArray_1 : std_logic_vector(31 downto 0);
	signal MC_r_dataInArray_2 : std_logic_vector(4 downto 0);
	signal MC_r_dataInArray_3 : std_logic_vector(31 downto 0);
	signal MC_r_pValidArray_0 : std_logic;
	signal MC_r_pValidArray_1 : std_logic;
	signal MC_r_pValidArray_2 : std_logic;
	signal MC_r_pValidArray_3 : std_logic;
	signal MC_r_readyArray_0 : std_logic;
	signal MC_r_readyArray_1 : std_logic;
	signal MC_r_readyArray_2 : std_logic;
	signal MC_r_readyArray_3 : std_logic;
	signal MC_r_nReadyArray_0 : std_logic;
	signal MC_r_validArray_0 : std_logic;
	signal MC_r_dataOutArray_0 : std_logic_vector(31 downto 0);
	signal MC_r_nReadyArray_1 : std_logic;
	signal MC_r_validArray_1 : std_logic;
	signal MC_r_dataOutArray_1 : std_logic_vector(0 downto 0);
	signal MC_r_we0_ce0 : std_logic;

	signal MC_p_clk : std_logic;
	signal MC_p_rst : std_logic;
	signal MC_p_dataInArray_0 : std_logic_vector(4 downto 0);
	signal MC_p_dataInArray_1 : std_logic_vector(31 downto 0);
	signal MC_p_dataInArray_2 : std_logic_vector(4 downto 0);
	signal MC_p_dataInArray_3 : std_logic_vector(31 downto 0);
	signal MC_p_pValidArray_0 : std_logic;
	signal MC_p_pValidArray_1 : std_logic;
	signal MC_p_pValidArray_2 : std_logic;
	signal MC_p_pValidArray_3 : std_logic;
	signal MC_p_readyArray_0 : std_logic;
	signal MC_p_readyArray_1 : std_logic;
	signal MC_p_readyArray_2 : std_logic;
	signal MC_p_readyArray_3 : std_logic;
	signal MC_p_nReadyArray_0 : std_logic;
	signal MC_p_validArray_0 : std_logic;
	signal MC_p_dataOutArray_0 : std_logic_vector(31 downto 0);
	signal MC_p_nReadyArray_1 : std_logic;
	signal MC_p_validArray_1 : std_logic;
	signal MC_p_dataOutArray_1 : std_logic_vector(0 downto 0);
	signal MC_p_we0_ce0 : std_logic;
	...
	signal end_0_dataInArray_5 : std_logic_vector(31 downto 0);
...
port(
	...
	io_storeAddrOut : out std_logic_vector(4 downto 0);
	...
	io_rdPortsPrev_0_bits : in std_logic_vector(4 downto 0);
	io_wrAddrPorts_0_valid : in std_logic;
	io_wrAddrPorts_0_ready : out std_logic;
	io_wrAddrPorts_0_bits : in std_logic_vector(4 downto 0);
	...
	io_loadAddrOut : out std_logic_vector(4  downto 0);
...
begin
	...
	branch_0_clk <= clk;
	branch_0_rst <= rst;
	Buffer_10_pValidArray_0 <= branch_0_validArray_0;
	branch_0_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	branchC_9_pValidArray_0 <= forkC_14_validArray_1;
	forkC_14_nReadyArray_1 <= branchC_9_readyArray_0;
	branchC_9_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_14_dataOutArray_1),branchC_9_dataInArray_0'length));
	...
	branchC_9_clk <= clk;
	branchC_9_rst <= rst;
	Buffer_20_pValidArray_0 <= branchC_9_validArray_0;
	branchC_9_nReadyArray_0 <= Buffer_20_readyArray_0;
	Buffer_20_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_9_dataOutArray_0),Buffer_20_dataInArray_0'length));
	...
	branchC_9_pValidArray_1 <= fork_15_validArray_1;
	fork_15_nReadyArray_1 <= branchC_9_readyArray_1;
	branchC_9_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_15_dataOutArray_1),branchC_9_dataInArray_1'length));

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_1_pValidArray_1 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_1_readyArray_1;
	phi_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_1_dataInArray_1'length));

	Buffer_20_clk <= clk;
	Buffer_20_rst <= rst;
	phiC_4_pValidArray_0 <= Buffer_20_validArray_0;
	Buffer_20_nReadyArray_0 <= phiC_4_readyArray_0;
	phiC_4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_20_dataOutArray_0),phiC_4_dataInArray_0'length));
	...
	MC_q_pValidArray_1 <= load_4_validArray_1;
	load_4_nReadyArray_1 <= MC_q_readyArray_1;
	MC_q_dataInArray_1 <= std_logic_vector (resize(unsigned(load_4_dataOutArray_1),MC_q_dataInArray_1'length));

	brCst_block2_clk <= clk;
	brCst_block2_rst <= rst;
	fork_10_pValidArray_0 <= brCst_block2_validArray_0;
	brCst_block2_nReadyArray_0 <= fork_10_readyArray_0;
	fork_10_dataInArray_0 <= std_logic_vector (resize(unsigned(brCst_block2_dataOutArray_0),fork_10_dataInArray_0'length));
	...
	branch_3_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_0),branch_3_dataInArray_1'length));
	branch_2_pValidArray_1 <= fork_10_validArray_1;
	fork_10_nReadyArray_1 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_1),branch_2_dataInArray_1'length));
	Buffer_11_pValidArray_0 <= fork_10_validArray_2;
	fork_10_nReadyArray_2 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_2),Buffer_11_dataInArray_0'length));
	branchC_10_pValidArray_1 <= fork_10_validArray_3;
	fork_10_nReadyArray_3 <= branchC_10_readyArray_1;
	branchC_10_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_3),branchC_10_dataInArray_1'length));

	phiC_4_clk <= clk;
	phiC_4_rst <= rst;
	Buffer_21_pValidArray_0 <= phiC_4_validArray_0;
	phiC_4_nReadyArray_0 <= Buffer_21_readyArray_0;
	Buffer_21_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_4_dataOutArray_0),Buffer_21_dataInArray_0'length));
	...
	branchC_10_pValidArray_0 <= forkC_16_validArray_1;
	forkC_16_nReadyArray_1 <= branchC_10_readyArray_0;
	branchC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_16_dataOutArray_1),branchC_10_dataInArray_0'length));
	...
	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	branch_1_pValidArray_1 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= branch_1_readyArray_1;
	branch_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),branch_1_dataInArray_1'length));

	Buffer_21_clk <= clk;
	Buffer_21_rst <= rst;
	forkC_16_pValidArray_0 <= Buffer_21_validArray_0;
	Buffer_21_nReadyArray_0 <= forkC_16_readyArray_0;
	forkC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_21_dataOutArray_0),forkC_16_dataInArray_0'length));

	phi_6_clk <= clk;
	phi_6_rst <= rst;
	Buffer_2_pValidArray_0 <= phi_6_validArray_0;
	phi_6_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_6_dataOutArray_0),Buffer_2_dataInArray_0'length));

	phi_7_clk <= clk;
	phi_7_rst <= rst;
	Buffer_3_pValidArray_0 <= phi_7_validArray_0;
	phi_7_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_7_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	load_11_clk <= clk;
	load_11_rst <= rst;
	fork_2_pValidArray_0 <= load_11_validArray_0;
	load_11_nReadyArray_0 <= fork_2_readyArray_0;
	fork_2_dataInArray_0 <= std_logic_vector (resize(unsigned(load_11_dataOutArray_0),fork_2_dataInArray_0'length));
	...
	load_14_clk <= clk;
	load_14_rst <= rst;
	Buffer_4_pValidArray_0 <= load_14_validArray_0;
	load_14_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(load_14_dataOutArray_0),Buffer_4_dataInArray_0'length));
	LSQ_s_pValidArray_1 <= load_14_validArray_1;
	load_14_nReadyArray_1 <= LSQ_s_readyArray_1;
	LSQ_s_dataInArray_1 <= std_logic_vector (resize(unsigned(load_14_dataOutArray_1),LSQ_s_dataInArray_1'length));

	load_17_clk <= clk;
	load_17_rst <= rst;
	mul_18_pValidArray_0 <= load_17_validArray_0;
	load_17_nReadyArray_0 <= mul_18_readyArray_0;
	mul_18_dataInArray_0 <= std_logic_vector (resize(unsigned(load_17_dataOutArray_0),mul_18_dataInArray_0'length));
	MC_r_pValidArray_0 <= load_17_validArray_1;
	load_17_nReadyArray_1 <= MC_r_readyArray_0;
	MC_r_dataInArray_0 <= std_logic_vector (resize(unsigned(load_17_dataOutArray_1),MC_r_dataInArray_0'length));

	mul_18_clk <= clk;
	mul_18_rst <= rst;
	add_19_pValidArray_1 <= mul_18_validArray_0;
	mul_18_nReadyArray_0 <= add_19_readyArray_1;
	add_19_dataInArray_1 <= std_logic_vector (resize(unsigned(mul_18_dataOutArray_0),add_19_dataInArray_1'length));
	...
	store_0_clk <= clk;
	store_0_rst <= rst;
	LSQ_s_pValidArray_3 <= store_0_validArray_0;
	store_0_nReadyArray_0 <= LSQ_s_readyArray_3;
	LSQ_s_dataInArray_3 <= std_logic_vector (resize(unsigned(store_0_dataOutArray_0),LSQ_s_dataInArray_3'length));
	LSQ_s_pValidArray_2 <= store_0_validArray_1;
	store_0_nReadyArray_1 <= LSQ_s_readyArray_2;
	LSQ_s_dataInArray_2 <= std_logic_vector (resize(unsigned(store_0_dataOutArray_1),LSQ_s_dataInArray_2'length));

	load_24_clk <= clk;
	load_24_rst <= rst;
	mul_25_pValidArray_1 <= load_24_validArray_0;
	load_24_nReadyArray_0 <= mul_25_readyArray_1;
	mul_25_dataInArray_1 <= std_logic_vector (resize(unsigned(load_24_dataOutArray_0),mul_25_dataInArray_1'length));
	MC_p_pValidArray_0 <= load_24_validArray_1;
	load_24_nReadyArray_1 <= MC_p_readyArray_0;
	MC_p_dataInArray_0 <= std_logic_vector (resize(unsigned(load_24_dataOutArray_1),MC_p_dataInArray_0'length));

	mul_25_clk <= clk;
	mul_25_rst <= rst;
	add_26_pValidArray_1 <= mul_25_validArray_0;
	mul_25_nReadyArray_0 <= add_26_readyArray_1;
	add_26_dataInArray_1 <= std_logic_vector (resize(unsigned(mul_25_dataOutArray_0),add_26_dataInArray_1'length));

	add_26_clk <= clk;
	add_26_rst <= rst;
	branch_4_pValidArray_0 <= add_26_validArray_0;
	add_26_nReadyArray_0 <= branch_4_readyArray_0;
	branch_4_dataInArray_0 <= std_logic_vector (resize(unsigned(add_26_dataOutArray_0),branch_4_dataInArray_0'length));

	cst_2_clk <= clk;
	cst_2_rst <= rst;
	add_27_pValidArray_1 <= cst_2_validArray_0;
	cst_2_nReadyArray_0 <= add_27_readyArray_1;
	add_27_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_2_dataOutArray_0),add_27_dataInArray_1'length));

	add_27_clk <= clk;
	add_27_rst <= rst;
	Buffer_5_pValidArray_0 <= add_27_validArray_0;
	add_27_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(add_27_dataOutArray_0),Buffer_5_dataInArray_0'length));

	cst_3_clk <= clk;
	cst_3_rst <= rst;
	icmp_28_pValidArray_1 <= cst_3_validArray_0;
	cst_3_nReadyArray_0 <= icmp_28_readyArray_1;
	icmp_28_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_3_dataOutArray_0),icmp_28_dataInArray_1'length));

	icmp_28_clk <= clk;
	icmp_28_rst <= rst;
	fork_11_pValidArray_0 <= icmp_28_validArray_0;
	icmp_28_nReadyArray_0 <= fork_11_readyArray_0;
	fork_11_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_28_dataOutArray_0),fork_11_dataInArray_0'length));

	cst_6_clk <= clk;
	cst_6_rst <= rst;
	getelementptr_10_pValidArray_2 <= cst_6_validArray_0;
	cst_6_nReadyArray_0 <= getelementptr_10_readyArray_2;
	getelementptr_10_dataInArray_2 <= std_logic_vector (resize(unsigned(cst_6_dataOutArray_0),getelementptr_10_dataInArray_2'length));

	phi_n2_clk <= clk;
	phi_n2_rst <= rst;
	Buffer_7_pValidArray_0 <= phi_n2_validArray_0;
	phi_n2_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n2_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	add_27_pValidArray_0 <= fork_1_validArray_1;
	fork_1_nReadyArray_1 <= add_27_readyArray_0;
	add_27_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_1),add_27_dataInArray_0'length));
	...
	store_0_pValidArray_1 <= fork_1_validArray_3;
	fork_1_nReadyArray_3 <= store_0_readyArray_1;
	store_0_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_3),store_0_dataInArray_1'length));
	load_24_pValidArray_1 <= fork_1_validArray_4;
	fork_1_nReadyArray_4 <= load_24_readyArray_1;
	load_24_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_4),load_24_dataInArray_1'length));

	fork_2_clk <= clk;
	fork_2_rst <= rst;
	mul_18_pValidArray_1 <= fork_2_validArray_0;
	fork_2_nReadyArray_0 <= mul_18_readyArray_1;
	mul_18_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_0),mul_18_dataInArray_1'length));
	mul_25_pValidArray_0 <= fork_2_validArray_1;
	fork_2_nReadyArray_1 <= mul_25_readyArray_0;
	mul_25_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_1),mul_25_dataInArray_0'length));
	...
	load_17_pValidArray_1 <= fork_8_validArray_1;
	fork_8_nReadyArray_1 <= load_17_readyArray_1;
	load_17_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_1),load_17_dataInArray_1'length));
	Buffer_9_pValidArray_0 <= fork_8_validArray_2;
	fork_8_nReadyArray_2 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_2),Buffer_9_dataInArray_0'length));

	branch_4_clk <= clk;
	branch_4_rst <= rst;
	Buffer_12_pValidArray_0 <= branch_4_validArray_0;
	branch_4_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_0),Buffer_13_dataInArray_0'length));
	...
	fork_11_clk <= clk;
	fork_11_rst <= rst;
	Buffer_15_pValidArray_0 <= fork_11_validArray_0;
	fork_11_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_0),Buffer_15_dataInArray_0'length));
	branch_5_pValidArray_1 <= fork_11_validArray_1;
	fork_11_nReadyArray_1 <= branch_5_readyArray_1;
	branch_5_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_1),branch_5_dataInArray_1'length));
	Buffer_14_pValidArray_0 <= fork_11_validArray_2;
	fork_11_nReadyArray_2 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_2),Buffer_14_dataInArray_0'length));
	...
	phiC_5_clk <= clk;
	phiC_5_rst <= rst;
	forkC_17_pValidArray_0 <= phiC_5_validArray_0;
	phiC_5_nReadyArray_0 <= forkC_17_readyArray_0;
	forkC_17_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_5_dataOutArray_0),forkC_17_dataInArray_0'length));
	fork_21_pValidArray_0 <= phiC_5_validArray_1;
	phiC_5_nReadyArray_1 <= fork_21_readyArray_0;
	fork_21_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_5_dataOutArray_1),fork_21_dataInArray_0'length));

	forkC_17_clk <= clk;
	forkC_17_rst <= rst;
	LSQ_s_pValidArray_0 <= forkC_17_validArray_0;
	forkC_17_nReadyArray_0 <= LSQ_s_readyArray_0;
	LSQ_s_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_17_dataOutArray_0),LSQ_s_dataInArray_0'length));
	Buffer_22_pValidArray_0 <= forkC_17_validArray_1;
	forkC_17_nReadyArray_1 <= Buffer_22_readyArray_0;
	Buffer_22_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_17_dataOutArray_1),Buffer_22_dataInArray_0'length));
	...
	fork_21_clk <= clk;
	fork_21_rst <= rst;
	Buffer_25_pValidArray_0 <= fork_21_validArray_0;
	fork_21_nReadyArray_0 <= Buffer_25_readyArray_0;
	Buffer_25_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_21_dataOutArray_0),Buffer_25_dataInArray_0'length));
	phi_7_pValidArray_0 <= fork_21_validArray_1;
	fork_21_nReadyArray_1 <= phi_7_readyArray_0;
	phi_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_21_dataOutArray_1),phi_7_dataInArray_0'length));

	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	add_26_pValidArray_0 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= add_26_readyArray_0;
	add_26_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),add_26_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	add_19_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= add_19_readyArray_0;
	add_19_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),add_19_dataInArray_0'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	fork_4_pValidArray_0 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),fork_4_dataInArray_0'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	fork_8_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= fork_8_readyArray_0;
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),fork_8_dataInArray_0'length));

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	branch_6_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= branch_6_readyArray_0;
	branch_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),branch_6_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phi_6_pValidArray_2 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phi_6_readyArray_2;
	phi_6_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phi_6_dataInArray_2'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phi_7_pValidArray_2 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phi_7_readyArray_2;
	phi_7_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phi_7_dataInArray_2'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	branch_4_pValidArray_1 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= branch_4_readyArray_1;
	branch_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),branch_4_dataInArray_1'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branch_6_pValidArray_1 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branch_6_readyArray_1;
	branch_6_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branch_6_dataInArray_1'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	branchC_11_pValidArray_1 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= branchC_11_readyArray_1;
	branchC_11_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),branchC_11_dataInArray_1'length));

	Buffer_22_clk <= clk;
	Buffer_22_rst <= rst;
	branchC_11_pValidArray_0 <= Buffer_22_validArray_0;
	Buffer_22_nReadyArray_0 <= branchC_11_readyArray_0;
	branchC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_22_dataOutArray_0),branchC_11_dataInArray_0'length));

	Buffer_25_clk <= clk;
	Buffer_25_rst <= rst;
	phi_6_pValidArray_0 <= Buffer_25_validArray_0;
	Buffer_25_nReadyArray_0 <= phi_6_readyArray_0;
	phi_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_25_dataOutArray_0),phi_6_dataInArray_0'length));

	store_1_clk <= clk;
	store_1_rst <= rst;
	MC_q_pValidArray_3 <= store_1_validArray_0;
	store_1_nReadyArray_0 <= MC_q_readyArray_3;
	MC_q_dataInArray_3 <= std_logic_vector (resize(unsigned(store_1_dataOutArray_0),MC_q_dataInArray_3'length));
	MC_q_pValidArray_2 <= store_1_validArray_1;
	store_1_nReadyArray_1 <= MC_q_readyArray_2;
	MC_q_dataInArray_2 <= std_logic_vector (resize(unsigned(store_1_dataOutArray_1),MC_q_dataInArray_2'length));

	cst_4_clk <= clk;
	cst_4_rst <= rst;
	add_32_pValidArray_1 <= cst_4_validArray_0;
	cst_4_nReadyArray_0 <= add_32_readyArray_1;
	add_32_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_4_dataOutArray_0),add_32_dataInArray_1'length));

	add_32_clk <= clk;
	add_32_rst <= rst;
	Buffer_6_pValidArray_0 <= add_32_validArray_0;
	add_32_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(add_32_dataOutArray_0),Buffer_6_dataInArray_0'length));

	cst_5_clk <= clk;
	cst_5_rst <= rst;
	icmp_33_pValidArray_1 <= cst_5_validArray_0;
	cst_5_nReadyArray_0 <= icmp_33_readyArray_1;
	icmp_33_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_5_dataOutArray_0),icmp_33_dataInArray_1'length));

	icmp_33_clk <= clk;
	icmp_33_rst <= rst;
	fork_12_pValidArray_0 <= icmp_33_validArray_0;
	icmp_33_nReadyArray_0 <= fork_12_readyArray_0;
	fork_12_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_33_dataOutArray_0),fork_12_dataInArray_0'length));

	phi_n0_clk <= clk;
	phi_n0_rst <= rst;
	fork_6_pValidArray_0 <= phi_n0_validArray_0;
	phi_n0_nReadyArray_0 <= fork_6_readyArray_0;
	fork_6_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n0_dataOutArray_0),fork_6_dataInArray_0'length));
	...
	fork_5_clk <= clk;
	fork_5_rst <= rst;
	icmp_33_pValidArray_0 <= fork_5_validArray_0;
	fork_5_nReadyArray_0 <= icmp_33_readyArray_0;
	icmp_33_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_0),icmp_33_dataInArray_0'length));
	...
	fork_6_clk <= clk;
	fork_6_rst <= rst;
	store_1_pValidArray_0 <= fork_6_validArray_0;
	fork_6_nReadyArray_0 <= store_1_readyArray_0;
	store_1_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_0),store_1_dataInArray_0'length));
	branch_8_pValidArray_0 <= fork_6_validArray_1;
	fork_6_nReadyArray_1 <= branch_8_readyArray_0;
	branch_8_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_6_dataOutArray_1),branch_8_dataInArray_0'length));

	fork_7_clk <= clk;
	fork_7_rst <= rst;
	Buffer_8_pValidArray_0 <= fork_7_validArray_0;
	fork_7_nReadyArray_0 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_0),Buffer_8_dataInArray_0'length));
	add_32_pValidArray_0 <= fork_7_validArray_1;
	fork_7_nReadyArray_1 <= add_32_readyArray_0;
	add_32_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_1),add_32_dataInArray_0'length));

	branch_7_clk <= clk;
	branch_7_rst <= rst;
	Buffer_17_pValidArray_0 <= branch_7_validArray_0;
	branch_7_nReadyArray_0 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_7_dataOutArray_0),Buffer_17_dataInArray_0'length));
	...
	Buffer_18_pValidArray_0 <= branch_8_validArray_1;
	branch_8_nReadyArray_1 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_1),Buffer_18_dataInArray_0'length));

	fork_12_clk <= clk;
	fork_12_rst <= rst;
	Buffer_19_pValidArray_0 <= fork_12_validArray_0;
	fork_12_nReadyArray_0 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_0),Buffer_19_dataInArray_0'length));
	branch_7_pValidArray_1 <= fork_12_validArray_1;
	fork_12_nReadyArray_1 <= branch_7_readyArray_1;
	branch_7_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_1),branch_7_dataInArray_1'length));
	branchC_12_pValidArray_1 <= fork_12_validArray_2;
	fork_12_nReadyArray_2 <= branchC_12_readyArray_1;
	branchC_12_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_2),branchC_12_dataInArray_1'length));

	cst_7_clk <= clk;
	cst_7_rst <= rst;
	MC_q_pValidArray_0 <= cst_7_validArray_0;
	cst_7_nReadyArray_0 <= MC_q_readyArray_0;
	MC_q_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_7_dataOutArray_0),MC_q_dataInArray_0'length));

	phiC_6_clk <= clk;
	phiC_6_rst <= rst;
	forkC_18_pValidArray_0 <= phiC_6_validArray_0;
	phiC_6_nReadyArray_0 <= forkC_18_readyArray_0;
	forkC_18_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_6_dataOutArray_0),forkC_18_dataInArray_0'length));
	...
	branchC_12_pValidArray_0 <= forkC_18_validArray_1;
	forkC_18_nReadyArray_1 <= branchC_12_readyArray_0;
	branchC_12_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_18_dataOutArray_1),branchC_12_dataInArray_0'length));

	branchC_12_clk <= clk;
	branchC_12_rst <= rst;
	Buffer_23_pValidArray_0 <= branchC_12_validArray_0;
	branchC_12_nReadyArray_0 <= Buffer_23_readyArray_0;
	Buffer_23_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_12_dataOutArray_0),Buffer_23_dataInArray_0'length));
	Buffer_24_pValidArray_0 <= branchC_12_validArray_1;
	branchC_12_nReadyArray_1 <= Buffer_24_readyArray_0;
	Buffer_24_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_12_dataOutArray_1),Buffer_24_dataInArray_0'length));
	...
	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	phi_1_pValidArray_2 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= phi_1_readyArray_2;
	phi_1_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),phi_1_dataInArray_2'length));

	Buffer_18_clk <= clk;
	Buffer_18_rst <= rst;
	phi_n3_pValidArray_0 <= Buffer_18_validArray_0;
	Buffer_18_nReadyArray_0 <= phi_n3_readyArray_0;
	phi_n3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_18_dataOutArray_0),phi_n3_dataInArray_0'length));

	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	branch_8_pValidArray_1 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= branch_8_readyArray_1;
	branch_8_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),branch_8_dataInArray_1'length));

	Buffer_23_clk <= clk;
	Buffer_23_rst <= rst;
	phiC_4_pValidArray_1 <= Buffer_23_validArray_0;
	Buffer_23_nReadyArray_0 <= phiC_4_readyArray_1;
	phiC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_23_dataOutArray_0),phiC_4_dataInArray_1'length));

	Buffer_24_clk <= clk;
	Buffer_24_rst <= rst;
	phiC_7_pValidArray_0 <= Buffer_24_validArray_0;
	Buffer_24_nReadyArray_0 <= phiC_7_readyArray_0;
	phiC_7_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_24_dataOutArray_0),phiC_7_dataInArray_0'length));
	...
	LSQ_s_store_ready <= '1';
	LSQ_s_load_ready <= '1';
	s_address1 <= std_logic_vector (resize(unsigned(LSQ_s_address1),s_address1'length));
	s_ce1 <= LSQ_s_ce1;
	s_address0 <= std_logic_vector (resize(unsigned(LSQ_s_address0),s_address0'length));
	s_ce0 <= LSQ_s_we0_ce0;
	s_we0 <= LSQ_s_we0_ce0;
	s_dout0 <= LSQ_s_dout0;
	load_14_pValidArray_0 <= LSQ_s_validArray_0;
	LSQ_s_nReadyArray_0 <= load_14_readyArray_0;
	load_14_dataInArray_0 <= std_logic_vector (resize(unsigned(LSQ_s_dataOutArray_0),load_14_dataInArray_0'length));
	end_0_pValidArray_0 <= LSQ_s_validArray_1;
	LSQ_s_nReadyArray_1 <= end_0_readyArray_0;
	end_0_dataInArray_0 <= std_logic_vector (resize(unsigned(LSQ_s_dataOutArray_1),end_0_dataInArray_0'length));

	MC_q_clk <= clk;
	MC_q_rst <= rst;
	q_ce0 <= MC_q_we0_ce0;
	q_we0 <= MC_q_we0_ce0;
	load_4_pValidArray_0 <= MC_q_validArray_0;
	MC_q_nReadyArray_0 <= load_4_readyArray_0;
	load_4_dataInArray_0 <= std_logic_vector (resize(unsigned(MC_q_dataOutArray_0),load_4_dataInArray_0'length));
	end_0_pValidArray_1 <= MC_q_validArray_1;
	MC_q_nReadyArray_1 <= end_0_readyArray_1;
	end_0_dataInArray_1 <= std_logic_vector (resize(unsigned(MC_q_dataOutArray_1),end_0_dataInArray_1'length));
	...
	r_ce0 <= MC_r_we0_ce0;
	r_we0 <= MC_r_we0_ce0;
	load_17_pValidArray_0 <= MC_r_validArray_0;
	MC_r_nReadyArray_0 <= load_17_readyArray_0;
	load_17_dataInArray_0 <= std_logic_vector (resize(unsigned(MC_r_dataOutArray_0),load_17_dataInArray_0'length));
	end_0_pValidArray_3 <= MC_r_validArray_1;
	MC_r_nReadyArray_1 <= end_0_readyArray_3;
	end_0_dataInArray_3 <= std_logic_vector (resize(unsigned(MC_r_dataOutArray_1),end_0_dataInArray_3'length));

	MC_p_clk <= clk;
	MC_p_rst <= rst;
	p_ce0 <= MC_p_we0_ce0;
	p_we0 <= MC_p_we0_ce0;
	load_24_pValidArray_0 <= MC_p_validArray_0;
	MC_p_nReadyArray_0 <= load_24_readyArray_0;
	load_24_dataInArray_0 <= std_logic_vector (resize(unsigned(MC_p_dataOutArray_0),load_24_dataInArray_0'length));
	end_0_pValidArray_4 <= MC_p_validArray_1;
	MC_p_nReadyArray_1 <= end_0_readyArray_4;
	end_0_dataInArray_4 <= std_logic_vector (resize(unsigned(MC_p_dataOutArray_1),end_0_dataInArray_4'length));
...
load_4: entity work.mc_load_op(arch) generic map (2,2,5,32)
port map (
	clk => load_4_clk,
	rst => load_4_rst,
...
fork_10: entity work.fork(arch) generic map (1,4,1,1)
port map (
	clk => fork_10_clk,
	rst => fork_10_rst,
...
Buffer_11: entity work.TEHB(arch) generic map (1,1,1,1)
port map (
	clk => Buffer_11_clk,
	rst => Buffer_11_rst,
...
phi_7: entity work.Mux(arch) generic map (3,1,5,5,1)
port map (
	clk => phi_7_clk,
	rst => phi_7_rst,
...
load_14: entity work.lsq_load_op(arch) generic map (2,2,5,32)
port map (
	clk => load_14_clk,
	rst => load_14_rst,
...
load_17: entity work.mc_load_op(arch) generic map (2,2,5,32)
port map (
	clk => load_17_clk,
	rst => load_17_rst,
...
store_0: entity work.lsq_store_op(arch) generic map (2,2,5,32)
port map (
	clk => store_0_clk,
	rst => store_0_rst,
...
load_24: entity work.mc_load_op(arch) generic map (2,2,5,32)
port map (
	clk => load_24_clk,
	rst => load_24_rst,
...
mul_25: entity work.mul_op(arch) generic map (2,1,32,32)
port map (
	clk => mul_25_clk,
	rst => mul_25_rst,
	dataInArray(0) => mul_25_dataInArray_0,
	dataInArray(1) => mul_25_dataInArray_1,
	pValidArray(0) => mul_25_pValidArray_0,
	pValidArray(1) => mul_25_pValidArray_1,
	readyArray(0) => mul_25_readyArray_0,
	readyArray(1) => mul_25_readyArray_1,
	nReadyArray(0) => mul_25_nReadyArray_0,
	validArray(0) => mul_25_validArray_0,
	dataOutArray(0) => mul_25_dataOutArray_0
);
...
add_27: entity work.add_op(arch) generic map (2,1,5,5)
port map (
	clk => add_27_clk,
	rst => add_27_rst,
...
cst_3: entity work.Const(arch) generic map (1,1,5,5)
port map (
	clk => cst_3_clk,
	rst => cst_3_rst,
...
icmp_28: entity work.icmp_ult_op(arch) generic map (2,1,5,1)
port map (
	clk => icmp_28_clk,
	rst => icmp_28_rst,
...
fork_1: entity work.fork(arch) generic map (1,5,5,5)
port map (
	clk => fork_1_clk,
	rst => fork_1_rst,
...
Buffer_3: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_3_clk,
	rst => Buffer_3_rst,
...
Buffer_4: entity work.TEHB(arch) generic map (1,1,32,32)
port map (
	clk => Buffer_4_clk,
	rst => Buffer_4_rst,
...
Buffer_5: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_7: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_7_clk,
	rst => Buffer_7_rst,
...
Buffer_9: entity work.TEHB(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_9_clk,
	rst => Buffer_9_rst,
...
Buffer_13: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_13_clk,
	rst => Buffer_13_rst,
...
Buffer_14: entity work.transpFifo(arch) generic map (1,1,1,1,2)
port map (
	clk => Buffer_14_clk,
	rst => Buffer_14_rst,
...
Buffer_25: entity work.transpFifo(arch) generic map (1,1,1,1,2)
port map (
	clk => Buffer_25_clk,
	rst => Buffer_25_rst,
...
store_1: entity work.mc_store_op(arch) generic map (2,2,5,32)
port map (
	clk => store_1_clk,
	rst => store_1_rst,
...
add_32: entity work.add_op(arch) generic map (2,1,5,5)
port map (
	clk => add_32_clk,
	rst => add_32_rst,
...
icmp_33: entity work.icmp_ult_op(arch) generic map (2,1,5,1)
port map (
	clk => icmp_33_clk,
	rst => icmp_33_rst,
	dataInArray(0) => icmp_33_dataInArray_0,
	dataInArray(1) => icmp_33_dataInArray_1,
	pValidArray(0) => icmp_33_pValidArray_0,
	pValidArray(1) => icmp_33_pValidArray_1,
	readyArray(0) => icmp_33_readyArray_0,
	readyArray(1) => icmp_33_readyArray_1,
	nReadyArray(0) => icmp_33_nReadyArray_0,
	validArray(0) => icmp_33_validArray_0,
	dataOutArray(0) => icmp_33_dataOutArray_0
);
...
fork_12: entity work.fork(arch) generic map (1,3,1,1)
port map (
	clk => fork_12_clk,
	rst => fork_12_rst,
...
Buffer_8: entity work.TEHB(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_8_clk,
	rst => Buffer_8_rst,
...
Buffer_17: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_17_clk,
	rst => Buffer_17_rst,
...
port map (
	clock => LSQ_s_clk,
	reset => LSQ_s_rst,
	io_memIsReadyForLoads => LSQ_s_load_ready,
	io_memIsReadyForStores => LSQ_s_store_ready,
	io_storeDataOut => LSQ_s_dout0,
	io_storeAddrOut => LSQ_s_address0,
	io_storeEnable => LSQ_s_we0_ce0,
	io_loadDataIn => LSQ_s_din1,
	io_loadAddrOut => LSQ_s_address1,
	io_loadEnable => LSQ_s_ce1,
	io_bbReadyToPrevs_0 => LSQ_s_readyArray_0,
	io_bbpValids_0 => LSQ_s_pValidArray_0,
	io_rdPortsPrev_0_ready => LSQ_s_readyArray_1,
	io_rdPortsPrev_0_valid => LSQ_s_pValidArray_1,
	io_rdPortsPrev_0_bits => LSQ_s_dataInArray_1,
	io_wrAddrPorts_0_ready => LSQ_s_readyArray_2,
	io_wrAddrPorts_0_valid => LSQ_s_pValidArray_2,
	io_wrAddrPorts_0_bits => LSQ_s_dataInArray_2,
	io_wrDataPorts_0_ready => LSQ_s_readyArray_3,
	io_wrDataPorts_0_valid => LSQ_s_pValidArray_3,
	io_wrDataPorts_0_bits => LSQ_s_dataInArray_3,
	io_rdPortsNext_0_ready => LSQ_s_nReadyArray_0,
	io_rdPortsNext_0_valid => LSQ_s_validArray_0,
	io_rdPortsNext_0_bits => LSQ_s_dataOutArray_0,
	io_Empty_Valid => LSQ_s_validArray_1

);

MC_q: entity work.MemCont(arch) generic map (32,5,1,1,1)
port map (
	clk => MC_q_clk,
	rst => MC_q_rst,
	io_storeDataOut => q_dout0,
	io_storeAddrOut => q_address0,
	io_storeEnable => MC_q_we0_ce0,
	io_loadDataIn => q_din1,
	io_loadAddrOut => q_address1,
	io_loadEnable => q_ce1,
	io_bbReadyToPrevs(0) => MC_q_readyArray_0,
	io_bbpValids(0) => MC_q_pValidArray_0,
	io_bb_stCountArray(0) => MC_q_dataInArray_0,
	io_rdPortsPrev_ready(0) => MC_q_readyArray_1,
	io_rdPortsPrev_valid(0) => MC_q_pValidArray_1,
	io_rdPortsPrev_bits(0) => MC_q_dataInArray_1,
	io_wrAddrPorts_ready(0) => MC_q_readyArray_2,
	io_wrAddrPorts_valid(0) => MC_q_pValidArray_2,
	io_wrAddrPorts_bits(0) => MC_q_dataInArray_2,
	io_wrDataPorts_ready(0) => MC_q_readyArray_3,
	io_wrDataPorts_valid(0) => MC_q_pValidArray_3,
	io_wrDataPorts_bits(0) => MC_q_dataInArray_3,
	io_rdPortsNext_ready(0) => MC_q_nReadyArray_0,
	io_rdPortsNext_valid(0) => MC_q_validArray_0,
	io_rdPortsNext_bits(0) => MC_q_dataOutArray_0,
	io_Empty_Valid => MC_q_validArray_1,
	io_Empty_Ready => MC_q_nReadyArray_1
...
MC_r: entity work.MemCont(arch) generic map (32,5,1,1,1)
port map (
	clk => MC_r_clk,
	rst => MC_r_rst,
	io_storeDataOut => r_dout0,
	io_storeAddrOut => r_address0,
	io_storeEnable => MC_r_we0_ce0,
	io_loadDataIn => r_din1,
	io_loadAddrOut => r_address1,
	io_loadEnable => r_ce1,
	io_bbReadyToPrevs(0) => MC_r_readyArray_1,
	io_bbpValids(0) => '0',
	io_bb_stCountArray(0) => x"00000000",
	io_rdPortsPrev_ready(0) => MC_r_readyArray_0,
	io_rdPortsPrev_valid(0) => MC_r_pValidArray_0,
	io_rdPortsPrev_bits(0) => MC_r_dataInArray_0,
	io_wrAddrPorts_ready(0) => MC_r_readyArray_2,
	io_wrAddrPorts_valid(0) => MC_r_pValidArray_2,
	io_wrAddrPorts_bits(0) => MC_r_dataInArray_2,
	io_wrDataPorts_ready(0) => MC_r_readyArray_3,
	io_wrDataPorts_valid(0) => MC_r_pValidArray_3,
	io_wrDataPorts_bits(0) => MC_r_dataInArray_3,
	io_rdPortsNext_ready(0) => MC_r_nReadyArray_0,
	io_rdPortsNext_valid(0) => MC_r_validArray_0,
	io_rdPortsNext_bits(0) => MC_r_dataOutArray_0,
	io_Empty_Valid => MC_r_validArray_1,
	io_Empty_Ready => MC_r_nReadyArray_1

);

MC_p: entity work.MemCont(arch) generic map (32,5,1,1,1)
port map (
	clk => MC_p_clk,
	rst => MC_p_rst,
	io_storeDataOut => p_dout0,
	io_storeAddrOut => p_address0,
	io_storeEnable => MC_p_we0_ce0,
	io_loadDataIn => p_din1,
	io_loadAddrOut => p_address1,
	io_loadEnable => p_ce1,
	io_bbReadyToPrevs(0) => MC_p_readyArray_1,
	io_bbpValids(0) => '0',
	io_bb_stCountArray(0) => x"00000000",
	io_rdPortsPrev_ready(0) => MC_p_readyArray_0,
	io_rdPortsPrev_valid(0) => MC_p_pValidArray_0,
	io_rdPortsPrev_bits(0) => MC_p_dataInArray_0,
	io_wrAddrPorts_ready(0) => MC_p_readyArray_2,
	io_wrAddrPorts_valid(0) => MC_p_pValidArray_2,
	io_wrAddrPorts_bits(0) => MC_p_dataInArray_2,
	io_wrDataPorts_ready(0) => MC_p_readyArray_3,
	io_wrDataPorts_valid(0) => MC_p_pValidArray_3,
	io_wrDataPorts_bits(0) => MC_p_dataInArray_3,
	io_rdPortsNext_ready(0) => MC_p_nReadyArray_0,
	io_rdPortsNext_valid(0) => MC_p_validArray_0,
	io_rdPortsNext_bits(0) => MC_p_dataOutArray_0,
	io_Empty_Valid => MC_p_validArray_1,
	io_Empty_Ready => MC_p_nReadyArray_1

);

end_0: entity work.end_node(arch) generic map (1,5,1,32,32)
port map (
	clk => end_0_clk,
	rst => end_0_rst,
