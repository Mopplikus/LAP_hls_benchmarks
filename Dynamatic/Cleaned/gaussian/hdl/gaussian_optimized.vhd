...
-- File created: Tue Jun 13 18:47:44 2023
...
architecture behavioral of gaussian is 
	...
	signal Buffer_2_dataInArray_0 : std_logic_vector(5 downto 0);
	...
	signal Buffer_2_dataOutArray_0 : std_logic_vector(5 downto 0);
...
begin
	...
	branchC_14_clk <= clk;
	branchC_14_rst <= rst;
	Buffer_24_pValidArray_0 <= branchC_14_validArray_0;
	branchC_14_nReadyArray_0 <= Buffer_24_readyArray_0;
	Buffer_24_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_14_dataOutArray_0),Buffer_24_dataInArray_0'length));
	...
	Buffer_24_clk <= clk;
	Buffer_24_rst <= rst;
	phiC_8_pValidArray_0 <= Buffer_24_validArray_0;
	Buffer_24_nReadyArray_0 <= phiC_8_readyArray_0;
	phiC_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_24_dataOutArray_0),phiC_8_dataInArray_0'length));
	...
	add_2_clk <= clk;
	add_2_rst <= rst;
	Buffer_2_pValidArray_0 <= add_2_validArray_0;
	add_2_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(add_2_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	icmp_3_clk <= clk;
	icmp_3_rst <= rst;
	Buffer_3_pValidArray_0 <= icmp_3_validArray_0;
	icmp_3_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_3_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	fork_1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),fork_1_dataInArray_0'length));

	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	fork_10_pValidArray_0 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= fork_10_readyArray_0;
	fork_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),fork_10_dataInArray_0'length));
	...
	phiC_9_clk <= clk;
	phiC_9_rst <= rst;
	Buffer_25_pValidArray_0 <= phiC_9_validArray_0;
	phiC_9_nReadyArray_0 <= Buffer_25_readyArray_0;
	Buffer_25_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_9_dataOutArray_0),Buffer_25_dataInArray_0'length));
	...
	phi_6_clk <= clk;
	phi_6_rst <= rst;
	Buffer_4_pValidArray_0 <= phi_6_validArray_0;
	phi_6_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_6_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	branch_5_clk <= clk;
	branch_5_rst <= rst;
	Buffer_21_pValidArray_0 <= branch_5_validArray_0;
	branch_5_nReadyArray_0 <= Buffer_21_readyArray_0;
	Buffer_21_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_0),Buffer_21_dataInArray_0'length));
	...
	Buffer_22_pValidArray_0 <= fork_12_validArray_1;
	fork_12_nReadyArray_1 <= Buffer_22_readyArray_0;
	Buffer_22_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_1),Buffer_22_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	branch_6_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= branch_6_readyArray_0;
	branch_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),branch_6_dataInArray_0'length));
	...
	Buffer_22_clk <= clk;
	Buffer_22_rst <= rst;
	branch_6_pValidArray_1 <= Buffer_22_validArray_0;
	Buffer_22_nReadyArray_0 <= branch_6_readyArray_1;
	branch_6_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_22_dataOutArray_0),branch_6_dataInArray_1'length));

	Buffer_26_clk <= clk;
	Buffer_26_rst <= rst;
	phiC_11_pValidArray_0 <= Buffer_26_validArray_0;
	Buffer_26_nReadyArray_0 <= phiC_11_readyArray_0;
	phiC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_26_dataOutArray_0),phiC_11_dataInArray_0'length));
	...
	zext_10_clk <= clk;
	zext_10_rst <= rst;
	Buffer_5_pValidArray_0 <= zext_10_validArray_0;
	zext_10_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(zext_10_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	load_12_clk <= clk;
	load_12_rst <= rst;
	Buffer_6_pValidArray_0 <= load_12_validArray_0;
	load_12_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(load_12_dataOutArray_0),Buffer_6_dataInArray_0'length));
	...
	zext_17_clk <= clk;
	zext_17_rst <= rst;
	Buffer_7_pValidArray_0 <= zext_17_validArray_0;
	zext_17_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(zext_17_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	add_25_clk <= clk;
	add_25_rst <= rst;
	Buffer_8_pValidArray_0 <= add_25_validArray_0;
	add_25_nReadyArray_0 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(add_25_dataOutArray_0),Buffer_8_dataInArray_0'length));
	...
	icmp_26_clk <= clk;
	icmp_26_rst <= rst;
	Buffer_9_pValidArray_0 <= icmp_26_validArray_0;
	icmp_26_nReadyArray_0 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_26_dataOutArray_0),Buffer_9_dataInArray_0'length));
	...
	phi_n7_clk <= clk;
	phi_n7_rst <= rst;
	Buffer_14_pValidArray_0 <= phi_n7_validArray_0;
	phi_n7_nReadyArray_0 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n7_dataOutArray_0),Buffer_14_dataInArray_0'length));
	...
	Buffer_15_pValidArray_0 <= fork_2_validArray_2;
	fork_2_nReadyArray_2 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_2),Buffer_15_dataInArray_0'length));
	Buffer_16_pValidArray_0 <= fork_2_validArray_3;
	fork_2_nReadyArray_3 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_3),Buffer_16_dataInArray_0'length));
	...
	Buffer_17_pValidArray_0 <= fork_3_validArray_1;
	fork_3_nReadyArray_1 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_3_dataOutArray_1),Buffer_17_dataInArray_0'length));
	...
	fork_8_clk <= clk;
	fork_8_rst <= rst;
	Buffer_19_pValidArray_0 <= fork_8_validArray_0;
	fork_8_nReadyArray_0 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_0),Buffer_19_dataInArray_0'length));
	...
	fork_13_clk <= clk;
	fork_13_rst <= rst;
	Buffer_23_pValidArray_0 <= fork_13_validArray_0;
	fork_13_nReadyArray_0 <= Buffer_23_readyArray_0;
	Buffer_23_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_0),Buffer_23_dataInArray_0'length));
	...
	Buffer_27_pValidArray_0 <= forkC_22_validArray_1;
	forkC_22_nReadyArray_1 <= Buffer_27_readyArray_0;
	Buffer_27_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_22_dataOutArray_1),Buffer_27_dataInArray_0'length));
	...
	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	getelementptr_11_pValidArray_1 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= getelementptr_11_readyArray_1;
	getelementptr_11_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),getelementptr_11_dataInArray_1'length));

	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	sub_21_pValidArray_0 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= sub_21_readyArray_0;
	sub_21_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),sub_21_dataInArray_0'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	getelementptr_18_pValidArray_1 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= getelementptr_18_readyArray_1;
	getelementptr_18_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),getelementptr_18_dataInArray_1'length));
	...
	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	fork_13_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= fork_13_readyArray_0;
	fork_13_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),fork_13_dataInArray_0'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	fork_7_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= fork_7_readyArray_0;
	fork_7_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),fork_7_dataInArray_0'length));
	...
	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	zext_23_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= zext_23_readyArray_0;
	zext_23_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),zext_23_dataInArray_0'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	add_25_pValidArray_0 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= add_25_readyArray_0;
	add_25_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),add_25_dataInArray_0'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	branch_8_pValidArray_0 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= branch_8_readyArray_0;
	branch_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),branch_8_dataInArray_0'length));

	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	load_15_pValidArray_1 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= load_15_readyArray_1;
	load_15_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),load_15_dataInArray_1'length));

	Buffer_23_clk <= clk;
	Buffer_23_rst <= rst;
	branch_10_pValidArray_1 <= Buffer_23_validArray_0;
	Buffer_23_nReadyArray_0 <= branch_10_readyArray_1;
	branch_10_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_23_dataOutArray_0),branch_10_dataInArray_1'length));
	...
	add_28_clk <= clk;
	add_28_rst <= rst;
	Buffer_10_pValidArray_0 <= add_28_validArray_0;
	add_28_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(add_28_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	icmp_29_clk <= clk;
	icmp_29_rst <= rst;
	Buffer_11_pValidArray_0 <= icmp_29_validArray_0;
	icmp_29_nReadyArray_0 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_29_dataOutArray_0),Buffer_11_dataInArray_0'length));
	...
	phiC_12_clk <= clk;
	phiC_12_rst <= rst;
	Buffer_28_pValidArray_0 <= phiC_12_validArray_0;
	phiC_12_nReadyArray_0 <= Buffer_28_readyArray_0;
	Buffer_28_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_12_dataOutArray_0),Buffer_28_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	branch_11_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= branch_11_readyArray_0;
	branch_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),branch_11_dataInArray_0'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	fork_14_pValidArray_0 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= fork_14_readyArray_0;
	fork_14_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),fork_14_dataInArray_0'length));
	...
	icmp_32_clk <= clk;
	icmp_32_rst <= rst;
	Buffer_12_pValidArray_0 <= icmp_32_validArray_0;
	icmp_32_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_32_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	fork_4_clk <= clk;
	fork_4_rst <= rst;
	Buffer_18_pValidArray_0 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_0),Buffer_18_dataInArray_0'length));
	...
	Buffer_29_pValidArray_0 <= branchC_20_validArray_1;
	branchC_20_nReadyArray_1 <= Buffer_29_readyArray_0;
	Buffer_29_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_20_dataOutArray_1),Buffer_29_dataInArray_0'length));
	...
	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	fork_25_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= fork_25_readyArray_0;
	fork_25_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),fork_25_dataInArray_0'length));

	Buffer_18_clk <= clk;
	Buffer_18_rst <= rst;
	icmp_32_pValidArray_0 <= Buffer_18_validArray_0;
	Buffer_18_nReadyArray_0 <= icmp_32_readyArray_0;
	icmp_32_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_18_dataOutArray_0),icmp_32_dataInArray_0'length));

	Buffer_29_clk <= clk;
	Buffer_29_rst <= rst;
	phiC_14_pValidArray_0 <= Buffer_29_validArray_0;
	Buffer_29_nReadyArray_0 <= phiC_14_readyArray_0;
	phiC_14_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_29_dataOutArray_0),phiC_14_dataInArray_0'length));
...
Buffer_2: entity work.elasticBuffer(arch) generic map (1,1,6,6)
port map (
	clk => Buffer_2_clk,
	rst => Buffer_2_rst,
...
Buffer_6: entity work.transpFifo(arch) generic map (1,1,32,32,2)
port map (
	clk => Buffer_6_clk,
	rst => Buffer_6_rst,
...
Buffer_14: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_14_clk,
	rst => Buffer_14_rst,
...
Buffer_17: entity work.TEHB(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_17_clk,
	rst => Buffer_17_rst,
