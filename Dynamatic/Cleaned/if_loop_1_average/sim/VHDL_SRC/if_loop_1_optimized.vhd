...
-- File created: Tue Jun 13 20:09:32 2023
...
architecture behavioral of if_loop_1 is 
	...
	signal cst_3_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal cst_3_dataOutArray_0 : std_logic_vector(2 downto 0);
	...
	signal cst_4_dataInArray_0 : std_logic_vector(3 downto 0);
	...
	signal cst_4_dataOutArray_0 : std_logic_vector(3 downto 0);
	...
	signal add_11_dataInArray_0 : std_logic_vector(30 downto 0);
	signal add_11_dataInArray_1 : std_logic_vector(30 downto 0);
	...
	signal add_11_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal source_1_dataOutArray_0 : std_logic_vector(2 downto 0);
	...
	signal source_2_dataOutArray_0 : std_logic_vector(3 downto 0);
...
begin
	...
	icmp_0_clk <= clk;
	icmp_0_rst <= rst;
	Buffer_1_pValidArray_0 <= icmp_0_validArray_0;
	icmp_0_nReadyArray_0 <= Buffer_1_readyArray_0;
	Buffer_1_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_0_dataOutArray_0),Buffer_1_dataInArray_0'length));

	cst_7_clk <= clk;
	cst_7_rst <= rst;
	branch_0_pValidArray_0 <= cst_7_validArray_0;
	cst_7_nReadyArray_0 <= branch_0_readyArray_0;
	branch_0_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_7_dataOutArray_0),branch_0_dataInArray_0'length));
	...
	phi_14_pValidArray_1 <= branch_0_validArray_1;
	branch_0_nReadyArray_1 <= phi_14_readyArray_1;
	phi_14_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_1),phi_14_dataInArray_1'length));
	...
	forkC_10_clk <= clk;
	forkC_10_rst <= rst;
	cst_7_pValidArray_0 <= forkC_10_validArray_0;
	forkC_10_nReadyArray_0 <= cst_7_readyArray_0;
	cst_7_dataInArray_0 <= "0";
	...
	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	fork_6_pValidArray_0 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= fork_6_readyArray_0;
	fork_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),fork_6_dataInArray_0'length));
	...
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_3_dataOutArray_0),Buffer_11_dataInArray_0'length));
	...
	branchC_9_clk <= clk;
	branchC_9_rst <= rst;
	Buffer_15_pValidArray_0 <= branchC_9_validArray_0;
	branchC_9_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_9_dataOutArray_0),Buffer_15_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_3_pValidArray_1 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_3_readyArray_1;
	phi_3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_3_dataInArray_1'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_4_pValidArray_1 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_4_readyArray_1;
	phi_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_4_dataInArray_1'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phi_n1_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phi_n1_readyArray_0;
	phi_n1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phi_n1_dataInArray_0'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	phiC_3_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= phiC_3_readyArray_0;
	phiC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),phiC_3_dataInArray_0'length));
	...
	load_7_clk <= clk;
	load_7_rst <= rst;
	mul_8_pValidArray_0 <= load_7_validArray_0;
	load_7_nReadyArray_0 <= mul_8_readyArray_0;
	mul_8_dataInArray_0 <= std_logic_vector (resize(unsigned(load_7_dataOutArray_0),mul_8_dataInArray_0'length));
	...
	cst_3_clk <= clk;
	cst_3_rst <= rst;
	mul_8_pValidArray_1 <= cst_3_validArray_0;
	cst_3_nReadyArray_0 <= mul_8_readyArray_1;
	mul_8_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_3_dataOutArray_0),mul_8_dataInArray_1'length));

	mul_8_clk <= clk;
	mul_8_rst <= rst;
	fork_2_pValidArray_0 <= mul_8_validArray_0;
	mul_8_nReadyArray_0 <= fork_2_readyArray_0;
	fork_2_dataInArray_0 <= std_logic_vector (resize(unsigned(mul_8_dataOutArray_0),fork_2_dataInArray_0'length));

	cst_4_clk <= clk;
	cst_4_rst <= rst;
	icmp_9_pValidArray_1 <= cst_4_validArray_0;
	cst_4_nReadyArray_0 <= icmp_9_readyArray_1;
	icmp_9_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_4_dataOutArray_0),icmp_9_dataInArray_1'length));
	...
	cst_5_clk <= clk;
	cst_5_rst <= rst;
	select_0_pValidArray_2 <= cst_5_validArray_0;
	cst_5_nReadyArray_0 <= select_0_readyArray_2;
	select_0_dataInArray_2 <= std_logic_vector (resize(unsigned(cst_5_dataOutArray_0),select_0_dataInArray_2'length));

	select_0_clk <= clk;
	select_0_rst <= rst;
	Buffer_4_pValidArray_0 <= select_0_validArray_0;
	select_0_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(select_0_dataOutArray_0),Buffer_4_dataInArray_0'length));

	add_10_clk <= clk;
	add_10_rst <= rst;
	branch_5_pValidArray_0 <= add_10_validArray_0;
	add_10_nReadyArray_0 <= branch_5_readyArray_0;
	branch_5_dataInArray_0 <= std_logic_vector (resize(unsigned(add_10_dataOutArray_0),branch_5_dataInArray_0'length));

	cst_6_clk <= clk;
	cst_6_rst <= rst;
	add_11_pValidArray_1 <= cst_6_validArray_0;
	cst_6_nReadyArray_0 <= add_11_readyArray_1;
	add_11_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_6_dataOutArray_0),add_11_dataInArray_1'length));

	add_11_clk <= clk;
	add_11_rst <= rst;
	fork_4_pValidArray_0 <= add_11_validArray_0;
	add_11_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(add_11_dataOutArray_0),fork_4_dataInArray_0'length));

	icmp_12_clk <= clk;
	icmp_12_rst <= rst;
	Buffer_5_pValidArray_0 <= icmp_12_validArray_0;
	icmp_12_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_12_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	fork_1_clk <= clk;
	fork_1_rst <= rst;
	add_11_pValidArray_0 <= fork_1_validArray_0;
	fork_1_nReadyArray_0 <= add_11_readyArray_0;
	add_11_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_0),add_11_dataInArray_0'length));
	...
	fork_2_clk <= clk;
	fork_2_rst <= rst;
	icmp_9_pValidArray_0 <= fork_2_validArray_0;
	fork_2_nReadyArray_0 <= icmp_9_readyArray_0;
	icmp_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_0),icmp_9_dataInArray_0'length));
	...
	fork_4_clk <= clk;
	fork_4_rst <= rst;
	Buffer_7_pValidArray_0 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	fork_5_clk <= clk;
	fork_5_rst <= rst;
	icmp_12_pValidArray_1 <= fork_5_validArray_0;
	fork_5_nReadyArray_0 <= icmp_12_readyArray_1;
	icmp_12_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_0),icmp_12_dataInArray_1'length));
	...
	Buffer_13_pValidArray_0 <= branch_5_validArray_1;
	branch_5_nReadyArray_1 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_1),Buffer_13_dataInArray_0'length));
	...
	Buffer_14_pValidArray_0 <= fork_8_validArray_2;
	fork_8_nReadyArray_2 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_2),Buffer_14_dataInArray_0'length));
	...
	phiC_3_clk <= clk;
	phiC_3_rst <= rst;
	Buffer_16_pValidArray_0 <= phiC_3_validArray_0;
	phiC_3_nReadyArray_0 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_3_dataOutArray_0),Buffer_16_dataInArray_0'length));
	...
	Buffer_17_pValidArray_0 <= branchC_10_validArray_1;
	branchC_10_nReadyArray_1 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_10_dataOutArray_1),Buffer_17_dataInArray_0'length));

	source_1_clk <= clk;
	source_1_rst <= rst;
	cst_3_pValidArray_0 <= source_1_validArray_0;
	source_1_nReadyArray_0 <= cst_3_readyArray_0;
	cst_3_dataInArray_0 <= "101";

	source_2_clk <= clk;
	source_2_rst <= rst;
	cst_4_pValidArray_0 <= source_2_validArray_0;
	source_2_nReadyArray_0 <= cst_4_readyArray_0;
	cst_4_dataInArray_0 <= "1010";

	source_3_clk <= clk;
	source_3_rst <= rst;
	cst_5_pValidArray_0 <= source_3_validArray_0;
	source_3_nReadyArray_0 <= cst_5_readyArray_0;
	cst_5_dataInArray_0 <= "0";
	...
	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	add_10_pValidArray_0 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= add_10_readyArray_0;
	add_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),add_10_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	add_10_pValidArray_1 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= add_10_readyArray_1;
	add_10_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),add_10_dataInArray_1'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	fork_8_pValidArray_0 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= fork_8_readyArray_0;
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),fork_8_dataInArray_0'length));
	...
	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	icmp_12_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= icmp_12_readyArray_0;
	icmp_12_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),icmp_12_dataInArray_0'length));
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phi_14_pValidArray_2 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phi_14_readyArray_2;
	phi_14_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phi_14_dataInArray_2'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	branch_5_pValidArray_1 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= branch_5_readyArray_1;
	branch_5_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),branch_5_dataInArray_1'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	branchC_10_pValidArray_0 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= branchC_10_readyArray_0;
	branchC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),branchC_10_dataInArray_0'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	phiC_4_pValidArray_1 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= phiC_4_readyArray_1;
	phiC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),phiC_4_dataInArray_1'length));

	Buffer_18_clk <= clk;
	Buffer_18_rst <= rst;
	phi_3_pValidArray_0 <= Buffer_18_validArray_0;
	Buffer_18_nReadyArray_0 <= phi_3_readyArray_0;
	phi_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_18_dataOutArray_0),phi_3_dataInArray_0'length));

	phi_14_clk <= clk;
	phi_14_rst <= rst;
	ret_0_pValidArray_0 <= phi_14_validArray_0;
	phi_14_nReadyArray_0 <= ret_0_readyArray_0;
	ret_0_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_14_dataOutArray_0),ret_0_dataInArray_0'length));
	...
	phi_14_pValidArray_0 <= phiC_4_validArray_1;
	phiC_4_nReadyArray_1 <= phi_14_readyArray_0;
	phi_14_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_4_dataOutArray_1),phi_14_dataInArray_0'length));
...
cst_3: entity work.Const(arch) generic map (1,1,3,3)
port map (
	clk => cst_3_clk,
	rst => cst_3_rst,
...
cst_4: entity work.Const(arch) generic map (1,1,4,4)
port map (
	clk => cst_4_clk,
	rst => cst_4_rst,
...
add_11: entity work.add_op(arch) generic map (2,1,31,31)
port map (
	clk => add_11_clk,
	rst => add_11_rst,
...
icmp_12: entity work.icmp_slt_op(arch) generic map (2,1,32,1)
port map (
	clk => icmp_12_clk,
	rst => icmp_12_rst,
...
source_1: entity work.source(arch) generic map (0,1,32,3)
port map (
	clk => source_1_clk,
	rst => source_1_rst,
...
source_2: entity work.source(arch) generic map (0,1,32,4)
port map (
	clk => source_2_clk,
	rst => source_2_rst,
