...
for.body8:                                        ; preds = %for.cond6
  %6 = load [10 x i32]*, [10 x i32]** %A.addr, align 8
  ...
  %10 = load [10 x i32]*, [10 x i32]** %B.addr, align 8
  %11 = load i32, i32* %k, align 4
  %idxprom13 = sext i32 %11 to i64
  %arrayidx14 = getelementptr inbounds [10 x i32], [10 x i32]* %10, i64 %idxprom13
  ...
  %14 = load [10 x i32]*, [10 x i32]** %E.addr, align 8
...
for.body32:                                       ; preds = %for.cond30
  %23 = load [10 x i32]*, [10 x i32]** %F.addr, align 8
  %24 = load i32, i32* %i, align 4
  %idxprom33 = sext i32 %24 to i64
  %arrayidx34 = getelementptr inbounds [10 x i32], [10 x i32]* %23, i64 %idxprom33
...
for.body39:                                       ; preds = %for.cond37
  %27 = load [10 x i32]*, [10 x i32]** %C.addr, align 8
  %28 = load i32, i32* %i, align 4
  %idxprom40 = sext i32 %28 to i64
  %arrayidx41 = getelementptr inbounds [10 x i32], [10 x i32]* %27, i64 %idxprom40
  ...
  %31 = load [10 x i32]*, [10 x i32]** %D.addr, align 8
  %32 = load i32, i32* %k, align 4
  %idxprom44 = sext i32 %32 to i64
  %arrayidx45 = getelementptr inbounds [10 x i32], [10 x i32]* %31, i64 %idxprom44
  ...
  %mul48 = mul nsw i32 %30, %34
  %35 = load [10 x i32]*, [10 x i32]** %F.addr, align 8
  %36 = load i32, i32* %i, align 4
  %idxprom49 = sext i32 %36 to i64
  %arrayidx50 = getelementptr inbounds [10 x i32], [10 x i32]* %35, i64 %idxprom49
...
for.cond66:                                       ; preds = %for.inc93, %for.body65
  ...
  %cmp67 = icmp slt i32 %43, 10
  br i1 %cmp67, label %for.body68, label %for.end95

for.body68:                                       ; preds = %for.cond66
  %44 = load [10 x i32]*, [10 x i32]** %G.addr, align 8
  %45 = load i32, i32* %i, align 4
  %idxprom69 = sext i32 %45 to i64
  %arrayidx70 = getelementptr inbounds [10 x i32], [10 x i32]* %44, i64 %idxprom69
...
for.cond73:                                       ; preds = %for.inc90, %for.body68
  ...
  %cmp74 = icmp slt i32 %47, 10
  br i1 %cmp74, label %for.body75, label %for.end92

for.body75:                                       ; preds = %for.cond73
  %48 = load [10 x i32]*, [10 x i32]** %E.addr, align 8
  %49 = load i32, i32* %i, align 4
  %idxprom76 = sext i32 %49 to i64
  %arrayidx77 = getelementptr inbounds [10 x i32], [10 x i32]* %48, i64 %idxprom76
  %50 = load i32, i32* %k, align 4
  %idxprom78 = sext i32 %50 to i64
  %arrayidx79 = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx77, i64 0, i64 %idxprom78
  %51 = load i32, i32* %arrayidx79, align 4
  %52 = load [10 x i32]*, [10 x i32]** %F.addr, align 8
  %53 = load i32, i32* %k, align 4
  %idxprom80 = sext i32 %53 to i64
  %arrayidx81 = getelementptr inbounds [10 x i32], [10 x i32]* %52, i64 %idxprom80
  ...
  %mul84 = mul nsw i32 %51, %55
  %56 = load [10 x i32]*, [10 x i32]** %G.addr, align 8
  %57 = load i32, i32* %i, align 4
  %idxprom85 = sext i32 %57 to i64
  %arrayidx86 = getelementptr inbounds [10 x i32], [10 x i32]* %56, i64 %idxprom85
