...
-- File created: Tue Jun 13 18:42:21 2023
...
architecture behavioral of fir is 
	...
	signal Buffer_10_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_10_dataOutArray_0 : std_logic_vector(9 downto 0);
...
begin
	...
	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	phi_1_pValidArray_0 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= phi_1_readyArray_0;
	phi_1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),phi_1_dataInArray_0'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phiC_2_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phiC_2_readyArray_0;
	phiC_2_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phiC_2_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	branch_2_pValidArray_1 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),branch_2_dataInArray_1'length));

	phi_1_clk <= clk;
	phi_1_rst <= rst;
	Buffer_6_pValidArray_0 <= phi_1_validArray_0;
	phi_1_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_1_dataOutArray_0),Buffer_6_dataInArray_0'length));

	phi_2_clk <= clk;
	phi_2_rst <= rst;
	Buffer_7_pValidArray_0 <= phi_2_validArray_0;
	phi_2_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_2_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	add_12_clk <= clk;
	add_12_rst <= rst;
	Buffer_8_pValidArray_0 <= add_12_validArray_0;
	add_12_nReadyArray_0 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(add_12_dataOutArray_0),Buffer_8_dataInArray_0'length));
	...
	icmp_13_clk <= clk;
	icmp_13_rst <= rst;
	Buffer_9_pValidArray_0 <= icmp_13_validArray_0;
	icmp_13_nReadyArray_0 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_13_dataOutArray_0),Buffer_9_dataInArray_0'length));
	...
	Buffer_11_pValidArray_0 <= branch_2_validArray_1;
	branch_2_nReadyArray_1 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_1),Buffer_11_dataInArray_0'length));
	...
	Buffer_12_pValidArray_0 <= fork_4_validArray_1;
	fork_4_nReadyArray_1 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_1),Buffer_12_dataInArray_0'length));
	...
	phiC_1_clk <= clk;
	phiC_1_rst <= rst;
	Buffer_5_pValidArray_0 <= phiC_1_validArray_0;
	phiC_1_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_1_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	Buffer_13_pValidArray_0 <= branchC_5_validArray_1;
	branchC_5_nReadyArray_1 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_5_dataOutArray_1),Buffer_13_dataInArray_0'length));
	...
	fork_9_clk <= clk;
	fork_9_rst <= rst;
	Buffer_14_pValidArray_0 <= fork_9_validArray_0;
	fork_9_nReadyArray_0 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_9_dataOutArray_0),Buffer_14_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	branch_3_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= branch_3_readyArray_0;
	branch_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),branch_3_dataInArray_0'length));

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	fork_4_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),fork_4_dataInArray_0'length));
	...
	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	fork_0_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= fork_0_readyArray_0;
	fork_0_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),fork_0_dataInArray_0'length));

	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	add_11_pValidArray_0 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= add_11_readyArray_0;
	add_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),add_11_dataInArray_0'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	branchC_5_pValidArray_0 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= branchC_5_readyArray_0;
	branchC_5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),branchC_5_dataInArray_0'length));

	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	phi_1_pValidArray_2 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= phi_1_readyArray_2;
	phi_1_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),phi_1_dataInArray_2'length));
...
Buffer_10: entity work.TEHB(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_10_clk,
	rst => Buffer_10_rst,
...
Buffer_8: entity work.elasticBuffer(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_8_clk,
	rst => Buffer_8_rst,
