...
-- File created: Tue Jun 13 20:03:49 2023
...
architecture behavioral of triangular is 
	...
	signal phi_8_dataInArray_1 : std_logic_vector(30 downto 0);
	signal phi_8_dataInArray_2 : std_logic_vector(30 downto 0);
	...
	signal phi_8_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal add_9_dataInArray_0 : std_logic_vector(30 downto 0);
	signal add_9_dataInArray_1 : std_logic_vector(30 downto 0);
	...
	signal add_9_dataOutArray_0 : std_logic_vector(30 downto 0);

	signal sext_10_clk : std_logic;
	signal sext_10_rst : std_logic;
	signal sext_10_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal sext_10_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal sext_18_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal sext_18_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal cst_7_dataInArray_0 : std_logic_vector(6 downto 0);
	...
	signal cst_7_dataOutArray_0 : std_logic_vector(6 downto 0);

	signal cst_8_clk : std_logic;
	signal cst_8_rst : std_logic;
	signal cst_8_dataInArray_0 : std_logic_vector(6 downto 0);
	...
	signal cst_8_dataOutArray_0 : std_logic_vector(6 downto 0);
	...
	signal fork_3_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal fork_3_dataOutArray_0 : std_logic_vector(30 downto 0);
	signal fork_3_nReadyArray_1 : std_logic;
	signal fork_3_validArray_1 : std_logic;
	signal fork_3_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal fork_4_dataOutArray_2 : std_logic_vector(30 downto 0);
	...
	signal branch_9_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal branch_9_dataOutArray_0 : std_logic_vector(30 downto 0);
	signal branch_9_nReadyArray_1 : std_logic;
	signal branch_9_validArray_1 : std_logic;
	signal branch_9_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal source_7_dataOutArray_0 : std_logic_vector(6 downto 0);
	...
	signal source_8_dataOutArray_0 : std_logic_vector(6 downto 0);
...
begin
	...
	add_0_clk <= clk;
	add_0_rst <= rst;
	Buffer_1_pValidArray_0 <= add_0_validArray_0;
	add_0_nReadyArray_0 <= Buffer_1_readyArray_0;
	Buffer_1_dataInArray_0 <= std_logic_vector (resize(unsigned(add_0_dataOutArray_0),Buffer_1_dataInArray_0'length));
	...
	icmp_1_clk <= clk;
	icmp_1_rst <= rst;
	Buffer_2_pValidArray_0 <= icmp_1_validArray_0;
	icmp_1_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_1_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	branchC_14_pValidArray_0 <= start_0_validArray_0;
	start_0_nReadyArray_0 <= branchC_14_readyArray_0;
	branchC_14_dataInArray_0 <= std_logic_vector (resize(unsigned(start_0_dataOutArray_0),branchC_14_dataInArray_0'length));
	...
	source_1_clk <= clk;
	source_1_rst <= rst;
	cst_1_pValidArray_0 <= source_1_validArray_0;
	source_1_nReadyArray_0 <= cst_1_readyArray_0;
	cst_1_dataInArray_0 <= "0";

	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	branch_1_pValidArray_0 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= branch_1_readyArray_0;
	branch_1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),branch_1_dataInArray_0'length));

	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	fork_13_pValidArray_0 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= fork_13_readyArray_0;
	fork_13_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),fork_13_dataInArray_0'length));
	...
	branch_2_clk <= clk;
	branch_2_rst <= rst;
	Buffer_19_pValidArray_0 <= branch_2_validArray_0;
	branch_2_nReadyArray_0 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_0),Buffer_19_dataInArray_0'length));
	...
	branch_3_clk <= clk;
	branch_3_rst <= rst;
	Buffer_20_pValidArray_0 <= branch_3_validArray_0;
	branch_3_nReadyArray_0 <= Buffer_20_readyArray_0;
	Buffer_20_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_3_dataOutArray_0),Buffer_20_dataInArray_0'length));
	...
	branchC_15_clk <= clk;
	branchC_15_rst <= rst;
	Buffer_24_pValidArray_0 <= branchC_15_validArray_0;
	branchC_15_nReadyArray_0 <= Buffer_24_readyArray_0;
	Buffer_24_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_15_dataOutArray_0),Buffer_24_dataInArray_0'length));
	...
	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	phi_4_pValidArray_1 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= phi_4_readyArray_1;
	phi_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),phi_4_dataInArray_1'length));

	Buffer_20_clk <= clk;
	Buffer_20_rst <= rst;
	phi_n3_pValidArray_0 <= Buffer_20_validArray_0;
	Buffer_20_nReadyArray_0 <= phi_n3_readyArray_0;
	phi_n3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_20_dataOutArray_0),phi_n3_dataInArray_0'length));
	...
	icmp_5_clk <= clk;
	icmp_5_rst <= rst;
	Buffer_4_pValidArray_0 <= icmp_5_validArray_0;
	icmp_5_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_5_dataOutArray_0),Buffer_4_dataInArray_0'length));

	phi_n3_clk <= clk;
	phi_n3_rst <= rst;
	Buffer_13_pValidArray_0 <= phi_n3_validArray_0;
	phi_n3_nReadyArray_0 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n3_dataOutArray_0),Buffer_13_dataInArray_0'length));
	...
	Buffer_18_pValidArray_0 <= fork_2_validArray_1;
	fork_2_nReadyArray_1 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_1),Buffer_18_dataInArray_0'length));
	...
	phi_n4_pValidArray_0 <= branch_4_validArray_1;
	branch_4_nReadyArray_1 <= phi_n4_readyArray_0;
	phi_n4_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_1),phi_n4_dataInArray_0'length));
	...
	phi_n5_pValidArray_0 <= branch_5_validArray_1;
	branch_5_nReadyArray_1 <= phi_n5_readyArray_0;
	phi_n5_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_1),phi_n5_dataInArray_0'length));
	...
	phiC_11_clk <= clk;
	phiC_11_rst <= rst;
	Buffer_25_pValidArray_0 <= phiC_11_validArray_0;
	phiC_11_nReadyArray_0 <= Buffer_25_readyArray_0;
	Buffer_25_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_0),Buffer_25_dataInArray_0'length));
	...
	source_2_clk <= clk;
	source_2_rst <= rst;
	cst_2_pValidArray_0 <= source_2_validArray_0;
	source_2_nReadyArray_0 <= cst_2_readyArray_0;
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	branch_5_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= branch_5_readyArray_0;
	branch_5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),branch_5_dataInArray_0'length));
	...
	Buffer_25_clk <= clk;
	Buffer_25_rst <= rst;
	branchC_16_pValidArray_0 <= Buffer_25_validArray_0;
	Buffer_25_nReadyArray_0 <= branchC_16_readyArray_0;
	branchC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_25_dataOutArray_0),branchC_16_dataInArray_0'length));
	...
	branch_8_clk <= clk;
	branch_8_rst <= rst;
	Buffer_21_pValidArray_0 <= branch_8_validArray_0;
	branch_8_nReadyArray_0 <= Buffer_21_readyArray_0;
	Buffer_21_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_0),Buffer_21_dataInArray_0'length));
	...
	branchC_17_clk <= clk;
	branchC_17_rst <= rst;
	Buffer_26_pValidArray_0 <= branchC_17_validArray_0;
	branchC_17_nReadyArray_0 <= Buffer_26_readyArray_0;
	Buffer_26_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_17_dataOutArray_0),Buffer_26_dataInArray_0'length));
	...
	Buffer_21_clk <= clk;
	Buffer_21_rst <= rst;
	phi_8_pValidArray_1 <= Buffer_21_validArray_0;
	Buffer_21_nReadyArray_0 <= phi_8_readyArray_1;
	phi_8_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_21_dataOutArray_0),phi_8_dataInArray_1'length));

	Buffer_26_clk <= clk;
	Buffer_26_rst <= rst;
	phiC_13_pValidArray_0 <= Buffer_26_validArray_0;
	Buffer_26_nReadyArray_0 <= phiC_13_readyArray_0;
	phiC_13_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_26_dataOutArray_0),phiC_13_dataInArray_0'length));

	phi_8_clk <= clk;
	phi_8_rst <= rst;
	Buffer_5_pValidArray_0 <= phi_8_validArray_0;
	phi_8_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_8_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	Buffer_7_pValidArray_0 <= getelementptr_20_validArray_0;
	getelementptr_20_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(getelementptr_20_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	cst_8_clk <= clk;
	cst_8_rst <= rst;
	getelementptr_20_pValidArray_2 <= cst_8_validArray_0;
	cst_8_nReadyArray_0 <= getelementptr_20_readyArray_2;
	getelementptr_20_dataInArray_2 <= std_logic_vector (resize(unsigned(cst_8_dataOutArray_0),getelementptr_20_dataInArray_2'length));

	phi_n8_clk <= clk;
	phi_n8_rst <= rst;
	Buffer_16_pValidArray_0 <= phi_n8_validArray_0;
	phi_n8_nReadyArray_0 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n8_dataOutArray_0),Buffer_16_dataInArray_0'length));

	phi_n9_clk <= clk;
	phi_n9_rst <= rst;
	Buffer_17_pValidArray_0 <= phi_n9_validArray_0;
	phi_n9_nReadyArray_0 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n9_dataOutArray_0),Buffer_17_dataInArray_0'length));
	...
	sext_18_pValidArray_0 <= fork_4_validArray_1;
	fork_4_nReadyArray_1 <= sext_18_readyArray_0;
	sext_18_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_1),sext_18_dataInArray_0'length));
	...
	branch_9_clk <= clk;
	branch_9_rst <= rst;
	phi_8_pValidArray_2 <= branch_9_validArray_0;
	branch_9_nReadyArray_0 <= phi_8_readyArray_2;
	phi_8_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_9_dataOutArray_0),phi_8_dataInArray_2'length));
	...
	branch_10_clk <= clk;
	branch_10_rst <= rst;
	phi_n8_pValidArray_1 <= branch_10_validArray_0;
	branch_10_nReadyArray_0 <= phi_n8_readyArray_1;
	phi_n8_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_10_dataOutArray_0),phi_n8_dataInArray_1'length));
	...
	fork_17_clk <= clk;
	fork_17_rst <= rst;
	branch_11_pValidArray_1 <= fork_17_validArray_0;
	fork_17_nReadyArray_0 <= branch_11_readyArray_1;
	branch_11_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_17_dataOutArray_0),branch_11_dataInArray_1'length));
	...
	forkC_24_clk <= clk;
	forkC_24_rst <= rst;
	LSQ_A_pValidArray_0 <= forkC_24_validArray_0;
	forkC_24_nReadyArray_0 <= LSQ_A_readyArray_0;
	LSQ_A_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_24_dataOutArray_0),LSQ_A_dataInArray_0'length));
	cst_9_pValidArray_0 <= forkC_24_validArray_1;
	forkC_24_nReadyArray_1 <= cst_9_readyArray_0;
	cst_9_dataInArray_0 <= "1";
	Buffer_27_pValidArray_0 <= forkC_24_validArray_2;
	forkC_24_nReadyArray_2 <= Buffer_27_readyArray_0;
	Buffer_27_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_24_dataOutArray_2),Buffer_27_dataInArray_0'length));

	branchC_18_clk <= clk;
	branchC_18_rst <= rst;
	phiC_13_pValidArray_1 <= branchC_18_validArray_0;
	branchC_18_nReadyArray_0 <= phiC_13_readyArray_1;
	phiC_13_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_18_dataOutArray_0),phiC_13_dataInArray_1'length));
	...
	source_3_clk <= clk;
	source_3_rst <= rst;
	cst_3_pValidArray_0 <= source_3_validArray_0;
	source_3_nReadyArray_0 <= cst_3_readyArray_0;
	cst_3_dataInArray_0 <= "11111111111111111111111111111111";

	source_4_clk <= clk;
	source_4_rst <= rst;
	cst_4_pValidArray_0 <= source_4_validArray_0;
	source_4_nReadyArray_0 <= cst_4_readyArray_0;
	cst_4_dataInArray_0 <= "1";

	source_7_clk <= clk;
	source_7_rst <= rst;
	cst_7_pValidArray_0 <= source_7_validArray_0;
	source_7_nReadyArray_0 <= cst_7_readyArray_0;
	cst_7_dataInArray_0 <= "1100100";

	source_8_clk <= clk;
	source_8_rst <= rst;
	cst_8_pValidArray_0 <= source_8_validArray_0;
	source_8_nReadyArray_0 <= cst_8_readyArray_0;
	cst_8_dataInArray_0 <= "1100100";
	...
	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	fork_11_pValidArray_0 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= fork_11_readyArray_0;
	fork_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),fork_11_dataInArray_0'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	fork_12_pValidArray_0 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= fork_12_readyArray_0;
	fork_12_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),fork_12_dataInArray_0'length));

	Buffer_27_clk <= clk;
	Buffer_27_rst <= rst;
	branchC_18_pValidArray_0 <= Buffer_27_validArray_0;
	Buffer_27_nReadyArray_0 <= branchC_18_readyArray_0;
	branchC_18_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_27_dataOutArray_0),branchC_18_dataInArray_0'length));
	...
	add_25_clk <= clk;
	add_25_rst <= rst;
	Buffer_9_pValidArray_0 <= add_25_validArray_0;
	add_25_nReadyArray_0 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(add_25_dataOutArray_0),Buffer_9_dataInArray_0'length));
	...
	icmp_26_clk <= clk;
	icmp_26_rst <= rst;
	Buffer_10_pValidArray_0 <= icmp_26_validArray_0;
	icmp_26_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_26_dataOutArray_0),Buffer_10_dataInArray_0'length));

	phi_n4_clk <= clk;
	phi_n4_rst <= rst;
	Buffer_14_pValidArray_0 <= phi_n4_validArray_0;
	phi_n4_nReadyArray_0 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n4_dataOutArray_0),Buffer_14_dataInArray_0'length));

	phi_n5_clk <= clk;
	phi_n5_rst <= rst;
	Buffer_15_pValidArray_0 <= phi_n5_validArray_0;
	phi_n5_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n5_dataOutArray_0),Buffer_15_dataInArray_0'length));
	...
	Buffer_22_pValidArray_0 <= branch_12_validArray_1;
	branch_12_nReadyArray_1 <= Buffer_22_readyArray_0;
	Buffer_22_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_1),Buffer_22_dataInArray_0'length));
	...
	Buffer_23_pValidArray_0 <= branch_13_validArray_1;
	branch_13_nReadyArray_1 <= Buffer_23_readyArray_0;
	Buffer_23_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_13_dataOutArray_1),Buffer_23_dataInArray_0'length));

	fork_18_clk <= clk;
	fork_18_rst <= rst;
	branch_13_pValidArray_1 <= fork_18_validArray_0;
	fork_18_nReadyArray_0 <= branch_13_readyArray_1;
	branch_13_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_18_dataOutArray_0),branch_13_dataInArray_1'length));
	...
	phiC_14_clk <= clk;
	phiC_14_rst <= rst;
	Buffer_28_pValidArray_0 <= phiC_14_validArray_0;
	phiC_14_nReadyArray_0 <= Buffer_28_readyArray_0;
	Buffer_28_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_14_dataOutArray_0),Buffer_28_dataInArray_0'length));
	...
	Buffer_29_pValidArray_0 <= branchC_19_validArray_1;
	branchC_19_nReadyArray_1 <= Buffer_29_readyArray_0;
	Buffer_29_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_19_dataOutArray_1),Buffer_29_dataInArray_0'length));

	source_5_clk <= clk;
	source_5_rst <= rst;
	cst_5_pValidArray_0 <= source_5_validArray_0;
	source_5_nReadyArray_0 <= cst_5_readyArray_0;
	cst_5_dataInArray_0 <= "11111111111111111111111111111111";

	source_6_clk <= clk;
	source_6_rst <= rst;
	cst_6_pValidArray_0 <= source_6_validArray_0;
	source_6_nReadyArray_0 <= cst_6_readyArray_0;
	cst_6_dataInArray_0 <= "0";

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	branch_12_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= branch_12_readyArray_0;
	branch_12_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),branch_12_dataInArray_0'length));

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	fork_18_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= fork_18_readyArray_0;
	fork_18_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),fork_18_dataInArray_0'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	fork_8_pValidArray_0 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= fork_8_readyArray_0;
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),fork_8_dataInArray_0'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branch_13_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branch_13_readyArray_0;
	branch_13_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branch_13_dataInArray_0'length));

	Buffer_22_clk <= clk;
	Buffer_22_rst <= rst;
	phi_28_pValidArray_2 <= Buffer_22_validArray_0;
	Buffer_22_nReadyArray_0 <= phi_28_readyArray_2;
	phi_28_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_22_dataOutArray_0),phi_28_dataInArray_2'length));

	Buffer_23_clk <= clk;
	Buffer_23_rst <= rst;
	phi_n2_pValidArray_1 <= Buffer_23_validArray_0;
	Buffer_23_nReadyArray_0 <= phi_n2_readyArray_1;
	phi_n2_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_23_dataOutArray_0),phi_n2_dataInArray_1'length));

	Buffer_28_clk <= clk;
	Buffer_28_rst <= rst;
	branchC_19_pValidArray_0 <= Buffer_28_validArray_0;
	Buffer_28_nReadyArray_0 <= branchC_19_readyArray_0;
	branchC_19_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_28_dataOutArray_0),branchC_19_dataInArray_0'length));

	Buffer_29_clk <= clk;
	Buffer_29_rst <= rst;
	phiC_15_pValidArray_1 <= Buffer_29_validArray_0;
	Buffer_29_nReadyArray_0 <= phiC_15_readyArray_1;
	phiC_15_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_29_dataOutArray_0),phiC_15_dataInArray_1'length));
	...
	phi_n2_clk <= clk;
	phi_n2_rst <= rst;
	Buffer_12_pValidArray_0 <= phi_n2_validArray_0;
	phi_n2_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n2_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	add_29_pValidArray_0 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= add_29_readyArray_0;
	add_29_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),add_29_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	add_29_pValidArray_1 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= add_29_readyArray_1;
	add_29_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),add_29_dataInArray_1'length));
...
Buffer_21: entity work.TEHB(arch) generic map (1,1,32,32)
port map (
	clk => Buffer_21_clk,
	rst => Buffer_21_rst,
...
phi_8: entity work.Mux(arch) generic map (3,1,31,31,1)
port map (
	clk => phi_8_clk,
	rst => phi_8_rst,
...
add_9: entity work.add_op(arch) generic map (2,1,31,31)
port map (
	clk => add_9_clk,
	rst => add_9_rst,
...
sext_10: entity work.sext_op(arch) generic map (1,1,31,31)
port map (
	clk => sext_10_clk,
	rst => sext_10_rst,
...
sext_18: entity work.sext_op(arch) generic map (1,1,31,31)
port map (
	clk => sext_18_clk,
	rst => sext_18_rst,
...
cst_7: entity work.Const(arch) generic map (1,1,7,7)
port map (
	clk => cst_7_clk,
	rst => cst_7_rst,
...
cst_8: entity work.Const(arch) generic map (1,1,7,7)
port map (
	clk => cst_8_clk,
	rst => cst_8_rst,
...
fork_3: entity work.fork(arch) generic map (1,2,31,31)
port map (
	clk => fork_3_clk,
	rst => fork_3_rst,
...
fork_4: entity work.fork(arch) generic map (1,3,31,31)
port map (
	clk => fork_4_clk,
	rst => fork_4_rst,
...
branch_9: entity work.Branch(arch) generic map (2,2,31,31)
port map (
	clk => branch_9_clk,
	rst => branch_9_rst,
...
source_7: entity work.source(arch) generic map (0,1,32,7)
port map (
	clk => source_7_clk,
	rst => source_7_rst,
...
source_8: entity work.source(arch) generic map (0,1,32,7)
port map (
	clk => source_8_clk,
	rst => source_8_rst,
...
Buffer_5: entity work.elasticBuffer(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_6: entity work.elasticBuffer(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_6_clk,
	rst => Buffer_6_rst,
