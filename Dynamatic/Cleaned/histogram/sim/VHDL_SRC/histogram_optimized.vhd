...
-- File created: Tue Jun 13 18:58:35 2023
...
port (
	...
	end_out:  out std_logic_vector (30 downto 0);
...
architecture behavioral of histogram is 
	...
	signal branch_4_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal branch_4_dataOutArray_0 : std_logic_vector(30 downto 0);
	signal branch_4_nReadyArray_1 : std_logic;
	signal branch_4_validArray_1 : std_logic;
	signal branch_4_dataOutArray_1 : std_logic_vector(30 downto 0);
	...
	signal phi_19_dataInArray_1 : std_logic_vector(30 downto 0);
	signal phi_19_dataInArray_2 : std_logic_vector(30 downto 0);
	...
	signal phi_19_dataOutArray_0 : std_logic_vector(30 downto 0);

	signal ret_0_clk : std_logic;
	signal ret_0_rst : std_logic;
	signal ret_0_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal ret_0_dataOutArray_0 : std_logic_vector(30 downto 0);
	...
	signal end_0_dataInArray_3 : std_logic_vector(30 downto 0);
	...
	signal end_0_dataOutArray_0 : std_logic_vector(30 downto 0);
...
begin
	...
	branchC_6_pValidArray_0 <= forkC_9_validArray_1;
	forkC_9_nReadyArray_1 <= branchC_6_readyArray_0;
	branchC_6_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_9_dataOutArray_1),branchC_6_dataInArray_0'length));
	...
	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	fork_5_pValidArray_0 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= fork_5_readyArray_0;
	fork_5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),fork_5_dataInArray_0'length));
	...
	branch_2_clk <= clk;
	branch_2_rst <= rst;
	Buffer_9_pValidArray_0 <= branch_2_validArray_0;
	branch_2_nReadyArray_0 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_0),Buffer_9_dataInArray_0'length));
	...
	branch_3_clk <= clk;
	branch_3_rst <= rst;
	Buffer_10_pValidArray_0 <= branch_3_validArray_0;
	branch_3_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_3_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	branchC_7_clk <= clk;
	branchC_7_rst <= rst;
	Buffer_12_pValidArray_0 <= branchC_7_validArray_0;
	branchC_7_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_7_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	phi_3_pValidArray_1 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= phi_3_readyArray_1;
	phi_3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),phi_3_dataInArray_1'length));

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_n1_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_n1_readyArray_0;
	phi_n1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_n1_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phiC_3_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phiC_3_readyArray_0;
	phiC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phiC_3_dataInArray_0'length));
	...
	load_9_clk <= clk;
	load_9_rst <= rst;
	Buffer_3_pValidArray_0 <= load_9_validArray_0;
	load_9_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(load_9_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	add_16_clk <= clk;
	add_16_rst <= rst;
	Buffer_4_pValidArray_0 <= add_16_validArray_0;
	add_16_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(add_16_dataOutArray_0),Buffer_4_dataInArray_0'length));

	icmp_17_clk <= clk;
	icmp_17_rst <= rst;
	Buffer_5_pValidArray_0 <= icmp_17_validArray_0;
	icmp_17_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_17_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	load_9_pValidArray_1 <= fork_1_validArray_2;
	fork_1_nReadyArray_2 <= load_9_readyArray_1;
	load_9_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_2),load_9_dataInArray_1'length));
	...
	Buffer_7_pValidArray_0 <= fork_3_validArray_1;
	fork_3_nReadyArray_1 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_3_dataOutArray_1),Buffer_7_dataInArray_0'length));
	...
	Buffer_11_pValidArray_0 <= branch_4_validArray_1;
	branch_4_nReadyArray_1 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_1),Buffer_11_dataInArray_0'length));
	...
	forkC_11_clk <= clk;
	forkC_11_rst <= rst;
	LSQ_hist_pValidArray_0 <= forkC_11_validArray_0;
	forkC_11_nReadyArray_0 <= LSQ_hist_readyArray_0;
	LSQ_hist_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_11_dataOutArray_0),LSQ_hist_dataInArray_0'length));
	Buffer_13_pValidArray_0 <= forkC_11_validArray_1;
	forkC_11_nReadyArray_1 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_11_dataOutArray_1),Buffer_13_dataInArray_0'length));
	...
	Buffer_14_pValidArray_0 <= branchC_8_validArray_1;
	branchC_8_nReadyArray_1 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_8_dataOutArray_1),Buffer_14_dataInArray_0'length));
	...
	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	add_13_pValidArray_1 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= add_13_readyArray_1;
	add_13_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),add_13_dataInArray_1'length));
	...
	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	branch_5_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= branch_5_readyArray_0;
	branch_5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),branch_5_dataInArray_0'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_19_pValidArray_2 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_19_readyArray_2;
	phi_19_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_19_dataInArray_2'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	branchC_8_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= branchC_8_readyArray_0;
	branchC_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),branchC_8_dataInArray_0'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	phiC_4_pValidArray_1 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= phiC_4_readyArray_1;
	phiC_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),phiC_4_dataInArray_1'length));
...
branch_4: entity work.Branch(arch) generic map (2,2,31,31)
port map (
	clk => branch_4_clk,
	rst => branch_4_rst,
...
Buffer_3: entity work.transpFifo(arch) generic map (1,1,32,32,2)
port map (
	clk => Buffer_3_clk,
	rst => Buffer_3_rst,
...
Buffer_7: entity work.TEHB(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_7_clk,
	rst => Buffer_7_rst,
...
phi_19: entity work.Mux(arch) generic map (3,1,31,31,1)
port map (
	clk => phi_19_clk,
	rst => phi_19_rst,
...
ret_0: entity work.ret_op(arch) generic map (1,1,31,31)
port map (
	clk => ret_0_clk,
	rst => ret_0_rst,
...
end_0: entity work.end_node(arch) generic map (1,3,1,31,31)
port map (
	clk => end_0_clk,
	rst => end_0_rst,
