...
-- File created: Thu Apr 27 22:01:12 2023
...
architecture behavioral of jacobi_1d is 
	...
	signal Buffer_3_dataInArray_0 : std_logic_vector(6 downto 0);
	...
	signal Buffer_3_dataOutArray_0 : std_logic_vector(6 downto 0);

	signal Buffer_4_clk : std_logic;
	signal Buffer_4_rst : std_logic;
	signal Buffer_4_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_4_dataOutArray_0 : std_logic_vector(2 downto 0);
...
begin
	...
	branch_0_clk <= clk;
	branch_0_rst <= rst;
	Buffer_6_pValidArray_0 <= branch_0_validArray_0;
	branch_0_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_0),Buffer_6_dataInArray_0'length));
	...
	branchC_10_clk <= clk;
	branchC_10_rst <= rst;
	Buffer_11_pValidArray_0 <= branchC_10_validArray_0;
	branchC_10_nReadyArray_0 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_10_dataOutArray_0),Buffer_11_dataInArray_0'length));
	...
	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	phi_1_pValidArray_1 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= phi_1_readyArray_1;
	phi_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),phi_1_dataInArray_1'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phiC_5_pValidArray_0 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phiC_5_readyArray_0;
	phiC_5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phiC_5_dataInArray_0'length));
	...
	fork_8_clk <= clk;
	fork_8_rst <= rst;
	Buffer_7_pValidArray_0 <= fork_8_validArray_0;
	fork_8_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_0),Buffer_7_dataInArray_0'length));
	...
	phiC_5_clk <= clk;
	phiC_5_rst <= rst;
	forkC_16_pValidArray_0 <= phiC_5_validArray_0;
	phiC_5_nReadyArray_0 <= forkC_16_readyArray_0;
	forkC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_5_dataOutArray_0),forkC_16_dataInArray_0'length));
	...
	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	branch_2_pValidArray_1 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),branch_2_dataInArray_1'length));
	...
	Buffer_12_pValidArray_0 <= forkC_17_validArray_1;
	forkC_17_nReadyArray_1 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_17_dataOutArray_1),Buffer_12_dataInArray_0'length));
	...
	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	phi_n1_pValidArray_1 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= phi_n1_readyArray_1;
	phi_n1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),phi_n1_dataInArray_1'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	branchC_12_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= branchC_12_readyArray_0;
	branchC_12_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),branchC_12_dataInArray_0'length));
	...
	phi_24_clk <= clk;
	phi_24_rst <= rst;
	Buffer_3_pValidArray_0 <= phi_24_validArray_0;
	phi_24_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_24_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	branch_7_clk <= clk;
	branch_7_rst <= rst;
	phi_24_pValidArray_2 <= branch_7_validArray_0;
	branch_7_nReadyArray_0 <= phi_24_readyArray_2;
	phi_24_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_7_dataOutArray_0),phi_24_dataInArray_2'length));
	...
	Buffer_13_pValidArray_0 <= forkC_19_validArray_2;
	forkC_19_nReadyArray_2 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_19_dataOutArray_2),Buffer_13_dataInArray_0'length));

	branchC_14_clk <= clk;
	branchC_14_rst <= rst;
	phiC_8_pValidArray_1 <= branchC_14_validArray_0;
	branchC_14_nReadyArray_0 <= phiC_8_readyArray_1;
	phiC_8_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_14_dataOutArray_0),phiC_8_dataInArray_1'length));
	phiC_9_pValidArray_0 <= branchC_14_validArray_1;
	branchC_14_nReadyArray_1 <= phiC_9_readyArray_0;
	phiC_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_14_dataOutArray_1),phiC_9_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	branch_8_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= branch_8_readyArray_0;
	branch_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),branch_8_dataInArray_0'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	store_1_pValidArray_1 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= store_1_readyArray_1;
	store_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),store_1_dataInArray_1'length));

	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	phi_n0_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= phi_n0_readyArray_0;
	phi_n0_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),phi_n0_dataInArray_0'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	branchC_14_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= branchC_14_readyArray_0;
	branchC_14_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),branchC_14_dataInArray_0'length));
	...
	Buffer_10_pValidArray_0 <= branch_9_validArray_1;
	branch_9_nReadyArray_1 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_9_dataOutArray_1),Buffer_10_dataInArray_0'length));

	phiC_9_clk <= clk;
	phiC_9_rst <= rst;
	Buffer_14_pValidArray_0 <= phiC_9_validArray_0;
	phiC_9_nReadyArray_0 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_9_dataOutArray_0),Buffer_14_dataInArray_0'length));
	...
	Buffer_15_pValidArray_0 <= branchC_15_validArray_1;
	branchC_15_nReadyArray_1 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_15_dataOutArray_1),Buffer_15_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_n2_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_n2_readyArray_0;
	phi_n2_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_n2_dataInArray_0'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	branchC_15_pValidArray_0 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= branchC_15_readyArray_0;
	branchC_15_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),branchC_15_dataInArray_0'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	phiC_10_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= phiC_10_readyArray_0;
	phiC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),phiC_10_dataInArray_0'length));
...
Buffer_3: entity work.elasticBuffer(arch) generic map (1,1,7,7)
port map (
	clk => Buffer_3_clk,
	rst => Buffer_3_rst,
...
Buffer_4: entity work.elasticBuffer(arch) generic map (1,1,3,3)
port map (
	clk => Buffer_4_clk,
	rst => Buffer_4_rst,
...
Buffer_5: entity work.transpFifo(arch) generic map (1,1,7,7,5)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_10: entity work.elasticBuffer(arch) generic map (1,1,3,3)
port map (
	clk => Buffer_10_clk,
	rst => Buffer_10_rst,
