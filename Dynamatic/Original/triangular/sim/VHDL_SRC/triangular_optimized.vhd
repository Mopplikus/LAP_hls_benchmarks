...
-- File created: Wed Apr 12 20:37:20 2023
...
architecture behavioral of triangular is 
	...
	signal Buffer_2_dataInArray_0 : std_logic_vector(30 downto 0);
	...
	signal Buffer_2_dataOutArray_0 : std_logic_vector(30 downto 0);
...
begin
	...
	branch_2_clk <= clk;
	branch_2_rst <= rst;
	Buffer_8_pValidArray_0 <= branch_2_validArray_0;
	branch_2_nReadyArray_0 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_2_dataOutArray_0),Buffer_8_dataInArray_0'length));
	...
	branch_3_clk <= clk;
	branch_3_rst <= rst;
	Buffer_9_pValidArray_0 <= branch_3_validArray_0;
	branch_3_nReadyArray_0 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_3_dataOutArray_0),Buffer_9_dataInArray_0'length));
	...
	branchC_15_clk <= clk;
	branchC_15_rst <= rst;
	Buffer_12_pValidArray_0 <= branchC_15_validArray_0;
	branchC_15_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_15_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phiC_11_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phiC_11_readyArray_0;
	phiC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phiC_11_dataInArray_0'length));
	...
	phiC_11_clk <= clk;
	phiC_11_rst <= rst;
	Buffer_13_pValidArray_0 <= phiC_11_validArray_0;
	phiC_11_nReadyArray_0 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_0),Buffer_13_dataInArray_0'length));
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	branchC_16_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= branchC_16_readyArray_0;
	branchC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),branchC_16_dataInArray_0'length));
	...
	Buffer_3_pValidArray_0 <= getelementptr_20_validArray_0;
	getelementptr_20_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(getelementptr_20_dataOutArray_0),Buffer_3_dataInArray_0'length));
	...
	icmp_23_clk <= clk;
	icmp_23_rst <= rst;
	Buffer_4_pValidArray_0 <= icmp_23_validArray_0;
	icmp_23_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_23_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	Buffer_14_pValidArray_0 <= forkC_24_validArray_2;
	forkC_24_nReadyArray_2 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_24_dataOutArray_2),Buffer_14_dataInArray_0'length));
	...
	fork_5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),fork_5_dataInArray_0'length));
	...
	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	branchC_18_pValidArray_0 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= branchC_18_readyArray_0;
	branchC_18_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),branchC_18_dataInArray_0'length));
	...
	Buffer_10_pValidArray_0 <= branch_12_validArray_1;
	branch_12_nReadyArray_1 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_1),Buffer_10_dataInArray_0'length));
	...
	Buffer_11_pValidArray_0 <= branch_13_validArray_1;
	branch_13_nReadyArray_1 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_13_dataOutArray_1),Buffer_11_dataInArray_0'length));
	...
	phiC_14_clk <= clk;
	phiC_14_rst <= rst;
	branchC_19_pValidArray_0 <= phiC_14_validArray_0;
	phiC_14_nReadyArray_0 <= branchC_19_readyArray_0;
	branchC_19_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_14_dataOutArray_0),branchC_19_dataInArray_0'length));
	...
	Buffer_15_pValidArray_0 <= branchC_19_validArray_1;
	branchC_19_nReadyArray_1 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_19_dataOutArray_1),Buffer_15_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_28_pValidArray_2 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_28_readyArray_2;
	phi_28_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_28_dataInArray_2'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_n2_pValidArray_1 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_n2_readyArray_1;
	phi_n2_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_n2_dataInArray_1'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	phiC_15_pValidArray_1 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= phiC_15_readyArray_1;
	phiC_15_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),phiC_15_dataInArray_1'length));
...
Buffer_2: entity work.elasticBuffer(arch) generic map (1,1,31,31)
port map (
	clk => Buffer_2_clk,
	rst => Buffer_2_rst,
