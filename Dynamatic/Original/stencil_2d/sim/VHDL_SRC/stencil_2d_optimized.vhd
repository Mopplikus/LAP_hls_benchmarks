...
-- File created: Wed Apr 12 20:21:12 2023
...
architecture behavioral of stencil_2d is 
	...
	signal Buffer_10_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_10_dataOutArray_0 : std_logic_vector(2 downto 0);

	signal Buffer_11_clk : std_logic;
	signal Buffer_11_rst : std_logic;
	signal Buffer_11_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_11_dataOutArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_22_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_22_dataOutArray_0 : std_logic_vector(2 downto 0);

	signal Buffer_23_clk : std_logic;
	signal Buffer_23_rst : std_logic;
	signal Buffer_23_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_23_dataOutArray_0 : std_logic_vector(2 downto 0);

	signal Buffer_24_clk : std_logic;
	signal Buffer_24_rst : std_logic;
	signal Buffer_24_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_24_dataOutArray_0 : std_logic_vector(2 downto 0);

	signal Buffer_25_clk : std_logic;
	signal Buffer_25_rst : std_logic;
	signal Buffer_25_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_25_dataOutArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_12_dataInArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_12_dataOutArray_0 : std_logic_vector(2 downto 0);
	...
	signal Buffer_5_dataInArray_0 : std_logic_vector(10 downto 0);
	...
	signal Buffer_5_dataOutArray_0 : std_logic_vector(10 downto 0);
	...
	signal Buffer_32_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_32_dataOutArray_0 : std_logic_vector(4 downto 0);

	signal Buffer_33_clk : std_logic;
	signal Buffer_33_rst : std_logic;
	signal Buffer_33_dataInArray_0 : std_logic_vector(4 downto 0);
	...
	signal Buffer_33_dataOutArray_0 : std_logic_vector(4 downto 0);
...
begin
	...
	branch_0_clk <= clk;
	branch_0_rst <= rst;
	Buffer_17_pValidArray_0 <= branch_0_validArray_0;
	branch_0_nReadyArray_0 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_0),Buffer_17_dataInArray_0'length));
	...
	branchC_26_clk <= clk;
	branchC_26_rst <= rst;
	Buffer_38_pValidArray_0 <= branchC_26_validArray_0;
	branchC_26_nReadyArray_0 <= Buffer_38_readyArray_0;
	Buffer_38_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_26_dataOutArray_0),Buffer_38_dataInArray_0'length));
	...
	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	phi_1_pValidArray_1 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= phi_1_readyArray_1;
	phi_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),phi_1_dataInArray_1'length));

	Buffer_38_clk <= clk;
	Buffer_38_rst <= rst;
	phiC_16_pValidArray_0 <= Buffer_38_validArray_0;
	Buffer_38_nReadyArray_0 <= phiC_16_readyArray_0;
	phiC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_38_dataOutArray_0),phiC_16_dataInArray_0'length));
	...
	branch_1_clk <= clk;
	branch_1_rst <= rst;
	Buffer_18_pValidArray_0 <= branch_1_validArray_0;
	branch_1_nReadyArray_0 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_1_dataOutArray_0),Buffer_18_dataInArray_0'length));
	...
	fork_16_clk <= clk;
	fork_16_rst <= rst;
	Buffer_19_pValidArray_0 <= fork_16_validArray_0;
	fork_16_nReadyArray_0 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_16_dataOutArray_0),Buffer_19_dataInArray_0'length));
	...
	phiC_16_clk <= clk;
	phiC_16_rst <= rst;
	forkC_26_pValidArray_0 <= phiC_16_validArray_0;
	phiC_16_nReadyArray_0 <= forkC_26_readyArray_0;
	forkC_26_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_16_dataOutArray_0),forkC_26_dataInArray_0'length));
	phi_1_pValidArray_0 <= phiC_16_validArray_1;
	phiC_16_nReadyArray_1 <= phi_1_readyArray_0;
	phi_1_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_16_dataOutArray_1),phi_1_dataInArray_0'length));
	...
	branchC_27_clk <= clk;
	branchC_27_rst <= rst;
	Buffer_39_pValidArray_0 <= branchC_27_validArray_0;
	branchC_27_nReadyArray_0 <= Buffer_39_readyArray_0;
	Buffer_39_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_27_dataOutArray_0),Buffer_39_dataInArray_0'length));
	...
	Buffer_18_clk <= clk;
	Buffer_18_rst <= rst;
	phi_3_pValidArray_1 <= Buffer_18_validArray_0;
	Buffer_18_nReadyArray_0 <= phi_3_readyArray_1;
	phi_3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_18_dataOutArray_0),phi_3_dataInArray_1'length));

	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	branch_2_pValidArray_1 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),branch_2_dataInArray_1'length));

	Buffer_39_clk <= clk;
	Buffer_39_rst <= rst;
	phiC_17_pValidArray_0 <= Buffer_39_validArray_0;
	Buffer_39_nReadyArray_0 <= phiC_17_readyArray_0;
	phiC_17_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_39_dataOutArray_0),phiC_17_dataInArray_0'length));
	...
	phiC_17_clk <= clk;
	phiC_17_rst <= rst;
	forkC_27_pValidArray_0 <= phiC_17_validArray_0;
	phiC_17_nReadyArray_0 <= forkC_27_readyArray_0;
	forkC_27_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_17_dataOutArray_0),forkC_27_dataInArray_0'length));
	...
	Buffer_21_pValidArray_0 <= fork_18_validArray_1;
	fork_18_nReadyArray_1 <= Buffer_21_readyArray_0;
	Buffer_21_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_18_dataOutArray_1),Buffer_21_dataInArray_0'length));
	...
	Buffer_20_pValidArray_0 <= fork_18_validArray_3;
	fork_18_nReadyArray_3 <= Buffer_20_readyArray_0;
	Buffer_20_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_18_dataOutArray_3),Buffer_20_dataInArray_0'length));
	...
	branchC_29_clk <= clk;
	branchC_29_rst <= rst;
	phiC_19_pValidArray_0 <= branchC_29_validArray_0;
	branchC_29_nReadyArray_0 <= phiC_19_readyArray_0;
	phiC_19_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_29_dataOutArray_0),phiC_19_dataInArray_0'length));
	...
	Buffer_45_pValidArray_0 <= fork_36_validArray_1;
	fork_36_nReadyArray_1 <= Buffer_45_readyArray_0;
	Buffer_45_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_36_dataOutArray_1),Buffer_45_dataInArray_0'length));

	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	branch_8_pValidArray_0 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= branch_8_readyArray_0;
	branch_8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),branch_8_dataInArray_0'length));

	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	branch_10_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= branch_10_readyArray_0;
	branch_10_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),branch_10_dataInArray_0'length));

	Buffer_20_clk <= clk;
	Buffer_20_rst <= rst;
	branch_8_pValidArray_1 <= Buffer_20_validArray_0;
	Buffer_20_nReadyArray_0 <= branch_8_readyArray_1;
	branch_8_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_20_dataOutArray_0),branch_8_dataInArray_1'length));

	Buffer_21_clk <= clk;
	Buffer_21_rst <= rst;
	branch_10_pValidArray_1 <= Buffer_21_validArray_0;
	Buffer_21_nReadyArray_0 <= branch_10_readyArray_1;
	branch_10_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_21_dataOutArray_0),branch_10_dataInArray_1'length));

	Buffer_45_clk <= clk;
	Buffer_45_rst <= rst;
	phi_6_pValidArray_0 <= Buffer_45_validArray_0;
	Buffer_45_nReadyArray_0 <= phi_6_readyArray_0;
	phi_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_45_dataOutArray_0),phi_6_dataInArray_0'length));

	phi_8_clk <= clk;
	phi_8_rst <= rst;
	fork_0_pValidArray_0 <= phi_8_validArray_0;
	phi_8_nReadyArray_0 <= fork_0_readyArray_0;
	fork_0_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_8_dataOutArray_0),fork_0_dataInArray_0'length));
	...
	add_17_clk <= clk;
	add_17_rst <= rst;
	add_18_pValidArray_0 <= add_17_validArray_0;
	add_17_nReadyArray_0 <= add_18_readyArray_0;
	add_18_dataInArray_0 <= std_logic_vector (resize(unsigned(add_17_dataOutArray_0),add_18_dataInArray_0'length));
	...
	add_24_clk <= clk;
	add_24_rst <= rst;
	fork_2_pValidArray_0 <= add_24_validArray_0;
	add_24_nReadyArray_0 <= fork_2_readyArray_0;
	fork_2_dataInArray_0 <= std_logic_vector (resize(unsigned(add_24_dataOutArray_0),fork_2_dataInArray_0'length));
	...
	icmp_25_clk <= clk;
	icmp_25_rst <= rst;
	fork_19_pValidArray_0 <= icmp_25_validArray_0;
	icmp_25_nReadyArray_0 <= fork_19_readyArray_0;
	fork_19_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_25_dataOutArray_0),fork_19_dataInArray_0'length));

	phi_n12_clk <= clk;
	phi_n12_rst <= rst;
	fork_12_pValidArray_0 <= phi_n12_validArray_0;
	phi_n12_nReadyArray_0 <= fork_12_readyArray_0;
	fork_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n12_dataOutArray_0),fork_12_dataInArray_0'length));

	phi_n13_clk <= clk;
	phi_n13_rst <= rst;
	fork_13_pValidArray_0 <= phi_n13_validArray_0;
	phi_n13_nReadyArray_0 <= fork_13_readyArray_0;
	fork_13_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n13_dataOutArray_0),fork_13_dataInArray_0'length));
	...
	fork_0_clk <= clk;
	fork_0_rst <= rst;
	Buffer_10_pValidArray_0 <= fork_0_validArray_0;
	fork_0_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_0),Buffer_10_dataInArray_0'length));
	Buffer_11_pValidArray_0 <= fork_0_validArray_1;
	fork_0_nReadyArray_1 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_1),Buffer_11_dataInArray_0'length));
	...
	branch_13_pValidArray_0 <= fork_2_validArray_1;
	fork_2_nReadyArray_1 <= branch_13_readyArray_0;
	branch_13_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_1),branch_13_dataInArray_0'length));
	...
	Buffer_14_pValidArray_0 <= fork_12_validArray_1;
	fork_12_nReadyArray_1 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_1),Buffer_14_dataInArray_0'length));
	...
	Buffer_15_pValidArray_0 <= fork_13_validArray_1;
	fork_13_nReadyArray_1 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_1),Buffer_15_dataInArray_0'length));
	...
	branch_13_clk <= clk;
	branch_13_rst <= rst;
	Buffer_22_pValidArray_0 <= branch_13_validArray_0;
	branch_13_nReadyArray_0 <= Buffer_22_readyArray_0;
	Buffer_22_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_13_dataOutArray_0),Buffer_22_dataInArray_0'length));
	...
	branch_14_clk <= clk;
	branch_14_rst <= rst;
	Buffer_24_pValidArray_0 <= branch_14_validArray_0;
	branch_14_nReadyArray_0 <= Buffer_24_readyArray_0;
	Buffer_24_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_14_dataOutArray_0),Buffer_24_dataInArray_0'length));
	Buffer_23_pValidArray_0 <= branch_14_validArray_1;
	branch_14_nReadyArray_1 <= Buffer_23_readyArray_0;
	Buffer_23_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_14_dataOutArray_1),Buffer_23_dataInArray_0'length));

	branch_15_clk <= clk;
	branch_15_rst <= rst;
	Buffer_25_pValidArray_0 <= branch_15_validArray_0;
	branch_15_nReadyArray_0 <= Buffer_25_readyArray_0;
	Buffer_25_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_15_dataOutArray_0),Buffer_25_dataInArray_0'length));
	phi_n10_pValidArray_0 <= branch_15_validArray_1;
	branch_15_nReadyArray_1 <= phi_n10_readyArray_0;
	phi_n10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_15_dataOutArray_1),phi_n10_dataInArray_0'length));
	...
	fork_19_clk <= clk;
	fork_19_rst <= rst;
	Buffer_28_pValidArray_0 <= fork_19_validArray_0;
	fork_19_nReadyArray_0 <= Buffer_28_readyArray_0;
	Buffer_28_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_19_dataOutArray_0),Buffer_28_dataInArray_0'length));
	Buffer_27_pValidArray_0 <= fork_19_validArray_1;
	fork_19_nReadyArray_1 <= Buffer_27_readyArray_0;
	Buffer_27_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_19_dataOutArray_1),Buffer_27_dataInArray_0'length));
	...
	Buffer_26_pValidArray_0 <= fork_19_validArray_4;
	fork_19_nReadyArray_4 <= Buffer_26_readyArray_0;
	Buffer_26_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_19_dataOutArray_4),Buffer_26_dataInArray_0'length));
	...
	phiC_19_clk <= clk;
	phiC_19_rst <= rst;
	branchC_30_pValidArray_0 <= phiC_19_validArray_0;
	phiC_19_nReadyArray_0 <= branchC_30_readyArray_0;
	branchC_30_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_19_dataOutArray_0),branchC_30_dataInArray_0'length));
	...
	branchC_30_clk <= clk;
	branchC_30_rst <= rst;
	Buffer_40_pValidArray_0 <= branchC_30_validArray_0;
	branchC_30_nReadyArray_0 <= Buffer_40_readyArray_0;
	Buffer_40_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_30_dataOutArray_0),Buffer_40_dataInArray_0'length));
	...
	Buffer_46_pValidArray_0 <= fork_37_validArray_1;
	fork_37_nReadyArray_1 <= Buffer_46_readyArray_0;
	Buffer_46_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_37_dataOutArray_1),Buffer_46_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	add_11_pValidArray_1 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= add_11_readyArray_1;
	add_11_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),add_11_dataInArray_1'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	add_18_pValidArray_1 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= add_18_readyArray_1;
	add_18_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),add_18_dataInArray_1'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	add_15_pValidArray_1 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= add_15_readyArray_1;
	add_15_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),add_15_dataInArray_1'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branch_15_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branch_15_readyArray_0;
	branch_15_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branch_15_dataInArray_0'length));
	...
	Buffer_22_clk <= clk;
	Buffer_22_rst <= rst;
	phi_8_pValidArray_2 <= Buffer_22_validArray_0;
	Buffer_22_nReadyArray_0 <= phi_8_readyArray_2;
	phi_8_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_22_dataOutArray_0),phi_8_dataInArray_2'length));

	Buffer_23_clk <= clk;
	Buffer_23_rst <= rst;
	phi_n8_pValidArray_0 <= Buffer_23_validArray_0;
	Buffer_23_nReadyArray_0 <= phi_n8_readyArray_0;
	phi_n8_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_23_dataOutArray_0),phi_n8_dataInArray_0'length));

	Buffer_24_clk <= clk;
	Buffer_24_rst <= rst;
	phi_n12_pValidArray_1 <= Buffer_24_validArray_0;
	Buffer_24_nReadyArray_0 <= phi_n12_readyArray_1;
	phi_n12_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_24_dataOutArray_0),phi_n12_dataInArray_1'length));

	Buffer_25_clk <= clk;
	Buffer_25_rst <= rst;
	phi_n13_pValidArray_1 <= Buffer_25_validArray_0;
	Buffer_25_nReadyArray_0 <= phi_n13_readyArray_1;
	phi_n13_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_25_dataOutArray_0),phi_n13_dataInArray_1'length));

	Buffer_26_clk <= clk;
	Buffer_26_rst <= rst;
	branch_12_pValidArray_1 <= Buffer_26_validArray_0;
	Buffer_26_nReadyArray_0 <= branch_12_readyArray_1;
	branch_12_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_26_dataOutArray_0),branch_12_dataInArray_1'length));

	Buffer_27_clk <= clk;
	Buffer_27_rst <= rst;
	branch_15_pValidArray_1 <= Buffer_27_validArray_0;
	Buffer_27_nReadyArray_0 <= branch_15_readyArray_1;
	branch_15_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_27_dataOutArray_0),branch_15_dataInArray_1'length));
	...
	Buffer_40_clk <= clk;
	Buffer_40_rst <= rst;
	phiC_19_pValidArray_1 <= Buffer_40_validArray_0;
	Buffer_40_nReadyArray_0 <= phiC_19_readyArray_1;
	phiC_19_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_40_dataOutArray_0),phiC_19_dataInArray_1'length));

	Buffer_46_clk <= clk;
	Buffer_46_rst <= rst;
	phi_9_pValidArray_0 <= Buffer_46_validArray_0;
	Buffer_46_nReadyArray_0 <= phi_9_readyArray_0;
	phi_9_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_46_dataOutArray_0),phi_9_dataInArray_0'length));
	...
	icmp_28_clk <= clk;
	icmp_28_rst <= rst;
	fork_20_pValidArray_0 <= icmp_28_validArray_0;
	icmp_28_nReadyArray_0 <= fork_20_readyArray_0;
	fork_20_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_28_dataOutArray_0),fork_20_dataInArray_0'length));
	...
	Buffer_12_pValidArray_0 <= fork_3_validArray_1;
	fork_3_nReadyArray_1 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_3_dataOutArray_1),Buffer_12_dataInArray_0'length));
	...
	fork_20_clk <= clk;
	fork_20_rst <= rst;
	Buffer_31_pValidArray_0 <= fork_20_validArray_0;
	fork_20_nReadyArray_0 <= Buffer_31_readyArray_0;
	Buffer_31_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_20_dataOutArray_0),Buffer_31_dataInArray_0'length));
	...
	Buffer_30_pValidArray_0 <= fork_20_validArray_2;
	fork_20_nReadyArray_2 <= Buffer_30_readyArray_0;
	Buffer_30_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_20_dataOutArray_2),Buffer_30_dataInArray_0'length));
	Buffer_29_pValidArray_0 <= fork_20_validArray_3;
	fork_20_nReadyArray_3 <= Buffer_29_readyArray_0;
	Buffer_29_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_20_dataOutArray_3),Buffer_29_dataInArray_0'length));
	...
	phiC_20_clk <= clk;
	phiC_20_rst <= rst;
	Buffer_41_pValidArray_0 <= phiC_20_validArray_0;
	phiC_20_nReadyArray_0 <= Buffer_41_readyArray_0;
	Buffer_41_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_20_dataOutArray_0),Buffer_41_dataInArray_0'length));

	branchC_31_clk <= clk;
	branchC_31_rst <= rst;
	Buffer_42_pValidArray_0 <= branchC_31_validArray_0;
	branchC_31_nReadyArray_0 <= Buffer_42_readyArray_0;
	Buffer_42_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_31_dataOutArray_0),Buffer_42_dataInArray_0'length));
	...
	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	branch_17_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= branch_17_readyArray_0;
	branch_17_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),branch_17_dataInArray_0'length));

	Buffer_29_clk <= clk;
	Buffer_29_rst <= rst;
	branch_17_pValidArray_1 <= Buffer_29_validArray_0;
	Buffer_29_nReadyArray_0 <= branch_17_readyArray_1;
	branch_17_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_29_dataOutArray_0),branch_17_dataInArray_1'length));

	Buffer_30_clk <= clk;
	Buffer_30_rst <= rst;
	branch_18_pValidArray_1 <= Buffer_30_validArray_0;
	Buffer_30_nReadyArray_0 <= branch_18_readyArray_1;
	branch_18_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_30_dataOutArray_0),branch_18_dataInArray_1'length));

	Buffer_31_clk <= clk;
	Buffer_31_rst <= rst;
	branch_20_pValidArray_1 <= Buffer_31_validArray_0;
	Buffer_31_nReadyArray_0 <= branch_20_readyArray_1;
	branch_20_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_31_dataOutArray_0),branch_20_dataInArray_1'length));

	Buffer_41_clk <= clk;
	Buffer_41_rst <= rst;
	branchC_31_pValidArray_0 <= Buffer_41_validArray_0;
	Buffer_41_nReadyArray_0 <= branchC_31_readyArray_0;
	branchC_31_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_41_dataOutArray_0),branchC_31_dataInArray_0'length));

	Buffer_42_clk <= clk;
	Buffer_42_rst <= rst;
	phiC_18_pValidArray_1 <= Buffer_42_validArray_0;
	Buffer_42_nReadyArray_0 <= phiC_18_readyArray_1;
	phiC_18_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_42_dataOutArray_0),phiC_18_dataInArray_1'length));
	...
	add_31_clk <= clk;
	add_31_rst <= rst;
	Buffer_5_pValidArray_0 <= add_31_validArray_0;
	add_31_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(add_31_dataOutArray_0),Buffer_5_dataInArray_0'length));
	...
	add_34_clk <= clk;
	add_34_rst <= rst;
	fork_4_pValidArray_0 <= add_34_validArray_0;
	add_34_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(add_34_dataOutArray_0),fork_4_dataInArray_0'length));
	...
	icmp_35_clk <= clk;
	icmp_35_rst <= rst;
	fork_21_pValidArray_0 <= icmp_35_validArray_0;
	icmp_35_nReadyArray_0 <= fork_21_readyArray_0;
	fork_21_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_35_dataOutArray_0),fork_21_dataInArray_0'length));

	phi_n3_clk <= clk;
	phi_n3_rst <= rst;
	Buffer_6_pValidArray_0 <= phi_n3_validArray_0;
	phi_n3_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n3_dataOutArray_0),Buffer_6_dataInArray_0'length));
	...
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_0),Buffer_13_dataInArray_0'length));
	...
	branch_21_clk <= clk;
	branch_21_rst <= rst;
	Buffer_32_pValidArray_0 <= branch_21_validArray_0;
	branch_21_nReadyArray_0 <= Buffer_32_readyArray_0;
	Buffer_32_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_21_dataOutArray_0),Buffer_32_dataInArray_0'length));
	...
	Buffer_33_pValidArray_0 <= branch_22_validArray_1;
	branch_22_nReadyArray_1 <= Buffer_33_readyArray_0;
	Buffer_33_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_22_dataOutArray_1),Buffer_33_dataInArray_0'length));
	...
	fork_21_clk <= clk;
	fork_21_rst <= rst;
	Buffer_35_pValidArray_0 <= fork_21_validArray_0;
	fork_21_nReadyArray_0 <= Buffer_35_readyArray_0;
	Buffer_35_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_21_dataOutArray_0),Buffer_35_dataInArray_0'length));
	Buffer_34_pValidArray_0 <= fork_21_validArray_1;
	fork_21_nReadyArray_1 <= Buffer_34_readyArray_0;
	Buffer_34_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_21_dataOutArray_1),Buffer_34_dataInArray_0'length));
	...
	Buffer_36_pValidArray_0 <= fork_21_validArray_3;
	fork_21_nReadyArray_3 <= Buffer_36_readyArray_0;
	Buffer_36_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_21_dataOutArray_3),Buffer_36_dataInArray_0'length));
	...
	Buffer_43_pValidArray_0 <= forkC_31_validArray_1;
	forkC_31_nReadyArray_1 <= Buffer_43_readyArray_0;
	Buffer_43_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_31_dataOutArray_1),Buffer_43_dataInArray_0'length));
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	add_31_pValidArray_1 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= add_31_readyArray_1;
	add_31_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),add_31_dataInArray_1'length));

	Buffer_32_clk <= clk;
	Buffer_32_rst <= rst;
	phi_3_pValidArray_2 <= Buffer_32_validArray_0;
	Buffer_32_nReadyArray_0 <= phi_3_readyArray_2;
	phi_3_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_32_dataOutArray_0),phi_3_dataInArray_2'length));

	Buffer_33_clk <= clk;
	Buffer_33_rst <= rst;
	phi_n0_pValidArray_0 <= Buffer_33_validArray_0;
	Buffer_33_nReadyArray_0 <= phi_n0_readyArray_0;
	phi_n0_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_33_dataOutArray_0),phi_n0_dataInArray_0'length));

	Buffer_34_clk <= clk;
	Buffer_34_rst <= rst;
	branch_22_pValidArray_1 <= Buffer_34_validArray_0;
	Buffer_34_nReadyArray_0 <= branch_22_readyArray_1;
	branch_22_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_34_dataOutArray_0),branch_22_dataInArray_1'length));

	Buffer_35_clk <= clk;
	Buffer_35_rst <= rst;
	branch_23_pValidArray_1 <= Buffer_35_validArray_0;
	Buffer_35_nReadyArray_0 <= branch_23_readyArray_1;
	branch_23_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_35_dataOutArray_0),branch_23_dataInArray_1'length));

	Buffer_36_clk <= clk;
	Buffer_36_rst <= rst;
	branchC_32_pValidArray_1 <= Buffer_36_validArray_0;
	Buffer_36_nReadyArray_0 <= branchC_32_readyArray_1;
	branchC_32_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_36_dataOutArray_0),branchC_32_dataInArray_1'length));

	Buffer_43_clk <= clk;
	Buffer_43_rst <= rst;
	branchC_32_pValidArray_0 <= Buffer_43_validArray_0;
	Buffer_43_nReadyArray_0 <= branchC_32_readyArray_0;
	branchC_32_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_43_dataOutArray_0),branchC_32_dataInArray_0'length));
	...
	add_37_clk <= clk;
	add_37_rst <= rst;
	fork_5_pValidArray_0 <= add_37_validArray_0;
	add_37_nReadyArray_0 <= fork_5_readyArray_0;
	fork_5_dataInArray_0 <= std_logic_vector (resize(unsigned(add_37_dataOutArray_0),fork_5_dataInArray_0'length));
	...
	icmp_38_clk <= clk;
	icmp_38_rst <= rst;
	fork_22_pValidArray_0 <= icmp_38_validArray_0;
	icmp_38_nReadyArray_0 <= fork_22_readyArray_0;
	fork_22_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_38_dataOutArray_0),fork_22_dataInArray_0'length));
	...
	Buffer_37_pValidArray_0 <= branch_24_validArray_1;
	branch_24_nReadyArray_1 <= Buffer_37_readyArray_0;
	Buffer_37_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_24_dataOutArray_1),Buffer_37_dataInArray_0'length));
	...
	branchC_33_clk <= clk;
	branchC_33_rst <= rst;
	phiC_16_pValidArray_1 <= branchC_33_validArray_0;
	branchC_33_nReadyArray_0 <= phiC_16_readyArray_1;
	phiC_16_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_33_dataOutArray_0),phiC_16_dataInArray_1'length));
	Buffer_44_pValidArray_0 <= branchC_33_validArray_1;
	branchC_33_nReadyArray_1 <= Buffer_44_readyArray_0;
	Buffer_44_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_33_dataOutArray_1),Buffer_44_dataInArray_0'length));
	...
	Buffer_37_clk <= clk;
	Buffer_37_rst <= rst;
	phi_n15_pValidArray_0 <= Buffer_37_validArray_0;
	Buffer_37_nReadyArray_0 <= phi_n15_readyArray_0;
	phi_n15_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_37_dataOutArray_0),phi_n15_dataInArray_0'length));

	Buffer_44_clk <= clk;
	Buffer_44_rst <= rst;
	phiC_23_pValidArray_0 <= Buffer_44_validArray_0;
	Buffer_44_nReadyArray_0 <= phiC_23_readyArray_0;
	phiC_23_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_44_dataOutArray_0),phiC_23_dataInArray_0'length));
...
Buffer_20: entity work.transpFifo(arch) generic map (1,1,1,1,4)
port map (
	clk => Buffer_20_clk,
	rst => Buffer_20_rst,
...
Buffer_9: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_9_clk,
	rst => Buffer_9_rst,
...
Buffer_10: entity work.transpFifo(arch) generic map (1,1,3,3,4)
port map (
	clk => Buffer_10_clk,
	rst => Buffer_10_rst,
...
Buffer_11: entity work.transpFifo(arch) generic map (1,1,3,3,4)
port map (
	clk => Buffer_11_clk,
	rst => Buffer_11_rst,
...
Buffer_14: entity work.TEHB(arch) generic map (1,1,3,3)
port map (
	clk => Buffer_14_clk,
	rst => Buffer_14_rst,
...
Buffer_15: entity work.TEHB(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_15_clk,
	rst => Buffer_15_rst,
...
Buffer_16: entity work.transpFifo(arch) generic map (1,1,5,5,2)
port map (
	clk => Buffer_16_clk,
	rst => Buffer_16_rst,
...
Buffer_22: entity work.elasticBuffer(arch) generic map (1,1,3,3)
port map (
	clk => Buffer_22_clk,
	rst => Buffer_22_rst,
...
Buffer_23: entity work.elasticBuffer(arch) generic map (1,1,3,3)
port map (
	clk => Buffer_23_clk,
	rst => Buffer_23_rst,
...
Buffer_24: entity work.elasticBuffer(arch) generic map (1,1,3,3)
port map (
	clk => Buffer_24_clk,
	rst => Buffer_24_rst,
...
Buffer_25: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_25_clk,
	rst => Buffer_25_rst,
...
Buffer_26: entity work.transpFifo(arch) generic map (1,1,1,1,10)
port map (
	clk => Buffer_26_clk,
	rst => Buffer_26_rst,
...
Buffer_28: entity work.transpFifo(arch) generic map (1,1,1,1,2)
port map (
	clk => Buffer_28_clk,
	rst => Buffer_28_rst,
...
Buffer_46: entity work.transpFifo(arch) generic map (1,1,1,1,9)
port map (
	clk => Buffer_46_clk,
	rst => Buffer_46_rst,
...
Buffer_12: entity work.TEHB(arch) generic map (1,1,3,3)
port map (
	clk => Buffer_12_clk,
	rst => Buffer_12_rst,
...
Buffer_30: entity work.nontranspFifo(arch) generic map (1,1,1,1,5)
port map (
	clk => Buffer_30_clk,
	rst => Buffer_30_rst,
...
Buffer_41: entity work.TEHB(arch) generic map (1,1,1,1)
port map (
	clk => Buffer_41_clk,
	rst => Buffer_41_rst,
...
Buffer_5: entity work.transpFifo(arch) generic map (1,1,11,11,2)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_13: entity work.transpFifo(arch) generic map (1,1,5,5,2)
port map (
	clk => Buffer_13_clk,
	rst => Buffer_13_rst,
...
Buffer_32: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_32_clk,
	rst => Buffer_32_rst,
...
Buffer_33: entity work.elasticBuffer(arch) generic map (1,1,5,5)
port map (
	clk => Buffer_33_clk,
	rst => Buffer_33_rst,
...
Buffer_35: entity work.transpFifo(arch) generic map (1,1,1,1,5)
port map (
	clk => Buffer_35_clk,
	rst => Buffer_35_rst,
