...
-- File created: Wed Apr 12 17:55:18 2023
...
architecture behavioral of getTanh is 
	...
	signal Buffer_1_dataInArray_0 : std_logic_vector(9 downto 0);
	...
	signal Buffer_1_dataOutArray_0 : std_logic_vector(9 downto 0);
...
begin
	...
	branchC_10_clk <= clk;
	branchC_10_rst <= rst;
	Buffer_10_pValidArray_0 <= branchC_10_validArray_0;
	branchC_10_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_10_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phiC_6_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phiC_6_readyArray_0;
	phiC_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phiC_6_dataInArray_0'length));
	...
	Buffer_2_pValidArray_0 <= fork_0_validArray_1;
	fork_0_nReadyArray_1 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_1),Buffer_2_dataInArray_0'length));
	...
	Buffer_3_pValidArray_0 <= fork_1_validArray_1;
	fork_1_nReadyArray_1 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_1),Buffer_3_dataInArray_0'length));
	...
	phiC_6_clk <= clk;
	phiC_6_rst <= rst;
	forkC_13_pValidArray_0 <= phiC_6_validArray_0;
	phiC_6_nReadyArray_0 <= forkC_13_readyArray_0;
	forkC_13_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_6_dataOutArray_0),forkC_13_dataInArray_0'length));
	...
	forkC_13_clk <= clk;
	forkC_13_rst <= rst;
	Buffer_11_pValidArray_0 <= forkC_13_validArray_0;
	forkC_13_nReadyArray_0 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_13_dataOutArray_0),Buffer_11_dataInArray_0'length));
	...
	Buffer_12_pValidArray_0 <= forkC_13_validArray_2;
	forkC_13_nReadyArray_2 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_13_dataOutArray_2),Buffer_12_dataInArray_0'length));
	...
	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	branch_2_pValidArray_0 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= branch_2_readyArray_0;
	branch_2_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),branch_2_dataInArray_0'length));

	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	branch_3_pValidArray_0 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= branch_3_readyArray_0;
	branch_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),branch_3_dataInArray_0'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	cst_4_pValidArray_0 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= cst_4_readyArray_0;
	cst_4_dataInArray_0 <= "1";

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	branchC_11_pValidArray_0 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= branchC_11_readyArray_0;
	branchC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),branchC_11_dataInArray_0'length));
	...
	Buffer_4_pValidArray_0 <= fork_5_validArray_2;
	fork_5_nReadyArray_2 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_2),Buffer_4_dataInArray_0'length));
	Buffer_5_pValidArray_0 <= fork_5_validArray_3;
	fork_5_nReadyArray_3 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_3),Buffer_5_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	mul_12_pValidArray_1 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= mul_12_readyArray_1;
	mul_12_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),mul_12_dataInArray_1'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	mul_14_pValidArray_1 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= mul_14_readyArray_1;
	mul_14_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),mul_14_dataInArray_1'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	branch_5_pValidArray_1 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= branch_5_readyArray_1;
	branch_5_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),branch_5_dataInArray_1'length));
	...
	add_19_clk <= clk;
	add_19_rst <= rst;
	Buffer_1_pValidArray_0 <= add_19_validArray_0;
	add_19_nReadyArray_0 <= Buffer_1_readyArray_0;
	Buffer_1_dataInArray_0 <= std_logic_vector (resize(unsigned(add_19_dataOutArray_0),Buffer_1_dataInArray_0'length));
	...
	phi_n1_clk <= clk;
	phi_n1_rst <= rst;
	add_19_pValidArray_0 <= phi_n1_validArray_0;
	phi_n1_nReadyArray_0 <= add_19_readyArray_0;
	add_19_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n1_dataOutArray_0),add_19_dataInArray_0'length));
	...
	Buffer_8_pValidArray_0 <= branch_8_validArray_1;
	branch_8_nReadyArray_1 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_1),Buffer_8_dataInArray_0'length));
	...
	Buffer_13_pValidArray_0 <= phiC_8_validArray_1;
	phiC_8_nReadyArray_1 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_8_dataOutArray_1),Buffer_13_dataInArray_0'length));
	...
	Buffer_14_pValidArray_0 <= forkC_15_validArray_1;
	forkC_15_nReadyArray_1 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_15_dataOutArray_1),Buffer_14_dataInArray_0'length));
	...
	Buffer_15_pValidArray_0 <= branchC_13_validArray_1;
	branchC_13_nReadyArray_1 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_13_dataOutArray_1),Buffer_15_dataInArray_0'length));
	...
	Buffer_1_clk <= clk;
	Buffer_1_rst <= rst;
	fork_4_pValidArray_0 <= Buffer_1_validArray_0;
	Buffer_1_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_1_dataOutArray_0),fork_4_dataInArray_0'length));

	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	phi_n5_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= phi_n5_readyArray_0;
	phi_n5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),phi_n5_dataInArray_0'length));
	...
	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phi_16_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phi_16_readyArray_0;
	phi_16_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phi_16_dataInArray_0'length));
	...
	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	phiC_9_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= phiC_9_readyArray_0;
	phiC_9_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),phiC_9_dataInArray_0'length));
...
Buffer_7: entity work.transpFifo(arch) generic map (1,1,1,1,2)
port map (
	clk => Buffer_7_clk,
	rst => Buffer_7_rst,
...
Buffer_1: entity work.elasticBuffer(arch) generic map (1,1,10,10)
port map (
	clk => Buffer_1_clk,
	rst => Buffer_1_rst,
