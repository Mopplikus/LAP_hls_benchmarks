; ModuleID = '.bicg.cpp_mem2reg_constprop.ll'
...
for.body3:                                        ; preds = %for.body3, %for.body
  %tmp_q.12 = phi i32 [ %0, %for.body ], [ %add17, %for.body3 ]
...
for.end:                                          ; preds = %for.body3
  %tmp_q.1.lcssa = phi i32 [ %add17, %for.body3 ]
...
for.end22:                                        ; preds = %for.end
  %tmp_q.0.lcssa = phi i32 [ %tmp_q.1.lcssa, %for.end ]
