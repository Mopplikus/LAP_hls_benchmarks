...
-- File created: Thu Apr 20 04:46:04 2023
...
begin
	...
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_0),Buffer_8_dataInArray_0'length));
	...
	branchC_9_clk <= clk;
	branchC_9_rst <= rst;
	Buffer_13_pValidArray_0 <= branchC_9_validArray_0;
	branchC_9_nReadyArray_0 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_9_dataOutArray_0),Buffer_13_dataInArray_0'length));
	...
	phi_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),phi_1_dataInArray_1'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	phiC_4_pValidArray_0 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= phiC_4_readyArray_0;
	phiC_4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),phiC_4_dataInArray_0'length));
	...
	Buffer_9_pValidArray_0 <= fork_10_validArray_2;
	fork_10_nReadyArray_2 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_2),Buffer_9_dataInArray_0'length));
	...
	phiC_4_clk <= clk;
	phiC_4_rst <= rst;
	Buffer_14_pValidArray_0 <= phiC_4_validArray_0;
	phiC_4_nReadyArray_0 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_4_dataOutArray_0),Buffer_14_dataInArray_0'length));
	...
	branch_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),branch_1_dataInArray_1'length));
	...
	icmp_28_clk <= clk;
	icmp_28_rst <= rst;
	Buffer_4_pValidArray_0 <= icmp_28_validArray_0;
	icmp_28_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_28_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	Buffer_5_pValidArray_0 <= fork_4_validArray_1;
	fork_4_nReadyArray_1 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_1),Buffer_5_dataInArray_0'length));
	...
	Buffer_7_pValidArray_0 <= fork_8_validArray_2;
	fork_8_nReadyArray_2 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_2),Buffer_7_dataInArray_0'length));
	...
	branch_5_clk <= clk;
	branch_5_rst <= rst;
	phi_7_pValidArray_2 <= branch_5_validArray_0;
	branch_5_nReadyArray_0 <= phi_7_readyArray_2;
	phi_7_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_0),phi_7_dataInArray_2'length));
	...
	branch_6_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_0),branch_6_dataInArray_1'length));
	...
	Buffer_10_pValidArray_0 <= fork_11_validArray_2;
	fork_11_nReadyArray_2 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_2),Buffer_10_dataInArray_0'length));
	branchC_11_pValidArray_1 <= fork_11_validArray_3;
	fork_11_nReadyArray_3 <= branchC_11_readyArray_1;
	branchC_11_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_3),branchC_11_dataInArray_1'length));
	...
	Buffer_15_pValidArray_0 <= forkC_17_validArray_1;
	forkC_17_nReadyArray_1 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_17_dataOutArray_1),Buffer_15_dataInArray_0'length));
	...
	fork_21_clk <= clk;
	fork_21_rst <= rst;
	Buffer_17_pValidArray_0 <= fork_21_validArray_0;
	fork_21_nReadyArray_0 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_21_dataOutArray_0),Buffer_17_dataInArray_0'length));
	...
	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	fork_11_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= fork_11_readyArray_0;
	fork_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),fork_11_dataInArray_0'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	branch_5_pValidArray_0 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= branch_5_readyArray_0;
	branch_5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),branch_5_dataInArray_0'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	branch_6_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= branch_6_readyArray_0;
	branch_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),branch_6_dataInArray_0'length));

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	branch_4_pValidArray_1 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= branch_4_readyArray_1;
	branch_4_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),branch_4_dataInArray_1'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branchC_11_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branchC_11_readyArray_0;
	branchC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branchC_11_dataInArray_0'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	phi_6_pValidArray_0 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= phi_6_readyArray_0;
	phi_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_17_dataOutArray_0),phi_6_dataInArray_0'length));
	...
	add_32_clk <= clk;
	add_32_rst <= rst;
	fork_5_pValidArray_0 <= add_32_validArray_0;
	add_32_nReadyArray_0 <= fork_5_readyArray_0;
	fork_5_dataInArray_0 <= std_logic_vector (resize(unsigned(add_32_dataOutArray_0),fork_5_dataInArray_0'length));
	...
	fork_7_clk <= clk;
	fork_7_rst <= rst;
	Buffer_6_pValidArray_0 <= fork_7_validArray_0;
	fork_7_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_0),Buffer_6_dataInArray_0'length));
	...
	Buffer_11_pValidArray_0 <= branch_8_validArray_1;
	branch_8_nReadyArray_1 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_1),Buffer_11_dataInArray_0'length));

	fork_12_clk <= clk;
	fork_12_rst <= rst;
	Buffer_12_pValidArray_0 <= fork_12_validArray_0;
	fork_12_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_0),Buffer_12_dataInArray_0'length));
	...
	Buffer_16_pValidArray_0 <= branchC_12_validArray_1;
	branchC_12_nReadyArray_1 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_12_dataOutArray_1),Buffer_16_dataInArray_0'length));
	...
	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	store_1_pValidArray_1 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= store_1_readyArray_1;
	store_1_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),store_1_dataInArray_1'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_n3_pValidArray_0 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_n3_readyArray_0;
	phi_n3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_n3_dataInArray_0'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	branch_8_pValidArray_1 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= branch_8_readyArray_1;
	branch_8_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),branch_8_dataInArray_1'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	phiC_7_pValidArray_0 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= phiC_7_readyArray_0;
	phiC_7_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),phiC_7_dataInArray_0'length));
...
Buffer_9: entity work.TEHB(arch) generic map (1,1,1,1)
port map (
	clk => Buffer_9_clk,
	rst => Buffer_9_rst,
...
Buffer_2: entity work.nontranspFifo(arch) generic map (1,1,32,32,3)
port map (
	clk => Buffer_2_clk,
	rst => Buffer_2_rst,
...
Buffer_10: entity work.transpFifo(arch) generic map (1,1,1,1,5)
port map (
	clk => Buffer_10_clk,
	rst => Buffer_10_rst,
...
Buffer_17: entity work.transpFifo(arch) generic map (1,1,1,1,5)
port map (
	clk => Buffer_17_clk,
	rst => Buffer_17_rst,
...
Buffer_6: entity work.transpFifo(arch) generic map (1,1,5,5,3)
port map (
	clk => Buffer_6_clk,
	rst => Buffer_6_rst,
...
Buffer_12: entity work.transpFifo(arch) generic map (1,1,1,1,3)
port map (
	clk => Buffer_12_clk,
	rst => Buffer_12_rst,
